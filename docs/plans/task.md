...
| Task 4: Optional Photo Review Support (requiresReview Toggle) | In Progress | Support requiresReview configuration on creation, PATCH update, and confirm upload status. |
