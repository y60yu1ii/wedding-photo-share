import { a as attr_class, d as derived, c as store_get, u as unsubscribe_stores } from "../../../../../chunks/root.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></div></div> <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#e8d5c4] mb-4"><h2 class="text-sm font-semibold mb-3">分享連結</h2> `);
    if (urls().hasKeys) {
      $$renderer2.push("<!--[0-->");
