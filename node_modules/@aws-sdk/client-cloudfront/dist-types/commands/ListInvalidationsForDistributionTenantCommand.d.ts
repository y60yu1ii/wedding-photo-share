...
import type { ListInvalidationsForDistributionTenantRequest, ListInvalidationsForDistributionTenantResult } from "../models/models_1";
/**
 * @public
 */
...
declare const ListInvalidationsForDistributionTenantCommand_base: {
    new (input: ListInvalidationsForDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<ListInvalidationsForDistributionTenantCommandInput, ListInvalidationsForDistributionTenantCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListInvalidationsForDistributionTenantCommandInput): import("@smithy/core/client").CommandImpl<ListInvalidationsForDistributionTenantCommandInput, ListInvalidationsForDistributionTenantCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
