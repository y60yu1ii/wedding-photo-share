...
import type { GetAnycastIpListRequest, GetAnycastIpListResult } from "../models/models_0";
/**
 * @public
 */
...
declare const GetAnycastIpListCommand_base: {
    new (input: GetAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<GetAnycastIpListCommandInput, GetAnycastIpListCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAnycastIpListCommandInput): import("@smithy/core/client").CommandImpl<GetAnycastIpListCommandInput, GetAnycastIpListCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
