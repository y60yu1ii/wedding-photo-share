...
import type { CreateContinuousDeploymentPolicyRequest, CreateContinuousDeploymentPolicyResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateContinuousDeploymentPolicyCommand_base: {
    new (input: CreateContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateContinuousDeploymentPolicyCommandInput, CreateContinuousDeploymentPolicyCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateContinuousDeploymentPolicyCommandInput): import("@smithy/core/client").CommandImpl<CreateContinuousDeploymentPolicyCommandInput, CreateContinuousDeploymentPolicyCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
