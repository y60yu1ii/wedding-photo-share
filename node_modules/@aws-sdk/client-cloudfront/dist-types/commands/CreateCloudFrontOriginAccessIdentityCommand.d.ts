...
import type { CreateCloudFrontOriginAccessIdentityRequest, CreateCloudFrontOriginAccessIdentityResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateCloudFrontOriginAccessIdentityCommand_base: {
    new (input: CreateCloudFrontOriginAccessIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateCloudFrontOriginAccessIdentityCommandInput, CreateCloudFrontOriginAccessIdentityCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateCloudFrontOriginAccessIdentityCommandInput): import("@smithy/core/client").CommandImpl<CreateCloudFrontOriginAccessIdentityCommandInput, CreateCloudFrontOriginAccessIdentityCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
