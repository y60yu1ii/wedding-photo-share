...
import type { CreateInvalidationRequest, CreateInvalidationResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateInvalidationCommand_base: {
    new (input: CreateInvalidationCommandInput): import("@smithy/core/client").CommandImpl<CreateInvalidationCommandInput, CreateInvalidationCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateInvalidationCommandInput): import("@smithy/core/client").CommandImpl<CreateInvalidationCommandInput, CreateInvalidationCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
