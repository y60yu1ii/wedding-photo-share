...
import type { DescribeConnectionFunctionRequest, DescribeConnectionFunctionResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeConnectionFunctionCommand_base: {
    new (input: DescribeConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionFunctionCommandInput, DescribeConnectionFunctionCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeConnectionFunctionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionFunctionCommandInput, DescribeConnectionFunctionCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
