...
import type { CreateFieldLevelEncryptionProfileRequest, CreateFieldLevelEncryptionProfileResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateFieldLevelEncryptionProfileCommand_base: {
    new (input: CreateFieldLevelEncryptionProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateFieldLevelEncryptionProfileCommandInput, CreateFieldLevelEncryptionProfileCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateFieldLevelEncryptionProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateFieldLevelEncryptionProfileCommandInput, CreateFieldLevelEncryptionProfileCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
