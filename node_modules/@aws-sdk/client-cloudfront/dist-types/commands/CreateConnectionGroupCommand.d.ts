...
import type { CreateConnectionGroupRequest, CreateConnectionGroupResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateConnectionGroupCommand_base: {
    new (input: CreateConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionGroupCommandInput, CreateConnectionGroupCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateConnectionGroupCommandInput): import("@smithy/core/client").CommandImpl<CreateConnectionGroupCommandInput, CreateConnectionGroupCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
