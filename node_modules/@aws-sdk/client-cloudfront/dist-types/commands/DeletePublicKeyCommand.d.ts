...
import type { DeletePublicKeyRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const DeletePublicKeyCommand_base: {
    new (input: DeletePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicKeyCommandInput, DeletePublicKeyCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeletePublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeletePublicKeyCommandInput, DeletePublicKeyCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
