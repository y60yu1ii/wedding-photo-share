...
import type { CreateFieldLevelEncryptionConfigRequest, CreateFieldLevelEncryptionConfigResult } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateFieldLevelEncryptionConfigCommand_base: {
    new (input: CreateFieldLevelEncryptionConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateFieldLevelEncryptionConfigCommandInput, CreateFieldLevelEncryptionConfigCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateFieldLevelEncryptionConfigCommandInput): import("@smithy/core/client").CommandImpl<CreateFieldLevelEncryptionConfigCommandInput, CreateFieldLevelEncryptionConfigCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
