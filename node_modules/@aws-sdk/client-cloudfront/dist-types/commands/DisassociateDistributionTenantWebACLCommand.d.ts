...
import type { DisassociateDistributionTenantWebACLRequest, DisassociateDistributionTenantWebACLResult } from "../models/models_0";
/**
 * @public
 */
...
declare const DisassociateDistributionTenantWebACLCommand_base: {
    new (input: DisassociateDistributionTenantWebACLCommandInput): import("@smithy/core/client").CommandImpl<DisassociateDistributionTenantWebACLCommandInput, DisassociateDistributionTenantWebACLCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DisassociateDistributionTenantWebACLCommandInput): import("@smithy/core/client").CommandImpl<DisassociateDistributionTenantWebACLCommandInput, DisassociateDistributionTenantWebACLCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
