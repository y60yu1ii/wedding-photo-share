...
import type { UpdateCloudFrontOriginAccessIdentityRequest, UpdateCloudFrontOriginAccessIdentityResult } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateCloudFrontOriginAccessIdentityCommand_base: {
    new (input: UpdateCloudFrontOriginAccessIdentityCommandInput): import("@smithy/core/client").CommandImpl<UpdateCloudFrontOriginAccessIdentityCommandInput, UpdateCloudFrontOriginAccessIdentityCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateCloudFrontOriginAccessIdentityCommandInput): import("@smithy/core/client").CommandImpl<UpdateCloudFrontOriginAccessIdentityCommandInput, UpdateCloudFrontOriginAccessIdentityCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
