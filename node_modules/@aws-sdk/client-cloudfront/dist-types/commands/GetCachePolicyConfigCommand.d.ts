...
import type { GetCachePolicyConfigRequest, GetCachePolicyConfigResult } from "../models/models_0";
/**
 * @public
 */
...
declare const GetCachePolicyConfigCommand_base: {
    new (input: GetCachePolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyConfigCommandInput, GetCachePolicyConfigCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetCachePolicyConfigCommandInput): import("@smithy/core/client").CommandImpl<GetCachePolicyConfigCommandInput, GetCachePolicyConfigCommandOutput, CloudFrontClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
