...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef, cdk.ITaggable {
     ...
     * Use this parameter if the project will use *client-side evaluation powered by AWS AppConfig* .
     */
    get appConfigResource(): CfnProject.AppConfigResourceObjectProperty | cdk.IResolvable | undefined;
    /**
     * Use this parameter if the project will use *client-side evaluation powered by AWS AppConfig* .
     */
    set appConfigResource(value: CfnProject.AppConfigResourceObjectProperty | cdk.IResolvable | undefined);
    /**
     * A structure that contains information about where Evidently is to store evaluation events for longer term storage, if you choose to do so.
     */
    get dataDelivery(): CfnProject.DataDeliveryObjectProperty | cdk.IResolvable | undefined;
    /**
     * A structure that contains information about where Evidently is to store evaluation events for longer term storage, if you choose to do so.
     */
    set dataDelivery(value: CfnProject.DataDeliveryObjectProperty | cdk.IResolvable | undefined);
    /**
     * An optional description of the project.
     */
    get description(): string | undefined;
