...
import { ByteMatchSetReference, IByteMatchSetRef, IIPSetRef, IPSetReference, IRuleRef, ISizeConstraintSetRef, ISqlInjectionMatchSetRef, IWebACLRef, IXssMatchSetRef, RuleReference, SizeConstraintSetReference, SqlInjectionMatchSetReference, WebACLReference, XssMatchSetReference } from "../../interfaces/generated/aws-waf-interfaces.generated";
/**
...
export declare class CfnSizeConstraintSet extends cdk.CfnResource implements cdk.IInspectable, ISizeConstraintSetRef {
     ...
     * The size constraint and the part of the web request to check.
     */
    get sizeConstraints(): Array<cdk.IResolvable | CfnSizeConstraintSet.SizeConstraintProperty> | cdk.IResolvable;
    /**
     * The size constraint and the part of the web request to check.
     */
    set sizeConstraints(value: Array<cdk.IResolvable | CfnSizeConstraintSet.SizeConstraintProperty> | cdk.IResolvable);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnWebACL extends cdk.CfnResource implements cdk.IInspectable, IWebACLRef {
     ...
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    get defaultAction(): cdk.IResolvable | CfnWebACL.WafActionProperty;
    /**
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    set defaultAction(value: cdk.IResolvable | CfnWebACL.WafActionProperty);
    /**
     * The name of the metrics for this `WebACL` .
     */
    get metricName(): string;
     ...
     * An array that contains the action for each `Rule` in a `WebACL` , the priority of the `Rule` , and the ID of the `Rule` .
     */
    get rules(): Array<CfnWebACL.ActivatedRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array that contains the action for each `Rule` in a `WebACL` , the priority of the `Rule` , and the ID of the `Rule` .
     */
    set rules(value: Array<CfnWebACL.ActivatedRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnXssMatchSet extends cdk.CfnResource implements cdk.IInspectable, IXssMatchSetRef {
     ...
     * Specifies the parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    get xssMatchTuples(): Array<cdk.IResolvable | CfnXssMatchSet.XssMatchTupleProperty> | cdk.IResolvable;
    /**
     * Specifies the parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    set xssMatchTuples(value: Array<cdk.IResolvable | CfnXssMatchSet.XssMatchTupleProperty> | cdk.IResolvable);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
