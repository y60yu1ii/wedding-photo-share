...
export declare class CfnPublicRepository extends cdk.CfnResource implements cdk.IInspectable, IPublicRepositoryRef, cdk.ITaggable {
     ...
     */
    private _repositoryCatalogData?;
    /**
     ...
     * The details about the repository that are publicly visible in the Amazon ECR Public Gallery.
     */
    get repositoryCatalogData(): any | cdk.IResolvable | undefined;
    /**
     * The details about the repository that are publicly visible in the Amazon ECR Public Gallery.
     */
    set repositoryCatalogData(value: any | cdk.IResolvable | undefined);
    /**
     * The name to use for the public repository.
     */
     ...
     * The name to use for the public repository.
     */
    set repositoryName(value: string | undefined);
    /**
     * The JSON repository policy text to apply to the public repository.
     */
    get repositoryPolicyText(): any | cdk.IResolvable | undefined;
    /**
     * The JSON repository policy text to apply to the public repository.
     */
    set repositoryPolicyText(value: any | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare class CfnPullThroughCacheRule extends cdk.CfnResource implements cdk.IInspectable, IPullThroughCacheRuleRef {
     ...
     * The ARN of the Secrets Manager secret associated with the pull through cache rule.
     */
    get credentialArn(): string | undefined;
    /**
     * The ARN of the Secrets Manager secret associated with the pull through cache rule.
     */
    set credentialArn(value: string | undefined);
    /**
     * The ARN of the IAM role associated with the pull through cache rule.
     */
    get customRoleArn(): string | undefined;
    /**
     * The ARN of the IAM role associated with the pull through cache rule.
     */
    set customRoleArn(value: string | undefined);
    /**
     * The Amazon ECR repository prefix associated with the pull through cache rule.
     */
    get ecrRepositoryPrefix(): string | undefined;
    /**
     * The Amazon ECR repository prefix associated with the pull through cache rule.
     */
    set ecrRepositoryPrefix(value: string | undefined);
    /**
     * The name of the upstream source registry associated with the pull through cache rule.
     */
    get upstreamRegistry(): string | undefined;
    /**
     * The name of the upstream source registry associated with the pull through cache rule.
     */
    set upstreamRegistry(value: string | undefined);
    /**
     * The upstream registry URL associated with the pull through cache rule.
     */
    get upstreamRegistryUrl(): string | undefined;
    /**
     * The upstream registry URL associated with the pull through cache rule.
     */
    set upstreamRegistryUrl(value: string | undefined);
    /**
     * The upstream repository prefix associated with the pull through cache rule.
     */
    get upstreamRepositoryPrefix(): string | undefined;
    /**
     * The upstream repository prefix associated with the pull through cache rule.
     */
    set upstreamRepositoryPrefix(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnReplicationConfiguration extends cdk.CfnResource implements cdk.IInspectable, IReplicationConfigurationRef {
     ...
     * The replication configuration for a registry.
     */
    get replicationConfiguration(): cdk.IResolvable | CfnReplicationConfiguration.ReplicationConfigurationProperty;
    /**
     * The replication configuration for a registry.
     */
    set replicationConfiguration(value: cdk.IResolvable | CfnReplicationConfiguration.ReplicationConfigurationProperty);
    /**
...
export declare class CfnRepository extends cdk.CfnResource implements cdk.IInspectable, IRepositoryRef, cdk.ITaggable {
     ...
     */
    private _imageTagMutabilityExclusionFilters?;
    /**
     ...
     * If true, deleting the repository force deletes the contents of the repository.
     */
    get emptyOnDelete(): boolean | cdk.IResolvable | undefined;
    /**
     * If true, deleting the repository force deletes the contents of the repository.
     */
    set emptyOnDelete(value: boolean | cdk.IResolvable | undefined);
    /**
     * The encryption configuration for the repository.
     */
    get encryptionConfiguration(): CfnRepository.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The encryption configuration for the repository.
     */
    set encryptionConfiguration(value: CfnRepository.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * > The `imageScanningConfiguration` parameter is being deprecated, in favor of specifying the image scanning configuration at the registry level.
     */
    get imageScanningConfiguration(): CfnRepository.ImageScanningConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * > The `imageScanningConfiguration` parameter is being deprecated, in favor of specifying the image scanning configuration at the registry level.
     */
    set imageScanningConfiguration(value: CfnRepository.ImageScanningConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The tag mutability setting for the repository.
     */
     ...
     * A list of filters that specify which image tags are excluded from the repository's image tag mutability setting.
     */
    get imageTagMutabilityExclusionFilters(): Array<CfnRepository.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of filters that specify which image tags are excluded from the repository's image tag mutability setting.
     */
    set imageTagMutabilityExclusionFilters(value: Array<CfnRepository.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Creates or updates a lifecycle policy.
     */
    get lifecyclePolicy(): cdk.IResolvable | CfnRepository.LifecyclePolicyProperty | undefined;
    /**
     * Creates or updates a lifecycle policy.
     */
    set lifecyclePolicy(value: cdk.IResolvable | CfnRepository.LifecyclePolicyProperty | undefined);
    /**
     * The name to use for the repository.
     */
    get repositoryName(): string | undefined;
...
export declare class CfnRegistryScanningConfiguration extends cdk.CfnResource implements cdk.IInspectable, IRegistryScanningConfigurationRef {
     ...
     * The scanning rules associated with the registry.
     */
    get rules(): Array<cdk.IResolvable | CfnRegistryScanningConfiguration.ScanningRuleProperty> | cdk.IResolvable;
    /**
     * The scanning rules associated with the registry.
     */
    set rules(value: Array<cdk.IResolvable | CfnRegistryScanningConfiguration.ScanningRuleProperty> | cdk.IResolvable);
    /**
     * The type of scanning configured for the registry.
     */
    get scanType(): string;
...
export declare class CfnRepositoryCreationTemplate extends cdk.CfnResource implements cdk.IInspectable, IRepositoryCreationTemplateRef {
     ...
     * A list of enumerable Strings representing the repository creation scenarios that this template will apply towards.
     */
    get appliedFor(): Array<string>;
    /**
     * A list of enumerable Strings representing the repository creation scenarios that this template will apply towards.
     */
    set appliedFor(value: Array<string>);
    /**
     * The ARN of the role to be assumed by Amazon ECR.
     */
    get customRoleArn(): string | undefined;
     ...
     * The encryption configuration associated with the repository creation template.
     */
    get encryptionConfiguration(): CfnRepositoryCreationTemplate.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The encryption configuration associated with the repository creation template.
     */
    set encryptionConfiguration(value: CfnRepositoryCreationTemplate.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The tag mutability setting for the repository.
     */
    get imageTagMutability(): string | undefined;
     ...
     * A list of filters that specify which image tags are excluded from the repository creation template's image tag mutability setting.
     */
    get imageTagMutabilityExclusionFilters(): Array<CfnRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of filters that specify which image tags are excluded from the repository creation template's image tag mutability setting.
     */
    set imageTagMutabilityExclusionFilters(value: Array<CfnRepositoryCreationTemplate.ImageTagMutabilityExclusionFilterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The lifecycle policy to use for repositories created using the template.
     */
    get lifecyclePolicy(): string | undefined;
    /**
     * The lifecycle policy to use for repositories created using the template.
     */
    set lifecyclePolicy(value: string | undefined);
    /**
     * The repository namespace prefix associated with the repository creation template.
     */
    get prefix(): string;
     ...
     * The repository policy to apply to repositories created using the template.
     */
    get repositoryPolicy(): string | undefined;
    /**
     * The repository policy to apply to repositories created using the template.
     */
    set repositoryPolicy(value: string | undefined);
    /**
     * The metadata to apply to the repository to help you categorize and organize.
     */
    get resourceTags(): Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The metadata to apply to the repository to help you categorize and organize.
     */
    set resourceTags(value: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnSigningConfiguration extends cdk.CfnResource implements cdk.IInspectable, ISigningConfigurationRef {
     ...
     * A list of signing rules.
     */
    get rules(): Array<cdk.IResolvable | CfnSigningConfiguration.RuleProperty> | cdk.IResolvable;
    /**
     * A list of signing rules.
     */
    set rules(value: Array<cdk.IResolvable | CfnSigningConfiguration.RuleProperty> | cdk.IResolvable);
    /**
     * The account ID of the destination registry.
     *
     * @cloudformationAttribute RegistryId
