...
import { AwsLogSourceReference, DataLakeReference, IAwsLogSourceRef, IDataLakeRef, ISubscriberNotificationRef, ISubscriberRef, SubscriberNotificationReference, SubscriberReference } from "../../interfaces/generated/aws-securitylake-interfaces.generated";
/**
...
export declare class CfnAwsLogSource extends cdk.CfnResource implements cdk.IInspectable, IAwsLogSourceRef {
     ...
     * Specify the AWS account information where you want to enable Security Lake.
     */
    get accounts(): Array<string> | undefined;
    /**
     * Specify the AWS account information where you want to enable Security Lake.
     */
    set accounts(value: Array<string> | undefined);
    /**
     * The Amazon Resource Name (ARN) used to create the data lake.
     */
    get dataLakeArn(): string;
    /**
     * The Amazon Resource Name (ARN) used to create the data lake.
     */
    set dataLakeArn(value: string);
    /**
     * The name for a AWS source.
     */
...
export declare class CfnDataLake extends cdk.CfnResource implements cdk.IInspectable, IDataLakeRef, cdk.ITaggableV2 {
     ...
     * Provides encryption details of the Amazon Security Lake object.
     */
    get encryptionConfiguration(): CfnDataLake.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Provides encryption details of the Amazon Security Lake object.
     */
    set encryptionConfiguration(value: CfnDataLake.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * You can customize Security Lake to store data in your preferred AWS Regions for your preferred amount of time.
     */
    get lifecycleConfiguration(): cdk.IResolvable | CfnDataLake.LifecycleConfigurationProperty | undefined;
    /**
     * You can customize Security Lake to store data in your preferred AWS Regions for your preferred amount of time.
     */
    set lifecycleConfiguration(value: cdk.IResolvable | CfnDataLake.LifecycleConfigurationProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) used to create and update the AWS Glue table.
     */
    get metaStoreManagerRoleArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) used to create and update the AWS Glue table.
     */
    set metaStoreManagerRoleArn(value: string | undefined);
    /**
     * Provides replication details of Amazon Security Lake object.
     */
    get replicationConfiguration(): cdk.IResolvable | CfnDataLake.ReplicationConfigurationProperty | undefined;
    /**
     * Provides replication details of Amazon Security Lake object.
     */
    set replicationConfiguration(value: cdk.IResolvable | CfnDataLake.ReplicationConfigurationProperty | undefined);
    /**
     * An array of objects, one for each tag to associate with the data lake configuration.
     */
...
export declare class CfnSubscriber extends cdk.CfnResource implements cdk.IInspectable, ISubscriberRef, cdk.ITaggableV2 {
     ...
     * You can choose to notify subscribers of new objects with an Amazon Simple Queue Service (Amazon SQS) queue or through messaging to an HTTPS endpoint provided by the subscriber.
     */
    get accessTypes(): Array<string>;
    /**
     * You can choose to notify subscribers of new objects with an Amazon Simple Queue Service (Amazon SQS) queue or through messaging to an HTTPS endpoint provided by the subscriber.
     */
    set accessTypes(value: Array<string>);
    /**
     * The Amazon Resource Name (ARN) used to create the data lake.
     */
    get dataLakeArn(): string;
     ...
     * Amazon Security Lake supports log and event collection for natively supported AWS services .
     */
    get sources(): Array<cdk.IResolvable | CfnSubscriber.SourceProperty> | cdk.IResolvable;
    /**
     * Amazon Security Lake supports log and event collection for natively supported AWS services .
     */
    set sources(value: Array<cdk.IResolvable | CfnSubscriber.SourceProperty> | cdk.IResolvable);
    /**
     * The subscriber descriptions for a subscriber account.
     */
    get subscriberDescription(): string | undefined;
    /**
     * The subscriber descriptions for a subscriber account.
     */
    set subscriberDescription(value: string | undefined);
    /**
     * The AWS identity used to access your data.
     */
    get subscriberIdentity(): cdk.IResolvable | CfnSubscriber.SubscriberIdentityProperty;
    /**
     * The AWS identity used to access your data.
     */
    set subscriberIdentity(value: cdk.IResolvable | CfnSubscriber.SubscriberIdentityProperty);
    /**
     * The name of your Amazon Security Lake subscriber account.
     */
     ...
     */
    get attrResourceShareName(): string;
    /**
     ...
     */
    get attrSubscriberRoleArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnSubscriberNotification extends cdk.CfnResource implements cdk.IInspectable, ISubscriberNotificationRef {
     ...
     * Specify the configurations you want to use for subscriber notification.
     */
    get notificationConfiguration(): cdk.IResolvable | CfnSubscriberNotification.NotificationConfigurationProperty;
    /**
     * Specify the configurations you want to use for subscriber notification.
     */
    set notificationConfiguration(value: cdk.IResolvable | CfnSubscriberNotification.NotificationConfigurationProperty);
    /**
     * The Amazon Resource Name (ARN) of the Security Lake subscriber.
     */
    get subscriberArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the Security Lake subscriber.
     */
    set subscriberArn(value: string);
    /**
     * The endpoint the subscriber should listen to for notifications
     *
     * @cloudformationAttribute SubscriberEndpoint
     */
    get attrSubscriberEndpoint(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
