...
export declare class CfnBrowserSettings extends cdk.CfnResource implements cdk.IInspectable, IBrowserSettingsRef, cdk.ITaggableV2 {
     ...
     */
    private _webContentFilteringPolicy?;
    /**
     ...
     * A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
     */
    get browserPolicy(): string | undefined;
    /**
     * A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
     */
     ...
     * The custom managed key of the browser settings.
     */
    get customerManagedKey(): string | undefined;
    /**
     * The custom managed key of the browser settings.
     */
    set customerManagedKey(value: string | undefined);
    /**
     * The tags to add to the browser settings resource.
     */
     ...
     * The policy that specifies which URLs end users are allowed to access or which URLs or domain categories they are restricted from accessing for enhanced security.
     */
    get webContentFilteringPolicy(): cdk.IResolvable | CfnBrowserSettings.WebContentFilteringPolicyProperty | undefined;
    /**
     * The policy that specifies which URLs end users are allowed to access or which URLs or domain categories they are restricted from accessing for enhanced security.
     */
    set webContentFilteringPolicy(value: cdk.IResolvable | CfnBrowserSettings.WebContentFilteringPolicyProperty | undefined);
    /**
     ...
     */
    get attrAssociatedPortalArns(): Array<string>;
    /**
     * The ARN of the browser settings.
     *
     * @cloudformationAttribute BrowserSettingsArn
     */
    get attrBrowserSettingsArn(): string;
...
export declare class CfnIdentityProvider extends cdk.CfnResource implements cdk.IInspectable, IIdentityProviderRef, cdk.ITaggableV2 {
     ...
     * The identity provider details. The following list describes the provider detail keys for each identity provider type.
     */
    get identityProviderDetails(): cdk.IResolvable | Record<string, string>;
    /**
     * The identity provider details. The following list describes the provider detail keys for each identity provider type.
     */
    set identityProviderDetails(value: cdk.IResolvable | Record<string, string>);
    /**
     * The identity provider name.
     */
     ...
     * The ARN of the identity provider.
     */
    get portalArn(): string | undefined;
    /**
     * The ARN of the identity provider.
     */
    set portalArn(value: string | undefined);
    get tags(): Array<cdk.CfnTag> | undefined;
    set tags(value: Array<cdk.CfnTag> | undefined);
    /**
     * The ARN of the identity provider.
     ...
     */
    get attrIdentityProviderArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnIpAccessSettings extends cdk.CfnResource implements cdk.IInspectable, IIpAccessSettingsRef, cdk.ITaggableV2 {
     ...
     * The IP rules of the IP access settings.
     */
    get ipRules(): Array<CfnIpAccessSettings.IpRuleProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The IP rules of the IP access settings.
     */
    set ipRules(value: Array<CfnIpAccessSettings.IpRuleProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The tags to add to the IP access settings resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrIpAccessSettingsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnNetworkSettings extends cdk.CfnResource implements cdk.IInspectable, INetworkSettingsRef, cdk.ITaggableV2 {
     ...
     */
    get attrNetworkSettingsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnPortal extends cdk.CfnResource implements cdk.IInspectable, IPortalRef, cdk.ITaggableV2 {
     ...
     */
    private _dataProtectionSettingsArn?;
    /**
     ...
     */
    private _networkSettingsArn?;
    private _portalCustomDomain?;
    /**
     * The ARN of the session logger that is associated with the portal.
     */
    private _sessionLoggerArn?;
    /**
     ...
     */
    private _userAccessLoggingSettingsArn?;
    /**
     ...
     * The ARN of the browser settings that is associated with this web portal.
     */
    get browserSettingsArn(): string | undefined;
    /**
     * The ARN of the browser settings that is associated with this web portal.
     */
    set browserSettingsArn(value: string | undefined);
    /**
     * The customer managed key of the web portal.
     */
    get customerManagedKey(): string | undefined;
     ...
     * The ARN of the data protection settings.
     */
    get dataProtectionSettingsArn(): string | undefined;
    /**
     * The ARN of the data protection settings.
     */
    set dataProtectionSettingsArn(value: string | undefined);
    /**
     * The name of the web portal.
     */
    get displayName(): string | undefined;
     ...
     * The ARN of the IP access settings that is associated with the web portal.
     */
    get ipAccessSettingsArn(): string | undefined;
    /**
     * The ARN of the IP access settings that is associated with the web portal.
     */
    set ipAccessSettingsArn(value: string | undefined);
    /**
     * The maximum number of concurrent sessions for the portal.
     */
     ...
     * The ARN of the network settings that is associated with the web portal.
     */
    get networkSettingsArn(): string | undefined;
    /**
     * The ARN of the network settings that is associated with the web portal.
     */
    set networkSettingsArn(value: string | undefined);
    get portalCustomDomain(): string | undefined;
    set portalCustomDomain(value: string | undefined);
    /**
     * The ARN of the session logger that is associated with the portal.
     */
    get sessionLoggerArn(): string | undefined;
    /**
     * The ARN of the session logger that is associated with the portal.
     */
    set sessionLoggerArn(value: string | undefined);
    /**
     * The tags to add to the web portal.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * The ARN of the user access logging settings that is associated with the web portal.
     */
    get userAccessLoggingSettingsArn(): string | undefined;
    /**
     * The ARN of the user access logging settings that is associated with the web portal.
     */
    set userAccessLoggingSettingsArn(value: string | undefined);
    /**
     * The ARN of the user settings that is associated with the web portal.
     */
    get userSettingsArn(): string | undefined;
    /**
     * The ARN of the user settings that is associated with the web portal.
     */
    set userSettingsArn(value: string | undefined);
    /**
     * The browser that users see when using a streaming session.
     *
     * @cloudformationAttribute BrowserType
     */
    get attrBrowserType(): string;
    /**
...
export declare class CfnTrustStore extends cdk.CfnResource implements cdk.IInspectable, ITrustStoreRef, cdk.ITaggableV2 {
     ...
     * A list of CA certificates to be added to the trust store.
     */
    get certificateList(): Array<string>;
    /**
     * A list of CA certificates to be added to the trust store.
     */
    set certificateList(value: Array<string>);
    /**
     * The tags to add to the trust store.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnUserAccessLoggingSettings extends cdk.CfnResource implements cdk.IInspectable, IUserAccessLoggingSettingsRef, cdk.ITaggableV2 {
     ...
     */
    get attrUserAccessLoggingSettingsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnUserSettings extends cdk.CfnResource implements cdk.IInspectable, IUserSettingsRef, cdk.ITaggableV2 {
     ...
     */
    private _brandingConfiguration?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * The branding configuration that customizes the appearance of the web portal for end users.
     */
    get brandingConfiguration(): CfnUserSettings.BrandingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The branding configuration that customizes the appearance of the web portal for end users.
     */
    set brandingConfiguration(value: CfnUserSettings.BrandingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The configuration that specifies which cookies should be synchronized from the end user's local browser to the remote browser.
     */
    get cookieSynchronizationConfiguration(): CfnUserSettings.CookieSynchronizationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration that specifies which cookies should be synchronized from the end user's local browser to the remote browser.
     */
    set cookieSynchronizationConfiguration(value: CfnUserSettings.CookieSynchronizationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether the user can copy text from the streaming session to the local device.
     */
     ...
     * Specifies whether the user can use deep links that open automatically when connecting to a session.
     */
    get deepLinkAllowed(): string | undefined;
    /**
     * Specifies whether the user can use deep links that open automatically when connecting to a session.
     */
    set deepLinkAllowed(value: string | undefined);
    /**
     * The amount of time that a streaming session remains active after users disconnect.
     */
    get disconnectTimeoutInMinutes(): number | undefined;
    /**
     * The amount of time that a streaming session remains active after users disconnect.
     */
    set disconnectTimeoutInMinutes(value: number | undefined);
    /**
     * Specifies whether the user can download files from the streaming session to the local device.
     */
     ...
     * The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the disconnect timeout interval begins.
     */
    get idleDisconnectTimeoutInMinutes(): number | undefined;
    /**
     * The amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the disconnect timeout interval begins.
     */
    set idleDisconnectTimeoutInMinutes(value: number | undefined);
    /**
     * Specifies whether the user can paste text from the local device to the streaming session.
     */
     ...
     * The configuration of the toolbar.
     */
    get toolbarConfiguration(): cdk.IResolvable | CfnUserSettings.ToolbarConfigurationProperty | undefined;
    /**
     * The configuration of the toolbar.
     */
    set toolbarConfiguration(value: cdk.IResolvable | CfnUserSettings.ToolbarConfigurationProperty | undefined);
    /**
     * Specifies whether the user can upload files from the local device to the streaming session.
     */
     ...
     * Specifies whether the user can use WebAuthn redirection for passwordless login to websites within the streaming session.
     */
    get webAuthnAllowed(): string | undefined;
    /**
     * Specifies whether the user can use WebAuthn redirection for passwordless login to websites within the streaming session.
     */
    set webAuthnAllowed(value: string | undefined);
    /**
     ...
     */
    get attrBrandingConfigurationFaviconMetadata(): cdk.IResolvable;
    /**
     ...
     */
    get attrBrandingConfigurationLogoMetadata(): cdk.IResolvable;
    /**
     ...
     */
    get attrBrandingConfigurationWallpaperMetadata(): cdk.IResolvable;
    /**
     * The ARN of the user settings.
     *
     * @cloudformationAttribute UserSettingsArn
     */
    get attrUserSettingsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDataProtectionSettings extends cdk.CfnResource implements cdk.IInspectable, IDataProtectionSettingsRef, cdk.ITaggableV2 {
     ...
     * The inline redaction configuration for the data protection settings.
     */
    get inlineRedactionConfiguration(): CfnDataProtectionSettings.InlineRedactionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The inline redaction configuration for the data protection settings.
     */
    set inlineRedactionConfiguration(value: CfnDataProtectionSettings.InlineRedactionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The tags of the data protection settings.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDataProtectionSettingsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnSessionLogger extends cdk.CfnResource implements cdk.IInspectable, ISessionLoggerRef, cdk.ITaggableV2 {
     ...
     * The filter that specifies which events to monitor.
     */
    get eventFilter(): CfnSessionLogger.EventFilterProperty | cdk.IResolvable;
    /**
     * The filter that specifies which events to monitor.
     */
    set eventFilter(value: CfnSessionLogger.EventFilterProperty | cdk.IResolvable);
    /**
     * The configuration that specifies where logs are fowarded.
     */
    get logConfiguration(): cdk.IResolvable | CfnSessionLogger.LogConfigurationProperty;
    /**
     * The configuration that specifies where logs are fowarded.
     */
    set logConfiguration(value: cdk.IResolvable | CfnSessionLogger.LogConfigurationProperty);
    /**
     * The tags of the session logger.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrSessionLoggerArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
