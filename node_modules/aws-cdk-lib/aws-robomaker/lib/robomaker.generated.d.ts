...
import { FleetReference, IFleetRef, IRobotApplicationRef, IRobotApplicationVersionRef, IRobotRef, ISimulationApplicationRef, ISimulationApplicationVersionRef, RobotApplicationReference, RobotApplicationVersionReference, RobotReference, SimulationApplicationReference, SimulationApplicationVersionReference } from "../../interfaces/generated/aws-robomaker-interfaces.generated";
import { aws_robomaker as roboMakerRefs } from "../../interfaces";
/**
...
export declare class CfnRobot extends cdk.CfnResource implements cdk.IInspectable, IRobotRef, cdk.ITaggable {
     ...
     * The Amazon Resource Name (ARN) of the fleet to which the robot will be registered.
     */
    get fleet(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the fleet to which the robot will be registered.
     */
    set fleet(value: string | undefined);
    /**
     * The Greengrass group associated with the robot.
     */
...
export declare class CfnRobotApplication extends cdk.CfnResource implements cdk.IInspectable, IRobotApplicationRef, cdk.ITaggable {
     ...
     * The current revision id.
     */
    get currentRevisionId(): string | undefined;
    /**
     * The current revision id.
     */
    set currentRevisionId(value: string | undefined);
    /**
     * The environment of the robot application.
     */
     ...
     * The robot software suite used by the robot application.
     */
    get robotSoftwareSuite(): cdk.IResolvable | CfnRobotApplication.RobotSoftwareSuiteProperty;
    /**
     * The robot software suite used by the robot application.
     */
    set robotSoftwareSuite(value: cdk.IResolvable | CfnRobotApplication.RobotSoftwareSuiteProperty);
    /**
     * The sources of the robot application.
     */
    get sources(): Array<cdk.IResolvable | CfnRobotApplication.SourceConfigProperty> | cdk.IResolvable | undefined;
    /**
     * The sources of the robot application.
     */
    set sources(value: Array<cdk.IResolvable | CfnRobotApplication.SourceConfigProperty> | cdk.IResolvable | undefined);
    /**
     * A map that contains tag keys and tag values that are attached to the robot application.
     */
    get tagsRaw(): Record<string, string> | undefined;
     ...
     */
    get attrCurrentRevisionId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnRobotApplicationVersion extends cdk.CfnResource implements cdk.IInspectable, IRobotApplicationVersionRef {
     ...
     */
    get attrApplicationVersion(): string;
    /**
...
export declare class CfnSimulationApplication extends cdk.CfnResource implements cdk.IInspectable, ISimulationApplicationRef, cdk.ITaggable {
     ...
     * The rendering engine for the simulation application.
     */
    get renderingEngine(): cdk.IResolvable | CfnSimulationApplication.RenderingEngineProperty | undefined;
    /**
     * The rendering engine for the simulation application.
     */
    set renderingEngine(value: cdk.IResolvable | CfnSimulationApplication.RenderingEngineProperty | undefined);
    /**
     * The robot software suite used by the simulation application.
     */
    get robotSoftwareSuite(): cdk.IResolvable | CfnSimulationApplication.RobotSoftwareSuiteProperty;
    /**
     * The robot software suite used by the simulation application.
     */
    set robotSoftwareSuite(value: cdk.IResolvable | CfnSimulationApplication.RobotSoftwareSuiteProperty);
    /**
     * The simulation software suite used by the simulation application.
     */
    get simulationSoftwareSuite(): cdk.IResolvable | CfnSimulationApplication.SimulationSoftwareSuiteProperty;
    /**
     * The simulation software suite used by the simulation application.
     */
    set simulationSoftwareSuite(value: cdk.IResolvable | CfnSimulationApplication.SimulationSoftwareSuiteProperty);
    /**
     * The sources of the simulation application.
     */
    get sources(): Array<cdk.IResolvable | CfnSimulationApplication.SourceConfigProperty> | cdk.IResolvable | undefined;
    /**
     * The sources of the simulation application.
     */
    set sources(value: Array<cdk.IResolvable | CfnSimulationApplication.SourceConfigProperty> | cdk.IResolvable | undefined);
    /**
     * A map that contains tag keys and tag values that are attached to the simulation application.
     */
    get tagsRaw(): Record<string, string> | undefined;
