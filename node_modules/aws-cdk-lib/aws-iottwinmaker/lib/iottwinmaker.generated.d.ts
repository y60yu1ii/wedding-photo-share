...
import { ComponentTypeReference, EntityReference, IComponentTypeRef, IEntityRef, ISceneRef, ISyncJobRef, IWorkspaceRef, SceneReference, SyncJobReference, WorkspaceReference } from "../../interfaces/generated/aws-iottwinmaker-interfaces.generated";
import { aws_iam as iamRefs, aws_s3 as s3Refs } from "../../interfaces";
/**
...
export declare class CfnComponentType extends cdk.CfnResource implements cdk.IInspectable, IComponentTypeRef, cdk.ITaggable {
     ...
     * Maps strings to `compositeComponentTypes` of the `componentType` .
     */
    get compositeComponentTypes(): cdk.IResolvable | Record<string, CfnComponentType.CompositeComponentTypeProperty | cdk.IResolvable> | undefined;
    /**
     * Maps strings to `compositeComponentTypes` of the `componentType` .
     */
    set compositeComponentTypes(value: cdk.IResolvable | Record<string, CfnComponentType.CompositeComponentTypeProperty | cdk.IResolvable> | undefined);
    /**
     * The description of the component type.
     */
     ...
     * The name of the parent component type that this component type extends.
     */
    get extendsFrom(): Array<string> | undefined;
    /**
     * The name of the parent component type that this component type extends.
     */
    set extendsFrom(value: Array<string> | undefined);
    /**
     * An object that maps strings to the functions in the component type.
     */
    get functions(): cdk.IResolvable | Record<string, CfnComponentType.FunctionProperty | cdk.IResolvable> | undefined;
    /**
     * An object that maps strings to the functions in the component type.
     */
    set functions(value: cdk.IResolvable | Record<string, CfnComponentType.FunctionProperty | cdk.IResolvable> | undefined);
    /**
     * A boolean value that specifies whether an entity can have more than one component of this type.
     */
    get isSingleton(): boolean | cdk.IResolvable | undefined;
    /**
     * A boolean value that specifies whether an entity can have more than one component of this type.
     */
    set isSingleton(value: boolean | cdk.IResolvable | undefined);
    /**
     * An object that maps strings to the property definitions in the component type.
     */
    get propertyDefinitions(): cdk.IResolvable | Record<string, cdk.IResolvable | CfnComponentType.PropertyDefinitionProperty> | undefined;
    /**
     * An object that maps strings to the property definitions in the component type.
     */
    set propertyDefinitions(value: cdk.IResolvable | Record<string, cdk.IResolvable | CfnComponentType.PropertyDefinitionProperty> | undefined);
    /**
     * An object that maps strings to the property groups in the component type.
     */
    get propertyGroups(): cdk.IResolvable | Record<string, cdk.IResolvable | CfnComponentType.PropertyGroupProperty> | undefined;
    /**
     * An object that maps strings to the property groups in the component type.
     */
    set propertyGroups(value: cdk.IResolvable | Record<string, cdk.IResolvable | CfnComponentType.PropertyGroupProperty> | undefined);
    /**
     * The ComponentType tags.
     */
     ...
     */
    get attrIsAbstract(): cdk.IResolvable;
    /**
     * A boolean value that specifies whether the component type has a schema initializer and that the schema initializer has run.
     *
     * @cloudformationAttribute IsSchemaInitialized
     */
    get attrIsSchemaInitialized(): cdk.IResolvable;
    /**
...
export declare class CfnEntity extends cdk.CfnResource implements cdk.IInspectable, IEntityRef, cdk.ITaggable {
     ...
     * An object that maps strings to the components in the entity.
     */
    get components(): cdk.IResolvable | Record<string, CfnEntity.ComponentProperty | cdk.IResolvable> | undefined;
    /**
     * An object that maps strings to the components in the entity.
     */
    set components(value: cdk.IResolvable | Record<string, CfnEntity.ComponentProperty | cdk.IResolvable> | undefined);
    /**
     * Maps string to `compositeComponent` updates in the request.
     */
    get compositeComponents(): cdk.IResolvable | Record<string, CfnEntity.CompositeComponentProperty | cdk.IResolvable> | undefined;
    /**
     * Maps string to `compositeComponent` updates in the request.
     */
    set compositeComponents(value: cdk.IResolvable | Record<string, CfnEntity.CompositeComponentProperty | cdk.IResolvable> | undefined);
    /**
     * The description of the entity.
     */
    get description(): string | undefined;
     ...
     * The ID of the parent entity.
     */
    set parentEntityId(value: string | undefined);
    /**
     * Metadata that you can use to manage the entity.
     */
    get tagsRaw(): Record<string, string> | undefined;
     ...
     */
    get attrHasChildEntities(): cdk.IResolvable;
    /**
     * @cloudformationAttribute Status
     */
    get attrStatus(): cdk.IResolvable;
...
export declare class CfnScene extends cdk.CfnResource implements cdk.IInspectable, ISceneRef, cdk.ITaggable {
     ...
     * The scene metadata.
     */
    get sceneMetadata(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * The scene metadata.
     */
    set sceneMetadata(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The ComponentType tags.
     */
    get tagsRaw(): Record<string, string> | undefined;
     ...
     */
    get attrGeneratedSceneMetadata(): cdk.IResolvable;
    /**
...
export interface CfnWorkspaceProps {
     ...
     */
    readonly s3Location: s3Refs.IBucketRef | string;
    /**
     * Metadata that you can use to manage the workspace.
     *
