...
import { DomainReference, IDomainRef } from "../../interfaces/generated/aws-voiceid-interfaces.generated";
/**
...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef, cdk.ITaggable {
     ...
     * The server-side encryption configuration containing the KMS key identifier you want Voice ID to use to encrypt your data.
     */
    get serverSideEncryptionConfiguration(): cdk.IResolvable | CfnDomain.ServerSideEncryptionConfigurationProperty;
    /**
     * The server-side encryption configuration containing the KMS key identifier you want Voice ID to use to encrypt your data.
     */
    set serverSideEncryptionConfiguration(value: cdk.IResolvable | CfnDomain.ServerSideEncryptionConfigurationProperty);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
