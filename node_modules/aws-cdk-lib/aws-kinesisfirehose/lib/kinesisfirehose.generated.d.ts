...
import { DeliveryStreamReference, IDeliveryStreamRef } from "../../interfaces/generated/aws-kinesisfirehose-interfaces.generated";
/**
...
export declare class CfnDeliveryStream extends cdk.CfnResource implements cdk.IInspectable, IDeliveryStreamRef, cdk.ITaggable {
     ...
     */
    private _amazonOpenSearchServerlessDestinationConfiguration?;
    /**
     * The destination in Amazon OpenSearch Service.
     */
    private _amazonopensearchserviceDestinationConfiguration?;
    /**
     * The top level object for configuring streams with database as a source.
     */
    private _databaseSourceConfiguration?;
    /**
     ...
     */
    private _directPutSourceConfiguration?;
    /**
     ...
     */
    private _icebergDestinationConfiguration?;
    /**
     ...
     */
    private _snowflakeDestinationConfiguration?;
    /**
     ...
     * Describes the configuration of a destination in the Serverless offering for Amazon OpenSearch Service.
     */
    get amazonOpenSearchServerlessDestinationConfiguration(): CfnDeliveryStream.AmazonOpenSearchServerlessDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Describes the configuration of a destination in the Serverless offering for Amazon OpenSearch Service.
     */
    set amazonOpenSearchServerlessDestinationConfiguration(value: CfnDeliveryStream.AmazonOpenSearchServerlessDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The destination in Amazon OpenSearch Service.
     */
    get amazonopensearchserviceDestinationConfiguration(): CfnDeliveryStream.AmazonopensearchserviceDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The destination in Amazon OpenSearch Service.
     */
    set amazonopensearchserviceDestinationConfiguration(value: CfnDeliveryStream.AmazonopensearchserviceDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The top level object for configuring streams with database as a source.
     */
    get databaseSourceConfiguration(): CfnDeliveryStream.DatabaseSourceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The top level object for configuring streams with database as a source.
     */
    set databaseSourceConfiguration(value: CfnDeliveryStream.DatabaseSourceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the type and Amazon Resource Name (ARN) of the CMK to use for Server-Side Encryption (SSE).
     */
    get deliveryStreamEncryptionConfigurationInput(): CfnDeliveryStream.DeliveryStreamEncryptionConfigurationInputProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the type and Amazon Resource Name (ARN) of the CMK to use for Server-Side Encryption (SSE).
     */
    set deliveryStreamEncryptionConfigurationInput(value: CfnDeliveryStream.DeliveryStreamEncryptionConfigurationInputProperty | cdk.IResolvable | undefined);
    /**
     * The name of the Firehose stream.
     */
    get deliveryStreamName(): string | undefined;
    /**
     * The name of the Firehose stream.
     */
    set deliveryStreamName(value: string | undefined);
    /**
     * The Firehose stream type. This can be one of the following values:.
     */
    get deliveryStreamType(): string | undefined;
    /**
     * The Firehose stream type. This can be one of the following values:.
     */
    set deliveryStreamType(value: string | undefined);
    /**
     * The structure that configures parameters such as `ThroughputHintInMBs` for a stream configured with Direct PUT as a source.
     */
    get directPutSourceConfiguration(): CfnDeliveryStream.DirectPutSourceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The structure that configures parameters such as `ThroughputHintInMBs` for a stream configured with Direct PUT as a source.
     */
    set directPutSourceConfiguration(value: CfnDeliveryStream.DirectPutSourceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * An Amazon ES destination for the delivery stream.
     */
    get elasticsearchDestinationConfiguration(): CfnDeliveryStream.ElasticsearchDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * An Amazon ES destination for the delivery stream.
     */
    set elasticsearchDestinationConfiguration(value: CfnDeliveryStream.ElasticsearchDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * An Amazon S3 destination for the delivery stream.
     */
    get extendedS3DestinationConfiguration(): CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * An Amazon S3 destination for the delivery stream.
     */
    set extendedS3DestinationConfiguration(value: CfnDeliveryStream.ExtendedS3DestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Enables configuring Kinesis Firehose to deliver data to any HTTP endpoint destination.
     */
    get httpEndpointDestinationConfiguration(): CfnDeliveryStream.HttpEndpointDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Enables configuring Kinesis Firehose to deliver data to any HTTP endpoint destination.
     */
    set httpEndpointDestinationConfiguration(value: CfnDeliveryStream.HttpEndpointDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the destination configure settings for Apache Iceberg Table.
     */
    get icebergDestinationConfiguration(): CfnDeliveryStream.IcebergDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the destination configure settings for Apache Iceberg Table.
     */
    set icebergDestinationConfiguration(value: CfnDeliveryStream.IcebergDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * When a Kinesis stream is used as the source for the delivery stream, a [KinesisStreamSourceConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-kinesisstreamsourceconfiguration.html) containing the Kinesis stream ARN and the role ARN for the source stream.
     */
    get kinesisStreamSourceConfiguration(): cdk.IResolvable | CfnDeliveryStream.KinesisStreamSourceConfigurationProperty | undefined;
    /**
     * When a Kinesis stream is used as the source for the delivery stream, a [KinesisStreamSourceConfiguration](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-kinesisfirehose-deliverystream-kinesisstreamsourceconfiguration.html) containing the Kinesis stream ARN and the role ARN for the source stream.
     */
    set kinesisStreamSourceConfiguration(value: cdk.IResolvable | CfnDeliveryStream.KinesisStreamSourceConfigurationProperty | undefined);
    /**
     * The configuration for the Amazon MSK cluster to be used as the source for a delivery stream.
     */
    get mskSourceConfiguration(): cdk.IResolvable | CfnDeliveryStream.MSKSourceConfigurationProperty | undefined;
    /**
     * The configuration for the Amazon MSK cluster to be used as the source for a delivery stream.
     */
    set mskSourceConfiguration(value: cdk.IResolvable | CfnDeliveryStream.MSKSourceConfigurationProperty | undefined);
    /**
     * An Amazon Redshift destination for the delivery stream.
     */
    get redshiftDestinationConfiguration(): cdk.IResolvable | CfnDeliveryStream.RedshiftDestinationConfigurationProperty | undefined;
    /**
     * An Amazon Redshift destination for the delivery stream.
     */
    set redshiftDestinationConfiguration(value: cdk.IResolvable | CfnDeliveryStream.RedshiftDestinationConfigurationProperty | undefined);
    /**
     * The `S3DestinationConfiguration` property type specifies an Amazon Simple Storage Service (Amazon S3) destination to which Amazon Kinesis Data Firehose (Kinesis Data Firehose) delivers data.
     */
    get s3DestinationConfiguration(): cdk.IResolvable | CfnDeliveryStream.S3DestinationConfigurationProperty | undefined;
    /**
     * The `S3DestinationConfiguration` property type specifies an Amazon Simple Storage Service (Amazon S3) destination to which Amazon Kinesis Data Firehose (Kinesis Data Firehose) delivers data.
     */
    set s3DestinationConfiguration(value: cdk.IResolvable | CfnDeliveryStream.S3DestinationConfigurationProperty | undefined);
    /**
     * Configure Snowflake destination.
     */
    get snowflakeDestinationConfiguration(): cdk.IResolvable | CfnDeliveryStream.SnowflakeDestinationConfigurationProperty | undefined;
    /**
     * Configure Snowflake destination.
     */
    set snowflakeDestinationConfiguration(value: cdk.IResolvable | CfnDeliveryStream.SnowflakeDestinationConfigurationProperty | undefined);
    /**
     * The configuration of a destination in Splunk for the delivery stream.
     */
    get splunkDestinationConfiguration(): cdk.IResolvable | CfnDeliveryStream.SplunkDestinationConfigurationProperty | undefined;
    /**
     * The configuration of a destination in Splunk for the delivery stream.
     */
    set splunkDestinationConfiguration(value: cdk.IResolvable | CfnDeliveryStream.SplunkDestinationConfigurationProperty | undefined);
    /**
     * A set of tags to assign to the Firehose stream.
     */
...
export interface CfnDeliveryStreamProps {
     ...
     */
    readonly deliveryStreamName?: kinesisRefs.IStreamRef | string;
    /**
     * The Firehose stream type. This can be one of the following values:.
     *
