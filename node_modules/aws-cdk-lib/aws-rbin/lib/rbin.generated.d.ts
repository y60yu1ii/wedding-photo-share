...
export declare class CfnRule extends cdk.CfnResource implements cdk.IInspectable, IRuleRef, cdk.ITaggableV2 {
     ...
     * [Region-level retention rules only] Specifies the exclusion tags to use to identify resources that are to be excluded, or ignored, by a Region-level retention rule.
     */
    get excludeResourceTags(): Array<cdk.IResolvable | CfnRule.ResourceTagProperty> | cdk.IResolvable | undefined;
    /**
     * [Region-level retention rules only] Specifies the exclusion tags to use to identify resources that are to be excluded, or ignored, by a Region-level retention rule.
     */
    set excludeResourceTags(value: Array<cdk.IResolvable | CfnRule.ResourceTagProperty> | cdk.IResolvable | undefined);
    /**
     * Information about the retention rule lock configuration.
     */
    get lockConfiguration(): cdk.IResolvable | CfnRule.UnlockDelayProperty | undefined;
    /**
     * Information about the retention rule lock configuration.
     */
    set lockConfiguration(value: cdk.IResolvable | CfnRule.UnlockDelayProperty | undefined);
    /**
     * [Tag-level retention rules only] Specifies the resource tags to use to identify resources that are to be retained by a tag-level retention rule.
     */
    get resourceTags(): Array<cdk.IResolvable | CfnRule.ResourceTagProperty> | cdk.IResolvable | undefined;
    /**
     * [Tag-level retention rules only] Specifies the resource tags to use to identify resources that are to be retained by a tag-level retention rule.
     */
    set resourceTags(value: Array<cdk.IResolvable | CfnRule.ResourceTagProperty> | cdk.IResolvable | undefined);
    /**
     * The resource type to be retained by the retention rule.
     */
     ...
     * Information about the retention period for which the retention rule is to retain resources.
     */
    get retentionPeriod(): cdk.IResolvable | CfnRule.RetentionPeriodProperty;
    /**
     * Information about the retention period for which the retention rule is to retain resources.
     */
    set retentionPeriod(value: cdk.IResolvable | CfnRule.RetentionPeriodProperty);
    /**
     * The state of the retention rule.
     */
