...
import { AutoshiftObserverNotificationStatusReference, IAutoshiftObserverNotificationStatusRef, IZonalAutoshiftConfigurationRef, ZonalAutoshiftConfigurationReference } from "../../interfaces/generated/aws-arczonalshift-interfaces.generated";
/**
...
export declare class CfnZonalAutoshiftConfiguration extends cdk.CfnResource implements cdk.IInspectable, IZonalAutoshiftConfigurationRef {
     ...
     */
    private _practiceRunConfiguration?;
    /**
     ...
     * A practice run configuration for a resource includes the Amazon CloudWatch alarms that you've specified for a practice run, as well as any blocked dates or blocked windows for the practice run.
     */
    get practiceRunConfiguration(): cdk.IResolvable | CfnZonalAutoshiftConfiguration.PracticeRunConfigurationProperty | undefined;
    /**
     * A practice run configuration for a resource includes the Amazon CloudWatch alarms that you've specified for a practice run, as well as any blocked dates or blocked windows for the practice run.
     */
    set practiceRunConfiguration(value: cdk.IResolvable | CfnZonalAutoshiftConfiguration.PracticeRunConfigurationProperty | undefined);
    /**
     * The identifier for the resource that AWS shifts traffic for.
     */
     ...
     * When zonal autoshift is `ENABLED` , you authorize AWS to shift away resource traffic for an application from an Availability Zone during events, on your behalf, to help reduce time to recovery.
     */
    get zonalAutoshiftStatus(): string | undefined;
    /**
     * When zonal autoshift is `ENABLED` , you authorize AWS to shift away resource traffic for an application from an Availability Zone during events, on your behalf, to help reduce time to recovery.
     */
    set zonalAutoshiftStatus(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
