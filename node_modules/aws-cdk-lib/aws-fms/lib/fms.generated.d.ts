...
import { INotificationChannelRef, IPolicyRef, IResourceSetRef, NotificationChannelReference, PolicyReference, ResourceSetReference } from "../../interfaces/generated/aws-fms-interfaces.generated";
/**
...
export declare class CfnPolicy extends cdk.CfnResource implements cdk.IInspectable, IPolicyRef, cdk.ITaggableV2 {
     ...
     * Used when deleting a policy. If `true` , Firewall Manager performs cleanup according to the policy type.
     */
    get deleteAllPolicyResources(): boolean | cdk.IResolvable | undefined;
    /**
     * Used when deleting a policy. If `true` , Firewall Manager performs cleanup according to the policy type.
     */
    set deleteAllPolicyResources(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies the AWS account IDs and AWS Organizations organizational units (OUs) to exclude from the policy.
     */
    get excludeMap(): CfnPolicy.IEMapProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the AWS account IDs and AWS Organizations organizational units (OUs) to exclude from the policy.
     */
    set excludeMap(value: CfnPolicy.IEMapProperty | cdk.IResolvable | undefined);
    /**
     * Used only when tags are specified in the `ResourceTags` property.
     */
    get excludeResourceTags(): boolean | cdk.IResolvable;
    /**
     * Used only when tags are specified in the `ResourceTags` property.
     */
    set excludeResourceTags(value: boolean | cdk.IResolvable);
    /**
     * Specifies the AWS account IDs and AWS Organizations organizational units (OUs) to include in the policy.
     */
    get includeMap(): CfnPolicy.IEMapProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the AWS account IDs and AWS Organizations organizational units (OUs) to include in the policy.
     */
    set includeMap(value: CfnPolicy.IEMapProperty | cdk.IResolvable | undefined);
    /**
     * Your description of the AWS Firewall Manager policy.
     */
     ...
     * Indicates if the policy should be automatically applied to new resources.
     */
    get remediationEnabled(): boolean | cdk.IResolvable;
    /**
     * Indicates if the policy should be automatically applied to new resources.
     */
    set remediationEnabled(value: boolean | cdk.IResolvable);
    /**
     * Indicates whether AWS Firewall Manager should automatically remove protections from resources that leave the policy scope and clean up resources that Firewall Manager is managing for accounts when those accounts leave policy scope.
     */
    get resourcesCleanUp(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether AWS Firewall Manager should automatically remove protections from resources that leave the policy scope and clean up resources that Firewall Manager is managing for accounts when those accounts leave policy scope.
     */
    set resourcesCleanUp(value: boolean | cdk.IResolvable | undefined);
    /**
     * The unique identifiers of the resource sets used by the policy.
     */
    get resourceSetIds(): Array<string> | undefined;
    /**
     * The unique identifiers of the resource sets used by the policy.
     */
    set resourceSetIds(value: Array<string> | undefined);
    /**
     * Specifies whether to combine multiple resource tags with AND, so that a resource must have all tags to be included or excluded, or OR, so that a resource must have at least one tag.
     */
    get resourceTagLogicalOperator(): string | undefined;
    /**
     * Specifies whether to combine multiple resource tags with AND, so that a resource must have all tags to be included or excluded, or OR, so that a resource must have at least one tag.
     */
    set resourceTagLogicalOperator(value: string | undefined);
    /**
     * An array of `ResourceTag` objects, used to explicitly include resources in the policy scope or explicitly exclude them.
     */
    get resourceTags(): Array<cdk.IResolvable | CfnPolicy.ResourceTagProperty> | cdk.IResolvable | undefined;
    /**
     * An array of `ResourceTag` objects, used to explicitly include resources in the policy scope or explicitly exclude them.
     */
    set resourceTags(value: Array<cdk.IResolvable | CfnPolicy.ResourceTagProperty> | cdk.IResolvable | undefined);
    /**
     * The type of resource protected by or in scope of the policy.
     */
     ...
     * An array of `ResourceType` objects.
     */
    get resourceTypeList(): Array<string> | undefined;
    /**
     * An array of `ResourceType` objects.
     */
    set resourceTypeList(value: Array<string> | undefined);
    /**
     * Details about the security service that is being used to protect the resources.
     */
    get securityServicePolicyData(): cdk.IResolvable | CfnPolicy.SecurityServicePolicyDataProperty;
    /**
     * Details about the security service that is being used to protect the resources.
     */
    set securityServicePolicyData(value: cdk.IResolvable | CfnPolicy.SecurityServicePolicyDataProperty);
    /**
     * A collection of key:value pairs associated with an AWS resource.
     */
    get tags(): Array<CfnPolicy.PolicyTagProperty> | undefined;
    /**
     * A collection of key:value pairs associated with an AWS resource.
     */
    set tags(value: Array<CfnPolicy.PolicyTagProperty> | undefined);
    /**
...
export declare class CfnResourceSet extends cdk.CfnResource implements cdk.IInspectable, IResourceSetRef, cdk.ITaggable {
    ...
    get resources(): Array<string> | undefined;
    set resources(value: Array<string> | undefined);
    /**
     * Determines the resources that can be associated to the resource set.
     */
    get resourceTypeList(): Array<string>;
    /**
     * Determines the resources that can be associated to the resource set.
     */
    set resourceTypeList(value: Array<string>);
