...
import { ContactChannelReference, ContactReference, IContactChannelRef, IContactRef, IPlanRef, IRotationRef, PlanReference, RotationReference } from "../../interfaces/generated/aws-ssmcontacts-interfaces.generated";
/**
...
export declare class CfnContact extends cdk.CfnResource implements cdk.IInspectable, IContactRef, cdk.ITaggableV2 {
     ...
     * A list of stages.
     */
    get plan(): Array<cdk.IResolvable | CfnContact.StageProperty> | cdk.IResolvable | undefined;
    /**
     * A list of stages.
     */
    set plan(value: Array<cdk.IResolvable | CfnContact.StageProperty> | cdk.IResolvable | undefined);
...
export declare class CfnContactChannel extends cdk.CfnResource implements cdk.IInspectable, IContactChannelRef {
     ...
     * If you want to activate the channel at a later time, you can choose to defer activation.
     */
    get deferActivation(): boolean | cdk.IResolvable | undefined;
    /**
     * If you want to activate the channel at a later time, you can choose to defer activation.
     */
    set deferActivation(value: boolean | cdk.IResolvable | undefined);
    /**
...
export declare class CfnPlan extends cdk.CfnResource implements cdk.IInspectable, IPlanRef {
     ...
     * The Amazon Resource Names (ARNs) of the on-call rotations associated with the plan.
     */
    get rotationIds(): Array<string> | undefined;
    /**
     * The Amazon Resource Names (ARNs) of the on-call rotations associated with the plan.
     */
    set rotationIds(value: Array<string> | undefined);
    /**
     * A list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods.
     */
    get stages(): Array<cdk.IResolvable | CfnPlan.StageProperty> | cdk.IResolvable | undefined;
    /**
     * A list of stages that the escalation plan or engagement plan uses to engage contacts and contact methods.
     */
    set stages(value: Array<cdk.IResolvable | CfnPlan.StageProperty> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnRotation extends cdk.CfnResource implements cdk.IInspectable, IRotationRef, cdk.ITaggable {
     ...
     * The Amazon Resource Names (ARNs) of the contacts to add to the rotation.
     */
    get contactIds(): Array<string>;
    /**
     * The Amazon Resource Names (ARNs) of the contacts to add to the rotation.
     */
    set contactIds(value: Array<string>);
    /**
     * The name for the rotation.
     */
    get name(): string;
     ...
     * Information about the rule that specifies when shift team members rotate.
     */
    get recurrence(): cdk.IResolvable | CfnRotation.RecurrenceSettingsProperty;
    /**
     * Information about the rule that specifies when shift team members rotate.
     */
    set recurrence(value: cdk.IResolvable | CfnRotation.RecurrenceSettingsProperty);
    /**
     * The date and time the rotation goes into effect.
     */
