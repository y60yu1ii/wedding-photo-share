...
import { AliasReference, IAliasRef, IKeyRef, KeyReference } from "../../interfaces/generated/aws-paymentcryptography-interfaces.generated";
/**
...
export declare class CfnAlias extends cdk.CfnResource implements cdk.IInspectable, IAliasRef {
     ...
     * The `KeyARN` of the key associated with the alias.
     */
    get keyArn(): string | undefined;
    /**
     * The `KeyARN` of the key associated with the alias.
     */
    set keyArn(value: string | undefined);
...
export declare class CfnKey extends cdk.CfnResource implements cdk.IInspectable, IKeyRef, cdk.ITaggableV2 {
     ...
     * The cryptographic usage of an ECDH derived key as deﬁned in section A.5.2 of the TR-31 spec.
     */
    get deriveKeyUsage(): string | undefined;
    /**
     * The cryptographic usage of an ECDH derived key as deﬁned in section A.5.2 of the TR-31 spec.
     */
    set deriveKeyUsage(value: string | undefined);
    /**
     * Specifies whether the key is enabled.
     */
     ...
     * Specifies whether the key is exportable.
     */
    get exportable(): boolean | cdk.IResolvable;
    /**
     * Specifies whether the key is exportable.
     */
    set exportable(value: boolean | cdk.IResolvable);
    /**
     * The role of the key, the algorithm it supports, and the cryptographic operations allowed with the key.
     */
    get keyAttributes(): cdk.IResolvable | CfnKey.KeyAttributesProperty;
    /**
     * The role of the key, the algorithm it supports, and the cryptographic operations allowed with the key.
     */
    set keyAttributes(value: cdk.IResolvable | CfnKey.KeyAttributesProperty);
    /**
     * The algorithm that AWS Payment Cryptography uses to calculate the key check value (KCV).
     */
    get keyCheckValueAlgorithm(): string | undefined;
    /**
     * The algorithm that AWS Payment Cryptography uses to calculate the key check value (KCV).
     */
    set keyCheckValueAlgorithm(value: string | undefined);
    /**
     * The list of AWS Regions to remove from the key's replication configuration.
     */
    get replicationRegions(): Array<string> | undefined;
    /**
     * The list of AWS Regions to remove from the key's replication configuration.
     */
    set replicationRegions(value: Array<string> | undefined);
    get tags(): Array<cdk.CfnTag> | undefined;
    set tags(value: Array<cdk.CfnTag> | undefined);
    /**
     * @cloudformationAttribute KeyIdentifier
     */
    get attrKeyIdentifier(): string;
    /**
     ...
     */
    get attrKeyOrigin(): string;
    /**
     * The state of key that is being created or deleted.
     *
     * @cloudformationAttribute KeyState
     */
    get attrKeyState(): string;
    /**
     * @cloudformationAttribute ReplicationStatus
     */
    get attrReplicationStatus(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
