...
import { ContainerReference, IContainerRef } from "../../interfaces/generated/aws-mediastore-interfaces.generated";
/**
...
export declare class CfnContainer extends cdk.CfnResource implements cdk.IInspectable, IContainerRef, cdk.ITaggable {
     ...
     * The state of access logging on the container.
     */
    get accessLoggingEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * The state of access logging on the container.
     */
    set accessLoggingEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name for the container.
     */
     ...
     * > End of support notice: On November 13, 2025, AWS will discontinue support for AWS Elemental MediaStore.
     */
    get corsPolicy(): Array<CfnContainer.CorsRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * > End of support notice: On November 13, 2025, AWS will discontinue support for AWS Elemental MediaStore.
     */
    set corsPolicy(value: Array<CfnContainer.CorsRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * > End of support notice: On November 13, 2025, AWS will discontinue support for AWS Elemental MediaStore.
     */
     ...
     * The metric policy that is associated with the container.
     */
    get metricPolicy(): cdk.IResolvable | CfnContainer.MetricPolicyProperty | undefined;
    /**
     * The metric policy that is associated with the container.
     */
    set metricPolicy(value: cdk.IResolvable | CfnContainer.MetricPolicyProperty | undefined);
    /**
     * Creates an access policy for the specified container to restrict the users and clients that can access it.
     */
