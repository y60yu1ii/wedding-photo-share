...
import { ChannelReference, DatasetReference, DatastoreReference, IChannelRef, IDatasetRef, IDatastoreRef, IPipelineRef, PipelineReference } from "../../interfaces/generated/aws-iotanalytics-interfaces.generated";
/**
...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggable {
     ...
     * Where channel data is stored.
     */
    get channelStorage(): CfnChannel.ChannelStorageProperty | cdk.IResolvable | undefined;
    /**
     * Where channel data is stored.
     */
    set channelStorage(value: CfnChannel.ChannelStorageProperty | cdk.IResolvable | undefined);
    /**
     * How long, in days, message data is kept for the channel.
     */
    get retentionPeriod(): cdk.IResolvable | CfnChannel.RetentionPeriodProperty | undefined;
    /**
     * How long, in days, message data is kept for the channel.
     */
    set retentionPeriod(value: cdk.IResolvable | CfnChannel.RetentionPeriodProperty | undefined);
    /**
     * Metadata which can be used to manage the channel.
     */
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggable {
     ...
     * The `DatasetAction` objects that automatically create the dataset contents.
     */
    get actions(): Array<CfnDataset.ActionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The `DatasetAction` objects that automatically create the dataset contents.
     */
    set actions(value: Array<CfnDataset.ActionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * When dataset contents are created they are delivered to destinations specified here.
     */
    get contentDeliveryRules(): Array<CfnDataset.DatasetContentDeliveryRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * When dataset contents are created they are delivered to destinations specified here.
     */
    set contentDeliveryRules(value: Array<CfnDataset.DatasetContentDeliveryRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the dataset.
     */
     ...
     * The name of the dataset.
     */
    set datasetName(value: string | undefined);
    /**
     * A list of data rules that send notifications to CloudWatch, when data arrives late.
     */
    get lateDataRules(): Array<cdk.IResolvable | CfnDataset.LateDataRuleProperty> | cdk.IResolvable | undefined;
    /**
     * A list of data rules that send notifications to CloudWatch, when data arrives late.
     */
    set lateDataRules(value: Array<cdk.IResolvable | CfnDataset.LateDataRuleProperty> | cdk.IResolvable | undefined);
    /**
     * Optional.
     */
    get retentionPeriod(): cdk.IResolvable | CfnDataset.RetentionPeriodProperty | undefined;
    /**
     * Optional.
     */
    set retentionPeriod(value: cdk.IResolvable | CfnDataset.RetentionPeriodProperty | undefined);
    /**
     * Metadata which can be used to manage the data set.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The `DatasetTrigger` objects that specify when the dataset is automatically updated.
     */
    get triggers(): Array<cdk.IResolvable | CfnDataset.TriggerProperty> | cdk.IResolvable | undefined;
    /**
     * The `DatasetTrigger` objects that specify when the dataset is automatically updated.
     */
    set triggers(value: Array<cdk.IResolvable | CfnDataset.TriggerProperty> | cdk.IResolvable | undefined);
    /**
     * Optional.
     */
    get versioningConfiguration(): cdk.IResolvable | CfnDataset.VersioningConfigurationProperty | undefined;
    /**
     * Optional.
     */
    set versioningConfiguration(value: cdk.IResolvable | CfnDataset.VersioningConfigurationProperty | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnDatastore extends cdk.CfnResource implements cdk.IInspectable, IDatastoreRef, cdk.ITaggable {
     ...
     */
    private _datastorePartitions?;
    /**
     * Where data store data is stored.
     */
    private _datastoreStorage?;
    /**
     ...
     */
    private _fileFormatConfiguration?;
    /**
     ...
     * Information about the partition dimensions in a data store.
     */
    get datastorePartitions(): CfnDatastore.DatastorePartitionsProperty | cdk.IResolvable | undefined;
    /**
     * Information about the partition dimensions in a data store.
     */
    set datastorePartitions(value: CfnDatastore.DatastorePartitionsProperty | cdk.IResolvable | undefined);
    /**
     * Where data store data is stored.
     */
    get datastoreStorage(): CfnDatastore.DatastoreStorageProperty | cdk.IResolvable | undefined;
    /**
     * Where data store data is stored.
     */
    set datastoreStorage(value: CfnDatastore.DatastoreStorageProperty | cdk.IResolvable | undefined);
    /**
     * Contains the configuration information of file formats. ITA data stores support JSON and [Parquet](https://docs.aws.amazon.com/https://parquet.apache.org/) .
     */
    get fileFormatConfiguration(): CfnDatastore.FileFormatConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Contains the configuration information of file formats. ITA data stores support JSON and [Parquet](https://docs.aws.amazon.com/https://parquet.apache.org/) .
     */
    set fileFormatConfiguration(value: CfnDatastore.FileFormatConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * How long, in days, message data is kept for the data store.
     */
    get retentionPeriod(): cdk.IResolvable | CfnDatastore.RetentionPeriodProperty | undefined;
    /**
     * How long, in days, message data is kept for the data store.
     */
    set retentionPeriod(value: cdk.IResolvable | CfnDatastore.RetentionPeriodProperty | undefined);
    /**
     * Metadata which can be used to manage the data store.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnPipeline extends cdk.CfnResource implements cdk.IInspectable, IPipelineRef, cdk.ITaggable {
     ...
     * A list of "PipelineActivity" objects.
     */
    get pipelineActivities(): Array<CfnPipeline.ActivityProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of "PipelineActivity" objects.
     */
    set pipelineActivities(value: Array<CfnPipeline.ActivityProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of the pipeline.
     */
    get pipelineName(): string | undefined;
    /**
     * The name of the pipeline.
     */
    set pipelineName(value: string | undefined);
    /**
     * Metadata which can be used to manage the pipeline.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
