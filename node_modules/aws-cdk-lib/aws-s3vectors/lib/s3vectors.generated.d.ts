...
import { IIndexRef, IndexReference, IVectorBucketPolicyRef, IVectorBucketRef, VectorBucketPolicyReference, VectorBucketReference } from "../../interfaces/generated/aws-s3vectors-interfaces.generated";
/**
...
export declare class CfnIndex extends cdk.CfnResource implements cdk.IInspectable, IIndexRef, cdk.ITaggableV2 {
     ...
     * The encryption configuration for a vector index.
     */
    get encryptionConfiguration(): CfnIndex.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The encryption configuration for a vector index.
     */
    set encryptionConfiguration(value: CfnIndex.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The name of the vector index to create.
     */
     ...
     * The metadata configuration for the vector index.
     */
    get metadataConfiguration(): cdk.IResolvable | CfnIndex.MetadataConfigurationProperty | undefined;
    /**
     * The metadata configuration for the vector index.
     */
    set metadataConfiguration(value: cdk.IResolvable | CfnIndex.MetadataConfigurationProperty | undefined);
    /**
     * User tags (key-value pairs) to associate with the index.
     */
     ...
     * The Amazon Resource Name (ARN) of the vector bucket that contains the vector index.
     */
    get vectorBucketArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the vector bucket that contains the vector index.
     */
    set vectorBucketArn(value: string | undefined);
    /**
     * The name of the vector bucket that contains the vector index.
     */
     ...
     * The name of the vector bucket that contains the vector index.
     */
    set vectorBucketName(value: string | undefined);
    /**
...
export interface CfnIndexProps {
     ...
     */
    readonly encryptionConfiguration?: CfnIndex.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * The name of the vector index to create.
     *
 ...
 */
export declare class CfnVectorBucket extends cdk.CfnResource implements cdk.IInspectable, IVectorBucketRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * The encryption configuration for the vector bucket.
     */
    get encryptionConfiguration(): CfnVectorBucket.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The encryption configuration for the vector bucket.
     */
    set encryptionConfiguration(value: CfnVectorBucket.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * User tags (key-value pairs) to associate with the vector bucket.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrVectorBucketArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnVectorBucketPolicy extends cdk.CfnResource implements cdk.IInspectable, IVectorBucketPolicyRef {
     ...
     * A policy document containing permissions to add to the specified vector bucket.
     */
    get policy(): any | cdk.IResolvable | string;
    /**
     * A policy document containing permissions to add to the specified vector bucket.
     */
    set policy(value: any | cdk.IResolvable | string);
    /**
     * The Amazon Resource Name (ARN) of the S3 vector bucket to which the policy applies.
     */
    get vectorBucketArn(): string | undefined;
