...
export declare class CfnAlarm extends cdk.CfnResource implements cdk.IInspectable, IAlarmRef {
     ...
     */
    private _monitoredResourceName;
    /**
     ...
     * The contact protocols for the alarm, such as `Email` , `SMS` (text messaging), or both.
     */
    get contactProtocols(): Array<string> | undefined;
    /**
     * The contact protocols for the alarm, such as `Email` , `SMS` (text messaging), or both.
     */
    set contactProtocols(value: Array<string> | undefined);
    /**
     * The number of data points within the evaluation periods that must be breaching to cause the alarm to go to the `ALARM` state.
     */
     ...
     * The name of the Lightsail resource that the alarm monitors.
     */
    get monitoredResourceName(): string;
    /**
     * The name of the Lightsail resource that the alarm monitors.
     */
    set monitoredResourceName(value: string);
    /**
     * A Boolean value indicating whether the alarm is enabled.
     */
    get notificationEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether the alarm is enabled.
     */
    set notificationEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The alarm states that trigger a notification.
     */
    get notificationTriggers(): Array<string> | undefined;
    /**
     * The alarm states that trigger a notification.
     */
    set notificationTriggers(value: Array<string> | undefined);
    /**
     * The value against which the specified statistic is compared.
     */
...
export declare class CfnBucket extends cdk.CfnResource implements cdk.IInspectable, IBucketRef, cdk.ITaggable {
     ...
     */
    private _objectVersioning?;
    /**
     * An array of AWS account IDs that have read-only access to the bucket.
     */
    private _readOnlyAccessAccounts?;
    /**
     * An array of Lightsail instances that have access to the bucket.
     */
    private _resourcesReceivingAccess?;
    /**
     ...
     * An object that describes the access rules for the bucket.
     */
    get accessRules(): CfnBucket.AccessRulesProperty | cdk.IResolvable | undefined;
    /**
     * An object that describes the access rules for the bucket.
     */
    set accessRules(value: CfnBucket.AccessRulesProperty | cdk.IResolvable | undefined);
    /**
     * The name of the bucket.
     */
     ...
     * Indicates whether object versioning is enabled for the bucket.
     */
    get objectVersioning(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether object versioning is enabled for the bucket.
     */
    set objectVersioning(value: boolean | cdk.IResolvable | undefined);
    /**
     * An array of AWS account IDs that have read-only access to the bucket.
     */
    get readOnlyAccessAccounts(): Array<string> | undefined;
    /**
     * An array of AWS account IDs that have read-only access to the bucket.
     */
    set readOnlyAccessAccounts(value: Array<string> | undefined);
    /**
     * An array of Lightsail instances that have access to the bucket.
     */
    get resourcesReceivingAccess(): Array<string> | undefined;
    /**
     * An array of Lightsail instances that have access to the bucket.
     */
    set resourcesReceivingAccess(value: Array<string> | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
     ...
     */
    get attrAbleToUpdateBundle(): cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the bucket.
     *
     * @cloudformationAttribute BucketArn
     */
    get attrBucketArn(): string;
    /**
...
export declare class CfnContainer extends cdk.CfnResource implements cdk.IInspectable, IContainerRef, cdk.ITaggable {
     ...
     */
    private _containerServiceDeployment?;
    /**
     ...
     * An object that describes the current container deployment of the container service.
     */
    get containerServiceDeployment(): CfnContainer.ContainerServiceDeploymentProperty | cdk.IResolvable | undefined;
    /**
     * An object that describes the current container deployment of the container service.
     */
    set containerServiceDeployment(value: CfnContainer.ContainerServiceDeploymentProperty | cdk.IResolvable | undefined);
    /**
     * A Boolean value indicating whether the container service is disabled.
     */
    get isDisabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether the container service is disabled.
     */
    set isDisabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The power specification of the container service.
     */
    get power(): string;
     ...
     * An object that describes the configuration for the container service to access private container image repositories, such as  ( Amazon ECR ) private repositories.
     */
    get privateRegistryAccess(): cdk.IResolvable | CfnContainer.PrivateRegistryAccessProperty | undefined;
    /**
     * An object that describes the configuration for the container service to access private container image repositories, such as  ( Amazon ECR ) private repositories.
     */
    set privateRegistryAccess(value: cdk.IResolvable | CfnContainer.PrivateRegistryAccessProperty | undefined);
    /**
     * The public domain name of the container service, such as `example.com` and `www.example.com` .
     */
    get publicDomainNames(): Array<cdk.IResolvable | CfnContainer.PublicDomainNameProperty> | cdk.IResolvable | undefined;
    /**
     * The public domain name of the container service, such as `example.com` and `www.example.com` .
     */
    set publicDomainNames(value: Array<cdk.IResolvable | CfnContainer.PublicDomainNameProperty> | cdk.IResolvable | undefined);
    /**
     * The scale specification of the container service.
     */
    get scale(): number;
...
export declare class CfnDatabase extends cdk.CfnResource implements cdk.IInspectable, IDatabaseRef, cdk.ITaggable {
     ...
     */
    private _relationalDatabaseBlueprintId;
    /**
     * The bundle ID for the database (for example, `medium_1_0` ).
     */
    private _relationalDatabaseBundleId;
    /**
     ...
     */
    private _relationalDatabaseParameters?;
    /**
     ...
     * A Boolean value indicating whether automated backup retention is enabled for the database.
     */
    get backupRetention(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether automated backup retention is enabled for the database.
     */
    set backupRetention(value: boolean | cdk.IResolvable | undefined);
    /**
     * The certificate associated with the database.
     */
     ...
     * The blueprint ID for the database (for example, `mysql_8_0` ).
     */
    get relationalDatabaseBlueprintId(): string;
    /**
     * The blueprint ID for the database (for example, `mysql_8_0` ).
     */
    set relationalDatabaseBlueprintId(value: string);
    /**
     * The bundle ID for the database (for example, `medium_1_0` ).
     */
    get relationalDatabaseBundleId(): string;
    /**
     * The bundle ID for the database (for example, `medium_1_0` ).
     */
    set relationalDatabaseBundleId(value: string);
    /**
     * The name of the instance.
     */
     ...
     * An array of parameters for the database.
     */
    get relationalDatabaseParameters(): Array<cdk.IResolvable | CfnDatabase.RelationalDatabaseParameterProperty> | cdk.IResolvable | undefined;
    /**
     * An array of parameters for the database.
     */
    set relationalDatabaseParameters(value: Array<cdk.IResolvable | CfnDatabase.RelationalDatabaseParameterProperty> | cdk.IResolvable | undefined);
    /**
     * A Boolean value indicating whether to change the primary user password to a new, strong password generated by Lightsail .
     */
...
export declare class CfnDisk extends cdk.CfnResource implements cdk.IInspectable, IDiskRef, cdk.ITaggable {
     ...
     * An array of add-ons for the disk.
     */
    get addOns(): Array<CfnDisk.AddOnProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array of add-ons for the disk.
     */
    set addOns(value: Array<CfnDisk.AddOnProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The AWS Region and Availability Zone location for the disk (for example, `us-east-1a` ).
     */
    get availabilityZone(): string | undefined;
     ...
     * The AWS Region and Availability Zone where the disk is located.
     */
    get location(): cdk.IResolvable | CfnDisk.LocationProperty | undefined;
    /**
     * The AWS Region and Availability Zone where the disk is located.
     */
    set location(value: cdk.IResolvable | CfnDisk.LocationProperty | undefined);
    /**
     * The size of the disk in GB.
     */
    get sizeInGb(): number;
     ...
     */
    get attrAttachmentState(): string;
    /**
     * The Amazon Resource Name (ARN) of the disk.
     *
     * @cloudformationAttribute DiskArn
     */
    get attrDiskArn(): string;
    /**
...
export declare class CfnDistribution extends cdk.CfnResource implements cdk.IInspectable, IDistributionRef, cdk.ITaggable {
     ...
     * An array of objects that describe the per-path cache behavior of the distribution.
     */
    get cacheBehaviors(): Array<CfnDistribution.CacheBehaviorPerPathProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array of objects that describe the per-path cache behavior of the distribution.
     */
    set cacheBehaviors(value: Array<CfnDistribution.CacheBehaviorPerPathProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * An object that describes the cache behavior settings of the distribution.
     */
    get cacheBehaviorSettings(): CfnDistribution.CacheSettingsProperty | cdk.IResolvable | undefined;
    /**
     * An object that describes the cache behavior settings of the distribution.
     */
    set cacheBehaviorSettings(value: CfnDistribution.CacheSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The name of the SSL/TLS certificate attached to the distribution.
     */
     ...
     * An object that describes the default cache behavior of the distribution.
     */
    get defaultCacheBehavior(): CfnDistribution.CacheBehaviorProperty | cdk.IResolvable;
    /**
     * An object that describes the default cache behavior of the distribution.
     */
    set defaultCacheBehavior(value: CfnDistribution.CacheBehaviorProperty | cdk.IResolvable);
    /**
     * The name of the distribution.
     */
     ...
     * The name of the distribution.
     */
    set distributionName(value: string);
    /**
     * The IP address type of the distribution.
     */
     ...
     * A Boolean value indicating whether the distribution is enabled.
     */
    get isEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether the distribution is enabled.
     */
    set isEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
     */
    get origin(): CfnDistribution.InputOriginProperty | cdk.IResolvable;
    /**
     * An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
     */
    set origin(value: CfnDistribution.InputOriginProperty | cdk.IResolvable);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDistributionArn(): string;
    /**
...
export declare class CfnInstance extends cdk.CfnResource implements cdk.IInspectable, IInstanceRef, cdk.ITaggable {
     ...
     * An array of add-ons for the instance.
     */
    get addOns(): Array<CfnInstance.AddOnProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array of add-ons for the instance.
     */
    set addOns(value: Array<CfnInstance.AddOnProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The Availability Zone for the instance.
     */
    get availabilityZone(): string | undefined;
     ...
     * The hardware properties for the instance, such as the vCPU count, attached disks, and amount of RAM.
     */
    get hardware(): CfnInstance.HardwareProperty | cdk.IResolvable | undefined;
    /**
     * The hardware properties for the instance, such as the vCPU count, attached disks, and amount of RAM.
     */
    set hardware(value: CfnInstance.HardwareProperty | cdk.IResolvable | undefined);
    /**
     * The name of the instance.
     */
     ...
     * The location for the instance, such as the AWS Region and Availability Zone.
     */
    get location(): cdk.IResolvable | CfnInstance.LocationProperty | undefined;
    /**
     * The location for the instance, such as the AWS Region and Availability Zone.
     */
    set location(value: cdk.IResolvable | CfnInstance.LocationProperty | undefined);
    /**
     * The public ports and the monthly amount of data transfer allocated for the instance.
     */
    get networking(): cdk.IResolvable | CfnInstance.NetworkingProperty | undefined;
    /**
     * The public ports and the monthly amount of data transfer allocated for the instance.
     */
    set networking(value: cdk.IResolvable | CfnInstance.NetworkingProperty | undefined);
    /**
     * The status code and the state (for example, `running` ) of the instance.
     */
    get state(): cdk.IResolvable | CfnInstance.StateProperty | undefined;
    /**
     * The status code and the state (for example, `running` ) of the instance.
     */
    set state(value: cdk.IResolvable | CfnInstance.StateProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrHardwareCpuCount(): number;
    /**
     * The amount of RAM in GB on the instance (for example, `1.0` ).
     *
     * @cloudformationAttribute Hardware.RamSizeInGb
     */
    get attrHardwareRamSizeInGb(): number;
    /**
     ...
     */
    get attrIsStaticIp(): cdk.IResolvable;
    /**
     ...
     */
    get attrNetworkingMonthlyTransferGbPerMonthAllocated(): string;
    /**
     * The private IP address of the instance.
     *
     * @cloudformationAttribute PrivateIpAddress
     */
    get attrPrivateIpAddress(): string;
    /**
     * The public IP address of the instance.
     *
     * @cloudformationAttribute PublicIpAddress
     */
    get attrPublicIpAddress(): string;
    /**
...
export declare class CfnLoadBalancer extends cdk.CfnResource implements cdk.IInspectable, ILoadBalancerRef, cdk.ITaggable {
     ...
     * The Lightsail instances to attach to the load balancer.
     */
    get attachedInstances(): Array<string> | undefined;
    /**
     * The Lightsail instances to attach to the load balancer.
     */
    set attachedInstances(value: Array<string> | undefined);
    /**
     * The path on the attached instance where the health check will be performed.
     */
     ...
     * A Boolean value indicating whether session stickiness is enabled.
     */
    get sessionStickinessEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether session stickiness is enabled.
     */
    set sessionStickinessEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The time period, in seconds, after which the load balancer session stickiness cookie should be considered stale.
     */
    get sessionStickinessLbCookieDurationSeconds(): string | undefined;
    /**
     * The time period, in seconds, after which the load balancer session stickiness cookie should be considered stale.
     */
    set sessionStickinessLbCookieDurationSeconds(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The name of the TLS security policy for the load balancer.
     */
    get tlsPolicyName(): string | undefined;
    /**
     * The name of the TLS security policy for the load balancer.
     */
    set tlsPolicyName(value: string | undefined);
    /**
...
export declare class CfnLoadBalancerTlsCertificate extends cdk.CfnResource implements cdk.IInspectable, ILoadBalancerTlsCertificateRef {
     ...
     */
    private _certificateAlternativeNames?;
    /**
     * The domain name for the SSL/TLS certificate.
     */
    private _certificateDomainName;
    /**
     ...
     */
    private _httpsRedirectionEnabled?;
    /**
     ...
     * An array of alternative domain names and subdomain names for your SSL/TLS certificate.
     */
    get certificateAlternativeNames(): Array<string> | undefined;
    /**
     * An array of alternative domain names and subdomain names for your SSL/TLS certificate.
     */
    set certificateAlternativeNames(value: Array<string> | undefined);
    /**
     * The domain name for the SSL/TLS certificate.
     */
    get certificateDomainName(): string;
    /**
     * The domain name for the SSL/TLS certificate.
     */
    set certificateDomainName(value: string);
    /**
     * The name of the SSL/TLS certificate.
     */
    get certificateName(): string;
     ...
     * A Boolean value indicating whether HTTPS redirection is enabled for the load balancer that the TLS certificate is attached to.
     */
    get httpsRedirectionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether HTTPS redirection is enabled for the load balancer that the TLS certificate is attached to.
     */
    set httpsRedirectionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * A Boolean value indicating whether the SSL/TLS certificate is attached to a Lightsail load balancer.
     */
    get isAttached(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean value indicating whether the SSL/TLS certificate is attached to a Lightsail load balancer.
     */
    set isAttached(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the load balancer that the SSL/TLS certificate is attached to.
     */
    get loadBalancerName(): string;
     ...
     */
    get attrLoadBalancerTlsCertificateArn(): string;
    /**
...
export declare class CfnStaticIp extends cdk.CfnResource implements cdk.IInspectable, IStaticIpRef {
     ...
     * The instance that the static IP is attached to.
     */
    set attachedTo(value: string | undefined);
    /**
     * The name of the static IP.
     */
 ...
 */
export declare class CfnDatabaseSnapshot extends cdk.CfnResource implements cdk.IInspectable, IDatabaseSnapshotRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDatabaseSnapshot from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDatabaseSnapshot;
    /**
     * Checks whether the given object is a CfnDatabaseSnapshot
     */
    static isCfnDatabaseSnapshot(x: any): x is CfnDatabaseSnapshot;
    static arnForDatabaseSnapshot(resource: IDatabaseSnapshotRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     */
    private _relationalDatabaseSnapshotName;
    /**
     * An array of key-value pairs to apply to this resource.
     */
    private _tags?;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnDatabaseSnapshotProps);
    get databaseSnapshotRef(): DatabaseSnapshotReference;
    /**
     * The name of the database on which to base your new snapshot.
     */
    get relationalDatabaseName(): string;
     ...
     * The name for your new database snapshot.
     */
    get relationalDatabaseSnapshotName(): string;
    /**
     * The name for your new database snapshot.
     */
    set relationalDatabaseSnapshotName(value: string);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare namespace CfnDatabaseSnapshot {
    /**
     * The Region name and Availability Zone where the database snapshot is located.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lightsail-databasesnapshot.html
 */
export interface CfnDatabaseSnapshotProps {
    /**
     * The name of the database on which to base your new snapshot.
     *
...
export declare class CfnDiskSnapshot extends cdk.CfnResource implements cdk.IInspectable, IDiskSnapshotRef, cdk.ITaggableV2 {
     ...
     * The name of the disk snapshot ( `my-disk-snapshot` ).
     */
    get diskSnapshotName(): string;
    /**
     * The name of the disk snapshot ( `my-disk-snapshot` ).
     */
    set diskSnapshotName(value: string);
    /**
     * The tag keys and optional values for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef, cdk.ITaggableV2 {
     ...
     * An array of key-value pairs containing information about the domain entries.
     */
    get domainEntries(): Array<CfnDomain.DomainEntryProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array of key-value pairs containing information about the domain entries.
     */
    set domainEntries(value: Array<CfnDomain.DomainEntryProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The fully qualified domain name in the certificate request.
     */
    get domainName(): string;
...
export declare class CfnInstanceSnapshot extends cdk.CfnResource implements cdk.IInspectable, IInstanceSnapshotRef, cdk.ITaggableV2 {
     ...
     * The name of the snapshot.
     */
    get instanceSnapshotName(): string;
    /**
     * The name of the snapshot.
     */
    set instanceSnapshotName(value: string);
    /**
     * The tag keys and optional values for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrFromInstanceArn(): string;
    /**
     * The instance from which the snapshot was created.
     *
     * @cloudformationAttribute FromInstanceName
     */
    get attrFromInstanceName(): string;
    /**
     * A Boolean value indicating whether the snapshot was created from an automatic snapshot.
     *
     * @cloudformationAttribute IsFromAutoSnapshot
...
export type { IDatabaseSnapshotRef, DatabaseSnapshotReference };
