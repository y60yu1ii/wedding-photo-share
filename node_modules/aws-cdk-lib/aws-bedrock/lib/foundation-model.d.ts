...
export declare class FoundationModelIdentifier {
    ...
    static readonly AMAZON_NOVA_2_MULTIMODAL_EMBEDDINGS_V1_0: FoundationModelIdentifier;
    /**
    ...
    static readonly ANTHROPIC_CLAUDE_HAIKU_4_5_20251001_V1_0: FoundationModelIdentifier;
    ...
    static readonly ANTHROPIC_CLAUDE_OPUS_4_5_20251101_V1_0: FoundationModelIdentifier;
    /** Base model "anthropic.claude-opus-4-6-v1". */
    static readonly ANTHROPIC_CLAUDE_OPUS_4_6_V1: FoundationModelIdentifier;
    /** Base model "anthropic.claude-sonnet-4-6". */
    static readonly ANTHROPIC_CLAUDE_SONNET_4_6: FoundationModelIdentifier;
    /**
    ...
    static readonly MINIMAX_MINIMAX_M2: FoundationModelIdentifier;
    /** Base model "minimax.minimax-m2.1". */
    static readonly MINIMAX_MINIMAX_M2_1: FoundationModelIdentifier;
    /** Base model "minimax.minimax-m2.5". */
    static readonly MINIMAX_MINIMAX_M2_5: FoundationModelIdentifier;
    ...
    static readonly TWELVELABS_MARENGO_EMBED_3_0_V1_0: FoundationModelIdentifier;
    /** Base model "zai.glm-4.7". */
    static readonly ZAI_GLM_4_7: FoundationModelIdentifier;
    /** Base model "zai.glm-4.7-flash". */
    static readonly ZAI_GLM_4_7_FLASH: FoundationModelIdentifier;
    /** Base model "zai.glm-5". */
    static readonly ZAI_GLM_5: FoundationModelIdentifier;
    /**
