...
import { aws_ec2 as ec2Refs, aws_networkfirewall as networkFirewallRefs } from "../../interfaces";
import { FirewallPolicyReference, FirewallReference, IFirewallPolicyRef, IFirewallRef, ILoggingConfigurationRef, IRuleGroupRef, ITLSInspectionConfigurationRef, IVpcEndpointAssociationRef, LoggingConfigurationReference, RuleGroupReference, TLSInspectionConfigurationReference, VpcEndpointAssociationReference } from "../../interfaces/generated/aws-networkfirewall-interfaces.generated";
/**
...
export declare class CfnFirewall extends cdk.CfnResource implements cdk.IInspectable, IFirewallRef, cdk.ITaggable {
     ...
     */
    private _availabilityZoneMappings?;
    /**
     ...
     * A setting indicating whether the firewall is protected against changes to its Availability Zone configuration.
     */
    get availabilityZoneChangeProtection(): boolean | cdk.IResolvable | undefined;
    /**
     * A setting indicating whether the firewall is protected against changes to its Availability Zone configuration.
     */
    set availabilityZoneChangeProtection(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Availability Zones where the firewall endpoints are created for a transit gateway-attached firewall.
     */
    get availabilityZoneMappings(): Array<CfnFirewall.AvailabilityZoneMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The Availability Zones where the firewall endpoints are created for a transit gateway-attached firewall.
     */
    set availabilityZoneMappings(value: Array<CfnFirewall.AvailabilityZoneMappingProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A flag indicating whether it is possible to delete the firewall.
     */
    get deleteProtection(): boolean | cdk.IResolvable | undefined;
    /**
     * A flag indicating whether it is possible to delete the firewall.
     */
    set deleteProtection(value: boolean | cdk.IResolvable | undefined);
    /**
     * A description of the firewall.
     */
     ...
     * An optional setting indicating the specific traffic analysis types to enable on the firewall.
     */
    get enabledAnalysisTypes(): Array<string> | undefined;
    /**
     * An optional setting indicating the specific traffic analysis types to enable on the firewall.
     */
    set enabledAnalysisTypes(value: Array<string> | undefined);
    /**
     * The descriptive name of the firewall.
     */
     ...
     * A setting indicating whether the firewall is protected against a change to the firewall policy association.
     */
    get firewallPolicyChangeProtection(): boolean | cdk.IResolvable | undefined;
    /**
     * A setting indicating whether the firewall is protected against a change to the firewall policy association.
     */
    set firewallPolicyChangeProtection(value: boolean | cdk.IResolvable | undefined);
    /**
     * A setting indicating whether the firewall is protected against changes to the subnet associations.
     */
    get subnetChangeProtection(): boolean | cdk.IResolvable | undefined;
    /**
     * A setting indicating whether the firewall is protected against changes to the subnet associations.
     */
    set subnetChangeProtection(value: boolean | cdk.IResolvable | undefined);
    /**
     * The primary public subnets that Network Firewall is using for the firewall.
     */
    get subnetMappings(): Array<cdk.IResolvable | CfnFirewall.SubnetMappingProperty> | cdk.IResolvable | undefined;
    /**
     * The primary public subnets that Network Firewall is using for the firewall.
     */
    set subnetMappings(value: Array<cdk.IResolvable | CfnFirewall.SubnetMappingProperty> | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
     ...
     */
    get attrTransitGatewayAttachmentId(): string;
...
export interface CfnFirewallProps {
     ...
     */
    readonly firewallPolicyArn: networkFirewallRefs.IFirewallPolicyRef | string;
    /**
     * A setting indicating whether the firewall is protected against a change to the firewall policy association.
     *
...
export declare class CfnFirewallPolicy extends cdk.CfnResource implements cdk.IInspectable, IFirewallPolicyRef, cdk.ITaggable {
     ...
     * The traffic filtering behavior of a firewall policy, defined in a collection of stateless and stateful rule groups and other settings.
     */
    get firewallPolicy(): CfnFirewallPolicy.FirewallPolicyProperty | cdk.IResolvable;
    /**
     * The traffic filtering behavior of a firewall policy, defined in a collection of stateless and stateful rule groups and other settings.
     */
    set firewallPolicy(value: CfnFirewallPolicy.FirewallPolicyProperty | cdk.IResolvable);
    /**
     * The descriptive name of the firewall policy.
     */
...
export declare class CfnLoggingConfiguration extends cdk.CfnResource implements cdk.IInspectable, ILoggingConfigurationRef {
    ...
    get enableMonitoringDashboard(): boolean | cdk.IResolvable | undefined;
    set enableMonitoringDashboard(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the firewallthat the logging configuration is associated with.
     */
     ...
     * The name of the firewall that the logging configuration is associated with.
     */
    get firewallName(): string | undefined;
    /**
     * The name of the firewall that the logging configuration is associated with.
     */
    set firewallName(value: string | undefined);
    /**
     * Defines how AWS Network Firewall performs logging for a firewall.
     */
    get loggingConfiguration(): cdk.IResolvable | CfnLoggingConfiguration.LoggingConfigurationProperty;
    /**
     * Defines how AWS Network Firewall performs logging for a firewall.
     */
    set loggingConfiguration(value: cdk.IResolvable | CfnLoggingConfiguration.LoggingConfigurationProperty);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnLoggingConfigurationProps {
     ...
     */
    readonly firewallArn: networkFirewallRefs.IFirewallRef | string;
    /**
     * The name of the firewall that the logging configuration is associated with.
     *
     * You can't change the firewall specification after you create the logging configuration.
...
export declare class CfnRuleGroup extends cdk.CfnResource implements cdk.IInspectable, IRuleGroupRef, cdk.ITaggable {
     ...
     * An object that defines the rule group rules.
     */
    get ruleGroup(): cdk.IResolvable | CfnRuleGroup.RuleGroupProperty | undefined;
    /**
     * An object that defines the rule group rules.
     */
    set ruleGroup(value: cdk.IResolvable | CfnRuleGroup.RuleGroupProperty | undefined);
    /**
     * The descriptive name of the rule group.
     */
     ...
     * A complex type containing the currently selected rule option fields that will be displayed for rule summarization returned by `DescribeRuleGroupSummary` .
     */
    get summaryConfiguration(): cdk.IResolvable | CfnRuleGroup.SummaryConfigurationProperty | undefined;
    /**
     * A complex type containing the currently selected rule option fields that will be displayed for rule summarization returned by `DescribeRuleGroupSummary` .
     */
    set summaryConfiguration(value: cdk.IResolvable | CfnRuleGroup.SummaryConfigurationProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnTLSInspectionConfiguration extends cdk.CfnResource implements cdk.IInspectable, ITLSInspectionConfigurationRef, cdk.ITaggableV2 {
     ...
     */
    private _tlsInspectionConfigurationName;
    /**
     ...
     * The object that defines a TLS inspection configuration.
     */
    get tlsInspectionConfiguration(): cdk.IResolvable | CfnTLSInspectionConfiguration.TLSInspectionConfigurationProperty;
    /**
     * The object that defines a TLS inspection configuration.
     */
    set tlsInspectionConfiguration(value: cdk.IResolvable | CfnTLSInspectionConfiguration.TLSInspectionConfigurationProperty);
    /**
     * The descriptive name of the TLS inspection configuration.
     */
    get tlsInspectionConfigurationName(): string;
    /**
     * The descriptive name of the TLS inspection configuration.
     */
    set tlsInspectionConfigurationName(value: string);
    /**
     * The Amazon Resource Name (ARN) of the TLS inspection configuration.
     *
     * @cloudformationAttribute TLSInspectionConfigurationArn
     */
    get attrTlsInspectionConfigurationArn(): string;
    /**
     * A unique identifier for the TLS inspection configuration. This ID is returned in the responses to create and list commands. You provide it to operations such as update and delete.
     *
     * @cloudformationAttribute TLSInspectionConfigurationId
     */
    get attrTlsInspectionConfigurationId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnVpcEndpointAssociation extends cdk.CfnResource implements cdk.IInspectable, IVpcEndpointAssociationRef, cdk.ITaggableV2 {
     ...
     * The ID for a subnet that's used in an association with a firewall.
     */
    get subnetMapping(): cdk.IResolvable | CfnVpcEndpointAssociation.SubnetMappingProperty;
    /**
     * The ID for a subnet that's used in an association with a firewall.
     */
    set subnetMapping(value: cdk.IResolvable | CfnVpcEndpointAssociation.SubnetMappingProperty);
    /**
     * The key:value pairs to associate with the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrVpcEndpointAssociationArn(): string;
    /**
     * The unique identifier of the VPC endpoint association.
     *
     * @cloudformationAttribute VpcEndpointAssociationId
     */
    get attrVpcEndpointAssociationId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
