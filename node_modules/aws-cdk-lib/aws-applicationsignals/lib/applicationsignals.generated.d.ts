...
import { DiscoveryReference, GroupingConfigurationReference, IDiscoveryRef, IGroupingConfigurationRef, IServiceLevelObjectiveRef, ServiceLevelObjectiveReference } from "../../interfaces/generated/aws-applicationsignals-interfaces.generated";
/**
...
export declare class CfnGroupingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IGroupingConfigurationRef {
     ...
     */
    private _groupingAttributeDefinitions;
    /**
     ...
     * An array of grouping attribute definitions that specify how services should be grouped based on various attributes and source keys.
     */
    get groupingAttributeDefinitions(): Array<CfnGroupingConfiguration.GroupingAttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * An array of grouping attribute definitions that specify how services should be grouped based on various attributes and source keys.
     */
    set groupingAttributeDefinitions(value: Array<CfnGroupingConfiguration.GroupingAttributeDefinitionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The 12 digit AWS Account ID for the account.
     *
     * @cloudformationAttribute AccountId
...
export declare class CfnServiceLevelObjective extends cdk.CfnResource implements cdk.IInspectable, IServiceLevelObjectiveRef, cdk.ITaggableV2 {
     ...
     */
    private _burnRateConfigurations?;
    /**
     ...
     * Each object in this array defines the length of the look-back window used to calculate one burn rate metric for this SLO.
     */
    get burnRateConfigurations(): Array<CfnServiceLevelObjective.BurnRateConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Each object in this array defines the length of the look-back window used to calculate one burn rate metric for this SLO.
     */
    set burnRateConfigurations(value: Array<CfnServiceLevelObjective.BurnRateConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * An optional description for this SLO.
     */
     ...
     * The time window to be excluded from the SLO performance metrics.
     */
    get exclusionWindows(): Array<CfnServiceLevelObjective.ExclusionWindowProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The time window to be excluded from the SLO performance metrics.
     */
    set exclusionWindows(value: Array<CfnServiceLevelObjective.ExclusionWindowProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * This structure contains the attributes that determine the goal of an SLO.
     */
    get goal(): CfnServiceLevelObjective.GoalProperty | cdk.IResolvable | undefined;
    /**
     * This structure contains the attributes that determine the goal of an SLO.
     */
    set goal(value: CfnServiceLevelObjective.GoalProperty | cdk.IResolvable | undefined);
    /**
     * A name for this SLO.
     */
    get name(): string;
     ...
     * A structure containing information about the performance metric that this SLO monitors, if this is a request-based SLO.
     */
    get requestBasedSli(): cdk.IResolvable | CfnServiceLevelObjective.RequestBasedSliProperty | undefined;
    /**
     * A structure containing information about the performance metric that this SLO monitors, if this is a request-based SLO.
     */
    set requestBasedSli(value: cdk.IResolvable | CfnServiceLevelObjective.RequestBasedSliProperty | undefined);
    /**
     * A structure containing information about the performance metric that this SLO monitors, if this is a period-based SLO.
     */
    get sli(): cdk.IResolvable | CfnServiceLevelObjective.SliProperty | undefined;
    /**
     * A structure containing information about the performance metric that this SLO monitors, if this is a period-based SLO.
     */
    set sli(value: cdk.IResolvable | CfnServiceLevelObjective.SliProperty | undefined);
    /**
     * A list of key-value pairs to associate with the SLO.
     */
