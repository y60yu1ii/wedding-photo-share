...
import { CollectionReference, ICollectionRef, IProjectRef, IStreamProcessorRef, ProjectReference, StreamProcessorReference } from "../../interfaces/generated/aws-rekognition-interfaces.generated";
/**
...
export declare class CfnStreamProcessor extends cdk.CfnResource implements cdk.IInspectable, IStreamProcessorRef, cdk.ITaggable {
     ...
     */
    private _boundingBoxRegionsOfInterest?;
    /**
     * Connected home settings to use on a streaming video.
     */
    private _connectedHomeSettings?;
    /**
     ...
     */
    private _polygonRegionsOfInterest?;
    /**
     ...
     * List of BoundingBox objects, each of which denotes a region of interest on screen.
     */
    get boundingBoxRegionsOfInterest(): Array<CfnStreamProcessor.BoundingBoxProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * List of BoundingBox objects, each of which denotes a region of interest on screen.
     */
    set boundingBoxRegionsOfInterest(value: Array<CfnStreamProcessor.BoundingBoxProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Connected home settings to use on a streaming video.
     */
    get connectedHomeSettings(): CfnStreamProcessor.ConnectedHomeSettingsProperty | cdk.IResolvable | undefined;
    /**
     * Connected home settings to use on a streaming video.
     */
    set connectedHomeSettings(value: CfnStreamProcessor.ConnectedHomeSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Allows you to opt in or opt out to share data with Rekognition to improve model performance.
     */
    get dataSharingPreference(): CfnStreamProcessor.DataSharingPreferenceProperty | cdk.IResolvable | undefined;
    /**
     * Allows you to opt in or opt out to share data with Rekognition to improve model performance.
     */
    set dataSharingPreference(value: CfnStreamProcessor.DataSharingPreferenceProperty | cdk.IResolvable | undefined);
    /**
     * The input parameters used to recognize faces in a streaming video analyzed by an Amazon Rekognition stream processor.
     */
    get faceSearchSettings(): CfnStreamProcessor.FaceSearchSettingsProperty | cdk.IResolvable | undefined;
    /**
     * The input parameters used to recognize faces in a streaming video analyzed by an Amazon Rekognition stream processor.
     */
    set faceSearchSettings(value: CfnStreamProcessor.FaceSearchSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Amazon Rekognition's Video Stream Processor takes a Kinesis video stream as input.
     */
    get kinesisDataStream(): cdk.IResolvable | CfnStreamProcessor.KinesisDataStreamProperty | undefined;
    /**
     * Amazon Rekognition's Video Stream Processor takes a Kinesis video stream as input.
     */
    set kinesisDataStream(value: cdk.IResolvable | CfnStreamProcessor.KinesisDataStreamProperty | undefined);
    /**
     * The Kinesis video stream that provides the source of the streaming video for an Amazon Rekognition Video stream processor.
     */
    get kinesisVideoStream(): cdk.IResolvable | CfnStreamProcessor.KinesisVideoStreamProperty;
    /**
     * The Kinesis video stream that provides the source of the streaming video for an Amazon Rekognition Video stream processor.
     */
    set kinesisVideoStream(value: cdk.IResolvable | CfnStreamProcessor.KinesisVideoStreamProperty);
    /**
     * The identifier for your Amazon Key Management Service key (Amazon KMS key).
     */
     ...
     * The Amazon Simple Notification Service topic to which Amazon Rekognition publishes the object detection results and completion status of a video analysis operation.
     */
    get notificationChannel(): cdk.IResolvable | CfnStreamProcessor.NotificationChannelProperty | undefined;
    /**
     * The Amazon Simple Notification Service topic to which Amazon Rekognition publishes the object detection results and completion status of a video analysis operation.
     */
    set notificationChannel(value: cdk.IResolvable | CfnStreamProcessor.NotificationChannelProperty | undefined);
    /**
     * A set of ordered lists of [Point](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_Point) objects. Each entry of the set contains a polygon denoting a region of interest on the screen. Each polygon is an ordered list of [Point](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_Point) objects. For more information, see the Polygon field of [RegionOfInterest](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_RegionOfInterest) .
     */
    get polygonRegionsOfInterest(): any | cdk.IResolvable | undefined;
    /**
     * A set of ordered lists of [Point](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_Point) objects. Each entry of the set contains a polygon denoting a region of interest on the screen. Each polygon is an ordered list of [Point](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_Point) objects. For more information, see the Polygon field of [RegionOfInterest](https://docs.aws.amazon.com/rekognition/latest/APIReference/API_RegionOfInterest) .
     */
    set polygonRegionsOfInterest(value: any | cdk.IResolvable | undefined);
    /**
     * The ARN of the IAM role that allows access to the stream processor.
     */
    get roleArn(): string;
     ...
     * The Amazon S3 bucket location to which Amazon Rekognition publishes the detailed inference results of a video analysis operation.
     */
    get s3Destination(): cdk.IResolvable | CfnStreamProcessor.S3DestinationProperty | undefined;
    /**
     * The Amazon S3 bucket location to which Amazon Rekognition publishes the detailed inference results of a video analysis operation.
     */
    set s3Destination(value: cdk.IResolvable | CfnStreamProcessor.S3DestinationProperty | undefined);
    /**
     * A set of tags (key-value pairs) that you want to attach to the stream processor.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
