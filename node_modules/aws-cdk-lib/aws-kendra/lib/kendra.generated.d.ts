...
import { aws_iam as iamRefs, aws_kendra as kendraRefs } from "../../interfaces";
import { DataSourceReference, FaqReference, IDataSourceRef, IFaqRef, IIndexRef, IndexReference } from "../../interfaces/generated/aws-kendra-interfaces.generated";
/**
...
export declare class CfnDataSource extends cdk.CfnResource implements cdk.IInspectable, IDataSourceRef, cdk.ITaggable {
     ...
     * Configuration information for altering document metadata and content during the document ingestion process.
     */
    get customDocumentEnrichmentConfiguration(): CfnDataSource.CustomDocumentEnrichmentConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Configuration information for altering document metadata and content during the document ingestion process.
     */
    set customDocumentEnrichmentConfiguration(value: CfnDataSource.CustomDocumentEnrichmentConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Configuration information for an Amazon Kendra data source.
     */
    get dataSourceConfiguration(): CfnDataSource.DataSourceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Configuration information for an Amazon Kendra data source.
     */
    set dataSourceConfiguration(value: CfnDataSource.DataSourceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A description for the data source connector.
     */
...
export interface CfnDataSourceProps {
     ...
     */
    readonly indexId: kendraRefs.IIndexRef | string;
    /**
     * The code for a language.
     *
...
export declare class CfnFaq extends cdk.CfnResource implements cdk.IInspectable, IFaqRef, cdk.ITaggable {
     ...
     * The Amazon Simple Storage Service (Amazon S3) location of the FAQ input data.
     */
    get s3Path(): cdk.IResolvable | CfnFaq.S3PathProperty;
    /**
     * The Amazon Simple Storage Service (Amazon S3) location of the FAQ input data.
     */
    set s3Path(value: cdk.IResolvable | CfnFaq.S3PathProperty);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnIndex extends cdk.CfnResource implements cdk.IInspectable, IIndexRef, cdk.ITaggable {
     ...
     * Specifies additional capacity units configured for your Enterprise Edition index.
     */
    get capacityUnits(): CfnIndex.CapacityUnitsConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies additional capacity units configured for your Enterprise Edition index.
     */
    set capacityUnits(value: CfnIndex.CapacityUnitsConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A description for the index.
     */
    get description(): string | undefined;
     ...
     * Specifies the properties of an index field.
     */
    get documentMetadataConfigurations(): Array<CfnIndex.DocumentMetadataConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the properties of an index field.
     */
    set documentMetadataConfigurations(value: Array<CfnIndex.DocumentMetadataConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Indicates whether the index is a Enterprise Edition index, a Developer Edition index, or a GenAI Enterprise Edition index.
     */
    get edition(): string;
     ...
     * The identifier of the AWS KMS customer managed key (CMK) to use to encrypt data indexed by Amazon Kendra.
     */
    get serverSideEncryptionConfiguration(): cdk.IResolvable | CfnIndex.ServerSideEncryptionConfigurationProperty | undefined;
    /**
     * The identifier of the AWS KMS customer managed key (CMK) to use to encrypt data indexed by Amazon Kendra.
     */
    set serverSideEncryptionConfiguration(value: cdk.IResolvable | CfnIndex.ServerSideEncryptionConfigurationProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The user context policy.
     */
    get userContextPolicy(): string | undefined;
    /**
     * The user context policy.
     */
    set userContextPolicy(value: string | undefined);
    /**
     * Defines the type of user token used for the index.
     */
    get userTokenConfigurations(): Array<cdk.IResolvable | CfnIndex.UserTokenConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * Defines the type of user token used for the index.
     */
    set userTokenConfigurations(value: Array<cdk.IResolvable | CfnIndex.UserTokenConfigurationProperty> | cdk.IResolvable | undefined);
    /**
