...
import { DRTAccessReference, IDRTAccessRef, IProactiveEngagementRef, IProtectionGroupRef, IProtectionRef, ProactiveEngagementReference, ProtectionGroupReference, ProtectionReference } from "../../interfaces/generated/aws-shield-interfaces.generated";
/**
...
export declare class CfnDRTAccess extends cdk.CfnResource implements cdk.IInspectable, IDRTAccessRef {
     ...
     * Authorizes the Shield Response Team (SRT) to access the specified Amazon S3 bucket containing log data such as Application Load Balancer access logs, CloudFront logs, or logs from third party sources.
     */
    get logBucketList(): Array<string> | undefined;
    /**
     * Authorizes the Shield Response Team (SRT) to access the specified Amazon S3 bucket containing log data such as Application Load Balancer access logs, CloudFront logs, or logs from third party sources.
     */
    set logBucketList(value: Array<string> | undefined);
    /**
     * Authorizes the Shield Response Team (SRT) using the specified role, to access your AWS account to assist with DDoS attack mitigation during potential attacks.
     */
    get roleArn(): string;
...
export declare class CfnProactiveEngagement extends cdk.CfnResource implements cdk.IInspectable, IProactiveEngagementRef {
     ...
     */
    private _emergencyContactList;
    /**
     * Specifies whether proactive engagement is enabled or disabled.
     */
    private _proactiveEngagementStatus;
    /**
     ...
     * The list of email addresses and phone numbers that the Shield Response Team (SRT) can use to contact you for escalations to the SRT and to initiate proactive customer support, plus any relevant notes.
     */
    get emergencyContactList(): Array<CfnProactiveEngagement.EmergencyContactProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The list of email addresses and phone numbers that the Shield Response Team (SRT) can use to contact you for escalations to the SRT and to initiate proactive customer support, plus any relevant notes.
     */
    set emergencyContactList(value: Array<CfnProactiveEngagement.EmergencyContactProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Specifies whether proactive engagement is enabled or disabled.
     */
    get proactiveEngagementStatus(): string;
    /**
     * Specifies whether proactive engagement is enabled or disabled.
     */
    set proactiveEngagementStatus(value: string);
    /**
     * The ID of the account that submitted the template.
     *
     * @cloudformationAttribute AccountId
...
export declare class CfnProtection extends cdk.CfnResource implements cdk.IInspectable, IProtectionRef, cdk.ITaggableV2 {
     ...
     */
    private _applicationLayerAutomaticResponseConfiguration?;
    /**
     ...
     * The automatic application layer DDoS mitigation settings for the protection.
     */
    get applicationLayerAutomaticResponseConfiguration(): CfnProtection.ApplicationLayerAutomaticResponseConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The automatic application layer DDoS mitigation settings for the protection.
     */
    set applicationLayerAutomaticResponseConfiguration(value: CfnProtection.ApplicationLayerAutomaticResponseConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The ARN (Amazon Resource Name) of the health check to associate with the protection.
     */
    get healthCheckArns(): Array<string> | undefined;
    /**
     * The ARN (Amazon Resource Name) of the health check to associate with the protection.
     */
    set healthCheckArns(value: Array<string> | undefined);
    /**
     * The name of the protection. For example, `My CloudFront distributions` .
     */
    get name(): string;
...
export declare class CfnProtectionGroup extends cdk.CfnResource implements cdk.IInspectable, IProtectionGroupRef, cdk.ITaggableV2 {
     ...
     * The ARNs (Amazon Resource Names) of the resources to include in the protection group.
     */
    get members(): Array<string> | undefined;
    /**
     * The ARNs (Amazon Resource Names) of the resources to include in the protection group.
     */
    set members(value: Array<string> | undefined);
    /**
     * The criteria to use to choose the protected resources for inclusion in the group.
     */
    get pattern(): string;
     ...
     */
    get attrProtectionGroupArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
