...
export declare class CfnAccessPolicy extends cdk.CfnResource implements cdk.IInspectable, IAccessPolicyRef {
     ...
     * The identity for this access policy.
     */
    get accessPolicyIdentity(): CfnAccessPolicy.AccessPolicyIdentityProperty | cdk.IResolvable;
    /**
     * The identity for this access policy.
     */
    set accessPolicyIdentity(value: CfnAccessPolicy.AccessPolicyIdentityProperty | cdk.IResolvable);
    /**
     * The permission level for this access policy.
     */
     ...
     * The AWS IoT SiteWise Monitor resource for this access policy.
     */
    get accessPolicyResource(): CfnAccessPolicy.AccessPolicyResourceProperty | cdk.IResolvable;
    /**
     * The AWS IoT SiteWise Monitor resource for this access policy.
     */
    set accessPolicyResource(value: CfnAccessPolicy.AccessPolicyResourceProperty | cdk.IResolvable);
    /**
     ...
     */
    get attrAccessPolicyArn(): string;
    /**
     * The ID of the access policy.
     *
     * @cloudformationAttribute AccessPolicyId
     */
    get attrAccessPolicyId(): string;
...
export declare class CfnAsset extends cdk.CfnResource implements cdk.IInspectable, IAssetRef, cdk.ITaggable {
     ...
     * The ID of the asset, in UUID format.
     */
    get assetDescription(): string | undefined;
    /**
     * The ID of the asset, in UUID format.
     */
    set assetDescription(value: string | undefined);
    /**
     * The external ID of the asset model composite model.
     */
    get assetExternalId(): string | undefined;
    /**
     * The external ID of the asset model composite model.
     */
    set assetExternalId(value: string | undefined);
    /**
     * A list of asset hierarchies that each contain a `hierarchyId` .
     */
    get assetHierarchies(): Array<CfnAsset.AssetHierarchyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of asset hierarchies that each contain a `hierarchyId` .
     */
    set assetHierarchies(value: Array<CfnAsset.AssetHierarchyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The ID of the asset model from which to create the asset.
     */
     ...
     * The list of asset properties for the asset.
     */
    get assetProperties(): Array<CfnAsset.AssetPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of asset properties for the asset.
     */
    set assetProperties(value: Array<CfnAsset.AssetPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A list of key-value pairs that contain metadata for the asset.
     */
     ...
     */
    get attrAssetArn(): string;
    /**
     * The ID of the asset.
     *
     * @cloudformationAttribute AssetId
     */
    get attrAssetId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnAssetModel extends cdk.CfnResource implements cdk.IInspectable, IAssetModelRef, cdk.ITaggable {
     ...
     */
    private _assetModelType?;
    /**
     * a list of asset model and interface relationships.
     */
    private _enforcedAssetModelInterfaceRelationships?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * The composite models that are part of this asset model.
     */
    get assetModelCompositeModels(): Array<CfnAssetModel.AssetModelCompositeModelProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The composite models that are part of this asset model.
     */
    set assetModelCompositeModels(value: Array<CfnAssetModel.AssetModelCompositeModelProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A description for the asset model.
     */
    get assetModelDescription(): string | undefined;
    /**
     * A description for the asset model.
     */
    set assetModelDescription(value: string | undefined);
    /**
     * The external ID of the asset model.
     */
    get assetModelExternalId(): string | undefined;
    /**
     * The external ID of the asset model.
     */
    set assetModelExternalId(value: string | undefined);
    /**
     * The hierarchy definitions of the asset model.
     */
    get assetModelHierarchies(): Array<CfnAssetModel.AssetModelHierarchyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The hierarchy definitions of the asset model.
     */
    set assetModelHierarchies(value: Array<CfnAssetModel.AssetModelHierarchyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A unique name for the asset model.
     */
     ...
     * The property definitions of the asset model.
     */
    get assetModelProperties(): Array<CfnAssetModel.AssetModelPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The property definitions of the asset model.
     */
    set assetModelProperties(value: Array<CfnAssetModel.AssetModelPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The type of asset model.
     */
    get assetModelType(): string | undefined;
    /**
     * The type of asset model.
     */
    set assetModelType(value: string | undefined);
    /**
     * a list of asset model and interface relationships.
     */
    get enforcedAssetModelInterfaceRelationships(): Array<CfnAssetModel.EnforcedAssetModelInterfaceRelationshipProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * a list of asset model and interface relationships.
     */
    set enforcedAssetModelInterfaceRelationships(value: Array<CfnAssetModel.EnforcedAssetModelInterfaceRelationshipProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A list of key-value pairs that contain metadata for the asset.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrAssetModelArn(): string;
    /**
     * The ID of the asset model.
     *
     * @cloudformationAttribute AssetModelId
     */
    get attrAssetModelId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDashboard extends cdk.CfnResource implements cdk.IInspectable, IDashboardRef, cdk.ITaggable {
     ...
     */
    get attrDashboardArn(): string;
    /**
     * The ID of the dashboard.
     *
     * @cloudformationAttribute DashboardId
     */
    get attrDashboardId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnGateway extends cdk.CfnResource implements cdk.IInspectable, IGatewayRef, cdk.ITaggable {
     ...
     * A list of gateway capability summaries that each contain a namespace and status.
     */
    get gatewayCapabilitySummaries(): Array<CfnGateway.GatewayCapabilitySummaryProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of gateway capability summaries that each contain a namespace and status.
     */
    set gatewayCapabilitySummaries(value: Array<CfnGateway.GatewayCapabilitySummaryProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A unique name for the gateway.
     */
     ...
     * The gateway's platform.
     */
    get gatewayPlatform(): CfnGateway.GatewayPlatformProperty | cdk.IResolvable;
    /**
     * The gateway's platform.
     */
    set gatewayPlatform(value: CfnGateway.GatewayPlatformProperty | cdk.IResolvable);
    /**
     * The version of the gateway.
     */
    get gatewayVersion(): string | undefined;
    /**
     * The version of the gateway.
     */
    set gatewayVersion(value: string | undefined);
    /**
     * A list of key-value pairs that contain metadata for the gateway.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnPortal extends cdk.CfnResource implements cdk.IInspectable, IPortalRef, cdk.ITaggable {
     ...
     */
    private _portalTypeConfiguration?;
    /**
     ...
     * Contains the configuration information of an alarm created in an AWS IoT SiteWise Monitor portal.
     */
    get alarms(): any | cdk.IResolvable | undefined;
    /**
     * Contains the configuration information of an alarm created in an AWS IoT SiteWise Monitor portal.
     */
    set alarms(value: any | cdk.IResolvable | undefined);
    /**
     * The email address that sends alarm notifications.
     */
    get notificationSenderEmail(): string | undefined;
    /**
     * The email address that sends alarm notifications.
     */
    set notificationSenderEmail(value: string | undefined);
    /**
     * The service to use to authenticate users to the portal. Choose from the following options:.
     */
    get portalAuthMode(): string | undefined;
    /**
     * The service to use to authenticate users to the portal. Choose from the following options:.
     */
    set portalAuthMode(value: string | undefined);
    /**
     * The AWS administrator's contact email address.
     */
     ...
     * A description for the portal.
     */
    get portalDescription(): string | undefined;
    /**
     * A description for the portal.
     */
    set portalDescription(value: string | undefined);
    /**
     * A friendly name for the portal.
     */
     ...
     * Define the type of portal.
     */
    get portalType(): string | undefined;
    /**
     * Define the type of portal.
     */
    set portalType(value: string | undefined);
    /**
     * Map to associate detail of configuration related with a PortalType.
     */
    get portalTypeConfiguration(): cdk.IResolvable | Record<string, cdk.IResolvable | CfnPortal.PortalTypeEntryProperty> | undefined;
    /**
     * Map to associate detail of configuration related with a PortalType.
     */
    set portalTypeConfiguration(value: cdk.IResolvable | Record<string, cdk.IResolvable | CfnPortal.PortalTypeEntryProperty> | undefined);
    /**
     * The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of a service role that allows the portal's users to access your AWS IoT SiteWise resources on your behalf. For more information, see [Using service roles for AWS IoT SiteWise Monitor](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/monitor-service-role.html) in the *AWS IoT SiteWise User Guide* .
     */
    get roleArn(): string;
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef, cdk.ITaggable {
     ...
     * A list that contains the IDs of each asset associated with the project.
     */
    get assetIds(): Array<string> | undefined;
    /**
     * A list that contains the IDs of each asset associated with the project.
     */
    set assetIds(value: Array<string> | undefined);
    /**
     * The ID of the portal in which to create the project.
     */
    get portalId(): string;
...
export declare class CfnComputationModel extends cdk.CfnResource implements cdk.IInspectable, IComputationModelRef, cdk.ITaggableV2 {
     ...
     */
    private _computationModelConfiguration;
    /**
     * The data binding for the computation model.
     */
    private _computationModelDataBinding;
    /**
     * The description of the computation model.
     */
    private _computationModelDescription?;
    /**
     * The name of the computation model.
     */
    private _computationModelName;
    /**
     * A list of key-value pairs that contain metadata for the asset.
     */
    private _tags?;
     ...
     * The configuration for the computation model.
     */
    get computationModelConfiguration(): CfnComputationModel.ComputationModelConfigurationProperty | cdk.IResolvable;
    /**
     * The configuration for the computation model.
     */
    set computationModelConfiguration(value: CfnComputationModel.ComputationModelConfigurationProperty | cdk.IResolvable);
    /**
     * The data binding for the computation model.
     */
    get computationModelDataBinding(): cdk.IResolvable | Record<string, CfnComputationModel.ComputationModelDataBindingValueProperty | cdk.IResolvable>;
    /**
     * The data binding for the computation model.
     */
    set computationModelDataBinding(value: cdk.IResolvable | Record<string, CfnComputationModel.ComputationModelDataBindingValueProperty | cdk.IResolvable>);
    /**
     * The description of the computation model.
     */
    get computationModelDescription(): string | undefined;
    /**
     * The description of the computation model.
     */
    set computationModelDescription(value: string | undefined);
    /**
     * The name of the computation model.
     */
    get computationModelName(): string;
    /**
     * The name of the computation model.
     */
    set computationModelName(value: string);
    /**
     * A list of key-value pairs that contain metadata for the asset.
     */
     ...
     */
    get attrComputationModelArn(): string;
    /**
     * The ID of the computation model.
     *
     * @cloudformationAttribute ComputationModelId
     */
    get attrComputationModelId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggableV2 {
     ...
     * The data source for the dataset.
     */
    get datasetSource(): CfnDataset.DatasetSourceProperty | cdk.IResolvable;
    /**
     * The data source for the dataset.
     */
    set datasetSource(value: CfnDataset.DatasetSourceProperty | cdk.IResolvable);
    /**
     * A list of key-value pairs that contain metadata for the access policy.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
