...
export declare class CfnLifecyclePolicy extends cdk.CfnResource implements cdk.IInspectable, ILifecyclePolicyRef, cdk.ITaggable {
     ...
     */
    private _crossRegionCopyTargets?;
    /**
     ...
     * *[Default policies only]* Indicates whether the policy should copy tags from the source resource to the snapshot or AMI.
     */
    get copyTags(): boolean | cdk.IResolvable | undefined;
    /**
     * *[Default policies only]* Indicates whether the policy should copy tags from the source resource to the snapshot or AMI.
     */
    set copyTags(value: boolean | cdk.IResolvable | undefined);
    /**
     * *[Default policies only]* Specifies how often the policy should run and create snapshots or AMIs.
     */
    get createInterval(): number | undefined;
    /**
     * *[Default policies only]* Specifies how often the policy should run and create snapshots or AMIs.
     */
    set createInterval(value: number | undefined);
    /**
     * *[Default policies only]* Specifies destination Regions for snapshot or AMI copies.
     */
    get crossRegionCopyTargets(): Array<CfnLifecyclePolicy.CrossRegionCopyTargetProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * *[Default policies only]* Specifies destination Regions for snapshot or AMI copies.
     */
    set crossRegionCopyTargets(value: Array<CfnLifecyclePolicy.CrossRegionCopyTargetProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * *[Default policies only]* Specify the type of default policy to create.
     */
    get defaultPolicy(): string | undefined;
    /**
     * *[Default policies only]* Specify the type of default policy to create.
     */
    set defaultPolicy(value: string | undefined);
    /**
     * A description of the lifecycle policy.
     */
     ...
     * *[Default policies only]* Specifies exclusion parameters for volumes or instances for which you do not want to create snapshots or AMIs.
     */
    get exclusions(): CfnLifecyclePolicy.ExclusionsProperty | cdk.IResolvable | undefined;
    /**
     * *[Default policies only]* Specifies exclusion parameters for volumes or instances for which you do not want to create snapshots or AMIs.
     */
    set exclusions(value: CfnLifecyclePolicy.ExclusionsProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role used to run the operations specified by the lifecycle policy.
     */
     ...
     * *[Default policies only]* Defines the snapshot or AMI retention behavior for the policy if the source volume or instance is deleted, or if the policy enters the error, disabled, or deleted state.
     */
    get extendDeletion(): boolean | cdk.IResolvable | undefined;
    /**
     * *[Default policies only]* Defines the snapshot or AMI retention behavior for the policy if the source volume or instance is deleted, or if the policy enters the error, disabled, or deleted state.
     */
    set extendDeletion(value: boolean | cdk.IResolvable | undefined);
    /**
     * The configuration details of the lifecycle policy.
     */
    get policyDetails(): cdk.IResolvable | CfnLifecyclePolicy.PolicyDetailsProperty | undefined;
    /**
     * The configuration details of the lifecycle policy.
     */
    set policyDetails(value: cdk.IResolvable | CfnLifecyclePolicy.PolicyDetailsProperty | undefined);
    /**
     * *[Default policies only]* Specifies how long the policy should retain snapshots or AMIs before deleting them.
     */
    get retainInterval(): number | undefined;
    /**
     * *[Default policies only]* Specifies how long the policy should retain snapshots or AMIs before deleting them.
     */
    set retainInterval(value: number | undefined);
    /**
     * The activation state of the lifecycle policy.
     */
...
export declare namespace CfnLifecyclePolicy {
    ...
    interface PolicyDetailsProperty {
         ...
         */
        readonly crossRegionCopyTargets?: Array<CfnLifecyclePolicy.CrossRegionCopyTargetProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
    ...
    interface ExclusionsProperty {
         ...
         */
        readonly excludeTags?: Array<cdk.CfnTag | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly excludeVolumeTypes?: Array<any | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface CrossRegionCopyTargetProperty {
        /**
