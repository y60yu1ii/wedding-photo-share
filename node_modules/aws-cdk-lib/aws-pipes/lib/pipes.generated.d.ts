...
import { aws_events as eventsRefs, aws_iam as iamRefs, aws_kinesis as kinesisRefs, aws_lambda as lambdaRefs, aws_logs as logsRefs, aws_sns as snsRefs, aws_sqs as sqsRefs, aws_stepfunctions as stepFunctionsRefs } from "../../interfaces";
...
export declare class CfnPipe extends cdk.CfnResource implements cdk.IInspectable, IPipeRef, cdk.ITaggable {
     ...
     * The ARN of the enrichment resource.
     */
    get enrichment(): string | undefined;
    /**
     * The ARN of the enrichment resource.
     */
    set enrichment(value: string | undefined);
    /**
     * The parameters required to set up enrichment on your pipe.
     */
    get enrichmentParameters(): cdk.IResolvable | CfnPipe.PipeEnrichmentParametersProperty | undefined;
    /**
     * The parameters required to set up enrichment on your pipe.
     */
    set enrichmentParameters(value: cdk.IResolvable | CfnPipe.PipeEnrichmentParametersProperty | undefined);
    /**
     * The identifier of the AWS  customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt pipe data.
     */
     ...
     * The logging configuration settings for the pipe.
     */
    get logConfiguration(): cdk.IResolvable | CfnPipe.PipeLogConfigurationProperty | undefined;
    /**
     * The logging configuration settings for the pipe.
     */
    set logConfiguration(value: cdk.IResolvable | CfnPipe.PipeLogConfigurationProperty | undefined);
    /**
     * The name of the pipe.
     */
     ...
     * The parameters required to set up a source for your pipe.
     */
    get sourceParameters(): cdk.IResolvable | CfnPipe.PipeSourceParametersProperty | undefined;
    /**
     * The parameters required to set up a source for your pipe.
     */
    set sourceParameters(value: cdk.IResolvable | CfnPipe.PipeSourceParametersProperty | undefined);
    /**
     * The list of key-value pairs to associate with the pipe.
     */
     ...
     * The parameters required to set up a target for your pipe.
     */
    get targetParameters(): cdk.IResolvable | CfnPipe.PipeTargetParametersProperty | undefined;
    /**
     * The parameters required to set up a target for your pipe.
     */
    set targetParameters(value: cdk.IResolvable | CfnPipe.PipeTargetParametersProperty | undefined);
    /**
     * The ARN of the pipe.
     *
...
export interface CfnPipeProps {
     ...
     */
    readonly enrichment?: lambdaRefs.IFunctionRef | string;
    /**
     * The parameters required to set up enrichment on your pipe.
     *
     ...
     */
    readonly source: kinesisRefs.IStreamRef | sqsRefs.IQueueRef | string;
    /**
     * The parameters required to set up a source for your pipe.
     *
     ...
     */
    readonly target: eventsRefs.IEventBusRef | lambdaRefs.IFunctionRef | logsRefs.ILogGroupRef | snsRefs.ITopicRef | sqsRefs.IQueueRef | stepFunctionsRefs.IStateMachineRef | string;
    /**
     * The parameters required to set up a target for your pipe.
     *
     * For more information about pipe target parameters, including how to use dynamic path parameters, see [Target parameters](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-event-target.html) in the *Amazon EventBridge User Guide* .
