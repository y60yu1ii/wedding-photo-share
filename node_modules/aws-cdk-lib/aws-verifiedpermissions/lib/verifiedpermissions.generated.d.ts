...
import { IdentitySourceReference, IIdentitySourceRef, IPolicyRef, IPolicyStoreRef, IPolicyTemplateRef, PolicyReference, PolicyStoreReference, PolicyTemplateReference } from "../../interfaces/generated/aws-verifiedpermissions-interfaces.generated";
/**
...
export declare class CfnIdentitySource extends cdk.CfnResource implements cdk.IInspectable, IIdentitySourceRef {
     ...
     * Contains configuration information used when creating a new identity source.
     */
    get configuration(): CfnIdentitySource.IdentitySourceConfigurationProperty | cdk.IResolvable;
    /**
     * Contains configuration information used when creating a new identity source.
     */
    set configuration(value: CfnIdentitySource.IdentitySourceConfigurationProperty | cdk.IResolvable);
    /**
     * Specifies the ID of the policy store in which you want to store this identity source.
     */
     ...
     * Specifies the namespace and data type of the principals generated for identities authenticated by the new identity source.
     */
    get principalEntityType(): string | undefined;
    /**
     * Specifies the namespace and data type of the principals generated for identities authenticated by the new identity source.
     */
    set principalEntityType(value: string | undefined);
    /**
...
export declare class CfnPolicyStore extends cdk.CfnResource implements cdk.IInspectable, IPolicyStoreRef, cdk.ITaggableV2 {
     ...
     * Specifies whether the policy store can be deleted. If enabled, the policy store can't be deleted.
     */
    get deletionProtection(): CfnPolicyStore.DeletionProtectionProperty | cdk.IResolvable | undefined;
    /**
     * Specifies whether the policy store can be deleted. If enabled, the policy store can't be deleted.
     */
    set deletionProtection(value: CfnPolicyStore.DeletionProtectionProperty | cdk.IResolvable | undefined);
    /**
     * Descriptive text that you can provide to help with identification of the current policy store.
     */
    ...
    get encryptionSettings(): CfnPolicyStore.EncryptionSettingsProperty | cdk.IResolvable | undefined;
    set encryptionSettings(value: CfnPolicyStore.EncryptionSettingsProperty | cdk.IResolvable | undefined);
    /**
     * Creates or updates the policy schema in a policy store.
     */
    get schema(): cdk.IResolvable | CfnPolicyStore.SchemaDefinitionProperty | undefined;
    /**
     * Creates or updates the policy schema in a policy store.
     */
    set schema(value: cdk.IResolvable | CfnPolicyStore.SchemaDefinitionProperty | undefined);
    /**
     * The list of key-value pairs to associate with the policy store.
     */
     ...
     * Specifies the validation setting for this policy store.
     */
    get validationSettings(): cdk.IResolvable | CfnPolicyStore.ValidationSettingsProperty;
    /**
     * Specifies the validation setting for this policy store.
     */
    set validationSettings(value: cdk.IResolvable | CfnPolicyStore.ValidationSettingsProperty);
    /**
     ...
     */
    get attrEncryptionState(): cdk.IResolvable;
    /**
     * The unique ID of the new or updated policy store.
     *
     * @cloudformationAttribute PolicyStoreId
     */
    get attrPolicyStoreId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnPolicyStore {
     ...
     */
    interface EncryptionSettingsProperty {
        /**
         ...
         */
        readonly kmsEncryptionSettings?: cdk.IResolvable | CfnPolicyStore.KmsEncryptionSettingsProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface KmsEncryptionSettingsProperty {
         ...
         */
        readonly encryptionContext?: cdk.IResolvable | Record<string, string>;
        /**
    ...
    interface EncryptionStateProperty {
         ...
         */
        readonly kmsEncryptionState: cdk.IResolvable | CfnPolicyStore.KmsEncryptionStateProperty;
    }
    /**
     * @struct
     * @stability external
...
export interface CfnPolicyStoreProps {
     ...
     */
    readonly encryptionSettings?: CfnPolicyStore.EncryptionSettingsProperty | cdk.IResolvable;
    /**
     * Creates or updates the policy schema in a policy store.
     *
...
export declare class CfnPolicyTemplate extends cdk.CfnResource implements cdk.IInspectable, IPolicyTemplateRef {
     ...
     */
    get attrPolicyTemplateId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
