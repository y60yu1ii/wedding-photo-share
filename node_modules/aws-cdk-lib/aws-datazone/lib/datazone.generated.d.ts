...
export declare class CfnConnection extends cdk.CfnResource implements cdk.IInspectable, IConnectionRef {
     ...
     */
    private _enableTrustedIdentityPropagation?;
    /**
     * The ID of the environment where the connection is created.
     */
    private _environmentIdentifier?;
    /**
     ...
     * The location where the connection is created.
     */
    get awsLocation(): CfnConnection.AwsLocationProperty | cdk.IResolvable | undefined;
    /**
     * The location where the connection is created.
     */
    set awsLocation(value: CfnConnection.AwsLocationProperty | cdk.IResolvable | undefined);
    /**
     * Connection description.
     */
     ...
     * Specifies whether the trusted identity propagation is enabled.
     */
    get enableTrustedIdentityPropagation(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the trusted identity propagation is enabled.
     */
    set enableTrustedIdentityPropagation(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ID of the environment where the connection is created.
     */
    get environmentIdentifier(): string | undefined;
    /**
     * The ID of the environment where the connection is created.
     */
    set environmentIdentifier(value: string | undefined);
    /**
     * The name of the connection.
     */
    get name(): string;
     ...
     * The identifier of the project in which the connection should be created.
     */
    set projectIdentifier(value: string | undefined);
    /**
     * Connection props.
     */
    get props(): CfnConnection.ConnectionPropertiesInputProperty | cdk.IResolvable | undefined;
    /**
     * Connection props.
     */
    set props(value: CfnConnection.ConnectionPropertiesInputProperty | cdk.IResolvable | undefined);
    /**
     * The scope of the connection.
     */
     ...
     */
    get attrEnvironmentUserRole(): string;
    /**
...
export declare namespace CfnConnection {
    ...
    interface ConnectionPropertiesInputProperty {
         ...
         */
        readonly workflowsMwaaProperties?: cdk.IResolvable | CfnConnection.WorkflowsMwaaPropertiesInputProperty;
        /**
...
export declare class CfnDataSource extends cdk.CfnResource implements cdk.IInspectable, IDataSourceRef {
     ...
     * The metadata forms attached to the assets that the data source works with.
     */
    get assetFormsInput(): Array<CfnDataSource.FormInputProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The metadata forms attached to the assets that the data source works with.
     */
    set assetFormsInput(value: Array<CfnDataSource.FormInputProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The configuration of the data source.
     */
    get configuration(): CfnDataSource.DataSourceConfigurationInputProperty | cdk.IResolvable | undefined;
    /**
     * The configuration of the data source.
     */
    set configuration(value: CfnDataSource.DataSourceConfigurationInputProperty | cdk.IResolvable | undefined);
    /**
     * The unique identifier of a connection used to fetch relevant parameters from connection during Datasource run.
     */
    get connectionIdentifier(): string | undefined;
    /**
     * The unique identifier of a connection used to fetch relevant parameters from connection during Datasource run.
     */
    set connectionIdentifier(value: string | undefined);
    /**
     * The description of the data source.
     */
    get description(): string | undefined;
     ...
     * Specifies whether the data source is enabled.
     */
    get enableSetting(): string | undefined;
    /**
     * Specifies whether the data source is enabled.
     */
    set enableSetting(value: string | undefined);
    /**
     * The unique identifier of the Amazon DataZone environment to which the data source publishes assets.
     */
    get environmentIdentifier(): string | undefined;
     ...
     * Specifies whether the assets that this data source creates in the inventory are to be also automatically published to the catalog.
     */
    get publishOnImport(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the assets that this data source creates in the inventory are to be also automatically published to the catalog.
     */
    set publishOnImport(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether the business name generation is to be enabled for this data source.
     */
    get recommendation(): cdk.IResolvable | CfnDataSource.RecommendationConfigurationProperty | undefined;
    /**
     * Specifies whether the business name generation is to be enabled for this data source.
     */
    set recommendation(value: cdk.IResolvable | CfnDataSource.RecommendationConfigurationProperty | undefined);
    /**
     * The schedule of the data source runs.
     */
    get schedule(): cdk.IResolvable | CfnDataSource.ScheduleConfigurationProperty | undefined;
    /**
     * The schedule of the data source runs.
     */
    set schedule(value: cdk.IResolvable | CfnDataSource.ScheduleConfigurationProperty | undefined);
    /**
     * The type of the data source.
     */
    get type(): string;
     ...
     */
    get attrLastRunAssetCount(): cdk.IResolvable;
    /**
     * The timestamp of when the data source run was last performed.
     *
     * @cloudformationAttribute LastRunAt
     */
    get attrLastRunAt(): string;
    /**
     * The status of the last data source run.
     *
     * @cloudformationAttribute LastRunStatus
     */
    get attrLastRunStatus(): string;
    /**
...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef, cdk.ITaggableV2 {
     ...
     * The domain version.
     */
    get domainVersion(): string | undefined;
    /**
     * The domain version.
     */
    set domainVersion(value: string | undefined);
    /**
     * The identifier of the AWS Key Management Service (KMS) key that is used to encrypt the Amazon DataZone domain, metadata, and reporting data.
     */
     ...
     * The service role of the domain.
     */
    get serviceRole(): string | undefined;
    /**
     * The service role of the domain.
     */
    set serviceRole(value: string | undefined);
    /**
     * The single sign-on details in Amazon DataZone.
     */
    get singleSignOn(): cdk.IResolvable | CfnDomain.SingleSignOnProperty | undefined;
    /**
     * The single sign-on details in Amazon DataZone.
     */
    set singleSignOn(value: cdk.IResolvable | CfnDomain.SingleSignOnProperty | undefined);
    /**
     * The tags specified for the Amazon DataZone domain.
     */
...
export declare class CfnDomainUnit extends cdk.CfnResource implements cdk.IInspectable, IDomainUnitRef {
     ...
     */
    private _parentDomainUnitIdentifier;
    /**
     ...
     * The ID of the parent domain unit.
     */
    get parentDomainUnitIdentifier(): string;
    /**
     * The ID of the parent domain unit.
     */
    set parentDomainUnitIdentifier(value: string);
    /**
     ...
     */
    get attrParentDomainUnitId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef {
     ...
     */
    private _environmentAccountIdentifier?;
    /**
     * The AWS Region in which an environment exists.
     */
    private _environmentAccountRegion?;
    /**
     ...
     */
    private _environmentConfigurationId?;
    /**
     * The identifier of the environment profile that is used to create this Amazon DataZone environment.
     */
    private _environmentProfileIdentifier?;
    /**
     * The ARN of the environment role.
     */
    private _environmentRoleArn?;
    /**
     ...
     * The deployment order for the environment.
     */
    get deploymentOrder(): number | undefined;
    /**
     * The deployment order for the environment.
     */
    set deploymentOrder(value: number | undefined);
    /**
     * The description of the environment.
     */
    get description(): string | undefined;
     ...
     * The identifier of the AWS account in which an environment exists.
     */
    get environmentAccountIdentifier(): string | undefined;
    /**
     * The identifier of the AWS account in which an environment exists.
     */
    set environmentAccountIdentifier(value: string | undefined);
    /**
     * The AWS Region in which an environment exists.
     */
    get environmentAccountRegion(): string | undefined;
    /**
     * The AWS Region in which an environment exists.
     */
    set environmentAccountRegion(value: string | undefined);
    /**
     * The identifier of the environment blueprint.
     */
    get environmentBlueprintIdentifier(): string | undefined;
    /**
     * The identifier of the environment blueprint.
     */
    set environmentBlueprintIdentifier(value: string | undefined);
    /**
     * The identifier of the environment configuration.
     */
    get environmentConfigurationId(): string | undefined;
    /**
     * The identifier of the environment configuration.
     */
    set environmentConfigurationId(value: string | undefined);
    /**
     * The identifier of the environment profile that is used to create this Amazon DataZone environment.
     */
    get environmentProfileIdentifier(): string | undefined;
    /**
     * The identifier of the environment profile that is used to create this Amazon DataZone environment.
     */
    set environmentProfileIdentifier(value: string | undefined);
    /**
     * The ARN of the environment role.
     */
    get environmentRoleArn(): string | undefined;
    /**
     * The ARN of the environment role.
     */
    set environmentRoleArn(value: string | undefined);
    /**
     * The glossary terms that can be used in this Amazon DataZone environment.
     */
    get glossaryTerms(): Array<string> | undefined;
    /**
     * The glossary terms that can be used in this Amazon DataZone environment.
     */
    set glossaryTerms(value: Array<string> | undefined);
    /**
     * The name of the Amazon DataZone environment.
     */
    get name(): string;
     ...
     * The user parameters of this Amazon DataZone environment.
     */
    get userParameters(): Array<CfnEnvironment.EnvironmentParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The user parameters of this Amazon DataZone environment.
     */
    set userParameters(value: Array<CfnEnvironment.EnvironmentParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The identifier of the AWS account in which an environment exists.
     *
     ...
     */
    get attrAwsAccountRegion(): string;
    /**
     ...
     */
    get attrEnvironmentBlueprintId(): string;
    /**
     * The identifier of the environment profile with which the environment was created.
     *
     * @cloudformationAttribute EnvironmentProfileId
     */
    get attrEnvironmentProfileId(): string;
    /**
...
export declare class CfnEnvironmentActions extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentActionsRef {
     ...
     * The Amazon DataZone domain ID of the environment action.
     */
    get domainIdentifier(): string | undefined;
    /**
     * The Amazon DataZone domain ID of the environment action.
     */
    set domainIdentifier(value: string | undefined);
    /**
     * The environment ID of the environment action.
     */
    get environmentIdentifier(): string | undefined;
     ...
     * The parameters of the environment action.
     */
    get parameters(): CfnEnvironmentActions.AwsConsoleLinkParametersProperty | cdk.IResolvable | undefined;
    /**
     * The parameters of the environment action.
     */
    set parameters(value: CfnEnvironmentActions.AwsConsoleLinkParametersProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon DataZone domain ID of the environment action.
     *
     * @cloudformationAttribute DomainId
...
export declare class CfnEnvironmentBlueprintConfiguration extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentBlueprintConfigurationRef {
     ...
     */
    private _environmentRolePermissionBoundary?;
    /**
     ...
     */
    private _provisioningConfigurations?;
    /**
     ...
     * The enabled AWS Regions specified in a blueprint configuration.
     */
    get enabledRegions(): Array<string>;
    /**
     * The enabled AWS Regions specified in a blueprint configuration.
     */
    set enabledRegions(value: Array<string>);
    /**
     * The identifier of the environment blueprint.
     */
     ...
     * The environment role permission boundary.
     */
    get environmentRolePermissionBoundary(): string | undefined;
    /**
     * The environment role permission boundary.
     */
    set environmentRolePermissionBoundary(value: string | undefined);
    /**
     * Region-agnostic environment blueprint parameters.
     */
    get globalParameters(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Region-agnostic environment blueprint parameters.
     */
    set globalParameters(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The ARN of the manage access role.
     */
    get manageAccessRoleArn(): string | undefined;
    /**
     * The ARN of the manage access role.
     */
    set manageAccessRoleArn(value: string | undefined);
    /**
     * The provisioning configuration of a blueprint.
     */
    get provisioningConfigurations(): Array<cdk.IResolvable | CfnEnvironmentBlueprintConfiguration.ProvisioningConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * The provisioning configuration of a blueprint.
     */
    set provisioningConfigurations(value: Array<cdk.IResolvable | CfnEnvironmentBlueprintConfiguration.ProvisioningConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * The ARN of the provisioning role.
     */
    get provisioningRoleArn(): string | undefined;
    /**
     * The ARN of the provisioning role.
     */
    set provisioningRoleArn(value: string | undefined);
    /**
     * The regional parameters of the environment blueprint.
     */
    get regionalParameters(): Array<cdk.IResolvable | CfnEnvironmentBlueprintConfiguration.RegionalParameterProperty> | cdk.IResolvable | undefined;
    /**
     * The regional parameters of the environment blueprint.
     */
    set regionalParameters(value: Array<cdk.IResolvable | CfnEnvironmentBlueprintConfiguration.RegionalParameterProperty> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnEnvironmentProfile extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentProfileRef {
     ...
     * The user parameters of this Amazon DataZone environment profile.
     */
    get userParameters(): Array<CfnEnvironmentProfile.EnvironmentParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The user parameters of this Amazon DataZone environment profile.
     */
    set userParameters(value: Array<CfnEnvironmentProfile.EnvironmentParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnFormType extends cdk.CfnResource implements cdk.IInspectable, IFormTypeRef {
     ...
     * The model of the form type.
     */
    get model(): cdk.IResolvable | CfnFormType.ModelProperty;
    /**
     * The model of the form type.
     */
    set model(value: cdk.IResolvable | CfnFormType.ModelProperty);
    /**
     * The name of the form type.
     */
    get name(): string;
     ...
     */
    get attrFormTypeIdentifier(): string;
    /**
     * The identifier of the project that owns the form type.
     *
     * @cloudformationAttribute OwningProjectId
     */
    get attrOwningProjectId(): string;
    /**
     * The revision of the form type.
     *
     * @cloudformationAttribute Revision
     */
    get attrRevision(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnGroupProfile extends cdk.CfnResource implements cdk.IInspectable, IGroupProfileRef {
     ...
     * The ID of the group of a project member.
     */
    set groupIdentifier(value: string);
    /**
     * The status of a group profile.
     */
    get status(): string | undefined;
...
export declare class CfnOwner extends cdk.CfnResource implements cdk.IInspectable, IOwnerRef {
     ...
     * The owner that you want to add to the entity.
     */
    get owner(): cdk.IResolvable | CfnOwner.OwnerPropertiesProperty;
    /**
     * The owner that you want to add to the entity.
     */
    set owner(value: cdk.IResolvable | CfnOwner.OwnerPropertiesProperty);
    /**
     * The ID of the entity to which you want to add an owner.
     *
     * @cloudformationAttribute OwnerIdentifier
     */
    get attrOwnerIdentifier(): string;
    /**
     * The owner that you want to add to the entity.
     *
     * @cloudformationAttribute OwnerType
     */
    get attrOwnerType(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnPolicyGrant extends cdk.CfnResource implements cdk.IInspectable, IPolicyGrantRef {
     ...
     * The details of the policy grant member.
     */
    get detail(): cdk.IResolvable | CfnPolicyGrant.PolicyGrantDetailProperty | undefined;
    /**
     * The details of the policy grant member.
     */
    set detail(value: cdk.IResolvable | CfnPolicyGrant.PolicyGrantDetailProperty | undefined);
    /**
     * The ID of the domain where you want to add a policy grant.
     */
    get domainIdentifier(): string;
     ...
     * The principal of the policy grant member.
     */
    get principal(): cdk.IResolvable | CfnPolicyGrant.PolicyGrantPrincipalProperty | undefined;
    /**
     * The principal of the policy grant member.
     */
    set principal(value: cdk.IResolvable | CfnPolicyGrant.PolicyGrantPrincipalProperty | undefined);
    /**
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef {
     ...
     * The ID of the domain unit.
     */
    get domainUnitId(): string | undefined;
    /**
     * The ID of the domain unit.
     */
    set domainUnitId(value: string | undefined);
    /**
     * The glossary terms that can be used in this Amazon DataZone project.
     */
    get glossaryTerms(): Array<string> | undefined;
     ...
     * The ID of the project profile.
     */
    get projectProfileId(): string | undefined;
    /**
     * The ID of the project profile.
     */
    set projectProfileId(value: string | undefined);
    /**
     * The project profile version to which the project should be updated.
     */
    get projectProfileVersion(): string | undefined;
    /**
     * The project profile version to which the project should be updated.
     */
    set projectProfileVersion(value: string | undefined);
    /**
     * The resource tags of the project.
     */
    get resourceTags(): Array<cdk.IResolvable | CfnProject.ResourceTagProperty> | cdk.IResolvable | undefined;
    /**
     * The resource tags of the project.
     */
    set resourceTags(value: Array<cdk.IResolvable | CfnProject.ResourceTagProperty> | cdk.IResolvable | undefined);
    /**
     * The user parameters of the project.
     */
    get userParameters(): Array<CfnProject.EnvironmentConfigurationUserParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The user parameters of the project.
     */
    set userParameters(value: Array<CfnProject.EnvironmentConfigurationUserParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
...
export interface CfnProjectProps {
     ...
     */
    readonly resourceTags?: Array<cdk.IResolvable | CfnProject.ResourceTagProperty> | cdk.IResolvable;
    /**
     * The user parameters of the project.
     *
...
export declare class CfnProjectMembership extends cdk.CfnResource implements cdk.IInspectable, IProjectMembershipRef {
     ...
     * The details about a project member.
     */
    get member(): cdk.IResolvable | CfnProjectMembership.MemberProperty;
    /**
     * The details about a project member.
     */
    set member(value: cdk.IResolvable | CfnProjectMembership.MemberProperty);
    /**
     * The ID of the project for which this project membership was created.
     */
    get projectIdentifier(): string;
     ...
     */
    get attrMemberIdentifier(): string;
    /**
     * @cloudformationAttribute MemberIdentifierType
     */
    get attrMemberIdentifierType(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnProjectProfile extends cdk.CfnResource implements cdk.IInspectable, IProjectProfileRef {
    ...
    private _allowCustomProjectResourceTags?;
    /**
     ...
     */
    private _domainUnitIdentifier?;
    /**
     * Environment configurations of a project profile.
     */
    private _environmentConfigurations?;
    /**
     * The name of a project profile.
     */
    private _name;
    private _projectResourceTags?;
    private _projectResourceTagsDescription?;
    /**
     * The status of a project profile.
     */
    private _status?;
    private _useDefaultConfigurations?;
    /**
    ...
    get allowCustomProjectResourceTags(): boolean | cdk.IResolvable | undefined;
    set allowCustomProjectResourceTags(value: boolean | cdk.IResolvable | undefined);
    /**
     * The description of the project profile.
     */
    get description(): string | undefined;
     ...
     * A domain unit ID of the project profile.
     */
    get domainUnitIdentifier(): string | undefined;
    /**
     * A domain unit ID of the project profile.
     */
    set domainUnitIdentifier(value: string | undefined);
    /**
     * Environment configurations of a project profile.
     */
    get environmentConfigurations(): Array<CfnProjectProfile.EnvironmentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Environment configurations of a project profile.
     */
    set environmentConfigurations(value: Array<CfnProjectProfile.EnvironmentConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of a project profile.
     */
    get name(): string;
     ...
     */
    set name(value: string);
    get projectResourceTags(): Array<cdk.IResolvable | CfnProjectProfile.ResourceTagParameterProperty> | cdk.IResolvable | undefined;
    set projectResourceTags(value: Array<cdk.IResolvable | CfnProjectProfile.ResourceTagParameterProperty> | cdk.IResolvable | undefined);
    get projectResourceTagsDescription(): string | undefined;
    set projectResourceTagsDescription(value: string | undefined);
    /**
     * The status of a project profile.
     */
    get status(): string | undefined;
     ...
     */
    set status(value: string | undefined);
    get useDefaultConfigurations(): boolean | cdk.IResolvable | undefined;
    set useDefaultConfigurations(value: boolean | cdk.IResolvable | undefined);
    /**
...
export interface CfnProjectProfileProps {
     ...
     */
    readonly projectResourceTags?: Array<cdk.IResolvable | CfnProjectProfile.ResourceTagParameterProperty> | cdk.IResolvable;
    /**
...
export declare class CfnSubscriptionTarget extends cdk.CfnResource implements cdk.IInspectable, ISubscriptionTargetRef {
     ...
     */
    private _applicableAssetTypes;
    /**
     * The authorized principals included in the subscription target.
     */
    private _authorizedPrincipals;
    /**
     ...
     */
    private _subscriptionTargetConfig;
    /**
     ...
     * The asset types included in the subscription target.
     */
    get applicableAssetTypes(): Array<string>;
    /**
     * The asset types included in the subscription target.
     */
    set applicableAssetTypes(value: Array<string>);
    /**
     * The authorized principals included in the subscription target.
     */
    get authorizedPrincipals(): Array<string>;
    /**
     * The authorized principals included in the subscription target.
     */
    set authorizedPrincipals(value: Array<string>);
    /**
     * The ID of the Amazon DataZone domain in which subscription target is created.
     */
    get domainIdentifier(): string;
     ...
     * The ID of the environment in which subscription target is created.
     */
    get environmentIdentifier(): string;
    /**
     * The ID of the environment in which subscription target is created.
     */
    set environmentIdentifier(value: string);
    /**
     * The manage access role that is used to create the subscription target.
     */
    get manageAccessRole(): string | undefined;
    /**
     * The manage access role that is used to create the subscription target.
     */
    set manageAccessRole(value: string | undefined);
    /**
     * The name of the subscription target.
     */
    get name(): string;
     ...
     * The configuration of the subscription target.
     */
    get subscriptionTargetConfig(): Array<cdk.IResolvable | CfnSubscriptionTarget.SubscriptionTargetFormProperty> | cdk.IResolvable;
    /**
     * The configuration of the subscription target.
     */
    set subscriptionTargetConfig(value: Array<cdk.IResolvable | CfnSubscriptionTarget.SubscriptionTargetFormProperty> | cdk.IResolvable);
    /**
     * The type of the subscription target.
     */
    get type(): string;
...
export declare class CfnUserProfile extends cdk.CfnResource implements cdk.IInspectable, IUserProfileRef {
     ...
     */
    get attrDetails(): cdk.IResolvable;
    /**
     * The identifier of a Amazon DataZone domain in which a user profile exists.
     *
     * @cloudformationAttribute DomainId
