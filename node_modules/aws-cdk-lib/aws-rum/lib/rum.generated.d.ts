...
import { AppMonitorReference, IAppMonitorRef } from "../../interfaces/generated/aws-rum-interfaces.generated";
/**
...
export declare class CfnAppMonitor extends cdk.CfnResource implements cdk.IInspectable, IAppMonitorRef, cdk.ITaggable {
     ...
     */
    private _deobfuscationConfiguration?;
    /**
     ...
     * A structure that contains much of the configuration data for the app monitor.
     */
    get appMonitorConfiguration(): CfnAppMonitor.AppMonitorConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * A structure that contains much of the configuration data for the app monitor.
     */
    set appMonitorConfiguration(value: CfnAppMonitor.AppMonitorConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether this app monitor allows the web client to define and send custom events.
     */
    get customEvents(): CfnAppMonitor.CustomEventsProperty | cdk.IResolvable | undefined;
    /**
     * Specifies whether this app monitor allows the web client to define and send custom events.
     */
    set customEvents(value: CfnAppMonitor.CustomEventsProperty | cdk.IResolvable | undefined);
    /**
     * Data collected by CloudWatch RUM is kept by RUM for 30 days and then deleted.
     */
    get cwLogEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Data collected by CloudWatch RUM is kept by RUM for 30 days and then deleted.
     */
    set cwLogEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * A structure that contains the configuration for how an app monitor can deobfuscate stack traces.
     */
    get deobfuscationConfiguration(): CfnAppMonitor.DeobfuscationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * A structure that contains the configuration for how an app monitor can deobfuscate stack traces.
     */
    set deobfuscationConfiguration(value: CfnAppMonitor.DeobfuscationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The top-level internet domain name for which your application has administrative authority.
     */
     ...
     * List the domain names for which your application has administrative authority. This parameter or the `Domain` parameter is required.
     */
    get domainList(): Array<string> | undefined;
    /**
     * List the domain names for which your application has administrative authority. This parameter or the `Domain` parameter is required.
     */
    set domainList(value: Array<string> | undefined);
    /**
     * A name for the app monitor.
     */
    get name(): string;
     ...
     * Use this structure to assign a resource-based policy to a CloudWatch RUM app monitor to control access to it.
     */
    get resourcePolicy(): cdk.IResolvable | CfnAppMonitor.ResourcePolicyProperty | undefined;
    /**
     * Use this structure to assign a resource-based policy to a CloudWatch RUM app monitor to control access to it.
     */
    set resourcePolicy(value: cdk.IResolvable | CfnAppMonitor.ResourcePolicyProperty | undefined);
    /**
     * Assigns one or more tags (key-value pairs) to the app monitor.
     */
