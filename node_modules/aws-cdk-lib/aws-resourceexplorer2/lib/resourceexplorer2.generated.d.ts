...
import { DefaultViewAssociationReference, IDefaultViewAssociationRef, IIndexRef, IndexReference, IViewRef, ViewReference } from "../../interfaces/generated/aws-resourceexplorer2-interfaces.generated";
/**
...
export declare class CfnDefaultViewAssociation extends cdk.CfnResource implements cdk.IInspectable, IDefaultViewAssociationRef {
     ...
     */
    get attrAssociatedAwsPrincipal(): string;
...
export declare class CfnView extends cdk.CfnResource implements cdk.IInspectable, IViewRef, cdk.ITaggable {
     ...
     * An array of strings that include search keywords, prefixes, and operators that filter the results that are returned for queries made using this view.
     */
    get filters(): CfnView.FiltersProperty | cdk.IResolvable | undefined;
    /**
     * An array of strings that include search keywords, prefixes, and operators that filter the results that are returned for queries made using this view.
     */
    set filters(value: CfnView.FiltersProperty | cdk.IResolvable | undefined);
    /**
     * A list of fields that provide additional information about the view.
     */
    get includedProperties(): Array<CfnView.IncludedPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of fields that provide additional information about the view.
     */
    set includedProperties(value: Array<CfnView.IncludedPropertyProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The root ARN of the account, an organizational unit (OU), or an organization ARN.
     */
