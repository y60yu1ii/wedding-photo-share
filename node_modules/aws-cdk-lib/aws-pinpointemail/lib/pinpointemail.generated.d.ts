...
import { ConfigurationSetEventDestinationReference, ConfigurationSetReference, DedicatedIpPoolReference, IConfigurationSetEventDestinationRef, IConfigurationSetRef, IDedicatedIpPoolRef, IdentityReference, IIdentityRef } from "../../interfaces/generated/aws-pinpointemail-interfaces.generated";
/**
...
export declare class CfnConfigurationSetEventDestination extends cdk.CfnResource implements cdk.IInspectable, IConfigurationSetEventDestinationRef {
     ...
     * An object that defines the event destination.
     */
    get eventDestination(): CfnConfigurationSetEventDestination.EventDestinationProperty | cdk.IResolvable | undefined;
    /**
     * An object that defines the event destination.
     */
    set eventDestination(value: CfnConfigurationSetEventDestination.EventDestinationProperty | cdk.IResolvable | undefined);
    /**
     * The name of the event destination that you want to modify.
     */
...
export declare class CfnIdentity extends cdk.CfnResource implements cdk.IInspectable, IIdentityRef, cdk.ITaggableV2 {
     ...
     */
    private _dkimSigningEnabled?;
    /**
     * Used to enable or disable feedback forwarding for an identity.
     */
    private _feedbackForwardingEnabled?;
    /**
     ...
     * For domain identities, this attribute is used to enable or disable DomainKeys Identified Mail (DKIM) signing for the domain.
     */
    get dkimSigningEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * For domain identities, this attribute is used to enable or disable DomainKeys Identified Mail (DKIM) signing for the domain.
     */
    set dkimSigningEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Used to enable or disable feedback forwarding for an identity.
     */
    get feedbackForwardingEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Used to enable or disable feedback forwarding for an identity.
     */
    set feedbackForwardingEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Used to enable or disable the custom Mail-From domain configuration for an email identity.
     */
    get mailFromAttributes(): cdk.IResolvable | CfnIdentity.MailFromAttributesProperty | undefined;
    /**
     * Used to enable or disable the custom Mail-From domain configuration for an email identity.
     */
    set mailFromAttributes(value: cdk.IResolvable | CfnIdentity.MailFromAttributesProperty | undefined);
    /**
     * The address or domain of the identity, such as *sender@example.com* or *example.co.uk* .
     */
    get name(): string;
