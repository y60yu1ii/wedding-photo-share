...
export declare class CfnSimulation extends cdk.CfnResource implements cdk.IInspectable, ISimulationRef {
     ...
     * The maximum running time of the simulation, specified as a number of minutes (m or M), hours (h or H), or days (d or D).
     */
    get maximumDuration(): string | undefined;
    /**
     * The maximum running time of the simulation, specified as a number of minutes (m or M), hours (h or H), or days (d or D).
     */
    set maximumDuration(value: string | undefined);
    /**
     * The name of the simulation.
     */
    get name(): string;
     ...
     * The location of the simulation schema in Amazon Simple Storage Service ( Amazon S3 ).
     */
    get schemaS3Location(): cdk.IResolvable | CfnSimulation.S3LocationProperty | undefined;
    /**
     * The location of the simulation schema in Amazon Simple Storage Service ( Amazon S3 ).
     */
    set schemaS3Location(value: cdk.IResolvable | CfnSimulation.S3LocationProperty | undefined);
    /**
     * The location of the snapshot in Amazon Simple Storage Service ( Amazon S3 ).
     */
    get snapshotS3Location(): cdk.IResolvable | CfnSimulation.S3LocationProperty | undefined;
    /**
     * The location of the snapshot in Amazon Simple Storage Service ( Amazon S3 ).
     */
    set snapshotS3Location(value: cdk.IResolvable | CfnSimulation.S3LocationProperty | undefined);
    /**
     ...
     */
    get attrDescribePayload(): string;
