...
import { ApplicationReference, ConfigurationProfileReference, DeploymentReference, DeploymentStrategyReference, EnvironmentReference, ExtensionAssociationReference, ExtensionReference, HostedConfigurationVersionReference, IApplicationRef, IConfigurationProfileRef, IDeploymentRef, IDeploymentStrategyRef, IEnvironmentRef, IExtensionAssociationRef, IExtensionRef, IHostedConfigurationVersionRef } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
import { aws_appconfig as appConfigRefs, aws_iam as iamRefs } from "../../interfaces";
/**
...
export declare class CfnConfigurationProfile extends cdk.CfnResource implements cdk.IInspectable, IConfigurationProfileRef, cdk.ITaggableV2 {
     ...
     */
    private _deletionProtectionCheck?;
    /**
     ...
     * A parameter to configure deletion protection.
     */
    get deletionProtectionCheck(): string | undefined;
    /**
     * A parameter to configure deletion protection.
     */
    set deletionProtectionCheck(value: string | undefined);
    /**
     * A description of the configuration profile.
     */
    get description(): string | undefined;
     ...
     * The ARN of an IAM role with permission to access the configuration at the specified `LocationUri` .
     */
    get retrievalRoleArn(): string | undefined;
    /**
     * The ARN of an IAM role with permission to access the configuration at the specified `LocationUri` .
     */
    set retrievalRoleArn(value: string | undefined);
    /**
     * Metadata to assign to the configuration profile.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * A list of methods for validating the configuration.
     */
    get validators(): Array<cdk.IResolvable | CfnConfigurationProfile.ValidatorsProperty> | cdk.IResolvable | undefined;
    /**
     * A list of methods for validating the configuration.
     */
    set validators(value: Array<cdk.IResolvable | CfnConfigurationProfile.ValidatorsProperty> | cdk.IResolvable | undefined);
    /**
     * The configuration profile ID.
     *
     * @cloudformationAttribute ConfigurationProfileId
     */
    get attrConfigurationProfileId(): string;
    /**
...
export interface CfnConfigurationProfileProps {
     ...
     */
    readonly applicationId: appConfigRefs.IApplicationRef | string;
    /**
     * A parameter to configure deletion protection.
     *
     ...
     */
    readonly retrievalRoleArn?: iamRefs.IRoleRef | string;
    /**
     * Metadata to assign to the configuration profile.
     *
     * Tags help organize and categorize your AWS AppConfig resources. Each tag consists of a key and an optional value, both of which you define.
...
export declare class CfnDeployment extends cdk.CfnResource implements cdk.IInspectable, IDeploymentRef, cdk.ITaggableV2 {
     ...
     */
    private _dynamicExtensionParameters?;
    /**
     * The environment ID.
     */
     ...
     * A map of dynamic extension parameter names to values to pass to associated extensions with `PRE_START_DEPLOYMENT` actions.
     */
    get dynamicExtensionParameters(): Array<CfnDeployment.DynamicExtensionParametersProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A map of dynamic extension parameter names to values to pass to associated extensions with `PRE_START_DEPLOYMENT` actions.
     */
    set dynamicExtensionParameters(value: Array<CfnDeployment.DynamicExtensionParametersProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The environment ID.
     */
     ...
     */
    get attrDeploymentNumber(): string;
    /**
...
export declare class CfnDeploymentStrategy extends cdk.CfnResource implements cdk.IInspectable, IDeploymentStrategyRef, cdk.ITaggableV2 {
     ...
     * Specifies the amount of time AWS AppConfig monitors for Amazon CloudWatch alarms after the configuration has been deployed to 100% of its targets, before considering the deployment to be complete.
     */
    get finalBakeTimeInMinutes(): number | undefined;
    /**
     * Specifies the amount of time AWS AppConfig monitors for Amazon CloudWatch alarms after the configuration has been deployed to 100% of its targets, before considering the deployment to be complete.
     */
    set finalBakeTimeInMinutes(value: number | undefined);
    /**
     * The percentage of targets to receive a deployed configuration during each interval.
     */
     ...
     * The algorithm used to define how percentage grows over time. AWS AppConfig supports the following growth types:.
     */
    get growthType(): string | undefined;
    /**
     * The algorithm used to define how percentage grows over time. AWS AppConfig supports the following growth types:.
     */
    set growthType(value: string | undefined);
    /**
     * A name for the deployment strategy.
     */
    get name(): string;
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggableV2 {
     ...
     * Amazon CloudWatch alarms to monitor during the deployment process.
     */
    get monitors(): Array<cdk.IResolvable | CfnEnvironment.MonitorsProperty> | cdk.IResolvable | undefined;
    /**
     * Amazon CloudWatch alarms to monitor during the deployment process.
     */
    set monitors(value: Array<cdk.IResolvable | CfnEnvironment.MonitorsProperty> | cdk.IResolvable | undefined);
    /**
     * A name for the environment.
     */
    get name(): string;
...
export declare class CfnExtension extends cdk.CfnResource implements cdk.IInspectable, IExtensionRef, cdk.ITaggable {
     ...
     * The actions defined in the extension.
     */
    get actions(): any | cdk.IResolvable;
    /**
     * The actions defined in the extension.
     */
    set actions(value: any | cdk.IResolvable);
    /**
     * Information about the extension.
     */
    get description(): string | undefined;
     ...
     * You can omit this field when you create an extension.
     */
    get latestVersionNumber(): number | undefined;
    /**
     * You can omit this field when you create an extension.
     */
    set latestVersionNumber(value: number | undefined);
    /**
     * A name for the extension.
     */
    get name(): string;
     ...
     * The parameters accepted by the extension.
     */
    get parameters(): cdk.IResolvable | Record<string, cdk.IResolvable | CfnExtension.ParameterProperty> | undefined;
    /**
     * The parameters accepted by the extension.
     */
    set parameters(value: cdk.IResolvable | Record<string, cdk.IResolvable | CfnExtension.ParameterProperty> | undefined);
    /**
     * Adds one or more tags for the specified extension.
     */
...
export declare class CfnExtensionAssociation extends cdk.CfnResource implements cdk.IInspectable, IExtensionAssociationRef, cdk.ITaggable {
     ...
     */
    private _extensionIdentifier?;
    /**
     * The version number of the extension.
     */
    private _extensionVersionNumber?;
    /**
     ...
     * The name, the ID, or the Amazon Resource Name (ARN) of the extension.
     */
    get extensionIdentifier(): string | undefined;
    /**
     * The name, the ID, or the Amazon Resource Name (ARN) of the extension.
     */
    set extensionIdentifier(value: string | undefined);
    /**
     * The version number of the extension.
     */
    get extensionVersionNumber(): number | undefined;
    /**
     * The version number of the extension.
     */
    set extensionVersionNumber(value: number | undefined);
    /**
     * The parameter names and values defined in the extensions.
     */
...
export interface CfnHostedConfigurationVersionProps {
     ...
     */
    readonly configurationProfileId: appConfigRefs.IConfigurationProfileRef | string;
    /**
     * The configuration data, as bytes.
     *
