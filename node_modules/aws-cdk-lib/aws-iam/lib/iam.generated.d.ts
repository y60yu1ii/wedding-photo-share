...
import { AccessKeyReference, GroupPolicyReference, GroupReference, IAccessKeyRef, IGroupPolicyRef, IGroupRef, IInstanceProfileRef, IManagedPolicyRef, InstanceProfileReference, IOIDCProviderRef, IPolicyRef, IRolePolicyRef, IRoleRef, ISAMLProviderRef, IServerCertificateRef, IServiceLinkedRoleRef, IUserPolicyRef, IUserRef, IUserToGroupAdditionRef, IVirtualMFADeviceRef, ManagedPolicyReference, OIDCProviderReference, PolicyReference, RolePolicyReference, RoleReference, SAMLProviderReference, ServerCertificateReference, ServiceLinkedRoleReference, UserPolicyReference, UserReference, UserToGroupAdditionReference, VirtualMFADeviceReference } from "../../interfaces/generated/aws-iam-interfaces.generated";
...
export declare class CfnAccessKey extends cdk.CfnResource implements cdk.IInspectable, IAccessKeyRef {
     ...
     * This value is specific to CloudFormation and can only be *incremented* .
     */
    set serial(value: number | undefined);
    /**
     * The status of the access key.
     */
     ...
     */
    get attrSecretAccessKey(): string;
...
export declare class CfnGroup extends cdk.CfnResource implements cdk.IInspectable, IGroupRef {
     ...
     * Adds or updates an inline policy document that is embedded in the specified IAM group.
     */
    get policies(): Array<cdk.IResolvable | CfnGroup.PolicyProperty> | cdk.IResolvable | undefined;
    /**
     * Adds or updates an inline policy document that is embedded in the specified IAM group.
     */
    set policies(value: Array<cdk.IResolvable | CfnGroup.PolicyProperty> | cdk.IResolvable | undefined);
    /**
...
export interface CfnGroupProps {
     ...
     */
    readonly managedPolicyArns?: Array<iamRefs.IManagedPolicyRef | string>;
    /**
     * The path to the group. For more information about paths, see [IAM identifiers](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the *IAM User Guide* .
     *
...
export interface CfnInstanceProfileProps {
     ...
     */
    readonly roles: Array<iamRefs.IRoleRef | string>;
}
/**
...
export declare class CfnManagedPolicy extends cdk.CfnResource implements cdk.IInspectable, IManagedPolicyRef {
     ...
     * The name (friendly name, not ARN) of the group to attach the policy to.
     */
    set groups(value: Array<string> | undefined);
    /**
     * The friendly name of the policy.
     */
    get managedPolicyName(): string | undefined;
    /**
     * The friendly name of the policy.
     */
    set managedPolicyName(value: string | undefined);
    /**
     * The path for the policy.
     */
    get path(): string | undefined;
     ...
     * The name (friendly name, not ARN) of the role to attach the policy to.
     */
    get roles(): Array<string> | undefined;
    /**
     * The name (friendly name, not ARN) of the role to attach the policy to.
     */
    set roles(value: Array<string> | undefined);
    /**
     * The name (friendly name, not ARN) of the IAM user to attach the policy to.
     */
    get users(): Array<string> | undefined;
    /**
     * The name (friendly name, not ARN) of the IAM user to attach the policy to.
     */
    set users(value: Array<string> | undefined);
    /**
     * The number of principal entities (users, groups, and roles) that the policy is attached to.
     *
     * @cloudformationAttribute AttachmentCount
     */
    get attrAttachmentCount(): number;
    /**
     ...
     */
    get attrDefaultVersionId(): string;
    /**
     * Specifies whether the policy can be attached to an IAM user, group, or role.
     *
     * @cloudformationAttribute IsAttachable
     */
    get attrIsAttachable(): cdk.IResolvable;
    /**
     ...
     */
    get attrPermissionsBoundaryUsageCount(): number;
    /**
...
export interface CfnManagedPolicyProps {
     ...
     */
    readonly groups?: Array<iamRefs.IGroupRef | string>;
    /**
     * The friendly name of the policy.
     *
     * > If you specify a name, you cannot perform updates that require replacement of this resource. You can perform updates that require no or some interruption. If you must replace the resource, specify a new name.
     ...
     */
    readonly users?: Array<iamRefs.IUserRef | string>;
}
/**
...
export declare class CfnOIDCProvider extends cdk.CfnResource implements cdk.IInspectable, IOIDCProviderRef, cdk.ITaggable {
     ...
     * A list of client IDs (also known as audiences) that are associated with the specified IAM OIDC provider resource object.
     */
    get clientIdList(): Array<string> | undefined;
    /**
     * A list of client IDs (also known as audiences) that are associated with the specified IAM OIDC provider resource object.
     */
    set clientIdList(value: Array<string> | undefined);
    /**
     * A list of tags that are attached to the specified IAM OIDC provider.
     */
     ...
     * A list of certificate thumbprints that are associated with the specified IAM OIDC provider resource object.
     */
    get thumbprintList(): Array<string> | undefined;
    /**
     * A list of certificate thumbprints that are associated with the specified IAM OIDC provider resource object.
     */
    set thumbprintList(value: Array<string> | undefined);
    /**
     * The URL that the IAM OIDC provider resource object is associated with.
     */
...
export declare class CfnRole extends cdk.CfnResource implements cdk.IInspectable, IRoleRef, cdk.ITaggable {
     ...
     * The trust policy that is associated with this role.
     */
    get assumeRolePolicyDocument(): any | cdk.IResolvable;
    /**
     * The trust policy that is associated with this role.
     */
    set assumeRolePolicyDocument(value: any | cdk.IResolvable);
    /**
     * A description of the role that you provide.
     */
    get description(): string | undefined;
     ...
     * Adds or updates an inline policy document that is embedded in the specified IAM role.
     */
    get policies(): Array<cdk.IResolvable | CfnRole.PolicyProperty> | cdk.IResolvable | undefined;
    /**
     * Adds or updates an inline policy document that is embedded in the specified IAM role.
     */
    set policies(value: Array<cdk.IResolvable | CfnRole.PolicyProperty> | cdk.IResolvable | undefined);
    /**
     * A name for the IAM role, up to 64 characters in length.
     */
...
export interface CfnRoleProps {
     ...
     */
    readonly permissionsBoundary?: iamRefs.IManagedPolicyRef | string;
    /**
     * Adds or updates an inline policy document that is embedded in the specified IAM role.
     *
...
export declare class CfnSAMLProvider extends cdk.CfnResource implements cdk.IInspectable, ISAMLProviderRef, cdk.ITaggable {
     ...
     */
    private _addPrivateKey?;
    /**
     * Specifies the encryption setting for the SAML provider.
     */
    private _assertionEncryptionMode?;
    /**
     ...
     */
    private _privateKeyList?;
    /**
     * The Key ID of the private key to remove.
     */
    private _removePrivateKey?;
    /**
     ...
     * Specifies the new private key from your external identity provider.
     */
    get addPrivateKey(): string | undefined;
    /**
     * Specifies the new private key from your external identity provider.
     */
    set addPrivateKey(value: string | undefined);
    /**
     * Specifies the encryption setting for the SAML provider.
     */
    get assertionEncryptionMode(): string | undefined;
    /**
     * Specifies the encryption setting for the SAML provider.
     */
    set assertionEncryptionMode(value: string | undefined);
    /**
     * The name of the provider to create.
     */
     ...
     * The private key metadata for the SAML provider.
     */
    get privateKeyList(): Array<cdk.IResolvable | CfnSAMLProvider.SAMLPrivateKeyProperty> | cdk.IResolvable | undefined;
    /**
     * The private key metadata for the SAML provider.
     */
    set privateKeyList(value: Array<cdk.IResolvable | CfnSAMLProvider.SAMLPrivateKeyProperty> | cdk.IResolvable | undefined);
    /**
     * The Key ID of the private key to remove.
     */
    get removePrivateKey(): string | undefined;
    /**
     * The Key ID of the private key to remove.
     */
    set removePrivateKey(value: string | undefined);
    /**
     * An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document includes the issuer's name, expiration information, and keys that can be used to validate the SAML authentication response (assertions) that are received from the IdP. You must generate the metadata document using the identity management software that is used as your organization's IdP.
     */
    get samlMetadataDocument(): string | undefined;
    /**
     * An XML document generated by an identity provider (IdP) that supports SAML 2.0. The document includes the issuer's name, expiration information, and keys that can be used to validate the SAML authentication response (assertions) that are received from the IdP. You must generate the metadata document using the identity management software that is used as your organization's IdP.
     */
    set samlMetadataDocument(value: string | undefined);
    /**
     * A list of tags that you want to attach to the new IAM SAML provider.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrSamlProviderUuid(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnServerCertificate extends cdk.CfnResource implements cdk.IInspectable, IServerCertificateRef, cdk.ITaggable {
     ...
     * The name for the server certificate.
     */
    get serverCertificateName(): string | undefined;
    /**
     * The name for the server certificate.
     */
    set serverCertificateName(value: string | undefined);
    /**
     * A list of tags that are attached to the server certificate.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnServiceLinkedRole extends cdk.CfnResource implements cdk.IInspectable, IServiceLinkedRoleRef {
     ...
     * The service principal for the AWS service to which this role is attached.
     */
    get awsServiceName(): string | undefined;
    /**
     * The service principal for the AWS service to which this role is attached.
     */
    set awsServiceName(value: string | undefined);
    /**
     * A string that you provide, which is combined with the service-provided prefix to form the complete role name.
     */
...
export declare class CfnUser extends cdk.CfnResource implements cdk.IInspectable, IUserRef, cdk.ITaggable {
     ...
     * Creates a password for the specified IAM user.
     */
    get loginProfile(): cdk.IResolvable | CfnUser.LoginProfileProperty | undefined;
    /**
     * Creates a password for the specified IAM user.
     */
    set loginProfile(value: cdk.IResolvable | CfnUser.LoginProfileProperty | undefined);
    /**
     * A list of Amazon Resource Names (ARNs) of the IAM managed policies that you want to attach to the user.
     */
    get managedPolicyArns(): Array<string> | undefined;
     ...
     * Adds or updates an inline policy document that is embedded in the specified IAM user.
     */
    get policies(): Array<cdk.IResolvable | CfnUser.PolicyProperty> | cdk.IResolvable | undefined;
    /**
     * Adds or updates an inline policy document that is embedded in the specified IAM user.
     */
    set policies(value: Array<cdk.IResolvable | CfnUser.PolicyProperty> | cdk.IResolvable | undefined);
    /**
     * A list of tags that you want to attach to the new user.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnVirtualMFADevice extends cdk.CfnResource implements cdk.IInspectable, IVirtualMFADeviceRef, cdk.ITaggable {
     ...
     * The name of the virtual MFA device, which must be unique.
     */
    get virtualMfaDeviceName(): string | undefined;
    /**
     * The name of the virtual MFA device, which must be unique.
     */
    set virtualMfaDeviceName(value: string | undefined);
    /**
     * Returns the serial number for the specified `AWS::IAM::VirtualMFADevice` resource.
     *
     * @cloudformationAttribute SerialNumber
     */
    get attrSerialNumber(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
