...
import { GatewayRouteReference, IGatewayRouteRef, IMeshRef, IRouteRef, IVirtualGatewayRef, IVirtualNodeRef, IVirtualRouterRef, IVirtualServiceRef, MeshReference, RouteReference, VirtualGatewayReference, VirtualNodeReference, VirtualRouterReference, VirtualServiceReference } from "../../interfaces/generated/aws-appmesh-interfaces.generated";
/**
...
export declare class CfnGatewayRoute extends cdk.CfnResource implements cdk.IInspectable, IGatewayRouteRef, cdk.ITaggable {
     ...
     * The name of the gateway route.
     */
    get gatewayRouteName(): string | undefined;
    /**
     * The name of the gateway route.
     */
    set gatewayRouteName(value: string | undefined);
    /**
     * The name of the service mesh that the resource resides in.
     */
    get meshName(): string;
     ...
     * The AWS IAM account ID of the service mesh owner.
     */
    get meshOwner(): string | undefined;
    /**
     * The AWS IAM account ID of the service mesh owner.
     */
    set meshOwner(value: string | undefined);
    /**
     * The specifications of the gateway route.
     */
    get spec(): CfnGatewayRoute.GatewayRouteSpecProperty | cdk.IResolvable;
    /**
     * The specifications of the gateway route.
     */
    set spec(value: CfnGatewayRoute.GatewayRouteSpecProperty | cdk.IResolvable);
    /**
     * Optional metadata that you can apply to the gateway route to assist with categorization and organization.
     */
     ...
     */
    get attrGatewayRouteName(): string;
    /**
     ...
     */
    get attrVirtualGatewayName(): string;
...
export declare class CfnMesh extends cdk.CfnResource implements cdk.IInspectable, IMeshRef, cdk.ITaggable {
     ...
     * The name to use for the service mesh.
     */
    set meshName(value: string | undefined);
    /**
     * The service mesh specification to apply.
     */
    get spec(): cdk.IResolvable | CfnMesh.MeshSpecProperty | undefined;
    /**
     * The service mesh specification to apply.
     */
    set spec(value: cdk.IResolvable | CfnMesh.MeshSpecProperty | undefined);
    /**
     * Optional metadata that you can apply to the service mesh to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRoute extends cdk.CfnResource implements cdk.IInspectable, IRouteRef, cdk.ITaggable {
     ...
     * The route specification to apply.
     */
    get spec(): cdk.IResolvable | CfnRoute.RouteSpecProperty;
    /**
     * The route specification to apply.
     */
    set spec(value: cdk.IResolvable | CfnRoute.RouteSpecProperty);
    /**
     * Optional metadata that you can apply to the route to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrVirtualRouterName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnVirtualGateway extends cdk.CfnResource implements cdk.IInspectable, IVirtualGatewayRef, cdk.ITaggable {
     ...
     * The specifications of the virtual gateway.
     */
    get spec(): cdk.IResolvable | CfnVirtualGateway.VirtualGatewaySpecProperty;
    /**
     * The specifications of the virtual gateway.
     */
    set spec(value: cdk.IResolvable | CfnVirtualGateway.VirtualGatewaySpecProperty);
    /**
     * Optional metadata that you can apply to the virtual gateway to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The name of the virtual gateway.
     */
    get virtualGatewayName(): string | undefined;
    /**
     * The name of the virtual gateway.
     */
    set virtualGatewayName(value: string | undefined);
    /**
...
export declare class CfnVirtualNode extends cdk.CfnResource implements cdk.IInspectable, IVirtualNodeRef, cdk.ITaggable {
     ...
     * The virtual node specification to apply.
     */
    get spec(): cdk.IResolvable | CfnVirtualNode.VirtualNodeSpecProperty;
    /**
     * The virtual node specification to apply.
     */
    set spec(value: cdk.IResolvable | CfnVirtualNode.VirtualNodeSpecProperty);
    /**
     * Optional metadata that you can apply to the virtual node to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The name to use for the virtual node.
     */
    get virtualNodeName(): string | undefined;
    /**
     * The name to use for the virtual node.
     */
    set virtualNodeName(value: string | undefined);
    /**
     ...
     */
    get attrVirtualNodeName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnVirtualRouter extends cdk.CfnResource implements cdk.IInspectable, IVirtualRouterRef, cdk.ITaggable {
     ...
     * The virtual router specification to apply.
     */
    get spec(): cdk.IResolvable | CfnVirtualRouter.VirtualRouterSpecProperty;
    /**
     * The virtual router specification to apply.
     */
    set spec(value: cdk.IResolvable | CfnVirtualRouter.VirtualRouterSpecProperty);
    /**
     * Optional metadata that you can apply to the virtual router to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * The name to use for the virtual router.
     */
    get virtualRouterName(): string | undefined;
    /**
     * The name to use for the virtual router.
     */
    set virtualRouterName(value: string | undefined);
    /**
...
export declare class CfnVirtualService extends cdk.CfnResource implements cdk.IInspectable, IVirtualServiceRef, cdk.ITaggable {
     ...
     * The virtual service specification to apply.
     */
    get spec(): cdk.IResolvable | CfnVirtualService.VirtualServiceSpecProperty;
    /**
     * The virtual service specification to apply.
     */
    set spec(value: cdk.IResolvable | CfnVirtualService.VirtualServiceSpecProperty);
    /**
     * Optional metadata that you can apply to the virtual service to assist with categorization and organization.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrVirtualServiceName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
