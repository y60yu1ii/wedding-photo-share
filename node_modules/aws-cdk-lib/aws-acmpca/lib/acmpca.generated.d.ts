...
import { aws_acmpca as acmpcaRefs } from "../../interfaces";
import { CertificateAuthorityActivationReference, CertificateAuthorityReference, CertificateReference, ICertificateAuthorityActivationRef, ICertificateAuthorityRef, ICertificateRef, IPermissionRef, PermissionReference } from "../../interfaces/generated/aws-acmpca-interfaces.generated";
/**
...
export declare class CfnCertificate extends cdk.CfnResource implements cdk.IInspectable, ICertificateRef {
     ...
     * Specifies X.509 certificate information to be included in the issued certificate. An `APIPassthrough` or `APICSRPassthrough` template variant must be selected, or else this parameter is ignored.
     */
    get apiPassthrough(): CfnCertificate.ApiPassthroughProperty | cdk.IResolvable | undefined;
    /**
     * Specifies X.509 certificate information to be included in the issued certificate. An `APIPassthrough` or `APICSRPassthrough` template variant must be selected, or else this parameter is ignored.
     */
    set apiPassthrough(value: CfnCertificate.ApiPassthroughProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) for the private CA issues the certificate.
     */
     ...
     * Specifies a custom configuration template to use when issuing a certificate.
     */
    get templateArn(): string | undefined;
    /**
     * Specifies a custom configuration template to use when issuing a certificate.
     */
    set templateArn(value: string | undefined);
    /**
     * The period of time during which the certificate will be valid.
     */
    get validity(): cdk.IResolvable | CfnCertificate.ValidityProperty;
    /**
     * The period of time during which the certificate will be valid.
     */
    set validity(value: cdk.IResolvable | CfnCertificate.ValidityProperty);
    /**
     * Information describing the start of the validity period of the certificate.
     */
    get validityNotBefore(): cdk.IResolvable | CfnCertificate.ValidityProperty | undefined;
    /**
     * Information describing the start of the validity period of the certificate.
     */
    set validityNotBefore(value: cdk.IResolvable | CfnCertificate.ValidityProperty | undefined);
    /**
...
export interface CfnCertificateProps {
     ...
     */
    readonly certificateAuthorityArn: acmpcaRefs.ICertificateAuthorityRef | string;
    /**
     * The certificate signing request (CSR) for the certificate.
     *
     ...
     */
    readonly templateArn?: acmpcaRefs.ICertificateAuthorityRef | string;
    /**
     * The period of time during which the certificate will be valid.
     *
...
export declare class CfnCertificateAuthority extends cdk.CfnResource implements cdk.IInspectable, ICertificateAuthorityRef, cdk.ITaggable {
     ...
     * Specifies information to be added to the extension section of the certificate signing request (CSR).
     */
    get csrExtensions(): CfnCertificateAuthority.CsrExtensionsProperty | cdk.IResolvable | undefined;
    /**
     * Specifies information to be added to the extension section of the certificate signing request (CSR).
     */
    set csrExtensions(value: CfnCertificateAuthority.CsrExtensionsProperty | cdk.IResolvable | undefined);
    /**
     * Type of the public key algorithm and size, in bits, of the key pair that your CA creates when it issues a certificate.
     */
     ...
     * Specifies a cryptographic key management compliance standard for handling and protecting CA keys.
     */
    get keyStorageSecurityStandard(): string | undefined;
    /**
     * Specifies a cryptographic key management compliance standard for handling and protecting CA keys.
     */
    set keyStorageSecurityStandard(value: string | undefined);
    /**
     * Information about the Online Certificate Status Protocol (OCSP) configuration or certificate revocation list (CRL) created and maintained by your private CA.
     */
    get revocationConfiguration(): cdk.IResolvable | CfnCertificateAuthority.RevocationConfigurationProperty | undefined;
    /**
     * Information about the Online Certificate Status Protocol (OCSP) configuration or certificate revocation list (CRL) created and maintained by your private CA.
     */
    set revocationConfiguration(value: cdk.IResolvable | CfnCertificateAuthority.RevocationConfigurationProperty | undefined);
    /**
     * Name of the algorithm your private CA uses to sign certificate requests.
     */
    get signingAlgorithm(): string;
     ...
     * Structure that contains X.500 distinguished name information for your private CA.
     */
    get subject(): cdk.IResolvable | CfnCertificateAuthority.SubjectProperty;
    /**
     * Structure that contains X.500 distinguished name information for your private CA.
     */
    set subject(value: cdk.IResolvable | CfnCertificateAuthority.SubjectProperty);
    /**
     * Key-value pairs that will be attached to the new private CA.
     */
     ...
     * Specifies whether the CA issues general-purpose certificates that typically require a revocation mechanism, or short-lived certificates that may optionally omit revocation because they expire quickly.
     */
    get usageMode(): string | undefined;
    /**
     * Specifies whether the CA issues general-purpose certificates that typically require a revocation mechanism, or short-lived certificates that may optionally omit revocation because they expire quickly.
     */
    set usageMode(value: string | undefined);
    /**
     ...
     */
    get attrCertificateSigningRequest(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnCertificateAuthorityActivation extends cdk.CfnResource implements cdk.IInspectable, ICertificateAuthorityActivationRef {
     ...
     */
    get attrCompleteCertificateChain(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
