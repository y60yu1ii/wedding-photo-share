...
import { ILinkRef, ISinkRef, LinkReference, SinkReference } from "../../interfaces/generated/aws-oam-interfaces.generated";
/**
...
export declare class CfnLink extends cdk.CfnResource implements cdk.IInspectable, ILinkRef, cdk.ITaggable {
     ...
     * Specify a friendly human-readable name to use to identify this source account when you are viewing data from it in the monitoring account.
     */
    get labelTemplate(): string | undefined;
    /**
     * Specify a friendly human-readable name to use to identify this source account when you are viewing data from it in the monitoring account.
     */
    set labelTemplate(value: string | undefined);
    /**
     * Use this structure to optionally create filters that specify that only some metric namespaces or log groups are to be shared from the source account to the monitoring account.
     */
    get linkConfiguration(): cdk.IResolvable | CfnLink.LinkConfigurationProperty | undefined;
    /**
     * Use this structure to optionally create filters that specify that only some metric namespaces or log groups are to be shared from the source account to the monitoring account.
     */
    set linkConfiguration(value: cdk.IResolvable | CfnLink.LinkConfigurationProperty | undefined);
    /**
     * An array of strings that define which types of data that the source account shares with the monitoring account.
     */
    get resourceTypes(): Array<string>;
    /**
     * An array of strings that define which types of data that the source account shares with the monitoring account.
     */
    set resourceTypes(value: Array<string>);
    /**
     * The ARN of the sink in the monitoring account that you want to link to.
     */
