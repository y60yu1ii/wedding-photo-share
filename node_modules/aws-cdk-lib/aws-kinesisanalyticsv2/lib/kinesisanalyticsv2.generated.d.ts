...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggable {
     ...
     * Use this parameter to configure the application.
     */
    get applicationConfiguration(): CfnApplication.ApplicationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Use this parameter to configure the application.
     */
    set applicationConfiguration(value: CfnApplication.ApplicationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The description of the application.
     */
     ...
     * Specifies the maintenance window parameters for a Kinesis Data Analytics application.
     */
    get applicationMaintenanceConfiguration(): CfnApplication.ApplicationMaintenanceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the maintenance window parameters for a Kinesis Data Analytics application.
     */
    set applicationMaintenanceConfiguration(value: CfnApplication.ApplicationMaintenanceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * To create a Kinesis Data Analytics Studio notebook, you must set the mode to `INTERACTIVE` .
     */
     ...
     * Describes the starting parameters for an Managed Service for Apache Flink application.
     */
    get runConfiguration(): cdk.IResolvable | CfnApplication.RunConfigurationProperty | undefined;
    /**
     * Describes the starting parameters for an Managed Service for Apache Flink application.
     */
    set runConfiguration(value: cdk.IResolvable | CfnApplication.RunConfigurationProperty | undefined);
    /**
     * The runtime environment for the application.
     */
...
export declare class CfnApplicationCloudWatchLoggingOption extends cdk.CfnResource implements cdk.IInspectable, IApplicationCloudWatchLoggingOptionRef {
     ...
     * Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).
     */
    get cloudWatchLoggingOption(): CfnApplicationCloudWatchLoggingOption.CloudWatchLoggingOptionProperty | cdk.IResolvable;
    /**
     * Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).
     */
    set cloudWatchLoggingOption(value: CfnApplicationCloudWatchLoggingOption.CloudWatchLoggingOptionProperty | cdk.IResolvable);
    /**
...
export declare class CfnApplicationOutput extends cdk.CfnResource implements cdk.IInspectable, IApplicationOutputRef {
     ...
     * Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written.
     */
    get output(): cdk.IResolvable | CfnApplicationOutput.OutputProperty;
    /**
     * Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written.
     */
    set output(value: cdk.IResolvable | CfnApplicationOutput.OutputProperty);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnApplicationReferenceDataSource extends cdk.CfnResource implements cdk.IInspectable, IApplicationReferenceDataSourceRef {
     ...
     * For a SQL-based Kinesis Data Analytics application, describes the reference data source by providing the source information (Amazon S3 bucket name and object key name), the resulting in-application table name that is created, and the necessary schema to map the data elements in the Amazon S3 object to the in-application table.
     */
    get referenceDataSource(): cdk.IResolvable | CfnApplicationReferenceDataSource.ReferenceDataSourceProperty;
    /**
     * For a SQL-based Kinesis Data Analytics application, describes the reference data source by providing the source information (Amazon S3 bucket name and object key name), the resulting in-application table name that is created, and the necessary schema to map the data elements in the Amazon S3 object to the in-application table.
     */
    set referenceDataSource(value: cdk.IResolvable | CfnApplicationReferenceDataSource.ReferenceDataSourceProperty);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
