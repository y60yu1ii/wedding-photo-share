...
import { ConfigurationManagerReference, IConfigurationManagerRef, ILifecycleAutomationRef, LifecycleAutomationReference } from "../../interfaces/generated/aws-ssmquicksetup-interfaces.generated";
/**
...
export declare class CfnConfigurationManager extends cdk.CfnResource implements cdk.IInspectable, IConfigurationManagerRef, cdk.ITaggableV2 {
     ...
     */
    private _configurationDefinitions;
    /**
     ...
     * The definition of the Quick Setup configuration that the configuration manager deploys.
     */
    get configurationDefinitions(): Array<CfnConfigurationManager.ConfigurationDefinitionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The definition of the Quick Setup configuration that the configuration manager deploys.
     */
    set configurationDefinitions(value: Array<CfnConfigurationManager.ConfigurationDefinitionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The description of the configuration.
     */
     ...
     */
    get attrStatusSummaries(): cdk.IResolvable;
...
export declare class CfnLifecycleAutomation extends cdk.CfnResource implements cdk.IInspectable, ILifecycleAutomationRef, cdk.ITaggableV2 {
     ...
     * The name of the SSM Automation document to execute in response to CloudFormation lifecycle events (CREATE, UPDATE, DELETE).
     */
    get automationDocument(): string;
    /**
     * The name of the SSM Automation document to execute in response to CloudFormation lifecycle events (CREATE, UPDATE, DELETE).
     */
    set automationDocument(value: string);
    /**
     * A map of key-value parameters passed to the Automation document during execution.
     */
    get automationParameters(): cdk.IResolvable | Record<string, Array<string>>;
    /**
     * A map of key-value parameters passed to the Automation document during execution.
     */
    set automationParameters(value: cdk.IResolvable | Record<string, Array<string>>);
    /**
     * A unique identifier used for generating the SSM Association name.
     */
