...
import { DatasetReference, IDatasetRef, IJobRef, IProjectRef, IRecipeRef, IRulesetRef, IScheduleRef, JobReference, ProjectReference, RecipeReference, RulesetReference, ScheduleReference } from "../../interfaces/generated/aws-databrew-interfaces.generated";
/**
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggable {
     ...
     * A set of options that define how DataBrew interprets the data in the dataset.
     */
    get formatOptions(): CfnDataset.FormatOptionsProperty | cdk.IResolvable | undefined;
    /**
     * A set of options that define how DataBrew interprets the data in the dataset.
     */
    set formatOptions(value: CfnDataset.FormatOptionsProperty | cdk.IResolvable | undefined);
    /**
     * Information on how DataBrew can find the dataset, in either the AWS Glue Data Catalog or Amazon S3 .
     */
    get input(): CfnDataset.InputProperty | cdk.IResolvable;
    /**
     * Information on how DataBrew can find the dataset, in either the AWS Glue Data Catalog or Amazon S3 .
     */
    set input(value: CfnDataset.InputProperty | cdk.IResolvable);
    /**
     * The unique name of the dataset.
     */
    get name(): string;
     ...
     * A set of options that defines how DataBrew interprets an Amazon S3 path of the dataset.
     */
    get pathOptions(): cdk.IResolvable | CfnDataset.PathOptionsProperty | undefined;
    /**
     * A set of options that defines how DataBrew interprets an Amazon S3 path of the dataset.
     */
    set pathOptions(value: cdk.IResolvable | CfnDataset.PathOptionsProperty | undefined);
    /**
     * The location of the data for the dataset, either Amazon S3 or the AWS Glue Data Catalog .
     */
...
export declare class CfnJob extends cdk.CfnResource implements cdk.IInspectable, IJobRef, cdk.ITaggable {
     ...
     */
    private _validationConfigurations?;
    /**
     ...
     * Represents a list of JDBC database output objects which defines the output destination for a DataBrew recipe job to write into.
     */
    get databaseOutputs(): Array<CfnJob.DatabaseOutputProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Represents a list of JDBC database output objects which defines the output destination for a DataBrew recipe job to write into.
     */
    set databaseOutputs(value: Array<CfnJob.DatabaseOutputProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * One or more artifacts that represent the AWS Glue Data Catalog output from running the job.
     */
    get dataCatalogOutputs(): Array<CfnJob.DataCatalogOutputProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * One or more artifacts that represent the AWS Glue Data Catalog output from running the job.
     */
    set dataCatalogOutputs(value: Array<CfnJob.DataCatalogOutputProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A dataset that the job is to process.
     */
     ...
     * The encryption mode for the job, which can be one of the following:.
     */
    get encryptionMode(): string | undefined;
    /**
     * The encryption mode for the job, which can be one of the following:.
     */
    set encryptionMode(value: string | undefined);
    /**
     * A sample configuration for profile jobs only, which determines the number of rows on which the profile job is run.
     */
    get jobSample(): cdk.IResolvable | CfnJob.JobSampleProperty | undefined;
    /**
     * A sample configuration for profile jobs only, which determines the number of rows on which the profile job is run.
     */
    set jobSample(value: cdk.IResolvable | CfnJob.JobSampleProperty | undefined);
    /**
     * The current status of Amazon CloudWatch logging for the job.
     */
    get logSubscription(): string | undefined;
    /**
     * The current status of Amazon CloudWatch logging for the job.
     */
    set logSubscription(value: string | undefined);
    /**
     * The maximum number of nodes that can be consumed when the job processes data.
     */
     ...
     * The location in Amazon S3 where the job writes its output.
     */
    get outputLocation(): cdk.IResolvable | CfnJob.OutputLocationProperty | undefined;
    /**
     * The location in Amazon S3 where the job writes its output.
     */
    set outputLocation(value: cdk.IResolvable | CfnJob.OutputLocationProperty | undefined);
    /**
     * One or more artifacts that represent output from running the job.
     */
    get outputs(): Array<cdk.IResolvable | CfnJob.OutputProperty> | cdk.IResolvable | undefined;
    /**
     * One or more artifacts that represent output from running the job.
     */
    set outputs(value: Array<cdk.IResolvable | CfnJob.OutputProperty> | cdk.IResolvable | undefined);
    /**
     * Configuration for profile jobs.
     */
    get profileConfiguration(): cdk.IResolvable | CfnJob.ProfileConfigurationProperty | undefined;
    /**
     * Configuration for profile jobs.
     */
    set profileConfiguration(value: cdk.IResolvable | CfnJob.ProfileConfigurationProperty | undefined);
    /**
     * The name of the project that the job is associated with.
     */
     ...
     * A series of data transformation steps that the job runs.
     */
    get recipe(): cdk.IResolvable | CfnJob.RecipeProperty | undefined;
    /**
     * A series of data transformation steps that the job runs.
     */
    set recipe(value: cdk.IResolvable | CfnJob.RecipeProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the role to be assumed for this job.
     */
    get roleArn(): string;
     ...
     * List of validation configurations that are applied to the profile job.
     */
    get validationConfigurations(): Array<cdk.IResolvable | CfnJob.ValidationConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * List of validation configurations that are applied to the profile job.
     */
    set validationConfigurations(value: Array<cdk.IResolvable | CfnJob.ValidationConfigurationProperty> | cdk.IResolvable | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef, cdk.ITaggable {
     ...
     * The sample size and sampling type to apply to the data.
     */
    get sample(): cdk.IResolvable | CfnProject.SampleProperty | undefined;
    /**
     * The sample size and sampling type to apply to the data.
     */
    set sample(value: cdk.IResolvable | CfnProject.SampleProperty | undefined);
    /**
     * Metadata tags that have been applied to the project.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRecipe extends cdk.CfnResource implements cdk.IInspectable, IRecipeRef, cdk.ITaggable {
     ...
     * A list of steps that are defined by the recipe.
     */
    get steps(): Array<cdk.IResolvable | CfnRecipe.RecipeStepProperty> | cdk.IResolvable;
    /**
     * A list of steps that are defined by the recipe.
     */
    set steps(value: Array<cdk.IResolvable | CfnRecipe.RecipeStepProperty> | cdk.IResolvable);
    /**
     * Metadata tags that have been applied to the recipe.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRuleset extends cdk.CfnResource implements cdk.IInspectable, IRulesetRef, cdk.ITaggable {
     ...
     * Contains metadata about the ruleset.
     */
    get rules(): Array<cdk.IResolvable | CfnRuleset.RuleProperty> | cdk.IResolvable;
    /**
     * Contains metadata about the ruleset.
     */
    set rules(value: Array<cdk.IResolvable | CfnRuleset.RuleProperty> | cdk.IResolvable);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnSchedule extends cdk.CfnResource implements cdk.IInspectable, IScheduleRef, cdk.ITaggable {
     ...
     * A list of jobs to be run, according to the schedule.
     */
    get jobNames(): Array<string> | undefined;
    /**
     * A list of jobs to be run, according to the schedule.
     */
    set jobNames(value: Array<string> | undefined);
    /**
     * The name of the schedule.
     */
    get name(): string;
