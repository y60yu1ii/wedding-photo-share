...
import { CapabilityReference, ICapabilityRef, IPartnershipRef, IProfileRef, ITransformerRef, PartnershipReference, ProfileReference, TransformerReference } from "../../interfaces/generated/aws-b2bi-interfaces.generated";
/**
...
export declare class CfnCapability extends cdk.CfnResource implements cdk.IInspectable, ICapabilityRef, cdk.ITaggableV2 {
     ...
     */
    private _instructionsDocuments?;
    /**
     ...
     * Specifies a structure that contains the details for a capability.
     */
    get configuration(): CfnCapability.CapabilityConfigurationProperty | cdk.IResolvable;
    /**
     * Specifies a structure that contains the details for a capability.
     */
    set configuration(value: CfnCapability.CapabilityConfigurationProperty | cdk.IResolvable);
    /**
     * Specifies one or more locations in Amazon S3, each specifying an EDI document that can be used with this capability.
     */
    get instructionsDocuments(): Array<cdk.IResolvable | CfnCapability.S3LocationProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies one or more locations in Amazon S3, each specifying an EDI document that can be used with this capability.
     */
    set instructionsDocuments(value: Array<cdk.IResolvable | CfnCapability.S3LocationProperty> | cdk.IResolvable | undefined);
    /**
     * The display name of the capability.
     */
    get name(): string;
     ...
     */
    get attrCapabilityArn(): string;
    /**
     * Returns a system-assigned unique identifier for the capability.
     *
     * @cloudformationAttribute CapabilityId
     */
    get attrCapabilityId(): string;
    /**
...
export declare class CfnPartnership extends cdk.CfnResource implements cdk.IInspectable, IPartnershipRef, cdk.ITaggableV2 {
     ...
     * Contains the details for an Outbound EDI capability.
     */
    get capabilityOptions(): CfnPartnership.CapabilityOptionsProperty | cdk.IResolvable | undefined;
    /**
     * Contains the details for an Outbound EDI capability.
     */
    set capabilityOptions(value: CfnPartnership.CapabilityOptionsProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the email address associated with this trading partner.
     */
    get email(): string;
...
export declare class CfnTransformer extends cdk.CfnResource implements cdk.IInspectable, ITransformerRef, cdk.ITaggableV2 {
     ...
     */
    private _outputConversion?;
    /**
     * This shape is deprecated: This is a legacy trait.
     *
     * @deprecated this property has been deprecated
     */
    private _sampleDocument?;
    /**
     * Returns a structure that contains the Amazon S3 bucket and an array of the corresponding keys used to identify the location for your sample documents.
     */
    private _sampleDocuments?;
    /**
     ...
     * @deprecated this property has been deprecated
     */
    get ediType(): CfnTransformer.EdiTypeProperty | cdk.IResolvable | undefined;
    /**
     * @deprecated this property has been deprecated
     */
    set ediType(value: CfnTransformer.EdiTypeProperty | cdk.IResolvable | undefined);
    /**
     * @deprecated this property has been deprecated
     */
     ...
     * Returns a structure that contains the format options for the transformation.
     */
    get inputConversion(): CfnTransformer.InputConversionProperty | cdk.IResolvable | undefined;
    /**
     * Returns a structure that contains the format options for the transformation.
     */
    set inputConversion(value: CfnTransformer.InputConversionProperty | cdk.IResolvable | undefined);
    /**
     * Returns the structure that contains the mapping template and its language (either XSLT or JSONATA).
     */
    get mapping(): cdk.IResolvable | CfnTransformer.MappingProperty | undefined;
    /**
     * Returns the structure that contains the mapping template and its language (either XSLT or JSONATA).
     */
    set mapping(value: cdk.IResolvable | CfnTransformer.MappingProperty | undefined);
    /**
     * This shape is deprecated: This is a legacy trait.
     *
     * @deprecated this property has been deprecated
     */
    get mappingTemplate(): string | undefined;
    /**
     * This shape is deprecated: This is a legacy trait.
     *
     * @deprecated this property has been deprecated
     */
    set mappingTemplate(value: string | undefined);
    /**
     * Returns the descriptive name for the transformer.
     */
    get name(): string;
     ...
     * Returns the `OutputConversion` object, which contains the format options for the outbound transformation.
     */
    get outputConversion(): cdk.IResolvable | CfnTransformer.OutputConversionProperty | undefined;
    /**
     * Returns the `OutputConversion` object, which contains the format options for the outbound transformation.
     */
    set outputConversion(value: cdk.IResolvable | CfnTransformer.OutputConversionProperty | undefined);
    /**
     * This shape is deprecated: This is a legacy trait.
     *
     * @deprecated this property has been deprecated
     */
    get sampleDocument(): string | undefined;
    /**
     * This shape is deprecated: This is a legacy trait.
     *
     * @deprecated this property has been deprecated
     */
    set sampleDocument(value: string | undefined);
    /**
     * Returns a structure that contains the Amazon S3 bucket and an array of the corresponding keys used to identify the location for your sample documents.
     */
    get sampleDocuments(): cdk.IResolvable | CfnTransformer.SampleDocumentsProperty | undefined;
    /**
     * Returns a structure that contains the Amazon S3 bucket and an array of the corresponding keys used to identify the location for your sample documents.
     */
    set sampleDocuments(value: cdk.IResolvable | CfnTransformer.SampleDocumentsProperty | undefined);
    /**
     * Returns the state of the newly created transformer.
     */
    get status(): string;
