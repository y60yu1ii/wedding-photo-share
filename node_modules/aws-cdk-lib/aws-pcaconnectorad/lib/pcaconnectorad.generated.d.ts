...
import { ConnectorReference, DirectoryRegistrationReference, IConnectorRef, IDirectoryRegistrationRef, IServicePrincipalNameRef, ITemplateGroupAccessControlEntryRef, ITemplateRef, ServicePrincipalNameReference, TemplateGroupAccessControlEntryReference, TemplateReference } from "../../interfaces/generated/aws-pcaconnectorad-interfaces.generated";
/**
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef, cdk.ITaggableV2 {
     ...
     * Information of the VPC and security group(s) used with the connector.
     */
    get vpcInformation(): cdk.IResolvable | CfnConnector.VpcInformationProperty;
    /**
     * Information of the VPC and security group(s) used with the connector.
     */
    set vpcInformation(value: cdk.IResolvable | CfnConnector.VpcInformationProperty);
    /**
...
export declare class CfnDirectoryRegistration extends cdk.CfnResource implements cdk.IInspectable, IDirectoryRegistrationRef, cdk.ITaggableV2 {
     ...
     */
    get attrDirectoryRegistrationArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnServicePrincipalName extends cdk.CfnResource implements cdk.IInspectable, IServicePrincipalNameRef {
     ...
     * The Amazon Resource Name (ARN) that was returned when you called [CreateDirectoryRegistration](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html) .
     */
    private _directoryRegistrationArn?;
    /**
     ...
     * The Amazon Resource Name (ARN) that was returned when you called [CreateConnector.html](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateConnector.html) .
     */
    get connectorArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) that was returned when you called [CreateConnector.html](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateConnector.html) .
     */
    set connectorArn(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) that was returned when you called [CreateDirectoryRegistration](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html) .
     */
    get directoryRegistrationArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) that was returned when you called [CreateDirectoryRegistration](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateDirectoryRegistration.html) .
     */
    set directoryRegistrationArn(value: string | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnTemplate extends cdk.CfnResource implements cdk.IInspectable, ITemplateRef, cdk.ITaggableV2 {
     ...
     */
    private _reenrollAllCertificateHolders?;
    /**
     ...
     * Template configuration to define the information included in certificates.
     */
    get definition(): cdk.IResolvable | CfnTemplate.TemplateDefinitionProperty;
    /**
     * Template configuration to define the information included in certificates.
     */
    set definition(value: cdk.IResolvable | CfnTemplate.TemplateDefinitionProperty);
    /**
     * Name of the templates.
     */
    get name(): string;
     ...
     * This setting allows the major version of a template to be increased automatically.
     */
    get reenrollAllCertificateHolders(): boolean | cdk.IResolvable | undefined;
    /**
     * This setting allows the major version of a template to be increased automatically.
     */
    set reenrollAllCertificateHolders(value: boolean | cdk.IResolvable | undefined);
    /**
     * Metadata assigned to a template consisting of a key-value pair.
     */
    get tags(): Record<string, string> | undefined;
...
export declare class CfnTemplateGroupAccessControlEntry extends cdk.CfnResource implements cdk.IInspectable, ITemplateGroupAccessControlEntryRef {
     ...
     * Permissions to allow or deny an Active Directory group to enroll or autoenroll certificates issued against a template.
     */
    get accessRights(): CfnTemplateGroupAccessControlEntry.AccessRightsProperty | cdk.IResolvable;
    /**
     * Permissions to allow or deny an Active Directory group to enroll or autoenroll certificates issued against a template.
     */
    set accessRights(value: CfnTemplateGroupAccessControlEntry.AccessRightsProperty | cdk.IResolvable);
    /**
     * Name of the Active Directory group.
     */
     ...
     * Security identifier (SID) of the group object from Active Directory.
     */
    get groupSecurityIdentifier(): string | undefined;
    /**
     * Security identifier (SID) of the group object from Active Directory.
     */
    set groupSecurityIdentifier(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) that was returned when you called [CreateTemplate](https://docs.aws.amazon.com/pca-connector-ad/latest/APIReference/API_CreateTemplate.html) .
     */
