...
import { aws_kms as kmsRefs, aws_secretsmanager as secretsManagerRefs } from "../../interfaces";
import { IResourcePolicyRef, IRotationScheduleRef, ISecretRef, ISecretTargetAttachmentRef, ResourcePolicyReference, RotationScheduleReference, SecretReference, SecretTargetAttachmentReference } from "../../interfaces/generated/aws-secretsmanager-interfaces.generated";
/**
...
export declare class CfnResourcePolicy extends cdk.CfnResource implements cdk.IInspectable, IResourcePolicyRef {
     ...
     * Specifies whether to block resource-based policies that allow broad access to the secret.
     */
    get blockPublicPolicy(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether to block resource-based policies that allow broad access to the secret.
     */
    set blockPublicPolicy(value: boolean | cdk.IResolvable | undefined);
    /**
     * A JSON-formatted string for an AWS resource-based policy.
     */
...
export interface CfnResourcePolicyProps {
     ...
     */
    readonly secretId: secretsManagerRefs.ISecretRef | string;
}
/**
...
export declare class CfnRotationSchedule extends cdk.CfnResource implements cdk.IInspectable, IRotationScheduleRef {
     ...
     */
    private _rotateImmediatelyOnUpdate?;
    /**
     ...
     * The list of metadata needed to successfully rotate a managed external secret.
     */
    get externalSecretRotationMetadata(): Array<CfnRotationSchedule.ExternalSecretRotationMetadataItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of metadata needed to successfully rotate a managed external secret.
     */
    set externalSecretRotationMetadata(value: Array<CfnRotationSchedule.ExternalSecretRotationMetadataItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The ARN of the IAM role that is used by Secrets Manager to rotate a managed external secret.
     */
    get externalSecretRotationRoleArn(): string | undefined;
    /**
     * The ARN of the IAM role that is used by Secrets Manager to rotate a managed external secret.
     */
    set externalSecretRotationRoleArn(value: string | undefined);
    /**
     * Creates a new Lambda rotation function based on one of the [Secrets Manager rotation function templates](https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_available-rotation-templates.html) . To use a rotation function that already exists, specify `RotationLambdaARN` instead.
     */
    get hostedRotationLambda(): CfnRotationSchedule.HostedRotationLambdaProperty | cdk.IResolvable | undefined;
    /**
     * Creates a new Lambda rotation function based on one of the [Secrets Manager rotation function templates](https://docs.aws.amazon.com/secretsmanager/latest/userguide/reference_available-rotation-templates.html) . To use a rotation function that already exists, specify `RotationLambdaARN` instead.
     */
    set hostedRotationLambda(value: CfnRotationSchedule.HostedRotationLambdaProperty | cdk.IResolvable | undefined);
    /**
     * Determines whether to rotate the secret immediately or wait until the next scheduled rotation window when the rotation schedule is updated.
     */
    get rotateImmediatelyOnUpdate(): boolean | cdk.IResolvable | undefined;
    /**
     * Determines whether to rotate the secret immediately or wait until the next scheduled rotation window when the rotation schedule is updated.
     */
    set rotateImmediatelyOnUpdate(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARN of an existing Lambda rotation function.
     */
     ...
     * A structure that defines the rotation configuration for this secret.
     */
    get rotationRules(): cdk.IResolvable | CfnRotationSchedule.RotationRulesProperty | undefined;
    /**
     * A structure that defines the rotation configuration for this secret.
     */
    set rotationRules(value: cdk.IResolvable | CfnRotationSchedule.RotationRulesProperty | undefined);
    /**
     * The ARN or name of the secret to rotate. This is unique for each rotation schedule definition.
     */
    get secretId(): string;
...
export declare class CfnSecret extends cdk.CfnResource implements cdk.IInspectable, ISecretRef, cdk.ITaggable {
     ...
     * A structure that specifies how to generate a password to encrypt and store in the secret.
     */
    get generateSecretString(): CfnSecret.GenerateSecretStringProperty | cdk.IResolvable | undefined;
    /**
     * A structure that specifies how to generate a password to encrypt and store in the secret.
     */
    set generateSecretString(value: CfnSecret.GenerateSecretStringProperty | cdk.IResolvable | undefined);
    /**
     * The ARN, key ID, or alias of the AWS  key that Secrets Manager uses to encrypt the secret value in the secret.
     */
     ...
     * A custom type that specifies a `Region` and the `KmsKeyId` for a replica secret.
     */
    get replicaRegions(): Array<cdk.IResolvable | CfnSecret.ReplicaRegionProperty> | cdk.IResolvable | undefined;
    /**
     * A custom type that specifies a `Region` and the `KmsKeyId` for a replica secret.
     */
    set replicaRegions(value: Array<cdk.IResolvable | CfnSecret.ReplicaRegionProperty> | cdk.IResolvable | undefined);
    /**
     * The text to encrypt and store in the secret.
     */
     ...
     * The text to encrypt and store in the secret.
     */
    set secretString(value: string | undefined);
    /**
     * A list of tags to attach to the secret.
     */
