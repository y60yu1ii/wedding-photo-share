...
import { ApplicationCloudWatchLoggingOptionReference, ApplicationOutputReference, ApplicationReference, ApplicationReferenceDataSourceReference, IApplicationCloudWatchLoggingOptionRef, IApplicationOutputRef, IApplicationRef, IApplicationReferenceDataSourceRef } from "../../interfaces/generated/aws-kinesisanalyticsv2-interfaces.generated";
/**
...
export declare class CfnApplicationV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggable {
     ...
     */
    private _applicationMaintenanceConfiguration?;
    /**
     ...
     * Use this parameter to configure the application.
     */
    get applicationConfiguration(): CfnApplicationV2.ApplicationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Use this parameter to configure the application.
     */
    set applicationConfiguration(value: CfnApplicationV2.ApplicationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The description of the application.
     */
     ...
     * Specifies the maintenance window parameters for a Kinesis Data Analytics application.
     */
    get applicationMaintenanceConfiguration(): CfnApplicationV2.ApplicationMaintenanceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the maintenance window parameters for a Kinesis Data Analytics application.
     */
    set applicationMaintenanceConfiguration(value: CfnApplicationV2.ApplicationMaintenanceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * To create a Kinesis Data Analytics Studio notebook, you must set the mode to `INTERACTIVE` .
     */
    get applicationMode(): string | undefined;
    /**
     * To create a Kinesis Data Analytics Studio notebook, you must set the mode to `INTERACTIVE` .
     */
    set applicationMode(value: string | undefined);
    /**
     * The name of the application.
     */
     ...
     * Describes the starting parameters for an Managed Service for Apache Flink application.
     */
    get runConfiguration(): cdk.IResolvable | CfnApplicationV2.RunConfigurationProperty | undefined;
    /**
     * Describes the starting parameters for an Managed Service for Apache Flink application.
     */
    set runConfiguration(value: cdk.IResolvable | CfnApplicationV2.RunConfigurationProperty | undefined);
    /**
     * The runtime environment for the application.
     */
...
export interface CfnApplicationV2Props {
     ...
     */
    readonly serviceExecutionRole: iamRefs.IRoleRef | string;
    /**
     * A list of one or more tags to assign to the application.
     *
...
export declare class CfnApplicationCloudWatchLoggingOptionV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationCloudWatchLoggingOptionRef {
     ...
     */
    private _cloudWatchLoggingOption;
    /**
     ...
     * Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).
     */
    get cloudWatchLoggingOption(): CfnApplicationCloudWatchLoggingOptionV2.CloudWatchLoggingOptionProperty | cdk.IResolvable;
    /**
     * Provides a description of Amazon CloudWatch logging options, including the log stream Amazon Resource Name (ARN).
     */
    set cloudWatchLoggingOption(value: CfnApplicationCloudWatchLoggingOptionV2.CloudWatchLoggingOptionProperty | cdk.IResolvable);
    /**
...
export declare class CfnApplicationOutputV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationOutputRef {
     ...
     * Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written.
     */
    get output(): cdk.IResolvable | CfnApplicationOutputV2.OutputProperty;
    /**
     * Describes a SQL-based Kinesis Data Analytics application's output configuration, in which you identify an in-application stream and a destination where you want the in-application stream data to be written.
     */
    set output(value: cdk.IResolvable | CfnApplicationOutputV2.OutputProperty);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnApplicationReferenceDataSourceV2 extends cdk.CfnResource implements cdk.IInspectable, IApplicationReferenceDataSourceRef {
     ...
     * For a SQL-based Kinesis Data Analytics application, describes the reference data source by providing the source information (Amazon S3 bucket name and object key name), the resulting in-application table name that is created, and the necessary schema to map the data elements in the Amazon S3 object to the in-application table.
     */
    get referenceDataSource(): cdk.IResolvable | CfnApplicationReferenceDataSourceV2.ReferenceDataSourceProperty;
    /**
     * For a SQL-based Kinesis Data Analytics application, describes the reference data source by providing the source information (Amazon S3 bucket name and object key name), the resulting in-application table name that is created, and the necessary schema to map the data elements in the Amazon S3 object to the in-application table.
     */
    set referenceDataSource(value: cdk.IResolvable | CfnApplicationReferenceDataSourceV2.ReferenceDataSourceProperty);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
