...
import { ApplicationOutputReference, ApplicationReference, ApplicationReferenceDataSourceReference, IApplicationOutputRef, IApplicationRef, IApplicationReferenceDataSourceRef } from "../../interfaces/generated/aws-kinesisanalytics-interfaces.generated";
/**
...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef {
     ...
     * One or more SQL statements that read input data, transform it, and generate output.
     */
    set applicationCode(value: string | undefined);
    /**
     * Summary description of the application.
     */
     ...
     * Use this parameter to configure the application input.
     */
    get inputs(): Array<CfnApplication.InputProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Use this parameter to configure the application input.
     */
    set inputs(value: Array<CfnApplication.InputProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
