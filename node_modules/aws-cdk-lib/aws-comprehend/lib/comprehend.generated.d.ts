...
import { DocumentClassifierReference, FlywheelReference, IDocumentClassifierRef, IFlywheelRef } from "../../interfaces/generated/aws-comprehend-interfaces.generated";
/**
...
export declare class CfnDocumentClassifier extends cdk.CfnResource implements cdk.IInspectable, IDocumentClassifierRef, cdk.ITaggableV2 {
     ...
     */
    private _documentClassifierName;
    /**
     ...
     * The name of the document classifier.
     */
    get documentClassifierName(): string;
    /**
     * The name of the document classifier.
     */
    set documentClassifierName(value: string);
    /**
     * Specifies the format and location of the input data for the job.
     */
    get inputDataConfig(): CfnDocumentClassifier.DocumentClassifierInputDataConfigProperty | cdk.IResolvable;
    /**
     * Specifies the format and location of the input data for the job.
     */
    set inputDataConfig(value: CfnDocumentClassifier.DocumentClassifierInputDataConfigProperty | cdk.IResolvable);
    /**
     * The language of the input documents.
     */
     ...
     * ID for the AWS  key that Amazon Comprehend uses to encrypt trained custom models.
     */
    get modelKmsKeyId(): string | undefined;
    /**
     * ID for the AWS  key that Amazon Comprehend uses to encrypt trained custom models.
     */
    set modelKmsKeyId(value: string | undefined);
    /**
     * The resource-based policy to attach to your custom document classifier model.
     */
    get modelPolicy(): string | undefined;
    /**
     * The resource-based policy to attach to your custom document classifier model.
     */
    set modelPolicy(value: string | undefined);
    /**
     * Provides output results configuration parameters for custom classifier jobs.
     */
    get outputDataConfig(): CfnDocumentClassifier.DocumentClassifierOutputDataConfigProperty | cdk.IResolvable | undefined;
    /**
     * Provides output results configuration parameters for custom classifier jobs.
     */
    set outputDataConfig(value: CfnDocumentClassifier.DocumentClassifierOutputDataConfigProperty | cdk.IResolvable | undefined);
    /**
     * Tags to associate with the document classifier.
     */
     ...
     * ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt data on the storage volume attached to the ML compute instance(s) that process the analysis job.
     */
    get volumeKmsKeyId(): string | undefined;
    /**
     * ID for the AWS Key Management Service (KMS) key that Amazon Comprehend uses to encrypt data on the storage volume attached to the ML compute instance(s) that process the analysis job.
     */
    set volumeKmsKeyId(value: string | undefined);
    /**
     * Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you are using for your custom classifier.
     */
    get vpcConfig(): cdk.IResolvable | CfnDocumentClassifier.VpcConfigProperty | undefined;
    /**
     * Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you are using for your custom classifier.
     */
    set vpcConfig(value: cdk.IResolvable | CfnDocumentClassifier.VpcConfigProperty | undefined);
    /**
...
export declare class CfnFlywheel extends cdk.CfnResource implements cdk.IInspectable, IFlywheelRef, cdk.ITaggable {
     ...
     */
    private _dataLakeS3Uri;
    /**
     * Data security configuration.
     */
    private _dataSecurityConfig?;
    /**
     * Name for the flywheel.
     */
    private _flywheelName;
    /**
     ...
     * The Amazon Resource Number (ARN) of the active model version.
     */
    get activeModelArn(): string | undefined;
    /**
     * The Amazon Resource Number (ARN) of the active model version.
     */
    set activeModelArn(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the IAM role that grants Amazon Comprehend permission to access the flywheel data.
     */
    get dataAccessRoleArn(): string;
     ...
     * Amazon S3 URI of the data lake location.
     */
    get dataLakeS3Uri(): string;
    /**
     * Amazon S3 URI of the data lake location.
     */
    set dataLakeS3Uri(value: string);
    /**
     * Data security configuration.
     */
    get dataSecurityConfig(): CfnFlywheel.DataSecurityConfigProperty | cdk.IResolvable | undefined;
    /**
     * Data security configuration.
     */
    set dataSecurityConfig(value: CfnFlywheel.DataSecurityConfigProperty | cdk.IResolvable | undefined);
    /**
     * Name for the flywheel.
     */
    get flywheelName(): string;
    /**
     * Name for the flywheel.
     */
    set flywheelName(value: string);
    /**
     * Model type of the flywheel's model.
     */
     ...
     * Configuration about the model associated with a flywheel.
     */
    get taskConfig(): cdk.IResolvable | CfnFlywheel.TaskConfigProperty | undefined;
    /**
     * Configuration about the model associated with a flywheel.
     */
    set taskConfig(value: cdk.IResolvable | CfnFlywheel.TaskConfigProperty | undefined);
    /**
