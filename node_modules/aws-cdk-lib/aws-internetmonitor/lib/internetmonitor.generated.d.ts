...
export declare class CfnMonitor extends cdk.CfnResource implements cdk.IInspectable, IMonitorRef, cdk.ITaggable {
     ...
     */
    private _includeLinkedAccounts?;
    /**
     ...
     */
    private _resourcesToAdd?;
    /**
     * The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs).
     */
    private _resourcesToRemove?;
    /**
     ...
     * A complex type with the configuration information that determines the threshold and other conditions for when Internet Monitor creates a health event for an overall performance or availability issue, across an application's geographies.
     */
    get healthEventsConfig(): CfnMonitor.HealthEventsConfigProperty | cdk.IResolvable | undefined;
    /**
     * A complex type with the configuration information that determines the threshold and other conditions for when Internet Monitor creates a health event for an overall performance or availability issue, across an application's geographies.
     */
    set healthEventsConfig(value: CfnMonitor.HealthEventsConfigProperty | cdk.IResolvable | undefined);
    /**
     * A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor.
     */
    get includeLinkedAccounts(): boolean | cdk.IResolvable | undefined;
    /**
     * A boolean option that you can set to `TRUE` to include monitors for linked accounts in a list of monitors, when you've set up cross-account sharing in Internet Monitor.
     */
    set includeLinkedAccounts(value: boolean | cdk.IResolvable | undefined);
    /**
     * Publish internet measurements for a monitor for all city-networks (up to the 500,000 service limit) to another location, such as an Amazon S3 bucket.
     */
    get internetMeasurementsLogDelivery(): CfnMonitor.InternetMeasurementsLogDeliveryProperty | cdk.IResolvable | undefined;
    /**
     * Publish internet measurements for a monitor for all city-networks (up to the 500,000 service limit) to another location, such as an Amazon S3 bucket.
     */
    set internetMeasurementsLogDelivery(value: CfnMonitor.InternetMeasurementsLogDeliveryProperty | cdk.IResolvable | undefined);
    /**
     * The account ID for an account that you've set up cross-account sharing for in Internet Monitor.
     */
    get linkedAccountId(): string | undefined;
    /**
     * The account ID for an account that you've set up cross-account sharing for in Internet Monitor.
     */
    set linkedAccountId(value: string | undefined);
    /**
     * The maximum number of city-networks to monitor for your resources.
     */
    get maxCityNetworksToMonitor(): number | undefined;
    /**
     * The maximum number of city-networks to monitor for your resources.
     */
    set maxCityNetworksToMonitor(value: number | undefined);
    /**
     * The name of the monitor.
     */
     ...
     * The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs).
     */
    get resourcesToAdd(): Array<string> | undefined;
    /**
     * The resources to include in a monitor, which you provide as a set of Amazon Resource Names (ARNs).
     */
    set resourcesToAdd(value: Array<string> | undefined);
    /**
     * The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs).
     */
    get resourcesToRemove(): Array<string> | undefined;
    /**
     * The resources to remove from a monitor, which you provide as a set of Amazon Resource Names (ARNs).
     */
    set resourcesToRemove(value: Array<string> | undefined);
    /**
     * The status of a monitor.
     */
     ...
     * The percentage of the internet-facing traffic for your application that you want to monitor.
     */
    get trafficPercentageToMonitor(): number | undefined;
    /**
     * The percentage of the internet-facing traffic for your application that you want to monitor.
     */
    set trafficPercentageToMonitor(value: number | undefined);
    /**
     ...
     */
    get attrProcessingStatus(): string;
    /**
     * Additional information about the health of the data processing for the monitor.
     *
     * @cloudformationAttribute ProcessingStatusInfo
     */
    get attrProcessingStatusInfo(): string;
