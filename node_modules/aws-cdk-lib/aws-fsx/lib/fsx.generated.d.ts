...
import { DataRepositoryAssociationReference, FileSystemReference, IDataRepositoryAssociationRef, IFileSystemRef, IS3AccessPointAttachmentRef, ISnapshotRef, IStorageVirtualMachineRef, IVolumeRef, S3AccessPointAttachmentReference, SnapshotReference, StorageVirtualMachineReference, VolumeReference } from "../../interfaces/generated/aws-fsx-interfaces.generated";
/**
...
export declare class CfnDataRepositoryAssociation extends cdk.CfnResource implements cdk.IInspectable, IDataRepositoryAssociationRef, cdk.ITaggable {
     ...
     * A boolean flag indicating whether an import data repository task to import metadata should run after the data repository association is created.
     */
    get batchImportMetaDataOnCreate(): boolean | cdk.IResolvable | undefined;
    /**
     * A boolean flag indicating whether an import data repository task to import metadata should run after the data repository association is created.
     */
    set batchImportMetaDataOnCreate(value: boolean | cdk.IResolvable | undefined);
    /**
     * The path to the Amazon S3 data repository that will be linked to the file system.
     */
     ...
     * The configuration for an Amazon S3 data repository linked to an Amazon FSx Lustre file system with a data repository association.
     */
    get s3(): cdk.IResolvable | CfnDataRepositoryAssociation.S3Property | undefined;
    /**
     * The configuration for an Amazon S3 data repository linked to an Amazon FSx Lustre file system with a data repository association.
     */
    set s3(value: cdk.IResolvable | CfnDataRepositoryAssociation.S3Property | undefined);
    /**
     * A list of `Tag` values, with a maximum of 50 elements.
     */
...
export declare class CfnFileSystem extends cdk.CfnResource implements cdk.IInspectable, IFileSystemRef, cdk.ITaggable {
     ...
     * For FSx for Lustre file systems, sets the Lustre version for the file system that you're creating.
     */
    get fileSystemTypeVersion(): string | undefined;
    /**
     * For FSx for Lustre file systems, sets the Lustre version for the file system that you're creating.
     */
    set fileSystemTypeVersion(value: string | undefined);
    /**
     * The ID of the AWS Key Management Service ( AWS  ) key used to encrypt Amazon FSx file system data.
     */
     ...
     * The Lustre configuration for the file system being created.
     */
    get lustreConfiguration(): cdk.IResolvable | CfnFileSystem.LustreConfigurationProperty | undefined;
    /**
     * The Lustre configuration for the file system being created.
     */
    set lustreConfiguration(value: cdk.IResolvable | CfnFileSystem.LustreConfigurationProperty | undefined);
    /**
     * The network type of the file system.
     */
     ...
     * The ONTAP configuration properties of the FSx for ONTAP file system that you are creating.
     */
    get ontapConfiguration(): cdk.IResolvable | CfnFileSystem.OntapConfigurationProperty | undefined;
    /**
     * The ONTAP configuration properties of the FSx for ONTAP file system that you are creating.
     */
    set ontapConfiguration(value: cdk.IResolvable | CfnFileSystem.OntapConfigurationProperty | undefined);
    /**
     * The Amazon FSx for OpenZFS configuration properties for the file system that you are creating.
     */
    get openZfsConfiguration(): cdk.IResolvable | CfnFileSystem.OpenZFSConfigurationProperty | undefined;
    /**
     * The Amazon FSx for OpenZFS configuration properties for the file system that you are creating.
     */
    set openZfsConfiguration(value: cdk.IResolvable | CfnFileSystem.OpenZFSConfigurationProperty | undefined);
    /**
     * A list of IDs specifying the security groups to apply to all network interfaces created for file system access.
     */
     ...
     * The configuration object for the Microsoft Windows file system you are creating.
     */
    get windowsConfiguration(): cdk.IResolvable | CfnFileSystem.WindowsConfigurationProperty | undefined;
    /**
     * The configuration object for the Microsoft Windows file system you are creating.
     */
    set windowsConfiguration(value: cdk.IResolvable | CfnFileSystem.WindowsConfigurationProperty | undefined);
    /**
     ...
     */
    get attrLustreMountName(): string;
    /**
...
export declare namespace CfnFileSystem {
    ...
    interface WindowsConfigurationProperty {
         ...
         */
        readonly fsrmConfiguration?: CfnFileSystem.FsrmConfigurationProperty | cdk.IResolvable;
        /**
    ...
    interface FsrmConfigurationProperty {
         ...
         */
        readonly eventLogDestination?: string;
        /**
         ...
         */
        readonly fsrmServiceEnabled: boolean | cdk.IResolvable;
    }
    /**
...
export declare class CfnStorageVirtualMachine extends cdk.CfnResource implements cdk.IInspectable, IStorageVirtualMachineRef, cdk.ITaggable {
     ...
     * Describes the Microsoft Active Directory configuration to which the SVM is joined, if applicable.
     */
    get activeDirectoryConfiguration(): CfnStorageVirtualMachine.ActiveDirectoryConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Describes the Microsoft Active Directory configuration to which the SVM is joined, if applicable.
     */
    set activeDirectoryConfiguration(value: CfnStorageVirtualMachine.ActiveDirectoryConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the FSx for ONTAP file system on which to create the SVM.
     */
    get fileSystemId(): string;
     ...
     * The security style of the root volume of the SVM. Specify one of the following values:.
     */
    get rootVolumeSecurityStyle(): string | undefined;
    /**
     * The security style of the root volume of the SVM. Specify one of the following values:.
     */
    set rootVolumeSecurityStyle(value: string | undefined);
    /**
     * Specifies the password to use when logging on to the SVM using a secure shell (SSH) connection to the SVM's management endpoint.
     */
    get svmAdminPassword(): string | undefined;
    /**
     * Specifies the password to use when logging on to the SVM using a secure shell (SSH) connection to the SVM's management endpoint.
     */
    set svmAdminPassword(value: string | undefined);
    /**
     * A list of `Tag` values, with a maximum of 50 elements.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrStorageVirtualMachineId(): string;
    /**
...
export declare class CfnVolume extends cdk.CfnResource implements cdk.IInspectable, IVolumeRef, cdk.ITaggable {
     ...
     * The configuration of an Amazon FSx for NetApp ONTAP volume.
     */
    get ontapConfiguration(): cdk.IResolvable | CfnVolume.OntapConfigurationProperty | undefined;
    /**
     * The configuration of an Amazon FSx for NetApp ONTAP volume.
     */
    set ontapConfiguration(value: cdk.IResolvable | CfnVolume.OntapConfigurationProperty | undefined);
    /**
     * The configuration of an Amazon FSx for OpenZFS volume.
     */
    get openZfsConfiguration(): cdk.IResolvable | CfnVolume.OpenZFSConfigurationProperty | undefined;
    /**
     * The configuration of an Amazon FSx for OpenZFS volume.
     */
    set openZfsConfiguration(value: cdk.IResolvable | CfnVolume.OpenZFSConfigurationProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnS3AccessPointAttachment extends cdk.CfnResource implements cdk.IInspectable, IS3AccessPointAttachmentRef {
     ...
     * The ONTAP configuration of the S3 access point attachment.
     */
    get ontapConfiguration(): cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOntapConfigurationProperty | undefined;
    /**
     * The ONTAP configuration of the S3 access point attachment.
     */
    set ontapConfiguration(value: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOntapConfigurationProperty | undefined);
    /**
     * The OpenZFSConfiguration of the S3 access point attachment.
     */
    get openZfsConfiguration(): cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOpenZFSConfigurationProperty | undefined;
    /**
     * The OpenZFSConfiguration of the S3 access point attachment.
     */
    set openZfsConfiguration(value: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOpenZFSConfigurationProperty | undefined);
    /**
     * The S3 access point configuration of the S3 access point attachment.
     */
    get s3AccessPoint(): cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointProperty | undefined;
    /**
     * The S3 access point configuration of the S3 access point attachment.
     */
    set s3AccessPoint(value: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointProperty | undefined);
    /**
     * The type of Amazon FSx volume that the S3 access point is attached to.
     */
    get type(): string;
...
export declare namespace CfnS3AccessPointAttachment {
    ...
    interface S3AccessPointOntapConfigurationProperty {
         ...
         */
        readonly fileSystemIdentity: cdk.IResolvable | CfnS3AccessPointAttachment.OntapFileSystemIdentityProperty;
        /**
    ...
    interface OntapFileSystemIdentityProperty {
         ...
         */
        readonly unixUser?: cdk.IResolvable | CfnS3AccessPointAttachment.OntapUnixFileSystemUserProperty;
        /**
         ...
         */
        readonly windowsUser?: cdk.IResolvable | CfnS3AccessPointAttachment.OntapWindowsFileSystemUserProperty;
    }
    /**
...
export interface CfnS3AccessPointAttachmentProps {
     ...
     */
    readonly ontapConfiguration?: cdk.IResolvable | CfnS3AccessPointAttachment.S3AccessPointOntapConfigurationProperty;
    /**
     * The OpenZFSConfiguration of the S3 access point attachment.
     *
