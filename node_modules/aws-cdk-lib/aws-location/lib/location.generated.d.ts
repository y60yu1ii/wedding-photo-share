...
export declare class CfnGeofenceCollection extends cdk.CfnResource implements cdk.IInspectable, IGeofenceCollectionRef, cdk.ITaggableV2 {
     ...
     * @deprecated this property has been deprecated
     */
    get pricingPlanDataSource(): string | undefined;
    /**
     * This shape is deprecated since 2022-02-01: Deprecated.
     *
     * @deprecated this property has been deprecated
     */
    set pricingPlanDataSource(value: string | undefined);
    /**
     * Applies one or more tags to the geofence collection.
     */
...
export declare class CfnMap extends cdk.CfnResource implements cdk.IInspectable, IMapRef, cdk.ITaggableV2 {
     ...
     * Specifies the `MapConfiguration` , including the map style, for the map resource that you create.
     */
    get configuration(): cdk.IResolvable | CfnMap.MapConfigurationProperty;
    /**
     * Specifies the `MapConfiguration` , including the map style, for the map resource that you create.
     */
    set configuration(value: cdk.IResolvable | CfnMap.MapConfigurationProperty);
    /**
     * An optional description for the map resource.
     */
    get description(): string | undefined;
...
export declare class CfnPlaceIndex extends cdk.CfnResource implements cdk.IInspectable, IPlaceIndexRef, cdk.ITaggableV2 {
     ...
     * Specifies the data storage option requesting Places.
     */
    get dataSourceConfiguration(): CfnPlaceIndex.DataSourceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the data storage option requesting Places.
     */
    set dataSourceConfiguration(value: CfnPlaceIndex.DataSourceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The optional description for the place index resource.
     */
    get description(): string | undefined;
...
export declare class CfnTracker extends cdk.CfnResource implements cdk.IInspectable, ITrackerRef, cdk.ITaggableV2 {
     ...
     */
    private _description?;
    private _eventBridgeEnabled?;
    private _kmsKeyEnableGeospatialQueries?;
    /**
     * A key identifier for an [AWS KMS customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/create-keys.html) . Enter a key ID, key ARN, alias name, or alias ARN.
     */
    private _kmsKeyId?;
     ...
     */
    set description(value: string | undefined);
    get eventBridgeEnabled(): boolean | cdk.IResolvable | undefined;
    set eventBridgeEnabled(value: boolean | cdk.IResolvable | undefined);
    get kmsKeyEnableGeospatialQueries(): boolean | cdk.IResolvable | undefined;
    set kmsKeyEnableGeospatialQueries(value: boolean | cdk.IResolvable | undefined);
    /**
     * A key identifier for an [AWS KMS customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/create-keys.html) . Enter a key ID, key ARN, alias name, or alias ARN.
     */
    get kmsKeyId(): string | undefined;
     ...
     * Specifies the position filtering for the tracker resource.
     */
    get positionFiltering(): string | undefined;
    /**
     * Specifies the position filtering for the tracker resource.
     */
    set positionFiltering(value: string | undefined);
    /**
     * @deprecated this property has been deprecated
     */
    get pricingPlan(): string | undefined;
...
export declare class CfnAPIKey extends cdk.CfnResource implements cdk.IInspectable, IAPIKeyRef, cdk.ITaggableV2 {
     ...
     * The boolean flag to be included for updating `ExpireTime` or Restrictions details.
     */
    get forceUpdate(): boolean | cdk.IResolvable | undefined;
    /**
     * The boolean flag to be included for updating `ExpireTime` or Restrictions details.
     */
    set forceUpdate(value: boolean | cdk.IResolvable | undefined);
    /**
     * A custom name for the API key resource.
     */
    get keyName(): string;
     ...
     * Whether the API key should expire.
     */
    get noExpiry(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether the API key should expire.
     */
    set noExpiry(value: boolean | cdk.IResolvable | undefined);
    /**
     * The API key restrictions for the API key resource.
     */
    get restrictions(): CfnAPIKey.ApiKeyRestrictionsProperty | cdk.IResolvable;
    /**
     * The API key restrictions for the API key resource.
     */
    set restrictions(value: CfnAPIKey.ApiKeyRestrictionsProperty | cdk.IResolvable);
    /**
     * Applies one or more tags to the map resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
