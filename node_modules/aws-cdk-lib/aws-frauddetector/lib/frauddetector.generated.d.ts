...
import { DetectorReference, EntityTypeReference, EventTypeReference, IDetectorRef, IEntityTypeRef, IEventTypeRef, ILabelRef, IListRef, IOutcomeRef, IVariableRef, LabelReference, ListReference, OutcomeReference, VariableReference } from "../../interfaces/generated/aws-frauddetector-interfaces.generated";
/**
...
export declare class CfnDetector extends cdk.CfnResource implements cdk.IInspectable, IDetectorRef, cdk.ITaggable {
     ...
     * The models to associate with this detector.
     */
    get associatedModels(): Array<cdk.IResolvable | CfnDetector.ModelProperty> | cdk.IResolvable | undefined;
    /**
     * The models to associate with this detector.
     */
    set associatedModels(value: Array<cdk.IResolvable | CfnDetector.ModelProperty> | cdk.IResolvable | undefined);
    /**
     * The detector description.
     */
     ...
     * The status of the detector version.
     */
    get detectorVersionStatus(): string | undefined;
    /**
     * The status of the detector version.
     */
    set detectorVersionStatus(value: string | undefined);
    /**
     * The event type associated with this detector.
     */
    get eventType(): CfnDetector.EventTypeProperty | cdk.IResolvable;
    /**
     * The event type associated with this detector.
     */
    set eventType(value: CfnDetector.EventTypeProperty | cdk.IResolvable);
    /**
     * The rule execution mode for the rules included in the detector version.
     */
    get ruleExecutionMode(): string | undefined;
    /**
     * The rule execution mode for the rules included in the detector version.
     */
    set ruleExecutionMode(value: string | undefined);
    /**
     * The rules to include in the detector version.
     */
    get rules(): Array<cdk.IResolvable | CfnDetector.RuleProperty> | cdk.IResolvable;
    /**
     * The rules to include in the detector version.
     */
    set rules(value: Array<cdk.IResolvable | CfnDetector.RuleProperty> | cdk.IResolvable);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare class CfnEventType extends cdk.CfnResource implements cdk.IInspectable, IEventTypeRef, cdk.ITaggable {
     ...
     * The event type entity types.
     */
    get entityTypes(): Array<CfnEventType.EntityTypeProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The event type entity types.
     */
    set entityTypes(value: Array<CfnEventType.EntityTypeProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The event type event variables.
     */
    get eventVariables(): Array<CfnEventType.EventVariableProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The event type event variables.
     */
    set eventVariables(value: Array<CfnEventType.EventVariableProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The event type labels.
     */
    get labels(): Array<cdk.IResolvable | CfnEventType.LabelProperty> | cdk.IResolvable;
    /**
     * The event type labels.
     */
    set labels(value: Array<cdk.IResolvable | CfnEventType.LabelProperty> | cdk.IResolvable);
    /**
     * The event type name.
     */
    get name(): string;
...
export declare class CfnList extends cdk.CfnResource implements cdk.IInspectable, IListRef, cdk.ITaggable {
     ...
     * The elements in the list.
     */
    get elements(): Array<string> | undefined;
    /**
     * The elements in the list.
     */
    set elements(value: Array<string> | undefined);
    /**
     * The name of the list.
     */
    get name(): string;
     ...
     * The variable type of the list.
     */
    set variableType(value: string | undefined);
    /**
     * The event type ARN.
     *
     * @cloudformationAttribute Arn
