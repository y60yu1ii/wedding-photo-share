...
import { AccessPointReference, BucketPolicyReference, DirectoryBucketReference, IAccessPointRef, IBucketPolicyRef, IDirectoryBucketRef } from "../../interfaces/generated/aws-s3express-interfaces.generated";
/**
...
export declare class CfnAccessPoint extends cdk.CfnResource implements cdk.IInspectable, IAccessPointRef, cdk.ITaggableV2 {
     ...
     * You can use the access point scope to restrict access to specific prefixes, API operations, or a combination of both.
     */
    get scope(): cdk.IResolvable | CfnAccessPoint.ScopeProperty | undefined;
    /**
     * You can use the access point scope to restrict access to specific prefixes, API operations, or a combination of both.
     */
    set scope(value: cdk.IResolvable | CfnAccessPoint.ScopeProperty | undefined);
    /**
     * An array of tags that you can apply to access points.
     */
...
export declare class CfnBucketPolicy extends cdk.CfnResource implements cdk.IInspectable, IBucketPolicyRef {
     ...
     * A policy document containing permissions to add to the specified bucket.
     */
    get policyDocument(): any | cdk.IResolvable | string;
    /**
     * A policy document containing permissions to add to the specified bucket.
     */
    set policyDocument(value: any | cdk.IResolvable | string);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDirectoryBucket extends cdk.CfnResource implements cdk.IInspectable, IDirectoryBucketRef, cdk.ITaggableV2 {
     ...
     * Specifies default encryption for a bucket using server-side encryption with Amazon S3 managed keys (SSE-S3) or AWS KMS keys (SSE-KMS).
     */
    get bucketEncryption(): CfnDirectoryBucket.BucketEncryptionProperty | cdk.IResolvable | undefined;
    /**
     * Specifies default encryption for a bucket using server-side encryption with Amazon S3 managed keys (SSE-S3) or AWS KMS keys (SSE-KMS).
     */
    set bucketEncryption(value: CfnDirectoryBucket.BucketEncryptionProperty | cdk.IResolvable | undefined);
    /**
     * A name for the bucket.
     */
     ...
     * Container for lifecycle rules. You can add as many as 1000 rules.
     */
    get lifecycleConfiguration(): cdk.IResolvable | CfnDirectoryBucket.LifecycleConfigurationProperty | undefined;
    /**
     * Container for lifecycle rules. You can add as many as 1000 rules.
     */
    set lifecycleConfiguration(value: cdk.IResolvable | CfnDirectoryBucket.LifecycleConfigurationProperty | undefined);
    /**
     * The name of the location where the bucket will be created.
     */
     ...
     * Specifies the metrics configurations for the Amazon S3 Express bucket.
     */
    get metricsConfigurations(): Array<cdk.IResolvable | CfnDirectoryBucket.MetricsConfigurationProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the metrics configurations for the Amazon S3 Express bucket.
     */
    set metricsConfigurations(value: Array<cdk.IResolvable | CfnDirectoryBucket.MetricsConfigurationProperty> | cdk.IResolvable | undefined);
    /**
     * An array of tags that you can apply to the S3 directory bucket.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrAvailabilityZoneName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnDirectoryBucketProps {
     ...
     */
    readonly metricsConfigurations?: Array<cdk.IResolvable | CfnDirectoryBucket.MetricsConfigurationProperty> | cdk.IResolvable;
    /**
     * An array of tags that you can apply to the S3 directory bucket.
     *
