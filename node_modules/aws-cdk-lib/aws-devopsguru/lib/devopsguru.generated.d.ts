...
import { ILogAnomalyDetectionIntegrationRef, INotificationChannelRef, IResourceCollectionRef, LogAnomalyDetectionIntegrationReference, NotificationChannelReference, ResourceCollectionReference } from "../../interfaces/generated/aws-devopsguru-interfaces.generated";
/**
...
export declare class CfnNotificationChannel extends cdk.CfnResource implements cdk.IInspectable, INotificationChannelRef {
     ...
     * A `NotificationChannelConfig` object that contains information about configured notification channels.
     */
    get config(): cdk.IResolvable | CfnNotificationChannel.NotificationChannelConfigProperty;
    /**
     * A `NotificationChannelConfig` object that contains information about configured notification channels.
     */
    set config(value: cdk.IResolvable | CfnNotificationChannel.NotificationChannelConfigProperty);
    /**
...
export declare class CfnResourceCollection extends cdk.CfnResource implements cdk.IInspectable, IResourceCollectionRef {
     ...
     * Information about a filter used to specify which AWS resources are analyzed for anomalous behavior by DevOps Guru.
     */
    get resourceCollectionFilter(): cdk.IResolvable | CfnResourceCollection.ResourceCollectionFilterProperty;
    /**
     * Information about a filter used to specify which AWS resources are analyzed for anomalous behavior by DevOps Guru.
     */
    set resourceCollectionFilter(value: cdk.IResolvable | CfnResourceCollection.ResourceCollectionFilterProperty);
    /**
     ...
     */
    get attrResourceCollectionType(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
