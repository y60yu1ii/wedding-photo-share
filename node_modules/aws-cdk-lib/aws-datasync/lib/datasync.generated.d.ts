...
export declare class CfnAgent extends cdk.CfnResource implements cdk.IInspectable, IAgentRef, cdk.ITaggable {
     ...
     * Specifies a name for your agent.
     */
    set agentName(value: string | undefined);
    /**
     * The Amazon Resource Names (ARNs) of the security groups used to protect your data transfer task subnets.
     */
    get securityGroupArns(): Array<string> | undefined;
    /**
     * The Amazon Resource Names (ARNs) of the security groups used to protect your data transfer task subnets.
     */
    set securityGroupArns(value: Array<string> | undefined);
    /**
     * Specifies the ARN of the subnet where your VPC service endpoint is located.
     */
    get subnetArns(): Array<string> | undefined;
    /**
     * Specifies the ARN of the subnet where your VPC service endpoint is located.
     */
    set subnetArns(value: Array<string> | undefined);
    /**
     * Specifies labels that help you categorize, filter, and search for your AWS resources.
     */
...
export declare class CfnLocationAzureBlob extends cdk.CfnResource implements cdk.IInspectable, ILocationAzureBlobRef, cdk.ITaggableV2 {
     ...
     * (Optional) Specifies the Amazon Resource Name (ARN) of the DataSync agent that can connect with your Azure Blob Storage container.
     */
    get agentArns(): Array<string> | undefined;
    /**
     * (Optional) Specifies the Amazon Resource Name (ARN) of the DataSync agent that can connect with your Azure Blob Storage container.
     */
    set agentArns(value: Array<string> | undefined);
    /**
     * Specifies the access tier that you want your objects or files transferred into.
     */
    get azureAccessTier(): string | undefined;
    /**
     * Specifies the access tier that you want your objects or files transferred into.
     */
    set azureAccessTier(value: string | undefined);
    /**
     * Specifies the authentication method DataSync uses to access your Azure Blob Storage.
     */
    get azureBlobAuthenticationType(): string;
    /**
     * Specifies the authentication method DataSync uses to access your Azure Blob Storage.
     */
    set azureBlobAuthenticationType(value: string);
    /**
     * Specifies the URL of the Azure Blob Storage container involved in your transfer.
     */
    get azureBlobContainerUrl(): string | undefined;
    /**
     * Specifies the URL of the Azure Blob Storage container involved in your transfer.
     */
    set azureBlobContainerUrl(value: string | undefined);
    /**
     * Specifies the SAS configuration that allows DataSync to access your Azure Blob Storage.
     */
    get azureBlobSasConfiguration(): CfnLocationAzureBlob.AzureBlobSasConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the SAS configuration that allows DataSync to access your Azure Blob Storage.
     */
    set azureBlobSasConfiguration(value: CfnLocationAzureBlob.AzureBlobSasConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the type of blob that you want your objects or files to be when transferring them into Azure Blob Storage.
     */
    get azureBlobType(): string | undefined;
    /**
     * Specifies the type of blob that you want your objects or files to be when transferring them into Azure Blob Storage.
     */
    set azureBlobType(value: string | undefined);
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token, secret key, password, or Kerberos keytab that DataSync uses to access a specific storage location, with a customer-managed AWS KMS key .
     */
    get cmkSecretConfig(): CfnLocationAzureBlob.CmkSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token, secret key, password, or Kerberos keytab that DataSync uses to access a specific storage location, with a customer-managed AWS KMS key .
     */
    set cmkSecretConfig(value: CfnLocationAzureBlob.CmkSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where a storage location credentials is stored in Secrets Manager as plain text (for authentication token, secret key, or password) or as binary (for Kerberos keytab).
     */
    get customSecretConfig(): CfnLocationAzureBlob.CustomSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where a storage location credentials is stored in Secrets Manager as plain text (for authentication token, secret key, or password) or as binary (for Kerberos keytab).
     */
    set customSecretConfig(value: CfnLocationAzureBlob.CustomSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies path segments if you want to limit your transfer to a virtual directory in your container (for example, `/my/images` ).
     */
...
export declare class CfnLocationEFS extends cdk.CfnResource implements cdk.IInspectable, ILocationEFSRef, cdk.ITaggable {
     ...
     * Specifies the subnet and security groups DataSync uses to connect to one of your Amazon EFS file system's [mount targets](https://docs.aws.amazon.com/efs/latest/ug/accessing-fs.html) .
     */
    get ec2Config(): CfnLocationEFS.Ec2ConfigProperty | cdk.IResolvable;
    /**
     * Specifies the subnet and security groups DataSync uses to connect to one of your Amazon EFS file system's [mount targets](https://docs.aws.amazon.com/efs/latest/ug/accessing-fs.html) .
     */
    set ec2Config(value: CfnLocationEFS.Ec2ConfigProperty | cdk.IResolvable);
    /**
     * Specifies the ARN for your Amazon EFS file system.
     */
    get efsFilesystemArn(): string | undefined;
    /**
     * Specifies the ARN for your Amazon EFS file system.
     */
...
export declare class CfnLocationFSxLustre extends cdk.CfnResource implements cdk.IInspectable, ILocationFSxLustreRef, cdk.ITaggable {
     ...
     * The ARNs of the security groups that are used to configure the FSx for Lustre file system.
     */
    get securityGroupArns(): Array<string>;
    /**
     * The ARNs of the security groups that are used to configure the FSx for Lustre file system.
     */
    set securityGroupArns(value: Array<string>);
    /**
     * Specifies a mount path for your FSx for Lustre file system. The path can include subdirectories.
     */
    get subdirectory(): string | undefined;
...
export declare class CfnLocationFSxONTAP extends cdk.CfnResource implements cdk.IInspectable, ILocationFSxONTAPRef, cdk.ITaggable {
     ...
     * Specifies the data transfer protocol that DataSync uses to access your Amazon FSx file system.
     */
    get protocol(): cdk.IResolvable | CfnLocationFSxONTAP.ProtocolProperty | undefined;
    /**
     * Specifies the data transfer protocol that DataSync uses to access your Amazon FSx file system.
     */
    set protocol(value: cdk.IResolvable | CfnLocationFSxONTAP.ProtocolProperty | undefined);
    /**
     * Specifies the Amazon Resource Names (ARNs) of the security groups that DataSync can use to access your FSx for ONTAP file system.
     */
    get securityGroupArns(): Array<string>;
...
export declare class CfnLocationFSxOpenZFS extends cdk.CfnResource implements cdk.IInspectable, ILocationFSxOpenZFSRef, cdk.ITaggable {
     ...
     * The type of protocol that AWS DataSync uses to access your file system.
     */
    get protocol(): cdk.IResolvable | CfnLocationFSxOpenZFS.ProtocolProperty;
    /**
     * The type of protocol that AWS DataSync uses to access your file system.
     */
    set protocol(value: cdk.IResolvable | CfnLocationFSxOpenZFS.ProtocolProperty);
    /**
     * The ARNs of the security groups that are used to configure the FSx for OpenZFS file system.
     */
    get securityGroupArns(): Array<string>;
...
export declare class CfnLocationFSxWindows extends cdk.CfnResource implements cdk.IInspectable, ILocationFSxWindowsRef, cdk.ITaggable {
     ...
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and a customer-managed AWS KMS key.
     */
    get cmkSecretConfig(): CfnLocationFSxWindows.CmkSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and a customer-managed AWS KMS key.
     */
    set cmkSecretConfig(value: CfnLocationFSxWindows.CmkSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     */
    get customSecretConfig(): CfnLocationFSxWindows.CustomSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     */
    set customSecretConfig(value: CfnLocationFSxWindows.CustomSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the name of the Windows domain that the FSx for Windows File Server file system belongs to.
     */
...
export declare namespace CfnLocationFSxWindows {
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and a customer-managed AWS KMS key.
     *
     * @struct
...
export interface CfnLocationFSxWindowsProps {
     ...
     */
    readonly cmkSecretConfig?: CfnLocationFSxWindows.CmkSecretConfigProperty | cdk.IResolvable;
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     *
     ...
     */
    readonly customSecretConfig?: CfnLocationFSxWindows.CustomSecretConfigProperty | cdk.IResolvable;
    /**
     * Specifies the name of the Windows domain that the FSx for Windows File Server file system belongs to.
     *
...
export declare class CfnLocationHDFS extends cdk.CfnResource implements cdk.IInspectable, ILocationHDFSRef, cdk.ITaggable {
     ...
     * The Amazon Resource Names (ARNs) of the DataSync agents that can connect to your HDFS cluster.
     */
    get agentArns(): Array<string>;
    /**
     * The Amazon Resource Names (ARNs) of the DataSync agents that can connect to your HDFS cluster.
     */
    set agentArns(value: Array<string>);
    /**
     * The authentication mode used to determine identity of user.
     */
     ...
     * The size of data blocks to write into the HDFS cluster.
     */
    set blockSize(value: number | undefined);
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and a customer-managed AWS KMS key.
     */
    get cmkSecretConfig(): CfnLocationHDFS.CmkSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and a customer-managed AWS KMS key.
     */
    set cmkSecretConfig(value: CfnLocationHDFS.CmkSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     */
    get customSecretConfig(): CfnLocationHDFS.CustomSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     */
    set customSecretConfig(value: CfnLocationHDFS.CustomSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys.
     */
    get kerberosKeytab(): string | undefined;
    /**
     * The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys.
     */
    set kerberosKeytab(value: string | undefined);
    /**
     * The `krb5.conf` file that contains the Kerberos configuration information. You can load the `krb5.conf` by providing a string of the file's contents or an Amazon S3 presigned URL of the file. If `KERBEROS` is specified for `AuthType` , this value is required.
     */
    get kerberosKrb5Conf(): string | undefined;
    /**
     * The `krb5.conf` file that contains the Kerberos configuration information. You can load the `krb5.conf` by providing a string of the file's contents or an Amazon S3 presigned URL of the file. If `KERBEROS` is specified for `AuthType` , this value is required.
     */
    set kerberosKrb5Conf(value: string | undefined);
    /**
     * The Kerberos principal with access to the files and folders on the HDFS cluster.
     */
    get kerberosPrincipal(): string | undefined;
    /**
     * The Kerberos principal with access to the files and folders on the HDFS cluster.
     */
    set kerberosPrincipal(value: string | undefined);
    /**
     * The URI of the HDFS cluster's Key Management Server (KMS).
     */
    get kmsKeyProviderUri(): string | undefined;
    /**
     * The URI of the HDFS cluster's Key Management Server (KMS).
     */
    set kmsKeyProviderUri(value: string | undefined);
    /**
     * The NameNode that manages the HDFS namespace.
     */
    get nameNodes(): Array<cdk.IResolvable | CfnLocationHDFS.NameNodeProperty> | cdk.IResolvable;
    /**
     * The NameNode that manages the HDFS namespace.
     */
    set nameNodes(value: Array<cdk.IResolvable | CfnLocationHDFS.NameNodeProperty> | cdk.IResolvable);
    /**
     * The Quality of Protection (QOP) configuration specifies the Remote Procedure Call (RPC) and data transfer protection settings configured on the Hadoop Distributed File System (HDFS) cluster.
     */
    get qopConfiguration(): cdk.IResolvable | CfnLocationHDFS.QopConfigurationProperty | undefined;
    /**
     * The Quality of Protection (QOP) configuration specifies the Remote Procedure Call (RPC) and data transfer protection settings configured on the Hadoop Distributed File System (HDFS) cluster.
     */
    set qopConfiguration(value: cdk.IResolvable | CfnLocationHDFS.QopConfigurationProperty | undefined);
    /**
     * The number of DataNodes to replicate the data to when writing to the HDFS cluster.
     */
    get replicationFactor(): number | undefined;
    /**
     * The number of DataNodes to replicate the data to when writing to the HDFS cluster.
     */
    set replicationFactor(value: number | undefined);
    /**
     * The user name used to identify the client on the host operating system.
     */
    get simpleUser(): string | undefined;
    /**
     * The user name used to identify the client on the host operating system.
     */
    set simpleUser(value: string | undefined);
    /**
     * A subdirectory in the HDFS cluster.
     */
    get subdirectory(): string | undefined;
...
export interface CfnLocationHDFSProps {
     ...
     */
    readonly cmkSecretConfig?: CfnLocationHDFS.CmkSecretConfigProperty | cdk.IResolvable;
    /**
     * Specifies configuration information for a customer-managed secret, such as an authentication token or set of credentials that DataSync uses to access a specific transfer location, and an IAM role that DataSync can assume and access the customer-managed secret.
     *
     ...
     */
    readonly customSecretConfig?: CfnLocationHDFS.CustomSecretConfigProperty | cdk.IResolvable;
    /**
     * The Kerberos key table (keytab) that contains mappings between the defined Kerberos principal and the encrypted keys.
     *
...
export declare class CfnLocationNFS extends cdk.CfnResource implements cdk.IInspectable, ILocationNFSRef, cdk.ITaggable {
     ...
     * Specifies the options that DataSync can use to mount your NFS file server.
     */
    get mountOptions(): cdk.IResolvable | CfnLocationNFS.MountOptionsProperty | undefined;
    /**
     * Specifies the options that DataSync can use to mount your NFS file server.
     */
    set mountOptions(value: cdk.IResolvable | CfnLocationNFS.MountOptionsProperty | undefined);
    /**
     * Specifies the Amazon Resource Name (ARN) of the DataSync agent that can connect to your NFS file server.
     */
    get onPremConfig(): cdk.IResolvable | CfnLocationNFS.OnPremConfigProperty;
    /**
     * Specifies the Amazon Resource Name (ARN) of the DataSync agent that can connect to your NFS file server.
     */
    set onPremConfig(value: cdk.IResolvable | CfnLocationNFS.OnPremConfigProperty);
    /**
     * Specifies the DNS name or IP address (IPv4 or IPv6) of the NFS file server that your DataSync agent connects to.
     */
    get serverHostname(): string | undefined;
    /**
     * Specifies the DNS name or IP address (IPv4 or IPv6) of the NFS file server that your DataSync agent connects to.
     */
    set serverHostname(value: string | undefined);
    /**
     * Specifies the export path in your NFS file server that you want DataSync to mount.
     */
    get subdirectory(): string | undefined;
...
export declare class CfnLocationObjectStorage extends cdk.CfnResource implements cdk.IInspectable, ILocationObjectStorageRef, cdk.ITaggable {
     ...
     * Specifies configuration information for a DataSync-managed secret, which includes the `SecretKey` that DataSync uses to access a specific object storage location, with a customer-managed AWS KMS key .
     */
    get cmkSecretConfig(): CfnLocationObjectStorage.CmkSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a DataSync-managed secret, which includes the `SecretKey` that DataSync uses to access a specific object storage location, with a customer-managed AWS KMS key .
     */
    set cmkSecretConfig(value: CfnLocationObjectStorage.CmkSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where the secret key for a specific object storage location is stored in plain text, in Secrets Manager.
     */
    get customSecretConfig(): CfnLocationObjectStorage.CustomSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where the secret key for a specific object storage location is stored in plain text, in Secrets Manager.
     */
    set customSecretConfig(value: CfnLocationObjectStorage.CustomSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the secret key (for example, a password) if credentials are required to authenticate with the object storage server.
     */
     ...
     * Specifies a certificate chain for DataSync to authenticate with your object storage system if the system uses a private or self-signed certificate authority (CA).
     */
    get serverCertificate(): string | undefined;
    /**
     * Specifies a certificate chain for DataSync to authenticate with your object storage system if the system uses a private or self-signed certificate authority (CA).
     */
    set serverCertificate(value: string | undefined);
    /**
     * Specifies the domain name or IP address (IPv4 or IPv6) of the object storage server that your DataSync agent connects to.
     */
    get serverHostname(): string | undefined;
     ...
     * Specifies the port that your object storage server accepts inbound network traffic on (for example, port 443).
     */
    set serverPort(value: number | undefined);
    /**
     * Specifies the protocol that your object storage server uses to communicate.
     */
     ...
     * Specifies the protocol that your object storage server uses to communicate.
     */
    set serverProtocol(value: string | undefined);
    /**
     * Specifies the object prefix for your object storage server.
     */
    get subdirectory(): string | undefined;
...
export declare class CfnLocationS3 extends cdk.CfnResource implements cdk.IInspectable, ILocationS3Ref, cdk.ITaggable {
     ...
     * The ARN of the Amazon S3 bucket.
     */
    get s3BucketArn(): string | undefined;
    /**
     * The ARN of the Amazon S3 bucket.
     */
    set s3BucketArn(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that is used to access an Amazon S3 bucket.
     */
    get s3Config(): cdk.IResolvable | CfnLocationS3.S3ConfigProperty;
    /**
     * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that is used to access an Amazon S3 bucket.
     */
    set s3Config(value: cdk.IResolvable | CfnLocationS3.S3ConfigProperty);
    /**
     * The Amazon S3 storage class that you want to store your files in when this location is used as a task destination.
     */
    get s3StorageClass(): string | undefined;
    /**
     * The Amazon S3 storage class that you want to store your files in when this location is used as a task destination.
     */
    set s3StorageClass(value: string | undefined);
    /**
     * Specifies a prefix in the S3 bucket that DataSync reads from or writes to (depending on whether the bucket is a source or destination location).
     */
    get subdirectory(): string | undefined;
...
export interface CfnLocationS3Props {
     ...
     */
    readonly s3BucketArn?: s3Refs.IBucketRef | string;
    /**
     * The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that is used to access an Amazon S3 bucket.
     *
...
export declare class CfnLocationSMB extends cdk.CfnResource implements cdk.IInspectable, ILocationSMBRef, cdk.ITaggable {
     ...
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token, secret key, password, or Kerberos keytab that DataSync uses to access a specific storage location, with a customer-managed AWS KMS key .
     */
    get cmkSecretConfig(): CfnLocationSMB.CmkSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a DataSync-managed secret, such as an authentication token, secret key, password, or Kerberos keytab that DataSync uses to access a specific storage location, with a customer-managed AWS KMS key .
     */
    set cmkSecretConfig(value: CfnLocationSMB.CmkSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where a storage location credentials is stored in Secrets Manager as plain text (for authentication token, secret key, or password) or as binary (for Kerberos keytab).
     */
    get customSecretConfig(): CfnLocationSMB.CustomSecretConfigProperty | cdk.IResolvable | undefined;
    /**
     * Specifies configuration information for a customer-managed Secrets Manager secret where a storage location credentials is stored in Secrets Manager as plain text (for authentication token, secret key, or password) or as binary (for Kerberos keytab).
     */
    set customSecretConfig(value: CfnLocationSMB.CustomSecretConfigProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the IPv4 addresses for the DNS servers that your SMB file server belongs to.
     */
    get dnsIpAddresses(): Array<string> | undefined;
    /**
     * Specifies the IPv4 addresses for the DNS servers that your SMB file server belongs to.
     */
    set dnsIpAddresses(value: Array<string> | undefined);
    /**
     * Specifies the Windows domain name that your SMB file server belongs to.
     */
    get domain(): string | undefined;
     ...
     * Specifies the version of the SMB protocol that DataSync uses to access your SMB file server.
     */
    get mountOptions(): cdk.IResolvable | CfnLocationSMB.MountOptionsProperty | undefined;
    /**
     * Specifies the version of the SMB protocol that DataSync uses to access your SMB file server.
     */
    set mountOptions(value: cdk.IResolvable | CfnLocationSMB.MountOptionsProperty | undefined);
    /**
     * Specifies the password of the user who can mount your SMB file server and has permission to access the files and folders involved in your transfer.
     */
    get password(): string | undefined;
...
export declare class CfnTask extends cdk.CfnResource implements cdk.IInspectable, ITaskRef, cdk.ITaggable {
     ...
     * Specifies exclude filters that define the files, objects, and folders in your source location that you don't want DataSync to transfer.
     */
    get excludes(): Array<CfnTask.FilterRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies exclude filters that define the files, objects, and folders in your source location that you don't want DataSync to transfer.
     */
    set excludes(value: Array<CfnTask.FilterRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies include filters that define the files, objects, and folders in your source location that you want DataSync to transfer.
     */
    get includes(): Array<CfnTask.FilterRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies include filters that define the files, objects, and folders in your source location that you want DataSync to transfer.
     */
    set includes(value: Array<CfnTask.FilterRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The configuration of the manifest that lists the files or objects that you want DataSync to transfer.
     */
    get manifestConfig(): cdk.IResolvable | CfnTask.ManifestConfigProperty | undefined;
    /**
     * The configuration of the manifest that lists the files or objects that you want DataSync to transfer.
     */
    set manifestConfig(value: cdk.IResolvable | CfnTask.ManifestConfigProperty | undefined);
    /**
     * Specifies the name of your task.
     */
     ...
     * Specifies your task's settings, such as preserving file metadata, verifying data integrity, among other options.
     */
    get options(): cdk.IResolvable | CfnTask.OptionsProperty | undefined;
    /**
     * Specifies your task's settings, such as preserving file metadata, verifying data integrity, among other options.
     */
    set options(value: cdk.IResolvable | CfnTask.OptionsProperty | undefined);
    /**
     * Specifies a schedule for when you want your task to run.
     */
    get schedule(): cdk.IResolvable | CfnTask.TaskScheduleProperty | undefined;
    /**
     * Specifies a schedule for when you want your task to run.
     */
    set schedule(value: cdk.IResolvable | CfnTask.TaskScheduleProperty | undefined);
    /**
     * Specifies the ARN of your transfer's source location.
     */
     ...
     * The task mode that you're using.
     */
    set taskMode(value: string | undefined);
    /**
     * The configuration of your task report, which provides detailed information about your DataSync transfer.
     */
    get taskReportConfig(): cdk.IResolvable | CfnTask.TaskReportConfigProperty | undefined;
    /**
     * The configuration of your task report, which provides detailed information about your DataSync transfer.
     */
    set taskReportConfig(value: cdk.IResolvable | CfnTask.TaskReportConfigProperty | undefined);
    /**
     * The ARNs of the destination elastic network interfaces (ENIs) that were created for your subnet.
     *
     * @cloudformationAttribute DestinationNetworkInterfaceArns
     */
    get attrDestinationNetworkInterfaceArns(): Array<string>;
    /**
     * The ARNs of the source ENIs that were created for your subnet.
     *
     * @cloudformationAttribute SourceNetworkInterfaceArns
     */
    get attrSourceNetworkInterfaceArns(): Array<string>;
    /**
...
export interface CfnTaskProps {
     ...
     */
    readonly cloudWatchLogGroupArn?: logsRefs.ILogGroupRef | string;
    /**
     * The Amazon Resource Name (ARN) of an AWS storage resource's location.
     *
     ...
     */
    readonly destinationLocationArn: dataSyncRefs.ILocationEFSRef | dataSyncRefs.ILocationS3Ref | string;
    /**
     * Specifies exclude filters that define the files, objects, and folders in your source location that you don't want DataSync to transfer.
     *
     ...
     */
    readonly sourceLocationArn: dataSyncRefs.ILocationNFSRef | dataSyncRefs.ILocationS3Ref | string;
    /**
     * Specifies the tags that you want to apply to your task.
     *
