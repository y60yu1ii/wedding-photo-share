...
import { ByteMatchSetReference, GeoMatchSetReference, IByteMatchSetRef, IGeoMatchSetRef, IIPSetRef, IPSetReference, IRateBasedRuleRef, IRegexPatternSetRef, IRuleRef, ISizeConstraintSetRef, ISqlInjectionMatchSetRef, IWebACLAssociationRef, IWebACLRef, IXssMatchSetRef, RateBasedRuleReference, RegexPatternSetReference, RuleReference, SizeConstraintSetReference, SqlInjectionMatchSetReference, WebACLAssociationReference, WebACLReference, XssMatchSetReference } from "../../interfaces/generated/aws-wafregional-interfaces.generated";
/**
...
export declare class CfnByteMatchSet extends cdk.CfnResource implements cdk.IInspectable, IByteMatchSetRef {
     ...
     * Specifies the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests, the location in requests that you want AWS WAF to search, and other settings.
     */
    get byteMatchTuples(): Array<CfnByteMatchSet.ByteMatchTupleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests, the location in requests that you want AWS WAF to search, and other settings.
     */
    set byteMatchTuples(value: Array<CfnByteMatchSet.ByteMatchTupleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A friendly name or description of the `ByteMatchSet` .
     */
    get name(): string;
...
export declare class CfnGeoMatchSet extends cdk.CfnResource implements cdk.IInspectable, IGeoMatchSetRef {
     ...
     * An array of `GeoMatchConstraint` objects, which contain the country that you want AWS WAF to search for.
     */
    get geoMatchConstraints(): Array<CfnGeoMatchSet.GeoMatchConstraintProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An array of `GeoMatchConstraint` objects, which contain the country that you want AWS WAF to search for.
     */
    set geoMatchConstraints(value: Array<CfnGeoMatchSet.GeoMatchConstraintProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A friendly name or description of the `GeoMatchSet` .
     */
    get name(): string;
...
export declare class CfnIPSet extends cdk.CfnResource implements cdk.IInspectable, IIPSetRef {
     ...
     * The IP address type ( `IPV4` or `IPV6` ) and the IP address range (in CIDR notation) that web requests originate from.
     */
    get ipSetDescriptors(): Array<CfnIPSet.IPSetDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The IP address type ( `IPV4` or `IPV6` ) and the IP address range (in CIDR notation) that web requests originate from.
     */
    set ipSetDescriptors(value: Array<CfnIPSet.IPSetDescriptorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A friendly name or description of the `IPSet` .
     */
    get name(): string;
...
export declare class CfnRateBasedRule extends cdk.CfnResource implements cdk.IInspectable, IRateBasedRuleRef {
     ...
     * The `Predicates` object contains one `Predicate` element for each `ByteMatchSet` , `IPSet` , or `SqlInjectionMatchSet>` object that you want to include in a `RateBasedRule` .
     */
    get matchPredicates(): Array<cdk.IResolvable | CfnRateBasedRule.PredicateProperty> | cdk.IResolvable | undefined;
    /**
     * The `Predicates` object contains one `Predicate` element for each `ByteMatchSet` , `IPSet` , or `SqlInjectionMatchSet>` object that you want to include in a `RateBasedRule` .
     */
    set matchPredicates(value: Array<cdk.IResolvable | CfnRateBasedRule.PredicateProperty> | cdk.IResolvable | undefined);
    /**
     * A name for the metrics for a `RateBasedRule` .
     */
...
export declare class CfnRegexPatternSet extends cdk.CfnResource implements cdk.IInspectable, IRegexPatternSetRef {
     ...
     * Specifies the regular expression (regex) patterns that you want AWS WAF to search for, such as `B[a@]dB[o0]t` .
     */
    get regexPatternStrings(): Array<string>;
    /**
     * Specifies the regular expression (regex) patterns that you want AWS WAF to search for, such as `B[a@]dB[o0]t` .
     */
    set regexPatternStrings(value: Array<string>);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnRule extends cdk.CfnResource implements cdk.IInspectable, IRuleRef {
     ...
     * The `Predicates` object contains one `Predicate` element for each `ByteMatchSet` , `IPSet` , or `SqlInjectionMatchSet` object that you want to include in a `Rule` .
     */
    get predicates(): Array<cdk.IResolvable | CfnRule.PredicateProperty> | cdk.IResolvable | undefined;
    /**
     * The `Predicates` object contains one `Predicate` element for each `ByteMatchSet` , `IPSet` , or `SqlInjectionMatchSet` object that you want to include in a `Rule` .
     */
    set predicates(value: Array<cdk.IResolvable | CfnRule.PredicateProperty> | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnSizeConstraintSet extends cdk.CfnResource implements cdk.IInspectable, ISizeConstraintSetRef {
     ...
     * The size constraint and the part of the web request to check.
     */
    get sizeConstraints(): Array<cdk.IResolvable | CfnSizeConstraintSet.SizeConstraintProperty> | cdk.IResolvable | undefined;
    /**
     * The size constraint and the part of the web request to check.
     */
    set sizeConstraints(value: Array<cdk.IResolvable | CfnSizeConstraintSet.SizeConstraintProperty> | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnSqlInjectionMatchSet extends cdk.CfnResource implements cdk.IInspectable, ISqlInjectionMatchSetRef {
     ...
     * Specifies the parts of web requests that you want to inspect for snippets of malicious SQL code.
     */
    get sqlInjectionMatchTuples(): Array<cdk.IResolvable | CfnSqlInjectionMatchSet.SqlInjectionMatchTupleProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the parts of web requests that you want to inspect for snippets of malicious SQL code.
     */
    set sqlInjectionMatchTuples(value: Array<cdk.IResolvable | CfnSqlInjectionMatchSet.SqlInjectionMatchTupleProperty> | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnWebACL extends cdk.CfnResource implements cdk.IInspectable, IWebACLRef {
     ...
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    get defaultAction(): CfnWebACL.ActionProperty | cdk.IResolvable;
    /**
     * The action to perform if none of the `Rules` contained in the `WebACL` match.
     */
    set defaultAction(value: CfnWebACL.ActionProperty | cdk.IResolvable);
    /**
     * A name for the metrics for this `WebACL` .
     */
    get metricName(): string;
...
export declare class CfnXssMatchSet extends cdk.CfnResource implements cdk.IInspectable, IXssMatchSetRef {
     ...
     * Specifies the parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    get xssMatchTuples(): Array<cdk.IResolvable | CfnXssMatchSet.XssMatchTupleProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies the parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    set xssMatchTuples(value: Array<cdk.IResolvable | CfnXssMatchSet.XssMatchTupleProperty> | cdk.IResolvable | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
