...
import { ILedgerRef, IStreamRef, LedgerReference, StreamReference } from "../../interfaces/generated/aws-qldb-interfaces.generated";
...
export declare class CfnStream extends cdk.CfnResource implements cdk.IInspectable, IStreamRef, cdk.ITaggable {
     ...
     * The exclusive date and time that specifies when the stream ends.
     */
    get exclusiveEndTime(): string | undefined;
    /**
     * The exclusive date and time that specifies when the stream ends.
     */
    set exclusiveEndTime(value: string | undefined);
    /**
     * The inclusive start date and time from which to start streaming journal data.
     */
     ...
     * The configuration settings of the Kinesis Data Streams destination for your stream request.
     */
    get kinesisConfiguration(): cdk.IResolvable | CfnStream.KinesisConfigurationProperty;
    /**
     * The configuration settings of the Kinesis Data Streams destination for your stream request.
     */
    set kinesisConfiguration(value: cdk.IResolvable | CfnStream.KinesisConfigurationProperty);
    /**
     * The name of the ledger.
     */
