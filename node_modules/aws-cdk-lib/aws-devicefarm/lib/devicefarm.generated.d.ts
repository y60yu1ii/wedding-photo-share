...
import { DevicePoolReference, IDevicePoolRef, IInstanceProfileRef, INetworkProfileRef, InstanceProfileReference, IProjectRef, ITestGridProjectRef, IVPCEConfigurationRef, NetworkProfileReference, ProjectReference, TestGridProjectReference, VPCEConfigurationReference } from "../../interfaces/generated/aws-devicefarm-interfaces.generated";
/**
...
export declare class CfnDevicePool extends cdk.CfnResource implements cdk.IInspectable, IDevicePoolRef, cdk.ITaggable {
     ...
     * The number of devices that Device Farm can add to your device pool.
     */
    get maxDevices(): number | undefined;
    /**
     * The number of devices that Device Farm can add to your device pool.
     */
    set maxDevices(value: number | undefined);
    /**
     * The device pool's name.
     */
    get name(): string;
     ...
     * The device pool's rules.
     */
    get rules(): Array<cdk.IResolvable | CfnDevicePool.RuleProperty> | cdk.IResolvable;
    /**
     * The device pool's rules.
     */
    set rules(value: Array<cdk.IResolvable | CfnDevicePool.RuleProperty> | cdk.IResolvable);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare class CfnInstanceProfile extends cdk.CfnResource implements cdk.IInspectable, IInstanceProfileRef, cdk.ITaggable {
     ...
     * An array of strings containing the list of app packages that should not be cleaned up from the device after a test run completes.
     */
    get excludeAppPackagesFromCleanup(): Array<string> | undefined;
    /**
     * An array of strings containing the list of app packages that should not be cleaned up from the device after a test run completes.
     */
    set excludeAppPackagesFromCleanup(value: Array<string> | undefined);
    /**
     * The name of the instance profile.
     */
    get name(): string;
     ...
     * When set to `true` , Device Farm removes app packages after a test run.
     */
    get packageCleanup(): boolean | cdk.IResolvable | undefined;
    /**
     * When set to `true` , Device Farm removes app packages after a test run.
     */
    set packageCleanup(value: boolean | cdk.IResolvable | undefined);
    /**
     * When set to `true` , Device Farm reboots the instance after a test run.
     */
    get rebootAfterUse(): boolean | cdk.IResolvable | undefined;
    /**
     * When set to `true` , Device Farm reboots the instance after a test run.
     */
    set rebootAfterUse(value: boolean | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnNetworkProfile extends cdk.CfnResource implements cdk.IInspectable, INetworkProfileRef, cdk.ITaggable {
     ...
     * The data throughput rate in bits per second, as an integer from 0 to 104857600.
     */
    get downlinkBandwidthBits(): number | undefined;
    /**
     * The data throughput rate in bits per second, as an integer from 0 to 104857600.
     */
    set downlinkBandwidthBits(value: number | undefined);
    /**
     * Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
     */
    get downlinkDelayMs(): number | undefined;
    /**
     * Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
     */
    set downlinkDelayMs(value: number | undefined);
    /**
     * Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
     */
    get downlinkJitterMs(): number | undefined;
    /**
     * Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
     */
    set downlinkJitterMs(value: number | undefined);
    /**
     * Proportion of received packets that fail to arrive from 0 to 100 percent.
     */
    get downlinkLossPercent(): number | undefined;
    /**
     * Proportion of received packets that fail to arrive from 0 to 100 percent.
     */
    set downlinkLossPercent(value: number | undefined);
    /**
     * The name of the network profile.
     */
    get name(): string;
     ...
     * The data throughput rate in bits per second, as an integer from 0 to 104857600.
     */
    get uplinkBandwidthBits(): number | undefined;
    /**
     * The data throughput rate in bits per second, as an integer from 0 to 104857600.
     */
    set uplinkBandwidthBits(value: number | undefined);
    /**
     * Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
     */
    get uplinkDelayMs(): number | undefined;
    /**
     * Delay time for all packets to destination in milliseconds as an integer from 0 to 2000.
     */
    set uplinkDelayMs(value: number | undefined);
    /**
     * Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
     */
    get uplinkJitterMs(): number | undefined;
    /**
     * Time variation in the delay of received packets in milliseconds as an integer from 0 to 2000.
     */
    set uplinkJitterMs(value: number | undefined);
    /**
     * Proportion of transmitted packets that fail to arrive from 0 to 100 percent.
     */
    get uplinkLossPercent(): number | undefined;
    /**
     * Proportion of transmitted packets that fail to arrive from 0 to 100 percent.
     */
    set uplinkLossPercent(value: number | undefined);
    /**
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef, cdk.ITaggable {
     ...
     * Sets the execution timeout value (in minutes) for a project.
     */
    get defaultJobTimeoutMinutes(): number | undefined;
    /**
     * Sets the execution timeout value (in minutes) for a project.
     */
    set defaultJobTimeoutMinutes(value: number | undefined);
    get environmentVariables(): Array<CfnProject.EnvironmentVariableProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    set environmentVariables(value: Array<CfnProject.EnvironmentVariableProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
...
export declare class CfnTestGridProject extends cdk.CfnResource implements cdk.IInspectable, ITestGridProjectRef, cdk.ITaggable {
     ...
     * The VPC security groups and subnets that are attached to a project.
     */
    get vpcConfig(): cdk.IResolvable | CfnTestGridProject.VpcConfigProperty | undefined;
    /**
     * The VPC security groups and subnets that are attached to a project.
     */
    set vpcConfig(value: cdk.IResolvable | CfnTestGridProject.VpcConfigProperty | undefined);
    /**
...
export declare class CfnVPCEConfiguration extends cdk.CfnResource implements cdk.IInspectable, IVPCEConfigurationRef, cdk.ITaggable {
     ...
     * The DNS name that Device Farm will use to map to the private service you want to access.
     */
    get serviceDnsName(): string;
    /**
     * The DNS name that Device Farm will use to map to the private service you want to access.
     */
    set serviceDnsName(value: string);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * An optional description that provides details about your VPC endpoint configuration.
     */
    get vpceConfigurationDescription(): string | undefined;
    /**
     * An optional description that provides details about your VPC endpoint configuration.
     */
    set vpceConfigurationDescription(value: string | undefined);
    /**
     * The friendly name you give to your VPC endpoint configuration to manage your configurations more easily.
     */
    get vpceConfigurationName(): string;
    /**
     * The friendly name you give to your VPC endpoint configuration to manage your configurations more easily.
     */
    set vpceConfigurationName(value: string);
    /**
     * The name of the VPC endpoint service that you want to access from Device Farm.
     */
    get vpceServiceName(): string;
    /**
     * The name of the VPC endpoint service that you want to access from Device Farm.
     */
    set vpceServiceName(value: string);
    /**
