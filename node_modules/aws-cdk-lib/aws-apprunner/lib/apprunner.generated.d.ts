...
import { AutoScalingConfigurationReference, IAutoScalingConfigurationRef, IObservabilityConfigurationRef, IServiceRef, IVpcConnectorRef, IVpcIngressConnectionRef, ObservabilityConfigurationReference, ServiceReference, VpcConnectorReference, VpcIngressConnectionReference } from "../../interfaces/generated/aws-apprunner-interfaces.generated";
...
export declare class CfnAutoScalingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IAutoScalingConfigurationRef, cdk.ITaggableV2 {
     ...
     * The customer-provided auto scaling configuration name.
     */
    get autoScalingConfigurationName(): string | undefined;
    /**
     * The customer-provided auto scaling configuration name.
     */
    set autoScalingConfigurationName(value: string | undefined);
    /**
     * The maximum number of concurrent requests that an instance processes.
     */
     ...
     */
    get attrAutoScalingConfigurationArn(): string;
    /**
...
export declare class CfnObservabilityConfiguration extends cdk.CfnResource implements cdk.IInspectable, IObservabilityConfigurationRef, cdk.ITaggable {
     ...
     * A name for the observability configuration.
     */
    get observabilityConfigurationName(): string | undefined;
    /**
     * A name for the observability configuration.
     */
    set observabilityConfigurationName(value: string | undefined);
    /**
     * A list of metadata items that you can associate with your observability configuration resource.
     */
     ...
     * The configuration of the tracing feature within this observability configuration.
     */
    get traceConfiguration(): cdk.IResolvable | CfnObservabilityConfiguration.TraceConfigurationProperty | undefined;
    /**
     * The configuration of the tracing feature within this observability configuration.
     */
    set traceConfiguration(value: cdk.IResolvable | CfnObservabilityConfiguration.TraceConfigurationProperty | undefined);
    /**
     ...
     */
    get attrObservabilityConfigurationArn(): string;
    /**
     * The revision of this observability configuration. It's unique among all the active configurations ( `"Status": "ACTIVE"` ) that share the same `ObservabilityConfigurationName` .
     *
     * @cloudformationAttribute ObservabilityConfigurationRevision
     */
    get attrObservabilityConfigurationRevision(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnService extends cdk.CfnResource implements cdk.IInspectable, IServiceRef, cdk.ITaggable {
     ...
     * The Amazon Resource Name (ARN) of an App Runner automatic scaling configuration resource that you want to associate with your service.
     */
    get autoScalingConfigurationArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of an App Runner automatic scaling configuration resource that you want to associate with your service.
     */
    set autoScalingConfigurationArn(value: string | undefined);
    /**
     * An optional custom encryption key that App Runner uses to encrypt the copy of your source repository that it maintains and your service logs.
     */
    get encryptionConfiguration(): CfnService.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * An optional custom encryption key that App Runner uses to encrypt the copy of your source repository that it maintains and your service logs.
     */
    set encryptionConfiguration(value: CfnService.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The settings for the health check that AWS App Runner performs to monitor the health of the App Runner service.
     */
    get healthCheckConfiguration(): CfnService.HealthCheckConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The settings for the health check that AWS App Runner performs to monitor the health of the App Runner service.
     */
    set healthCheckConfiguration(value: CfnService.HealthCheckConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The runtime configuration of instances (scaling units) of your service.
     */
    get instanceConfiguration(): CfnService.InstanceConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The runtime configuration of instances (scaling units) of your service.
     */
    set instanceConfiguration(value: CfnService.InstanceConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Configuration settings related to network traffic of the web application that the App Runner service runs.
     */
     ...
     * The observability configuration of your service.
     */
    get observabilityConfiguration(): cdk.IResolvable | CfnService.ServiceObservabilityConfigurationProperty | undefined;
    /**
     * The observability configuration of your service.
     */
    set observabilityConfiguration(value: cdk.IResolvable | CfnService.ServiceObservabilityConfigurationProperty | undefined);
    /**
     * A name for the App Runner service.
     */
     ...
     * The source to deploy to the App Runner service.
     */
    get sourceConfiguration(): cdk.IResolvable | CfnService.SourceConfigurationProperty;
    /**
     * The source to deploy to the App Runner service.
     */
    set sourceConfiguration(value: cdk.IResolvable | CfnService.SourceConfigurationProperty);
    /**
     * An optional list of metadata items that you can associate with the App Runner service resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnVpcConnector extends cdk.CfnResource implements cdk.IInspectable, IVpcConnectorRef, cdk.ITaggable {
     ...
     * A name for the VPC connector.
     */
    get vpcConnectorName(): string | undefined;
    /**
     * A name for the VPC connector.
     */
    set vpcConnectorName(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of this VPC connector.
     *
     * @cloudformationAttribute VpcConnectorArn
     */
    get attrVpcConnectorArn(): string;
    /**
     ...
     */
    get attrVpcConnectorRevision(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnVpcIngressConnection extends cdk.CfnResource implements cdk.IInspectable, IVpcIngressConnectionRef, cdk.ITaggable {
     ...
     */
    private _vpcIngressConnectionName?;
    /**
     ...
     * Specifications for the customer’s Amazon VPC and the related AWS PrivateLink VPC endpoint that are used to create the VPC Ingress Connection resource.
     */
    get ingressVpcConfiguration(): CfnVpcIngressConnection.IngressVpcConfigurationProperty | cdk.IResolvable;
    /**
     * Specifications for the customer’s Amazon VPC and the related AWS PrivateLink VPC endpoint that are used to create the VPC Ingress Connection resource.
     */
    set ingressVpcConfiguration(value: CfnVpcIngressConnection.IngressVpcConfigurationProperty | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) for this App Runner service that is used to create the VPC Ingress Connection resource.
     */
     ...
     * The customer-provided VPC Ingress Connection name.
     */
    get vpcIngressConnectionName(): string | undefined;
    /**
     * The customer-provided VPC Ingress Connection name.
     */
    set vpcIngressConnectionName(value: string | undefined);
    /**
     ...
     */
    get attrVpcIngressConnectionArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
