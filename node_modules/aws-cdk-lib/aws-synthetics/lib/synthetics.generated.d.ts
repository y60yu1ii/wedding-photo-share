...
import { CanaryReference, GroupReference, ICanaryRef, IGroupRef } from "../../interfaces/generated/aws-synthetics-interfaces.generated";
/**
...
export declare class CfnCanary extends cdk.CfnResource implements cdk.IInspectable, ICanaryRef, cdk.ITaggable {
     ...
     */
    private _deleteLambdaResourcesOnCanaryDeletion?;
    /**
     * Specifies whether to perform a dry run before updating the canary.
     */
    private _dryRunAndUpdate?;
    /**
     ...
     */
    private _provisionedResourceCleanup?;
    /**
     ...
     */
    private _resourcesToReplicateTags?;
    /**
     ...
     */
    private _startCanaryAfterCreation?;
    /**
     ...
     * A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
     */
    get artifactConfig(): CfnCanary.ArtifactConfigProperty | cdk.IResolvable | undefined;
    /**
     * A structure that contains the configuration for canary artifacts, including the encryption-at-rest settings for artifacts that the canary uploads to Amazon S3.
     */
    set artifactConfig(value: CfnCanary.ArtifactConfigProperty | cdk.IResolvable | undefined);
    /**
     * The location in Amazon S3 where Synthetics stores artifacts from the runs of this canary.
     */
     ...
     * A structure that specifies the browser type to use for a canary run.
     */
    get browserConfigs(): Array<CfnCanary.BrowserConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A structure that specifies the browser type to use for a canary run.
     */
    set browserConfigs(value: Array<CfnCanary.BrowserConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Use this structure to input your script code for the canary.
     */
    get code(): CfnCanary.CodeProperty | cdk.IResolvable;
    /**
     * Use this structure to input your script code for the canary.
     */
    set code(value: CfnCanary.CodeProperty | cdk.IResolvable);
    /**
     * Deletes associated lambda resources created by Synthetics if set to True.
     *
     * @deprecated this property has been deprecated
     */
    get deleteLambdaResourcesOnCanaryDeletion(): boolean | cdk.IResolvable | undefined;
    /**
     * Deletes associated lambda resources created by Synthetics if set to True.
     *
     * @deprecated this property has been deprecated
     */
    set deleteLambdaResourcesOnCanaryDeletion(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether to perform a dry run before updating the canary.
     */
    get dryRunAndUpdate(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether to perform a dry run before updating the canary.
     */
    set dryRunAndUpdate(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARN of the IAM role to be used to run the canary.
     */
     ...
     * The number of days to retain data about failed runs of this canary.
     */
    get failureRetentionPeriod(): number | undefined;
    /**
     * The number of days to retain data about failed runs of this canary.
     */
    set failureRetentionPeriod(value: number | undefined);
    /**
     * The name for this canary.
     */
    get name(): string;
     ...
     * Specifies whether to also delete the Lambda functions and layers used by this canary when the canary is deleted.
     */
    get provisionedResourceCleanup(): string | undefined;
    /**
     * Specifies whether to also delete the Lambda functions and layers used by this canary when the canary is deleted.
     */
    set provisionedResourceCleanup(value: string | undefined);
    /**
     * To have the tags that you apply to this canary also be applied to the Lambda function that the canary uses, specify this property with the value `lambda-function` .
     */
    get resourcesToReplicateTags(): Array<string> | undefined;
    /**
     * To have the tags that you apply to this canary also be applied to the Lambda function that the canary uses, specify this property with the value `lambda-function` .
     */
    set resourcesToReplicateTags(value: Array<string> | undefined);
    /**
     * A structure that contains input information for a canary run.
     */
    get runConfig(): cdk.IResolvable | CfnCanary.RunConfigProperty | undefined;
    /**
     * A structure that contains input information for a canary run.
     */
    set runConfig(value: cdk.IResolvable | CfnCanary.RunConfigProperty | undefined);
    /**
     * Specifies the runtime version to use for the canary.
     */
     ...
     * A structure that contains information about how often the canary is to run, and when these runs are to stop.
     */
    get schedule(): cdk.IResolvable | CfnCanary.ScheduleProperty;
    /**
     * A structure that contains information about how often the canary is to run, and when these runs are to stop.
     */
    set schedule(value: cdk.IResolvable | CfnCanary.ScheduleProperty);
    /**
     * Specify TRUE to have the canary start making runs immediately after it is created.
     */
    get startCanaryAfterCreation(): boolean | cdk.IResolvable | undefined;
    /**
     * Specify TRUE to have the canary start making runs immediately after it is created.
     */
    set startCanaryAfterCreation(value: boolean | cdk.IResolvable | undefined);
    /**
     * The number of days to retain data about successful runs of this canary.
     */
    get successRetentionPeriod(): number | undefined;
    /**
     * The number of days to retain data about successful runs of this canary.
     */
    set successRetentionPeriod(value: number | undefined);
    /**
     * The list of key-value pairs that are associated with the canary.
     */
     ...
     * @deprecated this property has been deprecated
     */
    get visualReference(): cdk.IResolvable | CfnCanary.VisualReferenceProperty | undefined;
    /**
     * @deprecated this property has been deprecated
     */
    set visualReference(value: cdk.IResolvable | CfnCanary.VisualReferenceProperty | undefined);
    /**
     * A list of visual reference configurations for the canary, one for each browser type that the canary is configured to run on.
     */
    get visualReferences(): Array<cdk.IResolvable | CfnCanary.VisualReferenceProperty> | cdk.IResolvable | undefined;
    /**
     * A list of visual reference configurations for the canary, one for each browser type that the canary is configured to run on.
     */
    set visualReferences(value: Array<cdk.IResolvable | CfnCanary.VisualReferenceProperty> | cdk.IResolvable | undefined);
    /**
     * If this canary is to test an endpoint in a VPC, this structure contains information about the subnet and security groups of the VPC endpoint.
     */
    get vpcConfig(): cdk.IResolvable | CfnCanary.VPCConfigProperty | undefined;
    /**
     * If this canary is to test an endpoint in a VPC, this structure contains information about the subnet and security groups of the VPC endpoint.
     */
    set vpcConfig(value: cdk.IResolvable | CfnCanary.VPCConfigProperty | undefined);
    /**
     ...
     */
    get attrCodeSourceLocationArn(): string;
    /**
...
export declare class CfnGroup extends cdk.CfnResource implements cdk.IInspectable, IGroupRef, cdk.ITaggable {
     ...
     * The ARNs of the canaries that you want to associate with this group.
     */
    get resourceArns(): Array<string> | undefined;
    /**
     * The ARNs of the canaries that you want to associate with this group.
     */
    set resourceArns(value: Array<string> | undefined);
    /**
     * The list of key-value pairs that are associated with the group.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
