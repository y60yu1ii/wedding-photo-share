...
import { GroupReference, IGroupRef, ITagSyncTaskRef, TagSyncTaskReference } from "../../interfaces/generated/aws-resourcegroups-interfaces.generated";
/**
...
export declare class CfnGroup extends cdk.CfnResource implements cdk.IInspectable, IGroupRef, cdk.ITaggable {
     ...
     * The service configuration currently associated with the resource group and in effect for the members of the resource group.
     */
    get configuration(): Array<CfnGroup.ConfigurationItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The service configuration currently associated with the resource group and in effect for the members of the resource group.
     */
    set configuration(value: Array<CfnGroup.ConfigurationItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of the resource group.
     */
     ...
     * The resource query structure that is used to dynamically determine which AWS resources are members of the associated resource group.
     */
    get resourceQuery(): cdk.IResolvable | CfnGroup.ResourceQueryProperty | undefined;
    /**
     * The resource query structure that is used to dynamically determine which AWS resources are members of the associated resource group.
     */
    set resourceQuery(value: cdk.IResolvable | CfnGroup.ResourceQueryProperty | undefined);
    /**
     * A list of the Amazon Resource Names (ARNs) of AWS resources that you want to add to the specified group.
     */
...
export declare namespace CfnGroup {
     ...
     *
     * For details about service configurations and how to construct them, see [Service configurations for resource groups](https://docs.aws.amazon.com//ARG/latest/APIReference/about-slg.html) in the *Resource Groups User Guide* .
     *
     * @struct
     * @stability external
