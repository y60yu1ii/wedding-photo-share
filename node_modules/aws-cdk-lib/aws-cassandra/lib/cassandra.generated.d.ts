...
import { IKeyspaceRef, ITableRef, ITypeRef, KeyspaceReference, TableReference, TypeReference } from "../../interfaces/generated/aws-cassandra-interfaces.generated";
/**
...
export declare class CfnKeyspace extends cdk.CfnResource implements cdk.IInspectable, IKeyspaceRef, cdk.ITaggable {
     ...
     */
    private _clientSideTimestampsEnabled?;
    /**
     ...
     * Indicates whether client-side timestamps are enabled (true) or disabled (false) for all tables in the keyspace.
     */
    get clientSideTimestampsEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether client-side timestamps are enabled (true) or disabled (false) for all tables in the keyspace.
     */
    set clientSideTimestampsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the keyspace to be created.
     */
    get keyspaceName(): string | undefined;
    /**
     * The name of the keyspace to be created.
     */
    set keyspaceName(value: string | undefined);
    /**
     * Specifies the `ReplicationStrategy` of a keyspace. The options are:.
     */
    get replicationSpecification(): cdk.IResolvable | CfnKeyspace.ReplicationSpecificationProperty | undefined;
    /**
     * Specifies the `ReplicationStrategy` of a keyspace. The options are:.
     */
    set replicationSpecification(value: cdk.IResolvable | CfnKeyspace.ReplicationSpecificationProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export declare class CfnTable extends cdk.CfnResource implements cdk.IInspectable, ITableRef, cdk.ITaggable {
     ...
     */
    private _autoScalingSpecifications?;
    /**
     ...
     */
    private _replicaSpecifications?;
    /**
     ...
     * The optional auto scaling capacity settings for a table in provisioned capacity mode.
     */
    get autoScalingSpecifications(): CfnTable.AutoScalingSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * The optional auto scaling capacity settings for a table in provisioned capacity mode.
     */
    set autoScalingSpecifications(value: CfnTable.AutoScalingSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * The billing mode for the table, which determines how you'll be charged for reads and writes:.
     */
    get billingMode(): CfnTable.BillingModeProperty | cdk.IResolvable | undefined;
    /**
     * The billing mode for the table, which determines how you'll be charged for reads and writes:.
     */
    set billingMode(value: CfnTable.BillingModeProperty | cdk.IResolvable | undefined);
    /**
     * The settings for the CDC stream of a table.
     */
    get cdcSpecification(): CfnTable.CdcSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * The settings for the CDC stream of a table.
     */
    set cdcSpecification(value: CfnTable.CdcSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * Enables client-side timestamps for the table.
     */
    get clientSideTimestampsEnabled(): boolean | cdk.IResolvable | undefined;
     ...
     * One or more columns that determine how the table data is sorted.
     */
    get clusteringKeyColumns(): Array<CfnTable.ClusteringKeyColumnProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * One or more columns that determine how the table data is sorted.
     */
    set clusteringKeyColumns(value: Array<CfnTable.ClusteringKeyColumnProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The default Time To Live (TTL) value for all rows in a table in seconds.
     */
    get defaultTimeToLive(): number | undefined;
    /**
     * The default Time To Live (TTL) value for all rows in a table in seconds.
     */
    set defaultTimeToLive(value: number | undefined);
    /**
     * The encryption at rest options for the table.
     */
    get encryptionSpecification(): CfnTable.EncryptionSpecificationProperty | cdk.IResolvable | undefined;
    /**
     * The encryption at rest options for the table.
     */
    set encryptionSpecification(value: CfnTable.EncryptionSpecificationProperty | cdk.IResolvable | undefined);
    /**
     * The name of the keyspace to create the table in.
     */
     ...
     * One or more columns that uniquely identify every row in the table.
     */
    get partitionKeyColumns(): Array<CfnTable.ColumnProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * One or more columns that uniquely identify every row in the table.
     */
    set partitionKeyColumns(value: Array<CfnTable.ColumnProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Specifies if point-in-time recovery is enabled or disabled for the table.
     */
    get pointInTimeRecoveryEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies if point-in-time recovery is enabled or disabled for the table.
     */
    set pointInTimeRecoveryEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * One or more columns that are not part of the primary key - that is, columns that are *not* defined as partition key columns or clustering key columns.
     */
    get regularColumns(): Array<CfnTable.ColumnProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * One or more columns that are not part of the primary key - that is, columns that are *not* defined as partition key columns or clustering key columns.
     */
    set regularColumns(value: Array<CfnTable.ColumnProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The AWS Region specific settings of a multi-Region table.
     */
    get replicaSpecifications(): Array<cdk.IResolvable | CfnTable.ReplicaSpecificationProperty> | cdk.IResolvable | undefined;
    /**
     * The AWS Region specific settings of a multi-Region table.
     */
    set replicaSpecifications(value: Array<cdk.IResolvable | CfnTable.ReplicaSpecificationProperty> | cdk.IResolvable | undefined);
    /**
     * The name of the table to be created.
     */
...
export declare class CfnType extends cdk.CfnResource implements cdk.IInspectable, ITypeRef {
     ...
     * A list of fields that define this type.
     */
    get fields(): Array<CfnType.FieldProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of fields that define this type.
     */
    set fields(value: Array<CfnType.FieldProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of the keyspace to create the type in.
     */
    get keyspaceName(): string;
     ...
     */
    get attrDirectParentTypes(): Array<string>;
    /**
     * A list of tables that use this type.
     *
     * @cloudformationAttribute DirectReferringTables
     */
    get attrDirectReferringTables(): Array<string>;
    /**
     ...
     */
    get attrMaxNestingDepth(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
