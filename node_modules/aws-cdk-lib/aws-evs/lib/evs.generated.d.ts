...
import { EnvironmentReference, IEnvironmentRef } from "../../interfaces/generated/aws-evs-interfaces.generated";
/**
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggableV2 {
     ...
     * The connectivity configuration for the environment.
     */
    get connectivityInfo(): CfnEnvironment.ConnectivityInfoProperty | cdk.IResolvable;
    /**
     * The connectivity configuration for the environment.
     */
    set connectivityInfo(value: CfnEnvironment.ConnectivityInfoProperty | cdk.IResolvable);
    /**
     * The name of the environment.
     */
     ...
     * Required for environment resource creation.
     */
    get hosts(): Array<CfnEnvironment.HostInfoForCreateProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Required for environment resource creation.
     */
    set hosts(value: Array<CfnEnvironment.HostInfoForCreateProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * > Amazon EVS is in public preview release and is subject to change.
     */
    get initialVlans(): CfnEnvironment.InitialVlansProperty | cdk.IResolvable | undefined;
    /**
     * > Amazon EVS is in public preview release and is subject to change.
     */
    set initialVlans(value: CfnEnvironment.InitialVlansProperty | cdk.IResolvable | undefined);
    /**
     * The AWS KMS key ID that AWS Secrets Manager uses to encrypt secrets that are associated with the environment.
     */
     ...
     * The license information that Amazon EVS requires to create an environment.
     */
    get licenseInfo(): cdk.IResolvable | CfnEnvironment.LicenseInfoProperty;
    /**
     * The license information that Amazon EVS requires to create an environment.
     */
    set licenseInfo(value: cdk.IResolvable | CfnEnvironment.LicenseInfoProperty);
    /**
     * The security groups that allow traffic between the Amazon EVS control plane and your VPC for service access.
     */
    get serviceAccessSecurityGroups(): cdk.IResolvable | CfnEnvironment.ServiceAccessSecurityGroupsProperty | undefined;
    /**
     * The security groups that allow traffic between the Amazon EVS control plane and your VPC for service access.
     */
    set serviceAccessSecurityGroups(value: cdk.IResolvable | CfnEnvironment.ServiceAccessSecurityGroupsProperty | undefined);
    /**
     * The subnet that is used to establish connectivity between the Amazon EVS control plane and VPC.
     */
    get serviceAccessSubnetId(): string;
    /**
     * The subnet that is used to establish connectivity between the Amazon EVS control plane and VPC.
     */
    set serviceAccessSubnetId(value: string);
    /**
     * The Broadcom Site ID that is associated with your Amazon EVS environment.
     */
    get siteId(): string;
     ...
     * Customer confirmation that the customer has purchased and will continue to maintain the required number of VCF software licenses to cover all physical processor cores in the Amazon EVS environment.
     */
    get termsAccepted(): boolean | cdk.IResolvable;
    /**
     * Customer confirmation that the customer has purchased and will continue to maintain the required number of VCF software licenses to cover all physical processor cores in the Amazon EVS environment.
     */
    set termsAccepted(value: boolean | cdk.IResolvable);
    /**
     * The DNS hostnames to be used by the VCF management appliances in your environment.
     */
    get vcfHostnames(): cdk.IResolvable | CfnEnvironment.VcfHostnamesProperty;
    /**
     * The DNS hostnames to be used by the VCF management appliances in your environment.
     */
    set vcfHostnames(value: cdk.IResolvable | CfnEnvironment.VcfHostnamesProperty);
    /**
     * The VCF version of the environment.
     */
    get vcfVersion(): string;
    /**
     * The VCF version of the environment.
     */
    set vcfVersion(value: string);
    /**
     * The VPC associated with the environment.
     */
    get vpcId(): string;
     ...
     */
    get attrChecks(): cdk.IResolvable;
    /**
     ...
     */
    get attrCredentials(): cdk.IResolvable;
    /**
     ...
     */
    get attrEnvironmentState(): string;
    /**
