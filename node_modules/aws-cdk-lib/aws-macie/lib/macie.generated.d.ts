...
import { AllowListReference, CustomDataIdentifierReference, FindingsFilterReference, IAllowListRef, ICustomDataIdentifierRef, IFindingsFilterRef, ISessionRef, SessionReference } from "../../interfaces/generated/aws-macie-interfaces.generated";
/**
...
export declare class CfnAllowList extends cdk.CfnResource implements cdk.IInspectable, IAllowListRef, cdk.ITaggable {
     ...
     * The criteria that specify the text or text pattern to ignore.
     */
    get criteria(): CfnAllowList.CriteriaProperty | cdk.IResolvable;
    /**
     * The criteria that specify the text or text pattern to ignore.
     */
    set criteria(value: CfnAllowList.CriteriaProperty | cdk.IResolvable);
    /**
     * A custom description of the allow list.
     */
...
export declare class CfnCustomDataIdentifier extends cdk.CfnResource implements cdk.IInspectable, ICustomDataIdentifierRef, cdk.ITaggableV2 {
     ...
     * An array of character sequences ( *ignore words* ) to exclude from the results.
     */
    get ignoreWords(): Array<string> | undefined;
    /**
     * An array of character sequences ( *ignore words* ) to exclude from the results.
     */
    set ignoreWords(value: Array<string> | undefined);
    /**
     * An array of character sequences ( *keywords* ), one of which must precede and be in proximity ( `MaximumMatchDistance` ) of the regular expression ( `Regex` ) to match.
     */
    get keywords(): Array<string> | undefined;
    /**
     * An array of character sequences ( *keywords* ), one of which must precede and be in proximity ( `MaximumMatchDistance` ) of the regular expression ( `Regex` ) to match.
     */
    set keywords(value: Array<string> | undefined);
    /**
     * The maximum number of characters that can exist between the end of at least one complete character sequence specified by the `Keywords` array and the end of text that matches the regular expression ( `Regex` ).
     */
    get maximumMatchDistance(): number | undefined;
    /**
     * The maximum number of characters that can exist between the end of at least one complete character sequence specified by the `Keywords` array and the end of text that matches the regular expression ( `Regex` ).
     */
    set maximumMatchDistance(value: number | undefined);
    /**
     * A custom name for the custom data identifier. The name can contain 1-128 characters.
     */
    get name(): string;
...
export declare class CfnFindingsFilter extends cdk.CfnResource implements cdk.IInspectable, IFindingsFilterRef, cdk.ITaggableV2 {
     ...
     * The criteria to use to filter findings.
     */
    get findingCriteria(): CfnFindingsFilter.FindingCriteriaProperty | cdk.IResolvable;
    /**
     * The criteria to use to filter findings.
     */
    set findingCriteria(value: CfnFindingsFilter.FindingCriteriaProperty | cdk.IResolvable);
    /**
     * A custom name for the findings filter. The name can contain 3-64 characters.
     */
    get name(): string;
     ...
     */
    get attrFindingsFilterListItems(): cdk.IResolvable;
    /**
...
export declare class CfnSession extends cdk.CfnResource implements cdk.IInspectable, ISessionRef {
     ...
     */
    get attrAutomatedDiscoveryStatus(): string;
    /**
