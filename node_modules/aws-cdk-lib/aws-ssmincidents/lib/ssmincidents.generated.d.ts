...
import { IReplicationSetRef, IResponsePlanRef, ReplicationSetReference, ResponsePlanReference } from "../../interfaces/generated/aws-ssmincidents-interfaces.generated";
/**
...
export declare class CfnReplicationSet extends cdk.CfnResource implements cdk.IInspectable, IReplicationSetRef, cdk.ITaggable {
     ...
     * Determines if the replication set deletion protection is enabled or not.
     */
    get deletionProtected(): boolean | cdk.IResolvable | undefined;
    /**
     * Determines if the replication set deletion protection is enabled or not.
     */
    set deletionProtected(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies the Regions of the replication set.
     */
    get regions(): Array<cdk.IResolvable | CfnReplicationSet.ReplicationRegionProperty> | cdk.IResolvable;
    /**
     * Specifies the Regions of the replication set.
     */
    set regions(value: Array<cdk.IResolvable | CfnReplicationSet.ReplicationRegionProperty> | cdk.IResolvable);
    /**
     * A list of tags to add to the replication set.
     */
...
export declare class CfnResponsePlan extends cdk.CfnResource implements cdk.IInspectable, IResponsePlanRef, cdk.ITaggable {
     ...
     * The actions that the response plan starts at the beginning of an incident.
     */
    get actions(): Array<CfnResponsePlan.ActionProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The actions that the response plan starts at the beginning of an incident.
     */
    set actions(value: Array<CfnResponsePlan.ActionProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The  chat channel used for collaboration during an incident.
     */
    get chatChannel(): CfnResponsePlan.ChatChannelProperty | cdk.IResolvable | undefined;
    /**
     * The  chat channel used for collaboration during an incident.
     */
    set chatChannel(value: CfnResponsePlan.ChatChannelProperty | cdk.IResolvable | undefined);
    /**
     * The human readable name of the response plan.
     */
     ...
     * The Amazon Resource Name (ARN) for the contacts and escalation plans that the response plan engages during an incident.
     */
    get engagements(): Array<string> | undefined;
    /**
     * The Amazon Resource Name (ARN) for the contacts and escalation plans that the response plan engages during an incident.
     */
    set engagements(value: Array<string> | undefined);
    /**
     * Details used to create an incident when using this response plan.
     */
    get incidentTemplate(): CfnResponsePlan.IncidentTemplateProperty | cdk.IResolvable;
    /**
     * Details used to create an incident when using this response plan.
     */
    set incidentTemplate(value: CfnResponsePlan.IncidentTemplateProperty | cdk.IResolvable);
    /**
     * Information about third-party services integrated into the response plan.
     */
    get integrations(): Array<CfnResponsePlan.IntegrationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Information about third-party services integrated into the response plan.
     */
    set integrations(value: Array<CfnResponsePlan.IntegrationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the response plan.
     */
    get name(): string;
