...
import { aws_applicationautoscaling as applicationAutoScalingRefs, aws_iam as iamRefs, aws_msk as mskRefs } from "../../interfaces";
import { IScalableTargetRef, IScalingPolicyRef, ScalableTargetReference, ScalingPolicyReference } from "../../interfaces/generated/aws-applicationautoscaling-interfaces.generated";
/**
...
export declare class CfnScalableTarget extends cdk.CfnResource implements cdk.IInspectable, IScalableTargetRef {
     ...
     * The scheduled actions for the scalable target.
     */
    get scheduledActions(): Array<cdk.IResolvable | CfnScalableTarget.ScheduledActionProperty> | cdk.IResolvable | undefined;
    /**
     * The scheduled actions for the scalable target.
     */
    set scheduledActions(value: Array<cdk.IResolvable | CfnScalableTarget.ScheduledActionProperty> | cdk.IResolvable | undefined);
    /**
     * The namespace of the AWS service that provides the resource, or a `custom-resource` .
     */
     ...
     * An embedded object that contains attributes and attribute values that are used to suspend and resume automatic scaling.
     */
    get suspendedState(): cdk.IResolvable | CfnScalableTarget.SuspendedStateProperty | undefined;
    /**
     * An embedded object that contains attributes and attribute values that are used to suspend and resume automatic scaling.
     */
    set suspendedState(value: cdk.IResolvable | CfnScalableTarget.SuspendedStateProperty | undefined);
    /**
...
export interface CfnScalableTargetProps {
     ...
     */
    readonly resourceId: mskRefs.IClusterRef | string;
    /**
     * Specify the Amazon Resource Name (ARN) of an Identity and Access Management (IAM) role that allows Application Auto Scaling to modify the scalable target on your behalf.
     *
...
export declare class CfnScalingPolicy extends cdk.CfnResource implements cdk.IInspectable, IScalingPolicyRef {
     ...
     * The predictive scaling policy configuration.
     */
    get predictiveScalingPolicyConfiguration(): cdk.IResolvable | CfnScalingPolicy.PredictiveScalingPolicyConfigurationProperty | undefined;
    /**
     * The predictive scaling policy configuration.
     */
    set predictiveScalingPolicyConfiguration(value: cdk.IResolvable | CfnScalingPolicy.PredictiveScalingPolicyConfigurationProperty | undefined);
    /**
     * The identifier of the resource associated with the scaling policy.
     */
     ...
     * The CloudFormation-generated ID of an Application Auto Scaling scalable target.
     */
    get scalingTargetId(): string | undefined;
    /**
     * The CloudFormation-generated ID of an Application Auto Scaling scalable target.
     */
    set scalingTargetId(value: string | undefined);
    /**
     * The namespace of the AWS service that provides the resource, or a `custom-resource` .
     */
     ...
     * The namespace of the AWS service that provides the resource, or a `custom-resource` .
     */
    set serviceNamespace(value: string | undefined);
    /**
     * A step scaling policy.
     */
    get stepScalingPolicyConfiguration(): cdk.IResolvable | CfnScalingPolicy.StepScalingPolicyConfigurationProperty | undefined;
    /**
     * A step scaling policy.
     */
    set stepScalingPolicyConfiguration(value: cdk.IResolvable | CfnScalingPolicy.StepScalingPolicyConfigurationProperty | undefined);
    /**
     * A target tracking scaling policy.
     */
    get targetTrackingScalingPolicyConfiguration(): cdk.IResolvable | CfnScalingPolicy.TargetTrackingScalingPolicyConfigurationProperty | undefined;
    /**
     * A target tracking scaling policy.
     */
    set targetTrackingScalingPolicyConfiguration(value: cdk.IResolvable | CfnScalingPolicy.TargetTrackingScalingPolicyConfigurationProperty | undefined);
    /**
...
export interface CfnScalingPolicyProps {
     ...
     */
    readonly scalingTargetId?: applicationAutoScalingRefs.IScalableTargetRef | string;
    /**
     * The namespace of the AWS service that provides the resource, or a `custom-resource` .
     *
