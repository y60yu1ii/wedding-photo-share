...
export declare class CfnWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceRef {
     ...
     * Specifies whether this workspace uses SAML 2.0, SSOlong , or both to authenticate users for using the Grafana console within a workspace. For more information, see [User authentication in Amazon Managed Grafana](https://docs.aws.amazon.com/grafana/latest/userguide/authentication-in-AMG.html) .
     */
    get authenticationProviders(): Array<string>;
    /**
     * Specifies whether this workspace uses SAML 2.0, SSOlong , or both to authenticate users for using the Grafana console within a workspace. For more information, see [User authentication in Amazon Managed Grafana](https://docs.aws.amazon.com/grafana/latest/userguide/authentication-in-AMG.html) .
     */
    set authenticationProviders(value: Array<string>);
    /**
     * A unique, case-sensitive, user-provided identifier to ensure the idempotency of the request.
     */
     ...
     * Specifies the AWS data sources that have been configured to have IAM roles and permissions created to allow Amazon Managed Grafana to read data from these sources.
     */
    get dataSources(): Array<string> | undefined;
    /**
     * Specifies the AWS data sources that have been configured to have IAM roles and permissions created to allow Amazon Managed Grafana to read data from these sources.
     */
    set dataSources(value: Array<string> | undefined);
    /**
     * The user-defined description of the workspace.
     */
     ...
     * Specifies the version of Grafana to support in the workspace.
     */
    get grafanaVersion(): string | undefined;
    /**
     * Specifies the version of Grafana to support in the workspace.
     */
    set grafanaVersion(value: string | undefined);
    /**
     * The name of the workspace.
     */
     ...
     * The configuration settings for network access to your workspace.
     */
    get networkAccessControl(): cdk.IResolvable | CfnWorkspace.NetworkAccessControlProperty | undefined;
    /**
     * The configuration settings for network access to your workspace.
     */
    set networkAccessControl(value: cdk.IResolvable | CfnWorkspace.NetworkAccessControlProperty | undefined);
    /**
     * The AWS notification channels that Amazon Managed Grafana can automatically create IAM roles and permissions for, to allow Amazon Managed Grafana to use these channels.
     */
    get notificationDestinations(): Array<string> | undefined;
    /**
     * The AWS notification channels that Amazon Managed Grafana can automatically create IAM roles and permissions for, to allow Amazon Managed Grafana to use these channels.
     */
    set notificationDestinations(value: Array<string> | undefined);
    /**
     * Specifies the organizational units that this workspace is allowed to use data sources from, if this workspace is in an account that is part of an organization.
     */
    get organizationalUnits(): Array<string> | undefined;
    /**
     * Specifies the organizational units that this workspace is allowed to use data sources from, if this workspace is in an account that is part of an organization.
     */
    set organizationalUnits(value: Array<string> | undefined);
    /**
     * The name of the IAM role that is used to access resources through Organizations.
     */
    get organizationRoleName(): string | undefined;
    /**
     * The name of the IAM role that is used to access resources through Organizations.
     */
    set organizationRoleName(value: string | undefined);
    /**
     * If this is `SERVICE_MANAGED` , and the workplace was created through the Amazon Managed Grafana console, then Amazon Managed Grafana automatically creates the IAM roles and provisions the permissions that the workspace needs to use AWS data sources and notification channels.
     */
     ...
     * Whether plugin administration is enabled in the workspace.
     */
    get pluginAdminEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether plugin administration is enabled in the workspace.
     */
    set pluginAdminEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The IAM role that grants permissions to the AWS resources that the workspace will view data from.
     */
     ...
     * If the workspace uses SAML, use this structure to map SAML assertion attributes to workspace user information and define which groups in the assertion attribute are to have the `Admin` and `Editor` roles in the workspace.
     */
    get samlConfiguration(): cdk.IResolvable | CfnWorkspace.SamlConfigurationProperty | undefined;
    /**
     * If the workspace uses SAML, use this structure to map SAML assertion attributes to workspace user information and define which groups in the assertion attribute are to have the `Admin` and `Editor` roles in the workspace.
     */
    set samlConfiguration(value: cdk.IResolvable | CfnWorkspace.SamlConfigurationProperty | undefined);
    /**
     * The name of the AWS CloudFormation stack set that is used to generate IAM roles to be used for this workspace.
     */
    get stackSetName(): string | undefined;
    /**
     * The name of the AWS CloudFormation stack set that is used to generate IAM roles to be used for this workspace.
     */
    set stackSetName(value: string | undefined);
    /**
     * The configuration settings for an Amazon VPC that contains data sources for your Grafana workspace to connect to.
     */
    get vpcConfiguration(): cdk.IResolvable | CfnWorkspace.VpcConfigurationProperty | undefined;
    /**
     * The configuration settings for an Amazon VPC that contains data sources for your Grafana workspace to connect to.
     */
    set vpcConfiguration(value: cdk.IResolvable | CfnWorkspace.VpcConfigurationProperty | undefined);
    /**
     ...
     */
    get attrCreationTimestamp(): string;
    /**
     ...
     */
    get attrModificationTimestamp(): string;
    /**
     ...
     */
    get attrSamlConfigurationStatus(): string;
    /**
