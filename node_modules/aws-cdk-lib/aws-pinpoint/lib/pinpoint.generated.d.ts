...
export declare class CfnAPNSChannel extends cdk.CfnResource implements cdk.IInspectable, IAPNSChannelRef {
     ...
     * The default authentication method that you want Amazon Pinpoint to use when authenticating with APNs.
     */
    get defaultAuthenticationMethod(): string | undefined;
    /**
     * The default authentication method that you want Amazon Pinpoint to use when authenticating with APNs.
     */
    set defaultAuthenticationMethod(value: string | undefined);
    /**
     * Specifies whether to enable the APNs channel for the application.
     */
    get enabled(): boolean | cdk.IResolvable | undefined;
     ...
     * The authentication key to use for APNs tokens.
     */
    get tokenKey(): string | undefined;
    /**
     * The authentication key to use for APNs tokens.
     */
    set tokenKey(value: string | undefined);
    /**
     * The key identifier that's assigned to your APNs signing key.
     */
    get tokenKeyId(): string | undefined;
    /**
     * The key identifier that's assigned to your APNs signing key.
     */
    set tokenKeyId(value: string | undefined);
    /**
...
export declare class CfnApplicationSettings extends cdk.CfnResource implements cdk.IInspectable, IApplicationSettingsRef {
     ...
     * The settings for the Lambda function to use by default as a code hook for campaigns in the application.
     */
    get campaignHook(): CfnApplicationSettings.CampaignHookProperty | cdk.IResolvable | undefined;
    /**
     * The settings for the Lambda function to use by default as a code hook for campaigns in the application.
     */
    set campaignHook(value: CfnApplicationSettings.CampaignHookProperty | cdk.IResolvable | undefined);
    get cloudWatchMetricsEnabled(): boolean | cdk.IResolvable | undefined;
    set cloudWatchMetricsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The default sending limits for campaigns in the application.
     */
    get limits(): cdk.IResolvable | CfnApplicationSettings.LimitsProperty | undefined;
    /**
     * The default sending limits for campaigns in the application.
     */
    set limits(value: cdk.IResolvable | CfnApplicationSettings.LimitsProperty | undefined);
    /**
     * The default quiet time for campaigns in the application.
     */
    get quietTime(): cdk.IResolvable | CfnApplicationSettings.QuietTimeProperty | undefined;
    /**
     * The default quiet time for campaigns in the application.
     */
    set quietTime(value: cdk.IResolvable | CfnApplicationSettings.QuietTimeProperty | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnCampaign extends cdk.CfnResource implements cdk.IInspectable, ICampaignRef, cdk.ITaggable {
     ...
     */
    private _customDeliveryConfiguration?;
    /**
     ...
     * An array of requests that defines additional treatments for the campaign, in addition to the default treatment for the campaign.
     */
    get additionalTreatments(): Array<cdk.IResolvable | CfnCampaign.WriteTreatmentResourceProperty> | cdk.IResolvable | undefined;
    /**
     * An array of requests that defines additional treatments for the campaign, in addition to the default treatment for the campaign.
     */
    set additionalTreatments(value: Array<cdk.IResolvable | CfnCampaign.WriteTreatmentResourceProperty> | cdk.IResolvable | undefined);
    /**
     * The unique identifier for the Amazon Pinpoint application that the campaign is associated with.
     */
    get applicationId(): string;
     ...
     * Specifies the Lambda function to use as a code hook for a campaign.
     */
    get campaignHook(): CfnCampaign.CampaignHookProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the Lambda function to use as a code hook for a campaign.
     */
    set campaignHook(value: CfnCampaign.CampaignHookProperty | cdk.IResolvable | undefined);
    /**
     * The delivery configuration settings for sending the treatment through a custom channel.
     */
    get customDeliveryConfiguration(): CfnCampaign.CustomDeliveryConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The delivery configuration settings for sending the treatment through a custom channel.
     */
    set customDeliveryConfiguration(value: CfnCampaign.CustomDeliveryConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A custom description of the campaign.
     */
     ...
     * The allocated percentage of users (segment members) who shouldn't receive messages from the campaign.
     */
    get holdoutPercent(): number | undefined;
    /**
     * The allocated percentage of users (segment members) who shouldn't receive messages from the campaign.
     */
    set holdoutPercent(value: number | undefined);
    /**
     * Specifies whether to pause the campaign.
     */
    get isPaused(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether to pause the campaign.
     */
    set isPaused(value: boolean | cdk.IResolvable | undefined);
    /**
     * The messaging limits for the campaign.
     */
    get limits(): cdk.IResolvable | CfnCampaign.LimitsProperty | undefined;
    /**
     * The messaging limits for the campaign.
     */
    set limits(value: cdk.IResolvable | CfnCampaign.LimitsProperty | undefined);
    /**
     * The message configuration settings for the treatment.
     */
    get messageConfiguration(): cdk.IResolvable | CfnCampaign.MessageConfigurationProperty | undefined;
    /**
     * The message configuration settings for the treatment.
     */
    set messageConfiguration(value: cdk.IResolvable | CfnCampaign.MessageConfigurationProperty | undefined);
    /**
     * The name of the campaign.
     */
    get name(): string;
     ...
     * The schedule settings for the treatment.
     */
    get schedule(): cdk.IResolvable | CfnCampaign.ScheduleProperty;
    /**
     * The schedule settings for the treatment.
     */
    set schedule(value: cdk.IResolvable | CfnCampaign.ScheduleProperty);
    /**
     * The unique identifier for the segment to associate with the campaign.
     */
     ...
     * The version of the segment to associate with the campaign.
     */
    get segmentVersion(): number | undefined;
    /**
     * The version of the segment to associate with the campaign.
     */
    set segmentVersion(value: number | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): any | undefined;
     ...
     * The message template to use for the treatment.
     */
    get templateConfiguration(): cdk.IResolvable | CfnCampaign.TemplateConfigurationProperty | undefined;
    /**
     * The message template to use for the treatment.
     */
    set templateConfiguration(value: cdk.IResolvable | CfnCampaign.TemplateConfigurationProperty | undefined);
    /**
     * A custom description of the treatment.
     */
    get treatmentDescription(): string | undefined;
    /**
     * A custom description of the treatment.
     */
    set treatmentDescription(value: string | undefined);
    /**
     * A custom name for the treatment.
     */
    get treatmentName(): string | undefined;
    /**
     * A custom name for the treatment.
     */
    set treatmentName(value: string | undefined);
    /**
...
export declare class CfnEmailChannel extends cdk.CfnResource implements cdk.IInspectable, IEmailChannelRef {
     ...
     * The [Amazon SES configuration set](https://docs.aws.amazon.com/ses/latest/APIReference/API_ConfigurationSet.html) that you want to apply to messages that you send through the channel.
     */
    get configurationSet(): string | undefined;
    /**
     * The [Amazon SES configuration set](https://docs.aws.amazon.com/ses/latest/APIReference/API_ConfigurationSet.html) that you want to apply to messages that you send through the channel.
     */
    set configurationSet(value: string | undefined);
    /**
     * Specifies whether to enable the email channel for the application.
     */
    get enabled(): boolean | cdk.IResolvable | undefined;
     ...
     * The ARN of an IAM role for Amazon Pinpoint to use to send email from your campaigns or journeys through Amazon SES .
     */
    get orchestrationSendingRoleArn(): string | undefined;
    /**
     * The ARN of an IAM role for Amazon Pinpoint to use to send email from your campaigns or journeys through Amazon SES .
     */
    set orchestrationSendingRoleArn(value: string | undefined);
    /**
     * The ARN of the AWS Identity and Access Management (IAM) role that you want Amazon Pinpoint to use when it submits email-related event data for the channel.
     */
...
export declare class CfnEmailTemplate extends cdk.CfnResource implements cdk.IInspectable, IEmailTemplateRef, cdk.ITaggable {
     ...
     * A JSON object that specifies the default values to use for message variables in the message template.
     */
    get defaultSubstitutions(): string | undefined;
    /**
     * A JSON object that specifies the default values to use for message variables in the message template.
     */
    set defaultSubstitutions(value: string | undefined);
    /**
     * The message body, in HTML format, to use in email messages that are based on the message template.
     */
    get htmlPart(): string | undefined;
    /**
     * The message body, in HTML format, to use in email messages that are based on the message template.
     */
    set htmlPart(value: string | undefined);
    /**
     * The subject line, or title, to use in email messages that are based on the message template.
     */
    get subject(): string;
     ...
     * A custom description of the message template.
     */
    get templateDescription(): string | undefined;
    /**
     * A custom description of the message template.
     */
    set templateDescription(value: string | undefined);
    /**
     * The name of the message template.
     */
     ...
     * The message body, in plain text format, to use in email messages that are based on the message template.
     */
    get textPart(): string | undefined;
    /**
     * The message body, in plain text format, to use in email messages that are based on the message template.
     */
    set textPart(value: string | undefined);
    /**
...
export declare class CfnGCMChannel extends cdk.CfnResource implements cdk.IInspectable, IGCMChannelRef {
     ...
     * The contents of the JSON file provided by Google during registration in order to generate an access token for authentication.
     */
    get serviceJson(): string | undefined;
    /**
     * The contents of the JSON file provided by Google during registration in order to generate an access token for authentication.
     */
    set serviceJson(value: string | undefined);
    /**
...
export declare class CfnInAppTemplate extends cdk.CfnResource implements cdk.IInspectable, IInAppTemplateRef, cdk.ITaggable {
     ...
     * An object that contains information about the content of an in-app message, including its title and body text, text colors, background colors, images, buttons, and behaviors.
     */
    get content(): Array<CfnInAppTemplate.InAppMessageContentProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An object that contains information about the content of an in-app message, including its title and body text, text colors, background colors, images, buttons, and behaviors.
     */
    set content(value: Array<CfnInAppTemplate.InAppMessageContentProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Custom data, in the form of key-value pairs, that is included in an in-app messaging payload.
     */
    get customConfig(): any | cdk.IResolvable | undefined;
    /**
     * Custom data, in the form of key-value pairs, that is included in an in-app messaging payload.
     */
    set customConfig(value: any | cdk.IResolvable | undefined);
    /**
     * A string that determines the appearance of the in-app message. You can specify one of the following:.
     */
...
export declare class CfnPushTemplate extends cdk.CfnResource implements cdk.IInspectable, IPushTemplateRef, cdk.ITaggable {
     ...
     * The message template to use for the ADM (Amazon Device Messaging) channel.
     */
    get adm(): CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined;
    /**
     * The message template to use for the ADM (Amazon Device Messaging) channel.
     */
    set adm(value: CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined);
    /**
     * The message template to use for the APNs (Apple Push Notification service) channel.
     */
    get apns(): CfnPushTemplate.APNSPushNotificationTemplateProperty | cdk.IResolvable | undefined;
    /**
     * The message template to use for the APNs (Apple Push Notification service) channel.
     */
    set apns(value: CfnPushTemplate.APNSPushNotificationTemplateProperty | cdk.IResolvable | undefined);
    /**
     * The message template to use for the Baidu (Baidu Cloud Push) channel.
     */
    get baidu(): CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined;
    /**
     * The message template to use for the Baidu (Baidu Cloud Push) channel.
     */
    set baidu(value: CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined);
    /**
     * The default message template to use for push notification channels.
     */
    get default(): CfnPushTemplate.DefaultPushNotificationTemplateProperty | cdk.IResolvable | undefined;
    /**
     * The default message template to use for push notification channels.
     */
    set default(value: CfnPushTemplate.DefaultPushNotificationTemplateProperty | cdk.IResolvable | undefined);
    /**
     * A JSON object that specifies the default values to use for message variables in the message template.
     */
    get defaultSubstitutions(): string | undefined;
     ...
     * The message template to use for the GCM channel, which is used to send notifications through the Firebase Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service.
     */
    get gcm(): CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined;
    /**
     * The message template to use for the GCM channel, which is used to send notifications through the Firebase Cloud Messaging (FCM), formerly Google Cloud Messaging (GCM), service.
     */
    set gcm(value: CfnPushTemplate.AndroidPushNotificationTemplateProperty | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): any | undefined;
...
export declare class CfnSMSChannel extends cdk.CfnResource implements cdk.IInspectable, ISMSChannelRef {
     ...
     * The registered short code that you want to use when you send messages through the SMS channel.
     */
    set shortCode(value: string | undefined);
    /**
...
export declare class CfnSegment extends cdk.CfnResource implements cdk.IInspectable, ISegmentRef, cdk.ITaggable {
     ...
     * An array that defines the dimensions for the segment.
     */
    get dimensions(): cdk.IResolvable | CfnSegment.SegmentDimensionsProperty | undefined;
    /**
     * An array that defines the dimensions for the segment.
     */
    set dimensions(value: cdk.IResolvable | CfnSegment.SegmentDimensionsProperty | undefined);
    /**
     * The name of the segment.
     */
    get name(): string;
     ...
     * The segment group to use and the dimensions to apply to the group's base segments in order to build the segment.
     */
    get segmentGroups(): cdk.IResolvable | CfnSegment.SegmentGroupsProperty | undefined;
    /**
     * The segment group to use and the dimensions to apply to the group's base segments in order to build the segment.
     */
    set segmentGroups(value: cdk.IResolvable | CfnSegment.SegmentGroupsProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): any | undefined;
