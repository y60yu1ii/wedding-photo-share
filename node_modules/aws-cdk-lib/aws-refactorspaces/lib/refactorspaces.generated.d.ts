...
import { aws_ec2 as ec2Refs, aws_refactorspaces as refactorSpacesRefs } from "../../interfaces";
import { ApplicationReference, EnvironmentReference, IApplicationRef, IEnvironmentRef, IRouteRef, IServiceRef, RouteReference, ServiceReference } from "../../interfaces/generated/aws-refactorspaces-interfaces.generated";
/**
...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggable {
     ...
     * The endpoint URL of the Amazon API Gateway proxy.
     */
    get apiGatewayProxy(): CfnApplication.ApiGatewayProxyInputProperty | cdk.IResolvable | undefined;
    /**
     * The endpoint URL of the Amazon API Gateway proxy.
     */
    set apiGatewayProxy(value: CfnApplication.ApiGatewayProxyInputProperty | cdk.IResolvable | undefined);
    /**
     * The unique identifier of the environment.
     */
     ...
     */
    get attrApiGatewayId(): string;
    /**
     * The unique identifier of the application.
     *
     * @cloudformationAttribute ApplicationIdentifier
     */
    get attrApplicationIdentifier(): string;
    /**
...
export interface CfnApplicationProps {
     ...
     */
    readonly environmentIdentifier: refactorSpacesRefs.IEnvironmentRef | string;
    /**
     * The name of the application.
     *
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggable {
     ...
     * The network fabric type of the environment.
     */
    get networkFabricType(): string | undefined;
    /**
     * The network fabric type of the environment.
     */
    set networkFabricType(value: string | undefined);
    /**
     * The tags assigned to the environment.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRoute extends cdk.CfnResource implements cdk.IInspectable, IRouteRef, cdk.ITaggable {
     ...
     * Configuration for the default route type.
     */
    get defaultRoute(): CfnRoute.DefaultRouteInputProperty | cdk.IResolvable | undefined;
    /**
     * Configuration for the default route type.
     */
    set defaultRoute(value: CfnRoute.DefaultRouteInputProperty | cdk.IResolvable | undefined);
    /**
     * The unique identifier of the environment.
     */
    get environmentIdentifier(): string;
     ...
     * The configuration for the URI path route type.
     */
    get uriPathRoute(): cdk.IResolvable | CfnRoute.UriPathRouteInputProperty | undefined;
    /**
     * The configuration for the URI path route type.
     */
    set uriPathRoute(value: cdk.IResolvable | CfnRoute.UriPathRouteInputProperty | undefined);
    /**
     ...
     */
    get attrPathResourceToId(): string;
    /**
     * The unique identifier of the route.
     *
     * @cloudformationAttribute RouteIdentifier
     */
    get attrRouteIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnRouteProps {
     ...
     */
    readonly applicationIdentifier: refactorSpacesRefs.IApplicationRef | string;
    /**
     * Configuration for the default route type.
     *
     ...
     */
    readonly serviceIdentifier: refactorSpacesRefs.IServiceRef | string;
    /**
     * The tags assigned to the route.
     *
...
export declare class CfnService extends cdk.CfnResource implements cdk.IInspectable, IServiceRef, cdk.ITaggable {
     ...
     * A summary of the configuration for the AWS Lambda endpoint type.
     */
    get lambdaEndpoint(): cdk.IResolvable | CfnService.LambdaEndpointInputProperty | undefined;
    /**
     * A summary of the configuration for the AWS Lambda endpoint type.
     */
    set lambdaEndpoint(value: cdk.IResolvable | CfnService.LambdaEndpointInputProperty | undefined);
    /**
     * The name of the service.
     */
    get name(): string;
     ...
     * The summary of the configuration for the URL endpoint type.
     */
    get urlEndpoint(): cdk.IResolvable | CfnService.UrlEndpointInputProperty | undefined;
    /**
     * The summary of the configuration for the URL endpoint type.
     */
    set urlEndpoint(value: cdk.IResolvable | CfnService.UrlEndpointInputProperty | undefined);
    /**
     * The ID of the virtual private cloud (VPC).
     */
     ...
     */
    get attrServiceIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
