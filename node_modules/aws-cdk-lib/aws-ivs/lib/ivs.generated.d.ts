...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggable {
     ...
     */
    private _multitrackInputConfiguration?;
    /**
     * Channel name.
     */
    private _name?;
     ...
     * Whether the channel is authorized.
     */
    get authorized(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether the channel is authorized.
     */
    set authorized(value: boolean | cdk.IResolvable | undefined);
    /**
     * Indicates which content-packaging format is used (MPEG-TS or fMP4).
     */
    get containerFormat(): string | undefined;
    /**
     * Indicates which content-packaging format is used (MPEG-TS or fMP4).
     */
    set containerFormat(value: string | undefined);
    /**
     * Whether the channel allows insecure RTMP ingest.
     */
    get insecureIngest(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether the channel allows insecure RTMP ingest.
     */
    set insecureIngest(value: boolean | cdk.IResolvable | undefined);
    /**
     * Channel latency mode. Valid values:.
     */
    get latencyMode(): string | undefined;
    /**
     * Channel latency mode. Valid values:.
     */
    set latencyMode(value: string | undefined);
    /**
     * Object specifying multitrack input configuration.
     */
    get multitrackInputConfiguration(): cdk.IResolvable | CfnChannel.MultitrackInputConfigurationProperty | undefined;
    /**
     * Object specifying multitrack input configuration.
     */
    set multitrackInputConfiguration(value: cdk.IResolvable | CfnChannel.MultitrackInputConfigurationProperty | undefined);
    /**
     * Channel name.
     */
     ...
     * An optional transcode preset for the channel.
     */
    set preset(value: string | undefined);
    /**
     * The ARN of a RecordingConfiguration resource.
     */
    get recordingConfigurationArn(): string | undefined;
    /**
     * The ARN of a RecordingConfiguration resource.
     */
    set recordingConfigurationArn(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export interface CfnChannelProps {
     ...
     */
    readonly recordingConfigurationArn?: ivsRefs.IRecordingConfigurationRef | string;
    /**
     * An array of key-value pairs to apply to this resource.
     *
...
export declare class CfnPlaybackKeyPair extends cdk.CfnResource implements cdk.IInspectable, IPlaybackKeyPairRef, cdk.ITaggable {
     ...
     * The public portion of a customer-generated key pair.
     */
    get publicKeyMaterial(): string | undefined;
    /**
     * The public portion of a customer-generated key pair.
     */
    set publicKeyMaterial(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnRecordingConfiguration extends cdk.CfnResource implements cdk.IInspectable, IRecordingConfigurationRef, cdk.ITaggable {
     ...
     */
    private _renditionConfiguration?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * A destination configuration describes an S3 bucket where recorded video will be stored.
     */
    get destinationConfiguration(): CfnRecordingConfiguration.DestinationConfigurationProperty | cdk.IResolvable;
    /**
     * A destination configuration describes an S3 bucket where recorded video will be stored.
     */
    set destinationConfiguration(value: CfnRecordingConfiguration.DestinationConfigurationProperty | cdk.IResolvable);
    /**
     * Recording-configuration name.
     */
    get name(): string | undefined;
     ...
     * If a broadcast disconnects and then reconnects within the specified interval, the multiple streams will be considered a single broadcast and merged together.
     */
    get recordingReconnectWindowSeconds(): number | undefined;
    /**
     * If a broadcast disconnects and then reconnects within the specified interval, the multiple streams will be considered a single broadcast and merged together.
     */
    set recordingReconnectWindowSeconds(value: number | undefined);
    /**
     * A rendition configuration describes which renditions should be recorded for a stream.
     */
    get renditionConfiguration(): cdk.IResolvable | CfnRecordingConfiguration.RenditionConfigurationProperty | undefined;
    /**
     * A rendition configuration describes which renditions should be recorded for a stream.
     */
    set renditionConfiguration(value: cdk.IResolvable | CfnRecordingConfiguration.RenditionConfigurationProperty | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * A thumbnail configuration enables/disables the recording of thumbnails for a live session and controls the interval at which thumbnails are generated for the live session.
     */
    get thumbnailConfiguration(): cdk.IResolvable | CfnRecordingConfiguration.ThumbnailConfigurationProperty | undefined;
    /**
     * A thumbnail configuration enables/disables the recording of thumbnails for a live session and controls the interval at which thumbnails are generated for the live session.
     */
    set thumbnailConfiguration(value: cdk.IResolvable | CfnRecordingConfiguration.ThumbnailConfigurationProperty | undefined);
    /**
...
export interface CfnStreamKeyProps {
     ...
     */
    readonly channelArn: ivsRefs.IChannelRef | string;
    /**
     * An array of key-value pairs to apply to this resource.
     *
...
export declare class CfnEncoderConfiguration extends cdk.CfnResource implements cdk.IInspectable, IEncoderConfigurationRef, cdk.ITaggableV2 {
     ...
     * Video configuration.
     */
    get video(): cdk.IResolvable | CfnEncoderConfiguration.VideoProperty | undefined;
    /**
     * Video configuration.
     */
    set video(value: cdk.IResolvable | CfnEncoderConfiguration.VideoProperty | undefined);
    /**
...
export declare class CfnIngestConfiguration extends cdk.CfnResource implements cdk.IInspectable, IIngestConfigurationRef, cdk.ITaggableV2 {
     ...
     * Type of ingest protocol that the user employs for broadcasting.
     */
    get ingestProtocol(): string | undefined;
    /**
     * Type of ingest protocol that the user employs for broadcasting.
     */
    set ingestProtocol(value: string | undefined);
    /**
     * Whether the channel allows insecure RTMP ingest.
     */
    get insecureIngest(): boolean | cdk.IResolvable | undefined;
     ...
     * ARN of the stage with which the IngestConfiguration is associated.
     */
    get stageArn(): string | undefined;
    /**
     * ARN of the stage with which the IngestConfiguration is associated.
     */
    set stageArn(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnPlaybackRestrictionPolicy extends cdk.CfnResource implements cdk.IInspectable, IPlaybackRestrictionPolicyRef, cdk.ITaggableV2 {
     ...
     */
    private _enableStrictOriginEnforcement?;
    /**
     ...
     * A list of country codes that control geoblocking restrictions.
     */
    get allowedCountries(): Array<string> | undefined;
    /**
     * A list of country codes that control geoblocking restrictions.
     */
    set allowedCountries(value: Array<string> | undefined);
    /**
     * A list of origin sites that control CORS restriction.
     */
    get allowedOrigins(): Array<string> | undefined;
    /**
     * A list of origin sites that control CORS restriction.
     */
    set allowedOrigins(value: Array<string> | undefined);
    /**
     * Whether channel playback is constrained by the origin site.
     */
    get enableStrictOriginEnforcement(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether channel playback is constrained by the origin site.
     */
    set enableStrictOriginEnforcement(value: boolean | cdk.IResolvable | undefined);
    /**
     * Playback-restriction-policy name.
     */
    get name(): string | undefined;
...
export declare class CfnStage extends cdk.CfnResource implements cdk.IInspectable, IStageRef, cdk.ITaggableV2 {
     ...
     */
    private _autoParticipantRecordingConfiguration?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * Configuration object for individual participant recording.
     */
    get autoParticipantRecordingConfiguration(): CfnStage.AutoParticipantRecordingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Configuration object for individual participant recording.
     */
    set autoParticipantRecordingConfiguration(value: CfnStage.AutoParticipantRecordingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Stage name.
     */
    get name(): string | undefined;
     ...
     */
    get attrActiveSessionId(): string;
    /**
...
export declare class CfnStorageConfiguration extends cdk.CfnResource implements cdk.IInspectable, IStorageConfigurationRef, cdk.ITaggableV2 {
     ...
     * An S3 storage configuration contains information about where recorded video will be stored.
     */
    get s3(): cdk.IResolvable | CfnStorageConfiguration.S3StorageConfigurationProperty;
    /**
     * An S3 storage configuration contains information about where recorded video will be stored.
     */
    set s3(value: cdk.IResolvable | CfnStorageConfiguration.S3StorageConfigurationProperty);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
