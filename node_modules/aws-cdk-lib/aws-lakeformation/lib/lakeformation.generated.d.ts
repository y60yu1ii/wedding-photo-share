...
import { DataCellsFilterReference, DataLakeSettingsReference, IDataCellsFilterRef, IDataLakeSettingsRef, IPermissionsRef, IPrincipalPermissionsRef, IResourceRef, ITagAssociationRef, ITagRef, PermissionsReference, PrincipalPermissionsReference, ResourceReference, TagAssociationReference, TagReference } from "../../interfaces/generated/aws-lakeformation-interfaces.generated";
/**
...
export declare class CfnDataCellsFilter extends cdk.CfnResource implements cdk.IInspectable, IDataCellsFilterRef {
     ...
     * An array of UTF-8 strings.
     */
    get columnNames(): Array<string> | undefined;
    /**
     * An array of UTF-8 strings.
     */
    set columnNames(value: Array<string> | undefined);
    /**
     * A wildcard with exclusions.
     */
    get columnWildcard(): CfnDataCellsFilter.ColumnWildcardProperty | cdk.IResolvable | undefined;
    /**
     * A wildcard with exclusions.
     */
    set columnWildcard(value: CfnDataCellsFilter.ColumnWildcardProperty | cdk.IResolvable | undefined);
    /**
     * UTF-8 string, not less than 1 or more than 255 bytes long, matching the [single-line string pattern](https://docs.aws.amazon.com/lake-formation/latest/dg/aws-lake-formation-api-aws-lake-formation-api-common.html) .
     */
     ...
     * A PartiQL predicate.
     */
    get rowFilter(): cdk.IResolvable | CfnDataCellsFilter.RowFilterProperty | undefined;
    /**
     * A PartiQL predicate.
     */
    set rowFilter(value: cdk.IResolvable | CfnDataCellsFilter.RowFilterProperty | undefined);
    /**
     * Catalog id string, not less than 1 or more than 255 bytes long, matching the [single-line string pattern](https://docs.aws.amazon.com/lake-formation/latest/dg/aws-lake-formation-api-aws-lake-formation-api-common.html) .
     */
...
export declare class CfnDataLakeSettings extends cdk.CfnResource implements cdk.IInspectable, IDataLakeSettingsRef {
     ...
     * A list of AWS Lake Formation principals.
     */
    get admins(): Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of AWS Lake Formation principals.
     */
    set admins(value: Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Whether to allow Amazon EMR clusters or other third-party query engines to access data managed by Lake Formation .
     */
    get allowExternalDataFiltering(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to allow Amazon EMR clusters or other third-party query engines to access data managed by Lake Formation .
     */
    set allowExternalDataFiltering(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether query engines and applications can get credentials without IAM session tags if the user has full table access.
     */
    get allowFullTableExternalDataAccess(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether query engines and applications can get credentials without IAM session tags if the user has full table access.
     */
    set allowFullTableExternalDataAccess(value: boolean | cdk.IResolvable | undefined);
    /**
     * Lake Formation relies on a privileged process secured by Amazon EMR or the third party integrator to tag the user's role while assuming it.
     */
    get authorizedSessionTagValueList(): Array<string> | undefined;
    /**
     * Lake Formation relies on a privileged process secured by Amazon EMR or the third party integrator to tag the user's role while assuming it.
     */
    set authorizedSessionTagValueList(value: Array<string> | undefined);
    /**
     * Specifies whether access control on a newly created database is managed by Lake Formation permissions or exclusively by IAM permissions.
     */
    get createDatabaseDefaultPermissions(): Array<cdk.IResolvable | CfnDataLakeSettings.PrincipalPermissionsProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies whether access control on a newly created database is managed by Lake Formation permissions or exclusively by IAM permissions.
     */
    set createDatabaseDefaultPermissions(value: Array<cdk.IResolvable | CfnDataLakeSettings.PrincipalPermissionsProperty> | cdk.IResolvable | undefined);
    /**
     * Specifies whether access control on a newly created table is managed by Lake Formation permissions or exclusively by IAM permissions.
     */
    get createTableDefaultPermissions(): Array<cdk.IResolvable | CfnDataLakeSettings.PrincipalPermissionsProperty> | cdk.IResolvable | undefined;
    /**
     * Specifies whether access control on a newly created table is managed by Lake Formation permissions or exclusively by IAM permissions.
     */
    set createTableDefaultPermissions(value: Array<cdk.IResolvable | CfnDataLakeSettings.PrincipalPermissionsProperty> | cdk.IResolvable | undefined);
    /**
     * A list of the account IDs of AWS accounts with Amazon EMR clusters or third-party engines that are allwed to perform data filtering.
     */
    get externalDataFilteringAllowList(): Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of the account IDs of AWS accounts with Amazon EMR clusters or third-party engines that are allwed to perform data filtering.
     */
    set externalDataFilteringAllowList(value: Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies whether the data lake settings are updated by adding new values to the current settings ( `APPEND` ) or by replacing the current settings with new settings ( `REPLACE` ).
     */
    get mutationType(): string | undefined;
    /**
     * Specifies whether the data lake settings are updated by adding new values to the current settings ( `APPEND` ) or by replacing the current settings with new settings ( `REPLACE` ).
     */
    set mutationType(value: string | undefined);
    /**
     * A key-value map that provides an additional configuration on your data lake.
     */
    ...
    get readOnlyAdmins(): Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    set readOnlyAdmins(value: Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * An array of UTF-8 strings.
     */
    get trustedResourceOwners(): Array<string> | undefined;
    /**
     * An array of UTF-8 strings.
     */
    set trustedResourceOwners(value: Array<string> | undefined);
    /**
...
export interface CfnDataLakeSettingsProps {
     ...
     */
    readonly readOnlyAdmins?: Array<CfnDataLakeSettings.DataLakePrincipalProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * An array of UTF-8 strings.
     *
...
export declare class CfnPermissions extends cdk.CfnResource implements cdk.IInspectable, IPermissionsRef {
     ...
     * The AWS Lake Formation principal.
     */
    get dataLakePrincipal(): CfnPermissions.DataLakePrincipalProperty | cdk.IResolvable;
    /**
     * The AWS Lake Formation principal.
     */
    set dataLakePrincipal(value: CfnPermissions.DataLakePrincipalProperty | cdk.IResolvable);
    /**
     * The permissions granted or revoked.
     */
     ...
     * Indicates the ability to grant permissions (as a subset of permissions granted).
     */
    get permissionsWithGrantOption(): Array<string> | undefined;
    /**
     * Indicates the ability to grant permissions (as a subset of permissions granted).
     */
    set permissionsWithGrantOption(value: Array<string> | undefined);
    /**
     * A structure for the resource.
     */
    get resource(): cdk.IResolvable | CfnPermissions.ResourceProperty;
    /**
     * A structure for the resource.
     */
    set resource(value: cdk.IResolvable | CfnPermissions.ResourceProperty);
    /**
...
export declare class CfnPrincipalPermissions extends cdk.CfnResource implements cdk.IInspectable, IPrincipalPermissionsRef {
     ...
     * The identifier for the Data Catalog .
     */
    set catalog(value: string | undefined);
    /**
     * The permissions granted or revoked.
     */
     ...
     * Indicates the ability to grant permissions (as a subset of permissions granted).
     */
    get permissionsWithGrantOption(): Array<string>;
    /**
     * Indicates the ability to grant permissions (as a subset of permissions granted).
     */
    set permissionsWithGrantOption(value: Array<string>);
    /**
     * The principal to be granted a permission.
     */
    get principal(): CfnPrincipalPermissions.DataLakePrincipalProperty | cdk.IResolvable;
    /**
     * The principal to be granted a permission.
     */
    set principal(value: CfnPrincipalPermissions.DataLakePrincipalProperty | cdk.IResolvable);
    /**
     * The resource to be granted or revoked permissions.
     */
    get resource(): cdk.IResolvable | CfnPrincipalPermissions.ResourceProperty;
    /**
     * The resource to be granted or revoked permissions.
     */
    set resource(value: cdk.IResolvable | CfnPrincipalPermissions.ResourceProperty);
    /**
     ...
     */
    get attrPrincipalIdentifier(): string;
    /**
     ...
     */
    get attrResourceIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnResource extends cdk.CfnResource implements cdk.IInspectable, IResourceRef {
     ...
     * Indicates whether the data access of tables pointing to the location can be managed by both Lake Formation permissions as well as Amazon S3 bucket policies.
     */
    get hybridAccessEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether the data access of tables pointing to the location can be managed by both Lake Formation permissions as well as Amazon S3 bucket policies.
     */
    set hybridAccessEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the resource.
     */
     ...
     * Designates a trusted caller, an IAM principal, by registering this caller with the Data Catalog .
     */
    get useServiceLinkedRole(): boolean | cdk.IResolvable;
    /**
     * Designates a trusted caller, an IAM principal, by registering this caller with the Data Catalog .
     */
    set useServiceLinkedRole(value: boolean | cdk.IResolvable);
    /**
     * Allows Lake Formation to assume a role to access tables in a federated database.
     */
    get withFederation(): boolean | cdk.IResolvable | undefined;
    /**
     * Allows Lake Formation to assume a role to access tables in a federated database.
     */
    set withFederation(value: boolean | cdk.IResolvable | undefined);
    /**
...
export declare class CfnTag extends cdk.CfnResource implements cdk.IInspectable, ITagRef {
     ...
     * An array of UTF-8 strings, not less than 1 or more than 50 strings.
     */
    set tagValues(value: Array<string>);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnTagAssociation extends cdk.CfnResource implements cdk.IInspectable, ITagAssociationRef {
     ...
     * A structure containing an LF-tag key-value pair.
     */
    get lfTags(): Array<cdk.IResolvable | CfnTagAssociation.LFTagPairProperty> | cdk.IResolvable;
    /**
     * A structure containing an LF-tag key-value pair.
     */
    set lfTags(value: Array<cdk.IResolvable | CfnTagAssociation.LFTagPairProperty> | cdk.IResolvable);
    /**
     * UTF-8 string (valid values: `DATABASE | TABLE` ).
     */
    get resource(): cdk.IResolvable | CfnTagAssociation.ResourceProperty;
    /**
     * UTF-8 string (valid values: `DATABASE | TABLE` ).
     */
    set resource(value: cdk.IResolvable | CfnTagAssociation.ResourceProperty);
    /**
