...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggableV2 {
     ...
     * The networking configuration for the cluster's control plane.
     */
    get networking(): cdk.IResolvable | CfnCluster.NetworkingProperty;
    /**
     * The networking configuration for the cluster's control plane.
     */
    set networking(value: cdk.IResolvable | CfnCluster.NetworkingProperty);
    /**
     * The cluster management and job scheduling software associated with the cluster.
     */
    get scheduler(): cdk.IResolvable | CfnCluster.SchedulerProperty;
    /**
     * The cluster management and job scheduling software associated with the cluster.
     */
    set scheduler(value: cdk.IResolvable | CfnCluster.SchedulerProperty);
    /**
     * The size of the cluster.
     */
    get size(): string;
     ...
     * Additional options related to the Slurm scheduler.
     */
    get slurmConfiguration(): cdk.IResolvable | CfnCluster.SlurmConfigurationProperty | undefined;
    /**
     * Additional options related to the Slurm scheduler.
     */
    set slurmConfiguration(value: cdk.IResolvable | CfnCluster.SlurmConfigurationProperty | undefined);
    /**
     * 1 or more tags added to the resource.
     */
     ...
     */
    get attrEndpoints(): cdk.IResolvable;
    /**
     * The list of errors that occurred during cluster provisioning.
     *
     * @cloudformationAttribute ErrorInfo
     */
    get attrErrorInfo(): cdk.IResolvable;
    /**
...
export declare namespace CfnCluster {
    ...
    interface SlurmConfigurationProperty {
         ...
         */
        readonly cgroupCustomSettings?: Array<CfnCluster.CgroupCustomSettingProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly slurmdbdCustomSettings?: Array<cdk.IResolvable | CfnCluster.SlurmdbdCustomSettingProperty> | cdk.IResolvable;
        /**
...
export declare class CfnComputeNodeGroup extends cdk.CfnResource implements cdk.IInspectable, IComputeNodeGroupRef, cdk.ITaggableV2 {
     ...
     * An Amazon EC2 launch template AWS PCS uses to launch compute nodes.
     */
    get customLaunchTemplate(): CfnComputeNodeGroup.CustomLaunchTemplateProperty | cdk.IResolvable;
    /**
     * An Amazon EC2 launch template AWS PCS uses to launch compute nodes.
     */
    set customLaunchTemplate(value: CfnComputeNodeGroup.CustomLaunchTemplateProperty | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) of the IAM instance profile used to pass an IAM role when launching EC2 instances.
     */
     ...
     * A list of EC2 instance configurations that AWS PCS can provision in the compute node group.
     */
    get instanceConfigs(): Array<CfnComputeNodeGroup.InstanceConfigProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of EC2 instance configurations that AWS PCS can provision in the compute node group.
     */
    set instanceConfigs(value: Array<CfnComputeNodeGroup.InstanceConfigProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name that identifies the compute node group.
     */
    get name(): string | undefined;
     ...
     * Specifies how EC2 instances are purchased on your behalf.
     */
    get purchaseOption(): string | undefined;
    /**
     * Specifies how EC2 instances are purchased on your behalf.
     */
    set purchaseOption(value: string | undefined);
    /**
     * Specifies the boundaries of the compute node group auto scaling.
     */
    get scalingConfiguration(): cdk.IResolvable | CfnComputeNodeGroup.ScalingConfigurationProperty;
    /**
     * Specifies the boundaries of the compute node group auto scaling.
     */
    set scalingConfiguration(value: cdk.IResolvable | CfnComputeNodeGroup.ScalingConfigurationProperty);
    /**
     * Additional options related to the Slurm scheduler.
     */
    get slurmConfiguration(): cdk.IResolvable | CfnComputeNodeGroup.SlurmConfigurationProperty | undefined;
    /**
     * Additional options related to the Slurm scheduler.
     */
    set slurmConfiguration(value: cdk.IResolvable | CfnComputeNodeGroup.SlurmConfigurationProperty | undefined);
    /**
     * Additional configuration when you specify `SPOT` as the `purchaseOption` for the `CreateComputeNodeGroup` API action.
     */
    get spotOptions(): cdk.IResolvable | CfnComputeNodeGroup.SpotOptionsProperty | undefined;
    /**
     * Additional configuration when you specify `SPOT` as the `purchaseOption` for the `CreateComputeNodeGroup` API action.
     */
    set spotOptions(value: cdk.IResolvable | CfnComputeNodeGroup.SpotOptionsProperty | undefined);
    /**
     * The list of subnet IDs where instances are provisioned by the compute node group.
     */
...
export declare class CfnQueue extends cdk.CfnResource implements cdk.IInspectable, IQueueRef, cdk.ITaggableV2 {
     ...
     */
    private _computeNodeGroupConfigurations?;
    /**
     ...
     * The list of compute node group configurations associated with the queue.
     */
    get computeNodeGroupConfigurations(): Array<CfnQueue.ComputeNodeGroupConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of compute node group configurations associated with the queue.
     */
    set computeNodeGroupConfigurations(value: Array<CfnQueue.ComputeNodeGroupConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name that identifies the queue.
     */
    get name(): string | undefined;
     ...
     * Additional options related to the Slurm scheduler.
     */
    get slurmConfiguration(): cdk.IResolvable | CfnQueue.SlurmConfigurationProperty | undefined;
    /**
     * Additional options related to the Slurm scheduler.
     */
    set slurmConfiguration(value: cdk.IResolvable | CfnQueue.SlurmConfigurationProperty | undefined);
    /**
     * 1 or more tags added to the resource.
     */
    get tags(): Record<string, string> | undefined;
