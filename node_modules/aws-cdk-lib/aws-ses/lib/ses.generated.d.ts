...
export declare class CfnConfigurationSet extends cdk.CfnResource implements cdk.IInspectable, IConfigurationSetRef, cdk.ITaggableV2 {
     ...
     * An object that defines a MailManager archive that is used to preserve emails that you send using the configuration set.
     */
    get archivingOptions(): CfnConfigurationSet.ArchivingOptionsProperty | cdk.IResolvable | undefined;
    /**
     * An object that defines a MailManager archive that is used to preserve emails that you send using the configuration set.
     */
    set archivingOptions(value: CfnConfigurationSet.ArchivingOptionsProperty | cdk.IResolvable | undefined);
    /**
     * Specifies the name of the dedicated IP pool to associate with the configuration set and whether messages that use the configuration set are required to use Transport Layer Security (TLS).
     */
    get deliveryOptions(): CfnConfigurationSet.DeliveryOptionsProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the name of the dedicated IP pool to associate with the configuration set and whether messages that use the configuration set are required to use Transport Layer Security (TLS).
     */
    set deliveryOptions(value: CfnConfigurationSet.DeliveryOptionsProperty | cdk.IResolvable | undefined);
    /**
     * The name of the configuration set. The name must meet the following requirements:.
     */
     ...
     * An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set.
     */
    get reputationOptions(): cdk.IResolvable | CfnConfigurationSet.ReputationOptionsProperty | undefined;
    /**
     * An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set.
     */
    set reputationOptions(value: cdk.IResolvable | CfnConfigurationSet.ReputationOptionsProperty | undefined);
    /**
     * An object that defines whether or not Amazon SES can send email that you send using the configuration set.
     */
    get sendingOptions(): cdk.IResolvable | CfnConfigurationSet.SendingOptionsProperty | undefined;
    /**
     * An object that defines whether or not Amazon SES can send email that you send using the configuration set.
     */
    set sendingOptions(value: cdk.IResolvable | CfnConfigurationSet.SendingOptionsProperty | undefined);
    /**
     * An object that contains information about the suppression list preferences for your account.
     */
    get suppressionOptions(): cdk.IResolvable | CfnConfigurationSet.SuppressionOptionsProperty | undefined;
    /**
     * An object that contains information about the suppression list preferences for your account.
     */
    set suppressionOptions(value: cdk.IResolvable | CfnConfigurationSet.SuppressionOptionsProperty | undefined);
    /**
     * An array of objects that define the tags (keys and values) that are associated with the configuration set.
     */
     ...
     * An object that defines the open and click tracking options for emails that you send using the configuration set.
     */
    get trackingOptions(): cdk.IResolvable | CfnConfigurationSet.TrackingOptionsProperty | undefined;
    /**
     * An object that defines the open and click tracking options for emails that you send using the configuration set.
     */
    set trackingOptions(value: cdk.IResolvable | CfnConfigurationSet.TrackingOptionsProperty | undefined);
    /**
     * The Virtual Deliverability Manager (VDM) options that apply to the configuration set.
     */
    get vdmOptions(): cdk.IResolvable | CfnConfigurationSet.VdmOptionsProperty | undefined;
    /**
     * The Virtual Deliverability Manager (VDM) options that apply to the configuration set.
     */
    set vdmOptions(value: cdk.IResolvable | CfnConfigurationSet.VdmOptionsProperty | undefined);
...
export declare class CfnConfigurationSetEventDestination extends cdk.CfnResource implements cdk.IInspectable, IConfigurationSetEventDestinationRef {
     ...
     * An object that defines the event destination.
     */
    get eventDestination(): CfnConfigurationSetEventDestination.EventDestinationProperty | cdk.IResolvable;
    /**
     * An object that defines the event destination.
     */
    set eventDestination(value: CfnConfigurationSetEventDestination.EventDestinationProperty | cdk.IResolvable);
    /**
...
export declare class CfnContactList extends cdk.CfnResource implements cdk.IInspectable, IContactListRef, cdk.ITaggable {
     ...
     * The name of the contact list.
     */
    get contactListName(): string | undefined;
    /**
     * The name of the contact list.
     */
    set contactListName(value: string | undefined);
    /**
     * A description of what the contact list is about.
     */
     ...
     * An interest group, theme, or label within a list.
     */
    get topics(): Array<cdk.IResolvable | CfnContactList.TopicProperty> | cdk.IResolvable | undefined;
    /**
     * An interest group, theme, or label within a list.
     */
    set topics(value: Array<cdk.IResolvable | CfnContactList.TopicProperty> | cdk.IResolvable | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDedicatedIpPool extends cdk.CfnResource implements cdk.IInspectable, IDedicatedIpPoolRef, cdk.ITaggableV2 {
     ...
     * The name of the dedicated IP pool that the IP address is associated with.
     */
    get poolName(): string | undefined;
    /**
     * The name of the dedicated IP pool that the IP address is associated with.
     */
    set poolName(value: string | undefined);
    /**
     * The type of scaling mode.
     */
    get scalingMode(): string | undefined;
    /**
     * The type of scaling mode.
     */
    set scalingMode(value: string | undefined);
    /**
     * An object that defines the tags (keys and values) that you want to associate with the pool.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnEmailIdentity extends cdk.CfnResource implements cdk.IInspectable, IEmailIdentityRef, cdk.ITaggableV2 {
     ...
     */
    private _configurationSetAttributes?;
    /**
     * An object that contains information about the DKIM attributes for the identity.
     */
    private _dkimAttributes?;
    /**
     ...
     */
    private _feedbackAttributes?;
    /**
     * Used to enable or disable the custom Mail-From domain configuration for an email identity.
     */
    private _mailFromAttributes?;
    /**
     ...
     * Used to associate a configuration set with an email identity.
     */
    get configurationSetAttributes(): CfnEmailIdentity.ConfigurationSetAttributesProperty | cdk.IResolvable | undefined;
    /**
     * Used to associate a configuration set with an email identity.
     */
    set configurationSetAttributes(value: CfnEmailIdentity.ConfigurationSetAttributesProperty | cdk.IResolvable | undefined);
    /**
     * An object that contains information about the DKIM attributes for the identity.
     */
    get dkimAttributes(): CfnEmailIdentity.DkimAttributesProperty | cdk.IResolvable | undefined;
    /**
     * An object that contains information about the DKIM attributes for the identity.
     */
    set dkimAttributes(value: CfnEmailIdentity.DkimAttributesProperty | cdk.IResolvable | undefined);
    /**
     * If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for [Easy DKIM](https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html) .
     */
    get dkimSigningAttributes(): CfnEmailIdentity.DkimSigningAttributesProperty | cdk.IResolvable | undefined;
    /**
     * If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for [Easy DKIM](https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html) .
     */
    set dkimSigningAttributes(value: CfnEmailIdentity.DkimSigningAttributesProperty | cdk.IResolvable | undefined);
    /**
     * The email address or domain to verify.
     */
     ...
     * Used to enable or disable feedback forwarding for an identity.
     */
    get feedbackAttributes(): CfnEmailIdentity.FeedbackAttributesProperty | cdk.IResolvable | undefined;
    /**
     * Used to enable or disable feedback forwarding for an identity.
     */
    set feedbackAttributes(value: CfnEmailIdentity.FeedbackAttributesProperty | cdk.IResolvable | undefined);
    /**
     * Used to enable or disable the custom Mail-From domain configuration for an email identity.
     */
    get mailFromAttributes(): cdk.IResolvable | CfnEmailIdentity.MailFromAttributesProperty | undefined;
    /**
     * Used to enable or disable the custom Mail-From domain configuration for an email identity.
     */
    set mailFromAttributes(value: cdk.IResolvable | CfnEmailIdentity.MailFromAttributesProperty | undefined);
    /**
     * An array of objects that define the tags (keys and values) to associate with the email identity.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnReceiptFilter extends cdk.CfnResource implements cdk.IInspectable, IReceiptFilterRef {
     ...
     * A data structure that describes the IP address filter to create, which consists of a name, an IP address range, and whether to allow or block mail from it.
     */
    get filter(): CfnReceiptFilter.FilterProperty | cdk.IResolvable;
    /**
     * A data structure that describes the IP address filter to create, which consists of a name, an IP address range, and whether to allow or block mail from it.
     */
    set filter(value: CfnReceiptFilter.FilterProperty | cdk.IResolvable);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnReceiptRule extends cdk.CfnResource implements cdk.IInspectable, IReceiptRuleRef {
     ...
     * A data structure that contains the specified rule's name, actions, recipients, domains, enabled status, scan status, and TLS policy.
     */
    get rule(): cdk.IResolvable | CfnReceiptRule.RuleProperty;
    /**
     * A data structure that contains the specified rule's name, actions, recipients, domains, enabled status, scan status, and TLS policy.
     */
    set rule(value: cdk.IResolvable | CfnReceiptRule.RuleProperty);
    /**
     * The name of the rule set where the receipt rule is added.
     */
...
export declare class CfnReceiptRuleSet extends cdk.CfnResource implements cdk.IInspectable, IReceiptRuleSetRef {
     ...
     * The name of the receipt rule set to make active.
     */
    get ruleSetName(): string | undefined;
    /**
     * The name of the receipt rule set to make active.
     */
    set ruleSetName(value: string | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnTemplate extends cdk.CfnResource implements cdk.IInspectable, ITemplateRef, cdk.ITaggableV2 {
     ...
     * The content of the email, composed of a subject line and either an HTML part or a text-only part.
     */
    get template(): cdk.IResolvable | CfnTemplate.TemplateProperty | undefined;
    /**
     * The content of the email, composed of a subject line and either an HTML part or a text-only part.
     */
    set template(value: cdk.IResolvable | CfnTemplate.TemplateProperty | undefined);
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare class CfnVdmAttributes extends cdk.CfnResource implements cdk.IInspectable, IVdmAttributesRef {
     ...
     * Specifies additional settings for your VDM configuration as applicable to the Dashboard.
     */
    get dashboardAttributes(): CfnVdmAttributes.DashboardAttributesProperty | cdk.IResolvable | undefined;
    /**
     * Specifies additional settings for your VDM configuration as applicable to the Dashboard.
     */
    set dashboardAttributes(value: CfnVdmAttributes.DashboardAttributesProperty | cdk.IResolvable | undefined);
    /**
     * Specifies additional settings for your VDM configuration as applicable to the Guardian.
     */
    get guardianAttributes(): CfnVdmAttributes.GuardianAttributesProperty | cdk.IResolvable | undefined;
    /**
     * Specifies additional settings for your VDM configuration as applicable to the Guardian.
     */
    set guardianAttributes(value: CfnVdmAttributes.GuardianAttributesProperty | cdk.IResolvable | undefined);
    /**
 ...
 */
export declare class CfnCustomVerificationEmailTemplate extends cdk.CfnResource implements cdk.IInspectable, ICustomVerificationEmailTemplateRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCustomVerificationEmailTemplate from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCustomVerificationEmailTemplate;
    /**
     * Checks whether the given object is a CfnCustomVerificationEmailTemplate
     */
    static isCfnCustomVerificationEmailTemplate(x: any): x is CfnCustomVerificationEmailTemplate;
    /**
     * Creates a new ICustomVerificationEmailTemplateRef from a templateName
     */
    static fromTemplateName(scope: constructs.Construct, id: string, templateName: string): ICustomVerificationEmailTemplateRef;
    static arnForCustomVerificationEmailTemplate(resource: ICustomVerificationEmailTemplateRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _failureRedirectionUrl;
    /**
     ...
     */
    private _successRedirectionUrl;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCustomVerificationEmailTemplateProps);
    get customVerificationEmailTemplateRef(): CustomVerificationEmailTemplateReference;
    /**
     * The URL that the recipient of the verification email is sent to if his or her address is not successfully verified.
     */
    get failureRedirectionUrl(): string;
    /**
     * The URL that the recipient of the verification email is sent to if his or her address is not successfully verified.
     */
    set failureRedirectionUrl(value: string);
    /**
     * The email address that the custom verification email is sent from.
     */
     ...
     * The URL that the recipient of the verification email is sent to if his or her address is successfully verified.
     */
    get successRedirectionUrl(): string;
    /**
     * The URL that the recipient of the verification email is sent to if his or her address is successfully verified.
     */
    set successRedirectionUrl(value: string);
    /**
     * The tags (keys and values) associated with the tenant.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * The subject line of the custom verification email.
     */
    get templateSubject(): string;
    /**
     * The subject line of the custom verification email.
     */
    set templateSubject(value: string);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-customverificationemailtemplate.html
 */
export interface CfnCustomVerificationEmailTemplateProps {
    /**
     * The URL that the recipient of the verification email is sent to if his or her address is not successfully verified.
     *
...
export declare class CfnMailManagerAddonInstance extends cdk.CfnResource implements cdk.IInspectable, IMailManagerAddonInstanceRef, cdk.ITaggableV2 {
     ...
     * The subscription ID for the instance.
     */
    get addonSubscriptionId(): string;
    /**
     * The subscription ID for the instance.
     */
    set addonSubscriptionId(value: string);
    /**
     * The tags used to organize, track, or control access for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnMailManagerAddressList extends cdk.CfnResource implements cdk.IInspectable, IMailManagerAddressListRef, cdk.ITaggableV2 {
     ...
     * A user-friendly name for the address list.
     */
    get addressListName(): string | undefined;
    /**
     * A user-friendly name for the address list.
     */
    set addressListName(value: string | undefined);
    /**
     * The tags used to organize, track, or control access for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnMailManagerArchive extends cdk.CfnResource implements cdk.IInspectable, IMailManagerArchiveRef, cdk.ITaggableV2 {
     ...
     * The period for retaining emails in the archive before automatic deletion.
     */
    get retention(): CfnMailManagerArchive.ArchiveRetentionProperty | cdk.IResolvable | undefined;
    /**
     * The period for retaining emails in the archive before automatic deletion.
     */
    set retention(value: CfnMailManagerArchive.ArchiveRetentionProperty | cdk.IResolvable | undefined);
    /**
     * The tags used to organize, track, or control access for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnMailManagerIngressPoint extends cdk.CfnResource implements cdk.IInspectable, IMailManagerIngressPointRef, cdk.ITaggableV2 {
     ...
     * The configuration of the ingress endpoint resource.
     */
    get ingressPointConfiguration(): CfnMailManagerIngressPoint.IngressPointConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration of the ingress endpoint resource.
     */
    set ingressPointConfiguration(value: CfnMailManagerIngressPoint.IngressPointConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A user friendly name for an ingress endpoint resource.
     */
    get ingressPointName(): string | undefined;
    /**
     * A user friendly name for an ingress endpoint resource.
     */
    set ingressPointName(value: string | undefined);
    /**
     * The network type (IPv4-only, Dual-Stack, PrivateLink) of the ingress endpoint resource.
     */
    get networkConfiguration(): cdk.IResolvable | CfnMailManagerIngressPoint.NetworkConfigurationProperty | undefined;
    /**
     * The network type (IPv4-only, Dual-Stack, PrivateLink) of the ingress endpoint resource.
     */
    set networkConfiguration(value: cdk.IResolvable | CfnMailManagerIngressPoint.NetworkConfigurationProperty | undefined);
    /**
     * The identifier of an existing rule set that you attach to an ingress endpoint resource.
     */
     ...
     * The update status of an ingress endpoint.
     */
    get statusToUpdate(): string | undefined;
    /**
     * The update status of an ingress endpoint.
     */
    set statusToUpdate(value: string | undefined);
    /**
     * The tags used to organize, track, or control access for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnMailManagerRelay extends cdk.CfnResource implements cdk.IInspectable, IMailManagerRelayRef, cdk.ITaggableV2 {
     ...
     * Authentication for the relay destination server—specify the secretARN where the SMTP credentials are stored.
     */
    get authentication(): cdk.IResolvable | CfnMailManagerRelay.RelayAuthenticationProperty;
    /**
     * Authentication for the relay destination server—specify the secretARN where the SMTP credentials are stored.
     */
    set authentication(value: cdk.IResolvable | CfnMailManagerRelay.RelayAuthenticationProperty);
    /**
     * The unique relay name.
     */
    get relayName(): string | undefined;
    /**
     * The unique relay name.
     */
    set relayName(value: string | undefined);
    /**
     * The destination relay server address.
     */
...
export declare class CfnMailManagerRuleSet extends cdk.CfnResource implements cdk.IInspectable, IMailManagerRuleSetRef, cdk.ITaggableV2 {
     ...
     * Conditional rules that are evaluated for determining actions on email.
     */
    get rules(): Array<cdk.IResolvable | CfnMailManagerRuleSet.RuleProperty> | cdk.IResolvable;
    /**
     * Conditional rules that are evaluated for determining actions on email.
     */
    set rules(value: Array<cdk.IResolvable | CfnMailManagerRuleSet.RuleProperty> | cdk.IResolvable);
    /**
     * A user-friendly name for the rule set.
     */
    get ruleSetName(): string | undefined;
...
export declare class CfnMailManagerTrafficPolicy extends cdk.CfnResource implements cdk.IInspectable, IMailManagerTrafficPolicyRef, cdk.ITaggableV2 {
     ...
     * The maximum message size in bytes of email which is allowed in by this traffic policy—anything larger will be blocked.
     */
    get maxMessageSizeBytes(): number | undefined;
    /**
     * The maximum message size in bytes of email which is allowed in by this traffic policy—anything larger will be blocked.
     */
    set maxMessageSizeBytes(value: number | undefined);
    /**
     * Conditional statements for filtering email traffic.
     */
    get policyStatements(): Array<cdk.IResolvable | CfnMailManagerTrafficPolicy.PolicyStatementProperty> | cdk.IResolvable;
    /**
     * Conditional statements for filtering email traffic.
     */
    set policyStatements(value: Array<cdk.IResolvable | CfnMailManagerTrafficPolicy.PolicyStatementProperty> | cdk.IResolvable);
    /**
     * The tags used to organize, track, or control access for the resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * The name of the policy.
     */
    get trafficPolicyName(): string | undefined;
    /**
     * The name of the policy.
     */
    set trafficPolicyName(value: string | undefined);
    /**
...
export declare class CfnMultiRegionEndpoint extends cdk.CfnResource implements cdk.IInspectable, IMultiRegionEndpointRef, cdk.ITaggableV2 {
     ...
     * Contains details of a multi-region endpoint (global-endpoint) being created.
     */
    get details(): CfnMultiRegionEndpoint.DetailsProperty | cdk.IResolvable;
    /**
     * Contains details of a multi-region endpoint (global-endpoint) being created.
     */
    set details(value: CfnMultiRegionEndpoint.DetailsProperty | cdk.IResolvable);
    /**
     * The name of the multi-region endpoint (global-endpoint).
     */
...
export declare class CfnTenant extends cdk.CfnResource implements cdk.IInspectable, ITenantRef, cdk.ITaggableV2 {
     ...
     * The list of resources to associate with the tenant.
     */
    get resourceAssociations(): Array<cdk.IResolvable | CfnTenant.ResourceAssociationProperty> | cdk.IResolvable | undefined;
    /**
     * The list of resources to associate with the tenant.
     */
    set resourceAssociations(value: Array<cdk.IResolvable | CfnTenant.ResourceAssociationProperty> | cdk.IResolvable | undefined);
    /**
     * An array of objects that define the tags (keys and values) associated with the tenant.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export type { ICustomVerificationEmailTemplateRef, CustomVerificationEmailTemplateReference };
