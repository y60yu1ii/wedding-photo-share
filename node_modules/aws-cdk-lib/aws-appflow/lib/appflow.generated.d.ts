...
import { ConnectorProfileReference, ConnectorReference, FlowReference, IConnectorProfileRef, IConnectorRef, IFlowRef } from "../../interfaces/generated/aws-appflow-interfaces.generated";
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef {
     ...
     */
    private _connectorProvisioningConfig;
    /**
     * The provisioning type used to register the connector.
     */
    private _connectorProvisioningType;
    /**
     ...
     * The label used for registering the connector.
     */
    get connectorLabel(): string | undefined;
    /**
     * The label used for registering the connector.
     */
    set connectorLabel(value: string | undefined);
    /**
     * The configuration required for registering the connector.
     */
    get connectorProvisioningConfig(): CfnConnector.ConnectorProvisioningConfigProperty | cdk.IResolvable;
    /**
     * The configuration required for registering the connector.
     */
    set connectorProvisioningConfig(value: CfnConnector.ConnectorProvisioningConfigProperty | cdk.IResolvable);
    /**
     * The provisioning type used to register the connector.
     */
    get connectorProvisioningType(): string;
    /**
     * The provisioning type used to register the connector.
     */
    set connectorProvisioningType(value: string);
    /**
     * A description about the connector runtime setting.
     */
...
export declare class CfnConnectorProfile extends cdk.CfnResource implements cdk.IInspectable, IConnectorProfileRef {
     ...
     * Defines the connector-specific configuration and credentials.
     */
    get connectorProfileConfig(): CfnConnectorProfile.ConnectorProfileConfigProperty | cdk.IResolvable | undefined;
    /**
     * Defines the connector-specific configuration and credentials.
     */
    set connectorProfileConfig(value: CfnConnectorProfile.ConnectorProfileConfigProperty | cdk.IResolvable | undefined);
    /**
     * The name of the connector profile.
     */
     ...
     * The ARN (Amazon Resource Name) of the Key Management Service (KMS) key you provide for encryption.
     */
    get kmsArn(): string | undefined;
    /**
     * The ARN (Amazon Resource Name) of the Key Management Service (KMS) key you provide for encryption.
     */
    set kmsArn(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the connector profile.
     *
     * @cloudformationAttribute ConnectorProfileArn
     */
    get attrConnectorProfileArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the connector profile credentials.
     *
     * @cloudformationAttribute CredentialsArn
     */
    get attrCredentialsArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnFlow extends cdk.CfnResource implements cdk.IInspectable, IFlowRef, cdk.ITaggable {
     ...
     * The configuration that controls how Amazon AppFlow places data in the destination connector.
     */
    get destinationFlowConfigList(): Array<CfnFlow.DestinationFlowConfigProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The configuration that controls how Amazon AppFlow places data in the destination connector.
     */
    set destinationFlowConfigList(value: Array<CfnFlow.DestinationFlowConfigProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The specified name of the flow.
     */
    get flowName(): string;
     ...
     * Sets the status of the flow. You can specify one of the following values:.
     */
    get flowStatus(): string | undefined;
    /**
     * Sets the status of the flow. You can specify one of the following values:.
     */
    set flowStatus(value: string | undefined);
    /**
     * The ARN (Amazon Resource Name) of the Key Management Service (KMS) key you provide for encryption.
     */
    get kmsArn(): string | undefined;
     ...
     * Specifies the configuration that Amazon AppFlow uses when it catalogs your data.
     */
    get metadataCatalogConfig(): cdk.IResolvable | CfnFlow.MetadataCatalogConfigProperty | undefined;
    /**
     * Specifies the configuration that Amazon AppFlow uses when it catalogs your data.
     */
    set metadataCatalogConfig(value: cdk.IResolvable | CfnFlow.MetadataCatalogConfigProperty | undefined);
    /**
     * Contains information about the configuration of the source connector used in the flow.
     */
    get sourceFlowConfig(): cdk.IResolvable | CfnFlow.SourceFlowConfigProperty;
    /**
     * Contains information about the configuration of the source connector used in the flow.
     */
    set sourceFlowConfig(value: cdk.IResolvable | CfnFlow.SourceFlowConfigProperty);
    /**
     * The tags used to organize, track, or control access for your flow.
     */
     ...
     * A list of tasks that Amazon AppFlow performs while transferring the data in the flow run.
     */
    get tasks(): Array<cdk.IResolvable | CfnFlow.TaskProperty> | cdk.IResolvable;
    /**
     * A list of tasks that Amazon AppFlow performs while transferring the data in the flow run.
     */
    set tasks(value: Array<cdk.IResolvable | CfnFlow.TaskProperty> | cdk.IResolvable);
    /**
     * The trigger settings that determine how and when Amazon AppFlow runs the specified flow.
     */
    get triggerConfig(): cdk.IResolvable | CfnFlow.TriggerConfigProperty;
    /**
     * The trigger settings that determine how and when Amazon AppFlow runs the specified flow.
     */
    set triggerConfig(value: cdk.IResolvable | CfnFlow.TriggerConfigProperty);
    /**
...
export interface CfnFlowProps {
     ...
     */
    readonly kmsArn?: kmsRefs.IKeyRef | string;
    /**
     * Specifies the configuration that Amazon AppFlow uses when it catalogs your data.
     *
     * When Amazon AppFlow catalogs your data, it stores metadata in a data catalog.
