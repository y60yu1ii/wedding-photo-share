...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef {
     ...
     * Sets the branch patterns for automatic subdomain creation.
     */
    get autoSubDomainCreationPatterns(): Array<string> | undefined;
    /**
     * Sets the branch patterns for automatic subdomain creation.
     */
    set autoSubDomainCreationPatterns(value: Array<string> | undefined);
    /**
     * The required AWS Identity and Access Management (IAMlong) service role for the Amazon Resource Name (ARN) for automatically creating subdomains.
     */
    get autoSubDomainIamRole(): string | undefined;
    /**
     * The required AWS Identity and Access Management (IAMlong) service role for the Amazon Resource Name (ARN) for automatically creating subdomains.
     */
    set autoSubDomainIamRole(value: string | undefined);
    /**
     * The type of SSL/TLS certificate to use for your custom domain.
     */
    get certificateSettings(): CfnDomain.CertificateSettingsProperty | cdk.IResolvable | undefined;
    /**
     * The type of SSL/TLS certificate to use for your custom domain.
     */
    set certificateSettings(value: CfnDomain.CertificateSettingsProperty | cdk.IResolvable | undefined);
    /**
     * The domain name for the domain association.
     */
     ...
     * Enables the automated creation of subdomains for branches.
     */
    get enableAutoSubDomain(): boolean | cdk.IResolvable | undefined;
    /**
     * Enables the automated creation of subdomains for branches.
     */
    set enableAutoSubDomain(value: boolean | cdk.IResolvable | undefined);
    /**
     * The setting for the subdomain.
     */
    get subDomainSettings(): Array<cdk.IResolvable | CfnDomain.SubDomainSettingProperty> | cdk.IResolvable;
    /**
     * The setting for the subdomain.
     */
    set subDomainSettings(value: Array<cdk.IResolvable | CfnDomain.SubDomainSettingProperty> | cdk.IResolvable);
    /**
     ...
     */
    get attrEnableAutoSubDomain(): cdk.IResolvable;
    /**
...
export interface CfnDomainProps {
     ...
     */
    readonly autoSubDomainIamRole?: iamRefs.IRoleRef | string;
    /**
     * The type of SSL/TLS certificate to use for your custom domain.
     *
