...
import { aws_batch as batchRefs, aws_iam as iamRefs } from "../../interfaces";
import { ComputeEnvironmentReference, ConsumableResourceReference, IComputeEnvironmentRef, IConsumableResourceRef, IJobDefinitionRef, IJobQueueRef, IQuotaShareRef, ISchedulingPolicyRef, IServiceEnvironmentRef, JobDefinitionReference, JobQueueReference, QuotaShareReference, SchedulingPolicyReference, ServiceEnvironmentReference } from "../../interfaces/generated/aws-batch-interfaces.generated";
/**
...
export declare class CfnComputeEnvironment extends cdk.CfnResource implements cdk.IInspectable, IComputeEnvironmentRef, cdk.ITaggable {
     ...
     */
    private _replaceComputeEnvironment?;
    /**
     ...
     * The ComputeResources property type specifies details of the compute resources managed by the compute environment.
     */
    get computeResources(): CfnComputeEnvironment.ComputeResourcesProperty | cdk.IResolvable | undefined;
    /**
     * The ComputeResources property type specifies details of the compute resources managed by the compute environment.
     */
    set computeResources(value: CfnComputeEnvironment.ComputeResourcesProperty | cdk.IResolvable | undefined);
    /**
     * Reserved.
     */
     ...
     * The details for the Amazon EKS cluster that supports the compute environment.
     */
    get eksConfiguration(): CfnComputeEnvironment.EksConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The details for the Amazon EKS cluster that supports the compute environment.
     */
    set eksConfiguration(value: CfnComputeEnvironment.EksConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether the compute environment is replaced if an update is made that requires replacing the instances in the compute environment.
     */
    get replaceComputeEnvironment(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the compute environment is replaced if an update is made that requires replacing the instances in the compute environment.
     */
    set replaceComputeEnvironment(value: boolean | cdk.IResolvable | undefined);
    /**
     * The full Amazon Resource Name (ARN) of the IAM role that allows AWS Batch to make calls to other AWS services on your behalf.
     */
     ...
     * The maximum number of vCPUs for an unmanaged compute environment.
     */
    get unmanagedvCpus(): number | undefined;
    /**
     * The maximum number of vCPUs for an unmanaged compute environment.
     */
    set unmanagedvCpus(value: number | undefined);
    /**
     * Specifies the infrastructure update policy for the compute environment.
     */
    get updatePolicy(): cdk.IResolvable | CfnComputeEnvironment.UpdatePolicyProperty | undefined;
    /**
     * Specifies the infrastructure update policy for the compute environment.
     */
    set updatePolicy(value: cdk.IResolvable | CfnComputeEnvironment.UpdatePolicyProperty | undefined);
    /**
     ...
     */
    get attrComputeEnvironmentArn(): string;
...
export declare namespace CfnComputeEnvironment {
    ...
    interface ComputeResourcesProperty {
         ...
         */
        readonly scalingPolicy?: CfnComputeEnvironment.ComputeScalingPolicyProperty | cdk.IResolvable;
        /**
     ...
     */
    interface ComputeScalingPolicyProperty {
        /**
...
export declare class CfnJobDefinition extends cdk.CfnResource implements cdk.IInspectable, IJobDefinitionRef, cdk.ITaggable {
     ...
     */
    private _consumableResourceProperties?;
    /**
     ...
     */
    private _resourceRetentionPolicy?;
    /**
     ...
     * Contains a list of consumable resources required by the job.
     */
    get consumableResourceProperties(): CfnJobDefinition.ConsumableResourcePropertiesProperty | cdk.IResolvable | undefined;
    /**
     * Contains a list of consumable resources required by the job.
     */
    set consumableResourceProperties(value: CfnJobDefinition.ConsumableResourcePropertiesProperty | cdk.IResolvable | undefined);
    /**
     * An object with properties specific to Amazon ECS-based jobs.
     */
    get containerProperties(): CfnJobDefinition.ContainerPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * An object with properties specific to Amazon ECS-based jobs.
     */
    set containerProperties(value: CfnJobDefinition.ContainerPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * An object that contains the properties for the Amazon ECS resources of a job.When `ecsProperties` is used in the job definition, it can't be used in addition to `containerProperties` , `eksProperties` , or `nodeProperties` .
     */
    get ecsProperties(): CfnJobDefinition.EcsPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * An object that contains the properties for the Amazon ECS resources of a job.When `ecsProperties` is used in the job definition, it can't be used in addition to `containerProperties` , `eksProperties` , or `nodeProperties` .
     */
    set ecsProperties(value: CfnJobDefinition.EcsPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * An object with properties that are specific to Amazon EKS-based jobs.
     */
    get eksProperties(): CfnJobDefinition.EksPropertiesProperty | cdk.IResolvable | undefined;
    /**
     * An object with properties that are specific to Amazon EKS-based jobs.
     */
    set eksProperties(value: CfnJobDefinition.EksPropertiesProperty | cdk.IResolvable | undefined);
    /**
     * The name of the job definition.
     */
     ...
     * An object with properties that are specific to multi-node parallel jobs.
     */
    get nodeProperties(): cdk.IResolvable | CfnJobDefinition.NodePropertiesProperty | undefined;
    /**
     * An object with properties that are specific to multi-node parallel jobs.
     */
    set nodeProperties(value: cdk.IResolvable | CfnJobDefinition.NodePropertiesProperty | undefined);
    /**
     * Default parameters or parameter substitution placeholders that are set in the job definition.
     */
     ...
     * The platform capabilities required by the job definition.
     */
    get platformCapabilities(): Array<string> | undefined;
    /**
     * The platform capabilities required by the job definition.
     */
    set platformCapabilities(value: Array<string> | undefined);
    /**
     * Specifies whether to propagate the tags from the job or job definition to the corresponding Amazon ECS task.
     */
    get propagateTags(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether to propagate the tags from the job or job definition to the corresponding Amazon ECS task.
     */
    set propagateTags(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies the resource retention policy settings for the job definition.
     */
    get resourceRetentionPolicy(): cdk.IResolvable | CfnJobDefinition.ResourceRetentionPolicyProperty | undefined;
    /**
     * Specifies the resource retention policy settings for the job definition.
     */
    set resourceRetentionPolicy(value: cdk.IResolvable | CfnJobDefinition.ResourceRetentionPolicyProperty | undefined);
    /**
     * The retry strategy to use for failed jobs that are submitted with this job definition.
     */
    get retryStrategy(): cdk.IResolvable | CfnJobDefinition.RetryStrategyProperty | undefined;
    /**
     * The retry strategy to use for failed jobs that are submitted with this job definition.
     */
    set retryStrategy(value: cdk.IResolvable | CfnJobDefinition.RetryStrategyProperty | undefined);
    /**
     * The scheduling priority of the job definition.
     */
    get schedulingPriority(): number | undefined;
    /**
     * The scheduling priority of the job definition.
     */
    set schedulingPriority(value: number | undefined);
    /**
     * The tags that are applied to the job definition.
     */
     ...
     * The timeout time for jobs that are submitted with this job definition.
     */
    get timeout(): cdk.IResolvable | CfnJobDefinition.TimeoutProperty | undefined;
    /**
     * The timeout time for jobs that are submitted with this job definition.
     */
    set timeout(value: cdk.IResolvable | CfnJobDefinition.TimeoutProperty | undefined);
    /**
     * The type of job definition.
     */
    get type(): string;
...
export declare class CfnJobQueue extends cdk.CfnResource implements cdk.IInspectable, IJobQueueRef, cdk.ITaggable {
     ...
     */
    private _jobQueueName?;
    /**
     * The type of job queue.
     */
    private _jobQueueType?;
    /**
     ...
     */
    private _jobStateTimeLimitActions?;
    /**
     ...
     */
    private _serviceEnvironmentOrder?;
    /**
     ...
     * The set of compute environments mapped to a job queue and their order relative to each other.
     */
    get computeEnvironmentOrder(): Array<CfnJobQueue.ComputeEnvironmentOrderProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The set of compute environments mapped to a job queue and their order relative to each other.
     */
    set computeEnvironmentOrder(value: Array<CfnJobQueue.ComputeEnvironmentOrderProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the job queue.
     */
    get jobQueueName(): string | undefined;
    /**
     * The name of the job queue.
     */
    set jobQueueName(value: string | undefined);
    /**
     * The type of job queue.
     */
    get jobQueueType(): string | undefined;
    /**
     * The type of job queue.
     */
    set jobQueueType(value: string | undefined);
    /**
     * The set of actions that AWS Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times.
     */
    get jobStateTimeLimitActions(): Array<cdk.IResolvable | CfnJobQueue.JobStateTimeLimitActionProperty> | cdk.IResolvable | undefined;
    /**
     * The set of actions that AWS Batch perform on jobs that remain at the head of the job queue in the specified state longer than specified times.
     */
    set jobStateTimeLimitActions(value: Array<cdk.IResolvable | CfnJobQueue.JobStateTimeLimitActionProperty> | cdk.IResolvable | undefined);
    /**
     * The priority of the job queue.
     */
    get priority(): number;
     ...
     * The Amazon Resource Name (ARN) of the scheduling policy.
     */
    get schedulingPolicyArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the scheduling policy.
     */
    set schedulingPolicyArn(value: string | undefined);
    /**
     * The order of the service environment associated with the job queue.
     */
    get serviceEnvironmentOrder(): Array<cdk.IResolvable | CfnJobQueue.ServiceEnvironmentOrderProperty> | cdk.IResolvable | undefined;
    /**
     * The order of the service environment associated with the job queue.
     */
    set serviceEnvironmentOrder(value: Array<cdk.IResolvable | CfnJobQueue.ServiceEnvironmentOrderProperty> | cdk.IResolvable | undefined);
    /**
     * The state of the job queue.
     */
    get state(): string | undefined;
...
export interface CfnJobQueueProps {
     ...
     */
    readonly schedulingPolicyArn?: batchRefs.ISchedulingPolicyRef | string;
    /**
     * The order of the service environment associated with the job queue.
     *
     * Job queues with a higher priority are evaluated first when associated with the same service environment.
...
export declare class CfnSchedulingPolicy extends cdk.CfnResource implements cdk.IInspectable, ISchedulingPolicyRef, cdk.ITaggable {
     ...
     * The fair-share scheduling policy details.
     */
    get fairsharePolicy(): CfnSchedulingPolicy.FairsharePolicyProperty | cdk.IResolvable | undefined;
    /**
     * The fair-share scheduling policy details.
     */
    set fairsharePolicy(value: CfnSchedulingPolicy.FairsharePolicyProperty | cdk.IResolvable | undefined);
    /**
     * The name of the fair-share scheduling policy.
     */
     ...
     * Quota Share Policy for the Job Queue.
     */
    get quotaSharePolicy(): cdk.IResolvable | CfnSchedulingPolicy.QuotaSharePolicyProperty | undefined;
    /**
     * Quota Share Policy for the Job Queue.
     */
    set quotaSharePolicy(value: cdk.IResolvable | CfnSchedulingPolicy.QuotaSharePolicyProperty | undefined);
    /**
     * The tags that you apply to the scheduling policy to help you categorize and organize your resources.
     */
    get tagsRaw(): Record<string, string> | undefined;
...
export declare namespace CfnSchedulingPolicy {
     ...
     */
    interface QuotaSharePolicyProperty {
        /**
...
export interface CfnSchedulingPolicyProps {
     ...
     */
    readonly quotaSharePolicy?: cdk.IResolvable | CfnSchedulingPolicy.QuotaSharePolicyProperty;
    /**
     * The tags that you apply to the scheduling policy to help you categorize and organize your resources.
     *
...
export declare class CfnConsumableResource extends cdk.CfnResource implements cdk.IInspectable, IConsumableResourceRef, cdk.ITaggableV2 {
     ...
     */
    private _consumableResourceName?;
    /**
     ...
     * The name of the consumable resource.
     */
    get consumableResourceName(): string | undefined;
    /**
     * The name of the consumable resource.
     */
    set consumableResourceName(value: string | undefined);
    /**
     * Indicates whether the resource is available to be re-used after a job completes. Can be one of:.
     */
 ...
 */
export declare class CfnQuotaShare extends cdk.CfnResource implements cdk.IInspectable, IQuotaShareRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnQuotaShare from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnQuotaShare;
    /**
     * Checks whether the given object is a CfnQuotaShare
     */
    static isCfnQuotaShare(x: any): x is CfnQuotaShare;
    static arnForQuotaShare(resource: IQuotaShareRef): string;
    /**
     ...
     */
    private _jobQueue;
    private _preemptionConfiguration;
    /**
     * The name of the quota share.
     */
    private _quotaShareName;
    private _resourceSharingConfiguration;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnQuotaShareProps);
    get quotaShareRef(): QuotaShareReference;
    /**
     * The capacity limits for the quota share.
     */
    get capacityLimits(): Array<cdk.IResolvable | CfnQuotaShare.QuotaShareCapacityLimitProperty> | cdk.IResolvable;
    /**
     * The capacity limits for the quota share.
     */
    set capacityLimits(value: Array<cdk.IResolvable | CfnQuotaShare.QuotaShareCapacityLimitProperty> | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) or name of the job queue.
     */
    get jobQueue(): string;
     ...
     * The Amazon Resource Name (ARN) or name of the job queue.
     */
    set jobQueue(value: string);
    get preemptionConfiguration(): cdk.IResolvable | CfnQuotaShare.QuotaSharePreemptionConfigurationProperty;
    set preemptionConfiguration(value: cdk.IResolvable | CfnQuotaShare.QuotaSharePreemptionConfigurationProperty);
    /**
     * The name of the quota share.
     */
    get quotaShareName(): string;
    /**
     * The name of the quota share.
     */
    set quotaShareName(value: string);
    get resourceSharingConfiguration(): cdk.IResolvable | CfnQuotaShare.QuotaShareResourceSharingConfigurationProperty;
    set resourceSharingConfiguration(value: cdk.IResolvable | CfnQuotaShare.QuotaShareResourceSharingConfigurationProperty);
    /**
     * The state of the quota share.
     */
    get state(): string | undefined;
...
export declare namespace CfnQuotaShare {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-batch-quotashare.html
 */
export interface CfnQuotaShareProps {
    /**
     * The capacity limits for the quota share.
     *
     ...
     */
    readonly capacityLimits: Array<cdk.IResolvable | CfnQuotaShare.QuotaShareCapacityLimitProperty> | cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) or name of the job queue.
     *
     ...
     */
    readonly preemptionConfiguration: cdk.IResolvable | CfnQuotaShare.QuotaSharePreemptionConfigurationProperty;
    /**
     * The name of the quota share.
     *
     ...
     */
    readonly resourceSharingConfiguration: cdk.IResolvable | CfnQuotaShare.QuotaShareResourceSharingConfigurationProperty;
    /**
     * The state of the quota share.
     *
...
export declare class CfnServiceEnvironment extends cdk.CfnResource implements cdk.IInspectable, IServiceEnvironmentRef, cdk.ITaggableV2 {
     ...
     */
    private _serviceEnvironmentName?;
    /**
     * The type of service environment.
     */
    private _serviceEnvironmentType;
    /**
     ...
     * The capacity limits for the service environment.
     */
    get capacityLimits(): Array<CfnServiceEnvironment.CapacityLimitProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The capacity limits for the service environment.
     */
    set capacityLimits(value: Array<CfnServiceEnvironment.CapacityLimitProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The name of the service environment.
     */
    get serviceEnvironmentName(): string | undefined;
    /**
     * The name of the service environment.
     */
    set serviceEnvironmentName(value: string | undefined);
    /**
     * The type of service environment.
     */
    get serviceEnvironmentType(): string;
    /**
     * The type of service environment.
     */
    set serviceEnvironmentType(value: string);
    /**
     * The state of the service environment.
     */
    get state(): string | undefined;
     ...
     */
    get attrServiceEnvironmentArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export type { IQuotaShareRef, QuotaShareReference };
