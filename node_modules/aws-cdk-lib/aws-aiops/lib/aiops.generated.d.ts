...
export declare class CfnInvestigationGroup extends cdk.CfnResource implements cdk.IInspectable, IInvestigationGroupRef, cdk.ITaggableV2 {
     ...
     * Use this property to integrate CloudWatch investigations with chat applications.
     */
    get chatbotNotificationChannels(): Array<CfnInvestigationGroup.ChatbotNotificationChannelProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Use this property to integrate CloudWatch investigations with chat applications.
     */
    set chatbotNotificationChannels(value: Array<CfnInvestigationGroup.ChatbotNotificationChannelProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * List of `sourceRoleArn` values that have been configured for cross-account access.
     */
    get crossAccountConfigurations(): Array<CfnInvestigationGroup.CrossAccountConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * List of `sourceRoleArn` values that have been configured for cross-account access.
     */
    set crossAccountConfigurations(value: Array<CfnInvestigationGroup.CrossAccountConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the customer managed AWS  key that the investigation group uses to encrypt data, if there is one.
     */
    get encryptionConfig(): CfnInvestigationGroup.EncryptionConfigMapProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the customer managed AWS  key that the investigation group uses to encrypt data, if there is one.
     */
    set encryptionConfig(value: CfnInvestigationGroup.EncryptionConfigMapProperty | cdk.IResolvable | undefined);
    /**
     * Returns the JSON of the IAM resource policy associated with the specified investigation group in a string.
     */
    get investigationGroupPolicy(): string | undefined;
    /**
     * Returns the JSON of the IAM resource policy associated with the specified investigation group in a string.
     */
    set investigationGroupPolicy(value: string | undefined);
    /**
     * Specify `true` to enable CloudWatch investigations to have access to change events that are recorded by CloudTrail.
     */
    get isCloudTrailEventHistoryEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specify `true` to enable CloudWatch investigations to have access to change events that are recorded by CloudTrail.
     */
    set isCloudTrailEventHistoryEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specify either the name or the ARN of the investigation group that you want to view.
     */
    get name(): string;
     ...
     * Displays the custom tag keys for custom applications in your system that you have specified in the investigation group.
     */
    get tagKeyBoundaries(): Array<string> | undefined;
    /**
     * Displays the custom tag keys for custom applications in your system that you have specified in the investigation group.
     */
    set tagKeyBoundaries(value: Array<string> | undefined);
    /**
     * The list of key-value pairs to associate with the resource.
     */
