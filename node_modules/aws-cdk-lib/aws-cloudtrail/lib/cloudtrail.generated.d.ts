...
import { ChannelReference, DashboardReference, EventDataStoreReference, IChannelRef, IDashboardRef, IEventDataStoreRef, IResourcePolicyRef, ITrailRef, ResourcePolicyReference, TrailReference } from "../../interfaces/generated/aws-cloudtrail-interfaces.generated";
import { aws_iam as iamRefs, aws_kms as kmsRefs, aws_logs as logsRefs, aws_s3 as s3Refs } from "../../interfaces";
/**
...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggable {
     ...
     * One or more event data stores to which events arriving through a channel will be logged.
     */
    get destinations(): Array<CfnChannel.DestinationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * One or more event data stores to which events arriving through a channel will be logged.
     */
    set destinations(value: Array<CfnChannel.DestinationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The name of the channel.
     */
...
export declare class CfnEventDataStore extends cdk.CfnResource implements cdk.IInspectable, IEventDataStoreRef, cdk.ITaggable {
     ...
     * The advanced event selectors to use to select the events for the data store.
     */
    get advancedEventSelectors(): Array<CfnEventDataStore.AdvancedEventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The advanced event selectors to use to select the events for the data store.
     */
    set advancedEventSelectors(value: Array<CfnEventDataStore.AdvancedEventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The billing mode for the event data store determines the cost for ingesting events and the default and maximum retention period for the event data store.
     */
     ...
     * The list of context key selectors that are configured for the event data store.
     */
    get contextKeySelectors(): Array<CfnEventDataStore.ContextKeySelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of context key selectors that are configured for the event data store.
     */
    set contextKeySelectors(value: Array<CfnEventDataStore.ContextKeySelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Indicates if [Lake query federation](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html) is enabled. By default, Lake query federation is disabled. You cannot delete an event data store if Lake query federation is enabled.
     */
    get federationEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates if [Lake query federation](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/query-federation.html) is enabled. By default, Lake query federation is disabled. You cannot delete an event data store if Lake query federation is enabled.
     */
    set federationEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * If Lake query federation is enabled, provides the ARN of the federation role used to access the resources for the federated event data store.
     */
    get federationRoleArn(): string | undefined;
    /**
     * If Lake query federation is enabled, provides the ARN of the federation role used to access the resources for the federated event data store.
     */
    set federationRoleArn(value: string | undefined);
    /**
     * Specifies whether the event data store should start ingesting live events.
     */
    get ingestionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the event data store should start ingesting live events.
     */
    set ingestionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARN (or ID suffix of the ARN) of the destination event data store that logs Insights events.
     */
    get insightsDestination(): string | undefined;
    /**
     * The ARN (or ID suffix of the ARN) of the destination event data store that logs Insights events.
     */
    set insightsDestination(value: string | undefined);
    /**
     * A JSON string that contains the Insights types you want to log on an event data store.
     */
    get insightSelectors(): Array<CfnEventDataStore.InsightSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A JSON string that contains the Insights types you want to log on an event data store.
     */
    set insightSelectors(value: Array<CfnEventDataStore.InsightSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the AWS  key ID to use to encrypt the events delivered by CloudTrail.
     */
     ...
     * The maximum allowed size for events to be stored in the specified event data store.
     */
    get maxEventSize(): string | undefined;
    /**
     * The maximum allowed size for events to be stored in the specified event data store.
     */
    set maxEventSize(value: string | undefined);
    /**
     * Specifies whether the event data store includes events from all Regions, or only from the Region in which the event data store is created.
     */
    get multiRegionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the event data store includes events from all Regions, or only from the Region in which the event data store is created.
     */
    set multiRegionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the event data store.
     */
    get name(): string | undefined;
     ...
     * Specifies whether an event data store collects events logged for an organization in AWS Organizations .
     */
    get organizationEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether an event data store collects events logged for an organization in AWS Organizations .
     */
    set organizationEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The retention period of the event data store, in days.
     */
     ...
     * Specifies whether termination protection is enabled for the event data store.
     */
    get terminationProtectionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether termination protection is enabled for the event data store.
     */
    set terminationProtectionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrEventDataStoreArn(): string;
    /**
...
export declare class CfnTrail extends cdk.CfnResource implements cdk.IInspectable, ITrailRef, cdk.ITaggable {
     ...
     */
    private _aggregationConfigurations?;
    /**
     ...
     * Specifies the settings for advanced event selectors.
     */
    get advancedEventSelectors(): Array<CfnTrail.AdvancedEventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the settings for advanced event selectors.
     */
    set advancedEventSelectors(value: Array<CfnTrail.AdvancedEventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies the aggregation configuration to aggregate CloudTrail Events.
     */
    get aggregationConfigurations(): Array<CfnTrail.AggregationConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Specifies the aggregation configuration to aggregate CloudTrail Events.
     */
    set aggregationConfigurations(value: Array<CfnTrail.AggregationConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies a log group name using an Amazon Resource Name (ARN), a unique identifier that represents the log group to which CloudTrail logs are delivered.
     */
    get cloudWatchLogsLogGroupArn(): string | undefined;
    /**
     * Specifies a log group name using an Amazon Resource Name (ARN), a unique identifier that represents the log group to which CloudTrail logs are delivered.
     */
    set cloudWatchLogsLogGroupArn(value: string | undefined);
    /**
     * Specifies the role for the CloudWatch Logs endpoint to assume to write to a user's log group.
     */
     ...
     * Specifies whether log file validation is enabled. The default is false.
     */
    get enableLogFileValidation(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether log file validation is enabled. The default is false.
     */
    set enableLogFileValidation(value: boolean | cdk.IResolvable | undefined);
    /**
     * Use event selectors to further specify the management and data event settings for your trail.
     */
    get eventSelectors(): Array<CfnTrail.EventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Use event selectors to further specify the management and data event settings for your trail.
     */
    set eventSelectors(value: Array<CfnTrail.EventSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Specifies whether the trail is publishing events from global services such as IAM to the log files.
     */
    get includeGlobalServiceEvents(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the trail is publishing events from global services such as IAM to the log files.
     */
    set includeGlobalServiceEvents(value: boolean | cdk.IResolvable | undefined);
    /**
     * A JSON string that contains the Insights types you want to log on a trail.
     */
    get insightSelectors(): Array<CfnTrail.InsightSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A JSON string that contains the Insights types you want to log on a trail.
     */
    set insightSelectors(value: Array<CfnTrail.InsightSelectorProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Whether the CloudTrail trail is currently logging AWS API calls.
     */
    get isLogging(): boolean | cdk.IResolvable;
    /**
     * Whether the CloudTrail trail is currently logging AWS API calls.
     */
    set isLogging(value: boolean | cdk.IResolvable);
    /**
     * Specifies whether the trail applies only to the current Region or to all Regions.
     */
    get isMultiRegionTrail(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the trail applies only to the current Region or to all Regions.
     */
    set isMultiRegionTrail(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies whether the trail is applied to all accounts in an organization in AWS Organizations , or only for the current AWS account .
     */
    get isOrganizationTrail(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether the trail is applied to all accounts in an organization in AWS Organizations , or only for the current AWS account .
     */
    set isOrganizationTrail(value: boolean | cdk.IResolvable | undefined);
    /**
     * Specifies the AWS  key ID to use to encrypt the logs and digest files delivered by CloudTrail.
     */
    get kmsKeyId(): string | undefined;
     ...
     * Specifies the name of the trail. The name must meet the following requirements:.
     */
    get trailName(): string | undefined;
    /**
     * Specifies the name of the trail. The name must meet the following requirements:.
     */
    set trailName(value: string | undefined);
    /**
...
export interface CfnTrailProps {
     ...
     */
    readonly cloudWatchLogsLogGroupArn?: logsRefs.ILogGroupRef | string;
    /**
     * Specifies the role for the CloudWatch Logs endpoint to assume to write to a user's log group.
     *
     ...
     */
    readonly cloudWatchLogsRoleArn?: iamRefs.IRoleRef | string;
    /**
     * Specifies whether log file validation is enabled. The default is false.
     *
     ...
     */
    readonly kmsKeyId?: kmsRefs.IAliasRef | kmsRefs.IKeyRef | string;
    /**
     * Specifies the name of the Amazon S3 bucket designated for publishing log files.
     *
     ...
     */
    readonly s3BucketName: s3Refs.IBucketRef | string;
    /**
     * Specifies the Amazon S3 key prefix that comes after the name of the bucket you have designated for log file delivery.
     *
...
export declare class CfnDashboard extends cdk.CfnResource implements cdk.IInspectable, IDashboardRef, cdk.ITaggableV2 {
     ...
     * The schedule for a dashboard refresh.
     */
    get refreshSchedule(): cdk.IResolvable | CfnDashboard.RefreshScheduleProperty | undefined;
    /**
     * The schedule for a dashboard refresh.
     */
    set refreshSchedule(value: cdk.IResolvable | CfnDashboard.RefreshScheduleProperty | undefined);
    /**
     * A list of tags.
     */
     ...
     * An array of widgets for a custom dashboard. A custom dashboard can have a maximum of ten widgets.
     */
    get widgets(): Array<cdk.IResolvable | CfnDashboard.WidgetProperty> | cdk.IResolvable | undefined;
    /**
     * An array of widgets for a custom dashboard. A custom dashboard can have a maximum of ten widgets.
     */
    set widgets(value: Array<cdk.IResolvable | CfnDashboard.WidgetProperty> | cdk.IResolvable | undefined);
    /**
