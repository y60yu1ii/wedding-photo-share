...
export declare class CfnCidrCollection extends cdk.CfnResource implements cdk.IInspectable, ICidrCollectionRef {
     ...
     * A complex type that contains information about the list of CIDR locations.
     */
    get locations(): Array<cdk.IResolvable | CfnCidrCollection.LocationProperty> | cdk.IResolvable | undefined;
    /**
     * A complex type that contains information about the list of CIDR locations.
     */
    set locations(value: Array<cdk.IResolvable | CfnCidrCollection.LocationProperty> | cdk.IResolvable | undefined);
    /**
     * The name of a CIDR collection.
     */
    get name(): string;
...
export declare class CfnHealthCheck extends cdk.CfnResource implements cdk.IInspectable, IHealthCheckRef, cdk.ITaggableV2 {
     ...
     * A complex type that contains detailed information about one health check.
     */
    get healthCheckConfig(): CfnHealthCheck.HealthCheckConfigProperty | cdk.IResolvable;
    /**
     * A complex type that contains detailed information about one health check.
     */
    set healthCheckConfig(value: CfnHealthCheck.HealthCheckConfigProperty | cdk.IResolvable);
    /**
     * The `HealthCheckTags` property describes key-value pairs that are associated with an `AWS::Route53::HealthCheck` resource.
     */
    get healthCheckTags(): Array<CfnHealthCheck.HealthCheckTagProperty> | undefined;
    /**
     * The `HealthCheckTags` property describes key-value pairs that are associated with an `AWS::Route53::HealthCheck` resource.
     */
    set healthCheckTags(value: Array<CfnHealthCheck.HealthCheckTagProperty> | undefined);
    /**
     * The identifier that Amazon Route 53 assigned to the health check when you created it. When you add or update a resource record set, you use this value to specify which health check to use. The value can be up to 64 characters long.
     *
     * @cloudformationAttribute HealthCheckId
     */
    get attrHealthCheckId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnHostedZone extends cdk.CfnResource implements cdk.IInspectable, IHostedZoneRef, cdk.ITaggable {
     ...
     */
    private _hostedZoneFeatures?;
    /**
     * Adds, edits, or deletes tags for a health check or a hosted zone.
     */
    private _hostedZoneTagsRaw?;
    /**
     ...
     * A complex type that contains an optional comment.
     */
    get hostedZoneConfig(): CfnHostedZone.HostedZoneConfigProperty | cdk.IResolvable | undefined;
    /**
     * A complex type that contains an optional comment.
     */
    set hostedZoneConfig(value: CfnHostedZone.HostedZoneConfigProperty | cdk.IResolvable | undefined);
    /**
     * The features configuration for the hosted zone, including accelerated recovery settings and status information.
     */
    get hostedZoneFeatures(): CfnHostedZone.HostedZoneFeaturesProperty | cdk.IResolvable | undefined;
    /**
     * The features configuration for the hosted zone, including accelerated recovery settings and status information.
     */
    set hostedZoneFeatures(value: CfnHostedZone.HostedZoneFeaturesProperty | cdk.IResolvable | undefined);
    /**
     * Adds, edits, or deletes tags for a health check or a hosted zone.
     */
    get hostedZoneTagsRaw(): Array<CfnHostedZone.HostedZoneTagProperty> | undefined;
    /**
     * Adds, edits, or deletes tags for a health check or a hosted zone.
     */
    set hostedZoneTagsRaw(value: Array<CfnHostedZone.HostedZoneTagProperty> | undefined);
    /**
     * The name of the domain.
     */
     ...
     * Creates a configuration for DNS query logging.
     */
    get queryLoggingConfig(): cdk.IResolvable | CfnHostedZone.QueryLoggingConfigProperty | undefined;
    /**
     * Creates a configuration for DNS query logging.
     */
    set queryLoggingConfig(value: cdk.IResolvable | CfnHostedZone.QueryLoggingConfigProperty | undefined);
    /**
     * *Private hosted zones:* A complex type that contains information about the VPCs that are associated with the specified hosted zone.
     */
    get vpcs(): Array<cdk.IResolvable | CfnHostedZone.VPCProperty> | cdk.IResolvable | undefined;
    /**
     * *Private hosted zones:* A complex type that contains information about the VPCs that are associated with the specified hosted zone.
     */
    set vpcs(value: Array<cdk.IResolvable | CfnHostedZone.VPCProperty> | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrNameServers(): Array<string>;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnRecordSet extends cdk.CfnResource implements cdk.IInspectable, IRecordSetRef {
     ...
     * *Alias resource record sets only:* Information about the AWS resource, such as a CloudFront distribution or an Amazon S3 bucket, that you want to route traffic to.
     */
    get aliasTarget(): CfnRecordSet.AliasTargetProperty | cdk.IResolvable | undefined;
    /**
     * *Alias resource record sets only:* Information about the AWS resource, such as a CloudFront distribution or an Amazon S3 bucket, that you want to route traffic to.
     */
    set aliasTarget(value: CfnRecordSet.AliasTargetProperty | cdk.IResolvable | undefined);
    /**
     * The object that is specified in resource record set object when you are linking a resource record set to a CIDR location.
     */
    get cidrRoutingConfig(): CfnRecordSet.CidrRoutingConfigProperty | cdk.IResolvable | undefined;
    /**
     * The object that is specified in resource record set object when you are linking a resource record set to a CIDR location.
     */
    set cidrRoutingConfig(value: CfnRecordSet.CidrRoutingConfigProperty | cdk.IResolvable | undefined);
    /**
     * *Optional:* Any comments you want to include about a change batch request.
     */
     ...
     * *Failover resource record sets only:* To configure failover, you add the `Failover` element to two resource record sets.
     */
    get failover(): string | undefined;
    /**
     * *Failover resource record sets only:* To configure failover, you add the `Failover` element to two resource record sets.
     */
    set failover(value: string | undefined);
    /**
     * *Geolocation resource record sets only:* A complex type that lets you control how Amazon Route 53 responds to DNS queries based on the geographic origin of the query.
     */
    get geoLocation(): CfnRecordSet.GeoLocationProperty | cdk.IResolvable | undefined;
    /**
     * *Geolocation resource record sets only:* A complex type that lets you control how Amazon Route 53 responds to DNS queries based on the geographic origin of the query.
     */
    set geoLocation(value: CfnRecordSet.GeoLocationProperty | cdk.IResolvable | undefined);
    /**
     * *GeoproximityLocation resource record sets only:* A complex type that lets you control how Route 53 responds to DNS queries based on the geographic origin of the query and your resources.
     */
    get geoProximityLocation(): CfnRecordSet.GeoProximityLocationProperty | cdk.IResolvable | undefined;
    /**
     * *GeoproximityLocation resource record sets only:* A complex type that lets you control how Route 53 responds to DNS queries based on the geographic origin of the query and your resources.
     */
    set geoProximityLocation(value: CfnRecordSet.GeoProximityLocationProperty | cdk.IResolvable | undefined);
    /**
     * If you want Amazon Route 53 to return this resource record set in response to a DNS query only when the status of a health check is healthy, include the `HealthCheckId` element and specify the ID of the applicable health check.
     */
     ...
     * The name of the hosted zone that you want to create records in.
     */
    get hostedZoneName(): string | undefined;
    /**
     * The name of the hosted zone that you want to create records in.
     */
    set hostedZoneName(value: string | undefined);
    /**
     * *Multivalue answer resource record sets only* : To route traffic approximately randomly to multiple resources, such as web servers, create one multivalue answer record for each resource and specify `true` for `MultiValueAnswer` .
     */
    get multiValueAnswer(): boolean | cdk.IResolvable | undefined;
    /**
     * *Multivalue answer resource record sets only* : To route traffic approximately randomly to multiple resources, such as web servers, create one multivalue answer record for each resource and specify `true` for `MultiValueAnswer` .
     */
    set multiValueAnswer(value: boolean | cdk.IResolvable | undefined);
    /**
     * The name of the record that you want to create, update, or delete.
     */
    get name(): string;
     ...
     * One or more values that correspond with the value that you specified for the `Type` property.
     */
    get resourceRecords(): Array<string> | undefined;
    /**
     * One or more values that correspond with the value that you specified for the `Type` property.
     */
    set resourceRecords(value: Array<string> | undefined);
    /**
     * *Resource record sets that have a routing policy other than simple:* An identifier that differentiates among multiple resource record sets that have the same combination of name and type, such as multiple weighted resource record sets named acme.example.com that have a type of A. In a group of resource record sets that have the same name and type, the value of `SetIdentifier` must be unique for each resource record set.
     */
...
export declare class CfnRecordSetGroup extends cdk.CfnResource implements cdk.IInspectable, IRecordSetGroupRef {
     ...
     * A complex type that contains one `RecordSet` element for each record that you want to create.
     */
    get recordSets(): Array<cdk.IResolvable | CfnRecordSetGroup.RecordSetProperty> | cdk.IResolvable | undefined;
    /**
     * A complex type that contains one `RecordSet` element for each record that you want to create.
     */
    set recordSets(value: Array<cdk.IResolvable | CfnRecordSetGroup.RecordSetProperty> | cdk.IResolvable | undefined);
    /**
     * This element contains an ID that you use when performing a `GetChange` action to get detailed information about the change.
     *
     * @cloudformationAttribute Id
