...
import { CisScanConfigurationReference, CodeSecurityIntegrationReference, CodeSecurityScanConfigurationReference, FilterReference, ICisScanConfigurationRef, ICodeSecurityIntegrationRef, ICodeSecurityScanConfigurationRef, IFilterRef } from "../../interfaces/generated/aws-inspectorv2-interfaces.generated";
/**
...
export declare class CfnFilter extends cdk.CfnResource implements cdk.IInspectable, IFilterRef, cdk.ITaggableV2 {
     ...
     * The action that is to be applied to the findings that match the filter.
     */
    get filterAction(): string;
    /**
     * The action that is to be applied to the findings that match the filter.
     */
    set filterAction(value: string);
    /**
     * Details on the filter criteria associated with this filter.
     */
    get filterCriteria(): CfnFilter.FilterCriteriaProperty | cdk.IResolvable;
    /**
     * Details on the filter criteria associated with this filter.
     */
    set filterCriteria(value: CfnFilter.FilterCriteriaProperty | cdk.IResolvable);
    /**
     * The name of the filter.
     */
    get name(): string;
...
export declare class CfnCisScanConfiguration extends cdk.CfnResource implements cdk.IInspectable, ICisScanConfigurationRef, cdk.ITaggableV2 {
     ...
     * The name of the CIS scan configuration.
     */
    set scanName(value: string);
    /**
     * The CIS scan configuration's schedule.
     */
    get schedule(): cdk.IResolvable | CfnCisScanConfiguration.ScheduleProperty;
    /**
     * The CIS scan configuration's schedule.
     */
    set schedule(value: cdk.IResolvable | CfnCisScanConfiguration.ScheduleProperty);
    /**
     * The CIS scan configuration's CIS Benchmark level.
     */
     ...
     * The CIS scan configuration's targets.
     */
    get targets(): CfnCisScanConfiguration.CisTargetsProperty | cdk.IResolvable;
    /**
     * The CIS scan configuration's targets.
     */
    set targets(value: CfnCisScanConfiguration.CisTargetsProperty | cdk.IResolvable);
    /**
...
export declare class CfnCodeSecurityIntegration extends cdk.CfnResource implements cdk.IInspectable, ICodeSecurityIntegrationRef, cdk.ITaggableV2 {
     ...
     */
    private _createIntegrationDetails?;
    /**
     ...
     */
    private _updateIntegrationDetails?;
    /**
     ...
     * Contains details required to create a code security integration with a specific repository provider.
     */
    get createIntegrationDetails(): CfnCodeSecurityIntegration.CreateDetailsProperty | cdk.IResolvable | undefined;
    /**
     * Contains details required to create a code security integration with a specific repository provider.
     */
    set createIntegrationDetails(value: CfnCodeSecurityIntegration.CreateDetailsProperty | cdk.IResolvable | undefined);
    /**
     * The name of the code security integration.
     */
     ...
     * The updated integration details specific to the repository provider type.
     */
    get updateIntegrationDetails(): cdk.IResolvable | CfnCodeSecurityIntegration.UpdateDetailsProperty | undefined;
    /**
     * The updated integration details specific to the repository provider type.
     */
    set updateIntegrationDetails(value: cdk.IResolvable | CfnCodeSecurityIntegration.UpdateDetailsProperty | undefined);
    /**
     ...
     */
    get attrAuthorizationUrl(): string;
    /**
...
export declare class CfnCodeSecurityScanConfiguration extends cdk.CfnResource implements cdk.IInspectable, ICodeSecurityScanConfigurationRef, cdk.ITaggableV2 {
     ...
     * The configuration settings for the code security scan.
     */
    get configuration(): CfnCodeSecurityScanConfiguration.CodeSecurityScanConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration settings for the code security scan.
     */
    set configuration(value: CfnCodeSecurityScanConfiguration.CodeSecurityScanConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The security level for the scan configuration.
     */
     ...
     * The scope settings that define which repositories will be scanned.
     */
    get scopeSettings(): cdk.IResolvable | CfnCodeSecurityScanConfiguration.ScopeSettingsProperty | undefined;
    /**
     * The scope settings that define which repositories will be scanned.
     */
    set scopeSettings(value: cdk.IResolvable | CfnCodeSecurityScanConfiguration.ScopeSettingsProperty | undefined);
    /**
     * The tags to apply to the scan configuration.
     */
    get tags(): Record<string, string> | undefined;
