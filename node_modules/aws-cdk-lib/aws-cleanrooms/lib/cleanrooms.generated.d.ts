...
export declare class CfnAnalysisTemplate extends cdk.CfnResource implements cdk.IInspectable, IAnalysisTemplateRef, cdk.ITaggableV2 {
     ...
     */
    private _errorMessageConfiguration?;
    /**
     ...
     * The parameters of the analysis template.
     */
    get analysisParameters(): Array<CfnAnalysisTemplate.AnalysisParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The parameters of the analysis template.
     */
    set analysisParameters(value: Array<CfnAnalysisTemplate.AnalysisParameterProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of the analysis template.
     */
     ...
     * The configuration that specifies the level of detail in error messages returned by analyses using this template.
     */
    get errorMessageConfiguration(): CfnAnalysisTemplate.ErrorMessageConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration that specifies the level of detail in error messages returned by analyses using this template.
     */
    set errorMessageConfiguration(value: CfnAnalysisTemplate.ErrorMessageConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The format of the analysis template.
     */
    get format(): string;
     ...
     * The identifier for a membership resource.
     */
    get membershipIdentifier(): string;
    /**
     * The identifier for a membership resource.
     */
    set membershipIdentifier(value: string);
    /**
     * The name of the analysis template.
     */
    get name(): string;
     ...
     * The entire schema object.
     */
    get schema(): CfnAnalysisTemplate.AnalysisSchemaProperty | cdk.IResolvable | undefined;
    /**
     * The entire schema object.
     */
    set schema(value: CfnAnalysisTemplate.AnalysisSchemaProperty | cdk.IResolvable | undefined);
    /**
     * The source of the analysis template.
     */
    get source(): CfnAnalysisTemplate.AnalysisSourceProperty | cdk.IResolvable;
    /**
     * The source of the analysis template.
     */
    set source(value: CfnAnalysisTemplate.AnalysisSourceProperty | cdk.IResolvable);
    /**
     * The source metadata for the analysis template.
     */
    get sourceMetadata(): CfnAnalysisTemplate.AnalysisSourceMetadataProperty | cdk.IResolvable | undefined;
    /**
     * The source metadata for the analysis template.
     */
    set sourceMetadata(value: CfnAnalysisTemplate.AnalysisSourceMetadataProperty | cdk.IResolvable | undefined);
    /**
     * The parameters used to generate synthetic data for this analysis template.
     */
    get syntheticDataParameters(): cdk.IResolvable | CfnAnalysisTemplate.SyntheticDataParametersProperty | undefined;
    /**
     * The parameters used to generate synthetic data for this analysis template.
     */
    set syntheticDataParameters(value: cdk.IResolvable | CfnAnalysisTemplate.SyntheticDataParametersProperty | undefined);
    /**
     * An optional label that you can assign to a resource when you create it.
     */
     ...
     */
    get attrAnalysisTemplateIdentifier(): string;
    /**
     ...
     */
    get attrCollaborationArn(): string;
    /**
     ...
     */
    get attrCollaborationIdentifier(): string;
    /**
     ...
     */
    get attrSchemaReferencedTables(): Array<string>;
...
export declare class CfnCollaboration extends cdk.CfnResource implements cdk.IInspectable, ICollaborationRef, cdk.ITaggableV2 {
     ...
     */
    private _autoApprovedChangeTypes?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _creatorMlMemberAbilities?;
    /**
     * An object representing the collaboration member's payment responsibilities set by the collaboration creator.
     */
    private _creatorPaymentConfiguration?;
    /**
     ...
     */
    private _description;
    private _isMetricsEnabled?;
    /**
     * An indicator as to whether job logging has been enabled or disabled for the collaboration.
     */
    private _jobLogStatus?;
    /**
     ...
     * The AWS Regions where collaboration query results can be stored.
     */
    get allowedResultRegions(): Array<string> | undefined;
    /**
     * The AWS Regions where collaboration query results can be stored.
     */
    set allowedResultRegions(value: Array<string> | undefined);
    /**
     * The analytics engine for the collaboration.
     */
    get analyticsEngine(): string | undefined;
    /**
     * The analytics engine for the collaboration.
     */
    set analyticsEngine(value: string | undefined);
    /**
     * The types of change requests that are automatically approved for this collaboration.
     */
    get autoApprovedChangeTypes(): Array<string> | undefined;
    /**
     * The types of change requests that are automatically approved for this collaboration.
     */
    set autoApprovedChangeTypes(value: Array<string> | undefined);
    /**
     * A display name of the collaboration creator.
     */
     ...
     * The abilities granted to the collaboration creator.
     */
    get creatorMemberAbilities(): Array<string> | undefined;
    /**
     * The abilities granted to the collaboration creator.
     */
    set creatorMemberAbilities(value: Array<string> | undefined);
    /**
     * The ML member abilities for a collaboration member.
     */
    get creatorMlMemberAbilities(): cdk.IResolvable | CfnCollaboration.MLMemberAbilitiesProperty | undefined;
    /**
     * The ML member abilities for a collaboration member.
     */
    set creatorMlMemberAbilities(value: cdk.IResolvable | CfnCollaboration.MLMemberAbilitiesProperty | undefined);
    /**
     * An object representing the collaboration member's payment responsibilities set by the collaboration creator.
     */
    get creatorPaymentConfiguration(): cdk.IResolvable | CfnCollaboration.PaymentConfigurationProperty | undefined;
    /**
     * An object representing the collaboration member's payment responsibilities set by the collaboration creator.
     */
    set creatorPaymentConfiguration(value: cdk.IResolvable | CfnCollaboration.PaymentConfigurationProperty | undefined);
    /**
     * The settings for client-side encryption for cryptographic computing.
     */
    get dataEncryptionMetadata(): CfnCollaboration.DataEncryptionMetadataProperty | cdk.IResolvable | undefined;
    /**
     * The settings for client-side encryption for cryptographic computing.
     */
    set dataEncryptionMetadata(value: CfnCollaboration.DataEncryptionMetadataProperty | cdk.IResolvable | undefined);
    /**
     * A description of the collaboration provided by the collaboration owner.
     */
    ...
    get isMetricsEnabled(): boolean | cdk.IResolvable | undefined;
    set isMetricsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * An indicator as to whether job logging has been enabled or disabled for the collaboration.
     */
    get jobLogStatus(): string | undefined;
    /**
     * An indicator as to whether job logging has been enabled or disabled for the collaboration.
     */
    set jobLogStatus(value: string | undefined);
    /**
     * A list of initial members, not including the creator.
     */
    get members(): Array<cdk.IResolvable | CfnCollaboration.MemberSpecificationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of initial members, not including the creator.
     */
    set members(value: Array<cdk.IResolvable | CfnCollaboration.MemberSpecificationProperty> | cdk.IResolvable | undefined);
    /**
     * A human-readable identifier provided by the collaboration owner.
     */
    get name(): string;
...
export declare class CfnConfiguredTable extends cdk.CfnResource implements cdk.IInspectable, IConfiguredTableRef, cdk.ITaggableV2 {
     ...
     */
    private _selectedAnalysisMethods?;
    /**
     ...
     * The columns within the underlying AWS Glue table that can be used within collaborations.
     */
    get allowedColumns(): Array<string>;
    /**
     * The columns within the underlying AWS Glue table that can be used within collaborations.
     */
    set allowedColumns(value: Array<string>);
    /**
     * The analysis method for the configured table.
     */
     ...
     * The analysis rule that was created for the configured table.
     */
    get analysisRules(): Array<CfnConfiguredTable.AnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The analysis rule that was created for the configured table.
     */
    set analysisRules(value: Array<CfnConfiguredTable.AnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A description for the configured table.
     */
    get description(): string | undefined;
     ...
     * The selected analysis methods for the configured table.
     */
    get selectedAnalysisMethods(): Array<string> | undefined;
    /**
     * The selected analysis methods for the configured table.
     */
    set selectedAnalysisMethods(value: Array<string> | undefined);
    /**
     * The table that this configured table represents.
     */
    get tableReference(): cdk.IResolvable | CfnConfiguredTable.TableReferenceProperty;
    /**
     * The table that this configured table represents.
     */
    set tableReference(value: cdk.IResolvable | CfnConfiguredTable.TableReferenceProperty);
    /**
     * An optional label that you can assign to a resource when you create it.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrConfiguredTableIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnConfiguredTableAssociation extends cdk.CfnResource implements cdk.IInspectable, IConfiguredTableAssociationRef, cdk.ITaggableV2 {
     ...
     */
    private _configuredTableAssociationAnalysisRules?;
    /**
     * A unique identifier for the configured table to be associated to.
     */
    private _configuredTableIdentifier;
    /**
     ...
     * An analysis rule for a configured table association.
     */
    get configuredTableAssociationAnalysisRules(): Array<CfnConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * An analysis rule for a configured table association.
     */
    set configuredTableAssociationAnalysisRules(value: Array<CfnConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A unique identifier for the configured table to be associated to.
     */
    get configuredTableIdentifier(): string;
    /**
     * A unique identifier for the configured table to be associated to.
     */
    set configuredTableIdentifier(value: string);
    /**
     * A description of the configured table association.
     */
    get description(): string | undefined;
     ...
     */
    get attrConfiguredTableAssociationIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnMembership extends cdk.CfnResource implements cdk.IInspectable, IMembershipRef, cdk.ITaggableV2 {
     ...
     */
    private _collaborationIdentifier;
    /**
     * The default job result configuration for the membership.
     */
    private _defaultJobResultConfiguration?;
    /**
     ...
     * The unique ID for the associated collaboration.
     */
    get collaborationIdentifier(): string;
    /**
     * The unique ID for the associated collaboration.
     */
    set collaborationIdentifier(value: string);
    /**
     * The default job result configuration for the membership.
     */
    get defaultJobResultConfiguration(): cdk.IResolvable | CfnMembership.MembershipProtectedJobResultConfigurationProperty | undefined;
    /**
     * The default job result configuration for the membership.
     */
    set defaultJobResultConfiguration(value: cdk.IResolvable | CfnMembership.MembershipProtectedJobResultConfigurationProperty | undefined);
    /**
     * The default protected query result configuration as specified by the member who can receive results.
     */
    get defaultResultConfiguration(): cdk.IResolvable | CfnMembership.MembershipProtectedQueryResultConfigurationProperty | undefined;
    /**
     * The default protected query result configuration as specified by the member who can receive results.
     */
    set defaultResultConfiguration(value: cdk.IResolvable | CfnMembership.MembershipProtectedQueryResultConfigurationProperty | undefined);
    get isMetricsEnabled(): boolean | cdk.IResolvable | undefined;
    set isMetricsEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * An indicator as to whether job logging has been enabled or disabled for the collaboration.
     ...
     * The payment responsibilities accepted by the collaboration member.
     */
    get paymentConfiguration(): cdk.IResolvable | CfnMembership.MembershipPaymentConfigurationProperty | undefined;
    /**
     * The payment responsibilities accepted by the collaboration member.
     */
    set paymentConfiguration(value: cdk.IResolvable | CfnMembership.MembershipPaymentConfigurationProperty | undefined);
    /**
     * An indicator as to whether query logging has been enabled or disabled for the membership.
     */
    get queryLogStatus(): string;
     ...
     */
    get attrCollaborationCreatorAccountId(): string;
    /**
     ...
     */
    get attrMembershipIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnMembership {
    ...
    interface MembershipMLPaymentConfigProperty {
         ...
         */
        readonly syntheticDataGeneration?: cdk.IResolvable | CfnMembership.MembershipSyntheticDataGenerationPaymentConfigProperty;
    }
    /**
     * An object representing the collaboration member's model training payment responsibilities set by the collaboration creator.
     *
...
export declare class CfnIdMappingTable extends cdk.CfnResource implements cdk.IInspectable, IIdMappingTableRef, cdk.ITaggableV2 {
     ...
     * The input reference configuration for the ID mapping table.
     */
    get inputReferenceConfig(): CfnIdMappingTable.IdMappingTableInputReferenceConfigProperty | cdk.IResolvable;
    /**
     * The input reference configuration for the ID mapping table.
     */
    set inputReferenceConfig(value: CfnIdMappingTable.IdMappingTableInputReferenceConfigProperty | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) of the AWS KMS key.
     */
     ...
     */
    get attrIdMappingTableIdentifier(): string;
    /**
     * @cloudformationAttribute InputReferenceProperties
     */
    get attrInputReferenceProperties(): cdk.IResolvable;
    /**
...
export declare class CfnIdNamespaceAssociation extends cdk.CfnResource implements cdk.IInspectable, IIdNamespaceAssociationRef, cdk.ITaggableV2 {
     ...
     * The configuration settings for the ID mapping table.
     */
    get idMappingConfig(): CfnIdNamespaceAssociation.IdMappingConfigProperty | cdk.IResolvable | undefined;
    /**
     * The configuration settings for the ID mapping table.
     */
    set idMappingConfig(value: CfnIdNamespaceAssociation.IdMappingConfigProperty | cdk.IResolvable | undefined);
    /**
     * The input reference configuration for the ID namespace association.
     */
    get inputReferenceConfig(): CfnIdNamespaceAssociation.IdNamespaceAssociationInputReferenceConfigProperty | cdk.IResolvable;
    /**
     * The input reference configuration for the ID namespace association.
     */
    set inputReferenceConfig(value: CfnIdNamespaceAssociation.IdNamespaceAssociationInputReferenceConfigProperty | cdk.IResolvable);
    /**
     * The unique identifier of the membership that contains the ID namespace association.
     */
    get membershipIdentifier(): string;
     ...
     */
    get attrIdNamespaceAssociationIdentifier(): string;
    /**
     * @cloudformationAttribute InputReferenceProperties
     */
    get attrInputReferenceProperties(): cdk.IResolvable;
...
export declare class CfnPrivacyBudgetTemplate extends cdk.CfnResource implements cdk.IInspectable, IPrivacyBudgetTemplateRef, cdk.ITaggableV2 {
     ...
     * Specifies the epsilon and noise parameters for the privacy budget template.
     */
    get parameters(): cdk.IResolvable | CfnPrivacyBudgetTemplate.ParametersProperty;
    /**
     * Specifies the epsilon and noise parameters for the privacy budget template.
     */
    set parameters(value: cdk.IResolvable | CfnPrivacyBudgetTemplate.ParametersProperty);
    /**
     * Specifies the type of the privacy budget template.
     */
    get privacyBudgetType(): string;
    /**
     * Specifies the type of the privacy budget template.
     */
    set privacyBudgetType(value: string);
    /**
     * An optional label that you can assign to a resource when you create it.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrPrivacyBudgetTemplateIdentifier(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
