...
import { AccountReference, IAccountRef, IOrganizationalUnitRef, IOrganizationRef, IPolicyRef, IResourcePolicyRef, OrganizationalUnitReference, OrganizationReference, PolicyReference, ResourcePolicyReference } from "../../interfaces/generated/aws-organizations-interfaces.generated";
/**
...
export declare class CfnAccount extends cdk.CfnResource implements cdk.IInspectable, IAccountRef, cdk.ITaggable {
     ...
     * The unique identifier (ID) of the root or organizational unit (OU) that you want to create the new account in.
     */
    get parentIds(): Array<string> | undefined;
    /**
     * The unique identifier (ID) of the root or organizational unit (OU) that you want to create the new account in.
     */
    set parentIds(value: Array<string> | undefined);
    /**
     * The name of an IAM role that AWS Organizations automatically preconfigures in the new member account.
     */
     ...
     */
    get attrJoinedTimestamp(): string;
    /**
...
export declare class CfnPolicy extends cdk.CfnResource implements cdk.IInspectable, IPolicyRef, cdk.ITaggable {
     ...
     * List of unique identifiers (IDs) of the root, OU, or account that you want to attach the policy to.
     */
    get targetIds(): Array<string> | undefined;
    /**
     * List of unique identifiers (IDs) of the root, OU, or account that you want to attach the policy to.
     */
    set targetIds(value: Array<string> | undefined);
    /**
     * The type of policy to create.
     */
    get type(): string;
     ...
     */
    get attrAwsManaged(): cdk.IResolvable;
    /**
