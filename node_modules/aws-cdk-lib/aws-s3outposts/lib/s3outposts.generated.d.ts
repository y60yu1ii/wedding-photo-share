...
import { AccessPointReference, BucketPolicyReference, BucketReference, EndpointReference, IAccessPointRef, IBucketPolicyRef, IBucketRef, IEndpointRef } from "../../interfaces/generated/aws-s3outposts-interfaces.generated";
/**
...
export declare class CfnAccessPoint extends cdk.CfnResource implements cdk.IInspectable, IAccessPointRef {
     ...
     * The virtual private cloud (VPC) configuration for this access point, if one exists.
     */
    get vpcConfiguration(): cdk.IResolvable | CfnAccessPoint.VpcConfigurationProperty;
    /**
     * The virtual private cloud (VPC) configuration for this access point, if one exists.
     */
    set vpcConfiguration(value: cdk.IResolvable | CfnAccessPoint.VpcConfigurationProperty);
    /**
...
export declare class CfnEndpoint extends cdk.CfnResource implements cdk.IInspectable, IEndpointRef {
     ...
     * The failure reason, if any, for a create or delete endpoint operation.
     */
    get failedReason(): CfnEndpoint.FailedReasonProperty | cdk.IResolvable | undefined;
    /**
     * The failure reason, if any, for a create or delete endpoint operation.
     */
    set failedReason(value: CfnEndpoint.FailedReasonProperty | cdk.IResolvable | undefined);
    /**
     * The ID of the Outpost.
     */
    get outpostId(): string;
     ...
     */
    get attrNetworkInterfaces(): cdk.IResolvable;
    /**
