...
import { BackupPlanReference, BackupSelectionReference, BackupVaultReference, FrameworkReference, IBackupPlanRef, IBackupSelectionRef, IBackupVaultRef, IFrameworkRef, ILogicallyAirGappedBackupVaultRef, IReportPlanRef, IRestoreTestingPlanRef, IRestoreTestingSelectionRef, ITieringConfigurationRef, LogicallyAirGappedBackupVaultReference, ReportPlanReference, RestoreTestingPlanReference, RestoreTestingSelectionReference, TieringConfigurationReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
import { aws_backup as backupRefs, aws_kms as kmsRefs } from "../../interfaces";
/**
...
export declare class CfnBackupPlan extends cdk.CfnResource implements cdk.IInspectable, IBackupPlanRef, cdk.ITaggableV2 {
     ...
     * Uniquely identifies the backup plan to be associated with the selection of resources.
     */
    get backupPlan(): CfnBackupPlan.BackupPlanResourceTypeProperty | cdk.IResolvable;
    /**
     * Uniquely identifies the backup plan to be associated with the selection of resources.
     */
    set backupPlan(value: CfnBackupPlan.BackupPlanResourceTypeProperty | cdk.IResolvable);
    /**
     * The tags to assign to the backup plan.
     */
    get backupPlanTags(): Record<string, string> | undefined;
    /**
     * The tags to assign to the backup plan.
     */
    set backupPlanTags(value: Record<string, string> | undefined);
    /**
     * An Amazon Resource Name (ARN) that uniquely identifies a backup plan; for example, `arn:aws:backup:us-east-1:123456789012:plan:8F81F553-3A74-4A3F-B93D-B3360DC80C50` .
     *
     * @cloudformationAttribute BackupPlanArn
     */
    get attrBackupPlanArn(): string;
    /**
     * Uniquely identifies a backup plan.
     *
     * @cloudformationAttribute BackupPlanId
     */
    get attrBackupPlanId(): string;
    /**
...
export declare namespace CfnBackupPlan {
    ...
    interface BackupPlanResourceTypeProperty {
         ...
         */
        readonly scanSettings?: Array<cdk.IResolvable | CfnBackupPlan.ScanSettingResourceTypeProperty> | cdk.IResolvable;
    }
    /**
    ...
    interface BackupRuleResourceTypeProperty {
         ...
         */
        readonly scanActions?: Array<cdk.IResolvable | CfnBackupPlan.ScanActionResourceTypeProperty> | cdk.IResolvable;
        /**
     ...
     */
    interface ScanSettingResourceTypeProperty {
        /**
...
export declare class CfnBackupSelection extends cdk.CfnResource implements cdk.IInspectable, IBackupSelectionRef {
     ...
     * Specifies the body of a request to assign a set of resources to a backup plan.
     */
    get backupSelection(): CfnBackupSelection.BackupSelectionResourceTypeProperty | cdk.IResolvable;
    /**
     * Specifies the body of a request to assign a set of resources to a backup plan.
     */
    set backupSelection(value: CfnBackupSelection.BackupSelectionResourceTypeProperty | cdk.IResolvable);
    /**
     * Uniquely identifies a backup plan.
     *
     * @cloudformationAttribute BackupPlanId
...
export interface CfnBackupSelectionProps {
     ...
     */
    readonly backupPlanId: backupRefs.IBackupPlanRef | string;
    /**
     * Specifies the body of a request to assign a set of resources to a backup plan.
     *
...
export declare class CfnBackupVault extends cdk.CfnResource implements cdk.IInspectable, IBackupVaultRef, cdk.ITaggableV2 {
     ...
     * A resource-based policy that is used to manage access permissions on the target backup vault.
     */
    get accessPolicy(): any | cdk.IResolvable | undefined;
    /**
     * A resource-based policy that is used to manage access permissions on the target backup vault.
     */
    set accessPolicy(value: any | cdk.IResolvable | undefined);
    /**
     * The name of a logical container where backups are stored.
     */
     ...
     * The tags to assign to the backup vault.
     */
    get backupVaultTags(): Record<string, string> | undefined;
    /**
     * The tags to assign to the backup vault.
     */
    set backupVaultTags(value: Record<string, string> | undefined);
    /**
     * A server-side encryption key you can specify to encrypt your backups from services that support full AWS Backup management;
     */
     ...
     * Configuration for [AWS Backup Vault Lock](https://docs.aws.amazon.com/aws-backup/latest/devguide/vault-lock.html) .
     */
    get lockConfiguration(): cdk.IResolvable | CfnBackupVault.LockConfigurationTypeProperty | undefined;
    /**
     * Configuration for [AWS Backup Vault Lock](https://docs.aws.amazon.com/aws-backup/latest/devguide/vault-lock.html) .
     */
    set lockConfiguration(value: cdk.IResolvable | CfnBackupVault.LockConfigurationTypeProperty | undefined);
    /**
     * The SNS event notifications for the specified backup vault.
     */
    get notifications(): cdk.IResolvable | CfnBackupVault.NotificationObjectTypeProperty | undefined;
    /**
     * The SNS event notifications for the specified backup vault.
     */
    set notifications(value: cdk.IResolvable | CfnBackupVault.NotificationObjectTypeProperty | undefined);
    /**
     * An Amazon Resource Name (ARN) that uniquely identifies a backup vault; for example, `arn:aws:backup:us-east-1:123456789012:backup-vault:aBackupVault` .
     *
     * @cloudformationAttribute BackupVaultArn
     */
    get attrBackupVaultArn(): string;
    /**
     ...
     */
    get attrBackupVaultName(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnFramework extends cdk.CfnResource implements cdk.IInspectable, IFrameworkRef, cdk.ITaggableV2 {
     ...
     */
    private _frameworkControls;
    /**
     * An optional description of the framework with a maximum 1,024 characters.
     */
    private _frameworkDescription?;
    /**
     * The unique name of a framework.
     */
    private _frameworkName?;
    /**
     * The tags to assign to your framework.
     */
    private _frameworkTags?;
    /**
     ...
     * Contains detailed information about all of the controls of a framework.
     */
    get frameworkControls(): Array<CfnFramework.FrameworkControlProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Contains detailed information about all of the controls of a framework.
     */
    set frameworkControls(value: Array<CfnFramework.FrameworkControlProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * An optional description of the framework with a maximum 1,024 characters.
     */
    get frameworkDescription(): string | undefined;
    /**
     * An optional description of the framework with a maximum 1,024 characters.
     */
    set frameworkDescription(value: string | undefined);
    /**
     * The unique name of a framework.
     */
    get frameworkName(): string | undefined;
    /**
     * The unique name of a framework.
     */
    set frameworkName(value: string | undefined);
    /**
     * The tags to assign to your framework.
     */
    get frameworkTags(): Array<cdk.CfnTag> | undefined;
    /**
     * The tags to assign to your framework.
     */
    set frameworkTags(value: Array<cdk.CfnTag> | undefined);
    /**
     ...
     */
    get attrFrameworkStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnReportPlan extends cdk.CfnResource implements cdk.IInspectable, IReportPlanRef, cdk.ITaggableV2 {
     ...
     */
    private _reportPlanDescription?;
    /**
     * The unique name of the report plan.
     */
    private _reportPlanName?;
    /**
     * The tags to assign to your report plan.
     */
    private _reportPlanTags?;
    /**
     ...
     * Contains information about where and how to deliver your reports, specifically your Amazon S3 bucket name, S3 key prefix, and the formats of your reports.
     */
    get reportDeliveryChannel(): any | cdk.IResolvable;
    /**
     * Contains information about where and how to deliver your reports, specifically your Amazon S3 bucket name, S3 key prefix, and the formats of your reports.
     */
    set reportDeliveryChannel(value: any | cdk.IResolvable);
    /**
     * An optional description of the report plan with a maximum 1,024 characters.
     */
    get reportPlanDescription(): string | undefined;
    /**
     * An optional description of the report plan with a maximum 1,024 characters.
     */
    set reportPlanDescription(value: string | undefined);
    /**
     * The unique name of the report plan.
     */
    get reportPlanName(): string | undefined;
    /**
     * The unique name of the report plan.
     */
    set reportPlanName(value: string | undefined);
    /**
     * The tags to assign to your report plan.
     */
    get reportPlanTags(): Array<cdk.CfnTag> | undefined;
    /**
     * The tags to assign to your report plan.
     */
    set reportPlanTags(value: Array<cdk.CfnTag> | undefined);
    /**
     * Identifies the report template for the report. Reports are built using a report template. The report templates are:.
     */
    get reportSetting(): any | cdk.IResolvable;
    /**
     * Identifies the report template for the report. Reports are built using a report template. The report templates are:.
     */
    set reportSetting(value: any | cdk.IResolvable);
    /**
     * The Amazon Resource Name (ARN) of your report plan.
     *
     * @cloudformationAttribute ReportPlanArn
     */
    get attrReportPlanArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnLogicallyAirGappedBackupVault extends cdk.CfnResource implements cdk.IInspectable, ILogicallyAirGappedBackupVaultRef, cdk.ITaggableV2 {
     ...
     * The backup vault access policy document in JSON format.
     */
    get accessPolicy(): any | cdk.IResolvable | string | undefined;
    /**
     * The backup vault access policy document in JSON format.
     */
    set accessPolicy(value: any | cdk.IResolvable | string | undefined);
    /**
     * The name of a logical container where backups are stored.
     */
    get backupVaultName(): string;
     ...
     * The Amazon Resource Name (ARN) of the MPA approval team to associate with the backup vault.
     */
    get mpaApprovalTeamArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the MPA approval team to associate with the backup vault.
     */
    set mpaApprovalTeamArn(value: string | undefined);
    /**
     * Returns event notifications for the specified backup vault.
     */
    get notifications(): cdk.IResolvable | CfnLogicallyAirGappedBackupVault.NotificationObjectTypeProperty | undefined;
    /**
     * Returns event notifications for the specified backup vault.
     */
    set notifications(value: cdk.IResolvable | CfnLogicallyAirGappedBackupVault.NotificationObjectTypeProperty | undefined);
    /**
...
export declare class CfnRestoreTestingPlan extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingPlanRef, cdk.ITaggableV2 {
     ...
     * The specified criteria to assign a set of resources, such as recovery point types or backup vaults.
     */
    get recoveryPointSelection(): cdk.IResolvable | CfnRestoreTestingPlan.RestoreTestingRecoveryPointSelectionProperty;
    /**
     * The specified criteria to assign a set of resources, such as recovery point types or backup vaults.
     */
    set recoveryPointSelection(value: cdk.IResolvable | CfnRestoreTestingPlan.RestoreTestingRecoveryPointSelectionProperty);
    /**
     * The RestoreTestingPlanName is a unique string that is the name of the restore testing plan.
     */
     ...
     * Defaults to 24 hours.
     */
    get startWindowHours(): number | undefined;
    /**
     * Defaults to 24 hours.
     */
    set startWindowHours(value: number | undefined);
    /**
     * Optional tags to include.
     */
     ...
     */
    get attrRestoreTestingPlanArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnRestoreTestingSelection extends cdk.CfnResource implements cdk.IInspectable, IRestoreTestingSelectionRef {
     ...
     */
    private _restoreTestingSelectionName;
    /**
     ...
     * You can include specific ARNs, such as `ProtectedResourceArns: ["arn:aws:...", "arn:aws:..."]` or you can include a wildcard: `ProtectedResourceArns: ["*"]` , but not both.
     */
    get protectedResourceArns(): Array<string> | undefined;
    /**
     * You can include specific ARNs, such as `ProtectedResourceArns: ["arn:aws:...", "arn:aws:..."]` or you can include a wildcard: `ProtectedResourceArns: ["*"]` , but not both.
     */
    set protectedResourceArns(value: Array<string> | undefined);
    /**
     * In a resource testing selection, this parameter filters by specific conditions such as `StringEquals` or `StringNotEquals` .
     */
    get protectedResourceConditions(): cdk.IResolvable | CfnRestoreTestingSelection.ProtectedResourceConditionsProperty | undefined;
    /**
     * In a resource testing selection, this parameter filters by specific conditions such as `StringEquals` or `StringNotEquals` .
     */
    set protectedResourceConditions(value: cdk.IResolvable | CfnRestoreTestingSelection.ProtectedResourceConditionsProperty | undefined);
    /**
     * The type of AWS resource included in a resource testing selection;
     */
     ...
     * You can override certain restore metadata keys by including the parameter `RestoreMetadataOverrides` in the body of `RestoreTestingSelection` .
     */
    get restoreMetadataOverrides(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * You can override certain restore metadata keys by including the parameter `RestoreMetadataOverrides` in the body of `RestoreTestingSelection` .
     */
    set restoreMetadataOverrides(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * Unique string that is the name of the restore testing plan.
     */
    get restoreTestingPlanName(): string;
     ...
     * The unique name of the restore testing selection that belongs to the related restore testing plan.
     */
    get restoreTestingSelectionName(): string;
    /**
     * The unique name of the restore testing selection that belongs to the related restore testing plan.
     */
    set restoreTestingSelectionName(value: string);
    /**
     * This is amount of hours (1 to 168) available to run a validation script on the data.
     */
    get validationWindowHours(): number | undefined;
    /**
     * This is amount of hours (1 to 168) available to run a validation script on the data.
     */
    set validationWindowHours(value: number | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 */
export declare class CfnTieringConfiguration extends cdk.CfnResource implements cdk.IInspectable, ITieringConfigurationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnTieringConfiguration from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnTieringConfiguration;
    /**
     * Checks whether the given object is a CfnTieringConfiguration
     */
    static isCfnTieringConfiguration(x: any): x is CfnTieringConfiguration;
    static arnForTieringConfiguration(resource: ITieringConfigurationRef): string;
    private _backupVaultName;
    /**
     * Tag Manager which manages the tags for this resource
     */
    ...
    private _tieringConfigurationName;
    private _tieringConfigurationTags?;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnTieringConfigurationProps);
    get tieringConfigurationRef(): TieringConfigurationReference;
    get backupVaultName(): string;
    set backupVaultName(value: string);
    get resourceSelection(): Array<cdk.IResolvable | CfnTieringConfiguration.ResourceSelectionProperty> | cdk.IResolvable;
    set resourceSelection(value: Array<cdk.IResolvable | CfnTieringConfiguration.ResourceSelectionProperty> | cdk.IResolvable);
    get tieringConfigurationName(): string;
    set tieringConfigurationName(value: string);
    get tieringConfigurationTags(): Record<string, string> | undefined;
    set tieringConfigurationTags(value: Record<string, string> | undefined);
    /**
     * @cloudformationAttribute CreationTime
     */
    get attrCreationTime(): string;
     ...
     */
    get attrTieringConfigurationArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnTieringConfiguration {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-tieringconfiguration.html
 */
export interface CfnTieringConfigurationProps {
    /**
     ...
     */
    readonly resourceSelection: Array<cdk.IResolvable | CfnTieringConfiguration.ResourceSelectionProperty> | cdk.IResolvable;
    /**
     ...
     */
    readonly tieringConfigurationTags?: Record<string, string>;
}
...
export type { ITieringConfigurationRef, TieringConfigurationReference };
