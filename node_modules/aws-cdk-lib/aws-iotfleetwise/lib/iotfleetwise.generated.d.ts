...
export declare class CfnCampaign extends cdk.CfnResource implements cdk.IInspectable, ICampaignRef, cdk.ITaggable {
     ...
     */
    private _dataDestinationConfigs?;
    /**
     * A list of vehicle attributes to associate with a campaign.
     */
    private _dataExtraDimensions?;
    /**
     * The data partitions associated with the signals collected from the vehicle.
     */
    private _dataPartitions?;
    /**
     ...
     */
    private _postTriggerCollectionDuration?;
    /**
     ...
     * The data collection scheme associated with the campaign.
     */
    get collectionScheme(): CfnCampaign.CollectionSchemeProperty | cdk.IResolvable;
    /**
     * The data collection scheme associated with the campaign.
     */
    set collectionScheme(value: CfnCampaign.CollectionSchemeProperty | cdk.IResolvable);
    /**
     * Whether to compress signals before transmitting data to AWS IoT FleetWise .
     */
     ...
     * The destination where the campaign sends data.
     */
    get dataDestinationConfigs(): Array<CfnCampaign.DataDestinationConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The destination where the campaign sends data.
     */
    set dataDestinationConfigs(value: Array<CfnCampaign.DataDestinationConfigProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A list of vehicle attributes to associate with a campaign.
     */
    get dataExtraDimensions(): Array<string> | undefined;
    /**
     * A list of vehicle attributes to associate with a campaign.
     */
    set dataExtraDimensions(value: Array<string> | undefined);
    /**
     * The data partitions associated with the signals collected from the vehicle.
     */
    get dataPartitions(): Array<CfnCampaign.DataPartitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The data partitions associated with the signals collected from the vehicle.
     */
    set dataPartitions(value: Array<CfnCampaign.DataPartitionProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of the campaign.
     */
     ...
     * Option for a vehicle to send diagnostic trouble codes to AWS IoT FleetWise .
     */
    get diagnosticsMode(): string | undefined;
    /**
     * Option for a vehicle to send diagnostic trouble codes to AWS IoT FleetWise .
     */
    set diagnosticsMode(value: string | undefined);
    /**
     * The time the campaign expires, in seconds since epoch (January 1, 1970 at midnight UTC time).
     */
     ...
     * The time the campaign expires, in seconds since epoch (January 1, 1970 at midnight UTC time).
     */
    set expiryTime(value: string | undefined);
    /**
     * The name of a campaign.
     */
    get name(): string;
     ...
     * How long (in milliseconds) to collect raw data after a triggering event initiates the collection.
     */
    get postTriggerCollectionDuration(): number | undefined;
    /**
     * How long (in milliseconds) to collect raw data after a triggering event initiates the collection.
     */
    set postTriggerCollectionDuration(value: number | undefined);
    /**
     * A number indicating the priority of one campaign over another campaign for a certain vehicle or fleet.
     */
     ...
     * The Amazon Resource Name (ARN) of the signal catalog associated with the campaign.
     */
    get signalCatalogArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the signal catalog associated with the campaign.
     */
    set signalCatalogArn(value: string);
    /**
     * A list of information about signals to collect.
     */
    get signalsToCollect(): Array<cdk.IResolvable | CfnCampaign.SignalInformationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of information about signals to collect.
     */
    set signalsToCollect(value: Array<cdk.IResolvable | CfnCampaign.SignalInformationProperty> | cdk.IResolvable | undefined);
    /**
     * A list of information about signals to fetch.
     */
    get signalsToFetch(): Array<cdk.IResolvable | CfnCampaign.SignalFetchInformationProperty> | cdk.IResolvable | undefined;
    /**
     * A list of information about signals to fetch.
     */
    set signalsToFetch(value: Array<cdk.IResolvable | CfnCampaign.SignalFetchInformationProperty> | cdk.IResolvable | undefined);
    /**
     * Whether to store collected data after a vehicle lost a connection with the cloud.
     */
    get spoolingMode(): string | undefined;
    /**
     * Whether to store collected data after a vehicle lost a connection with the cloud.
     */
    set spoolingMode(value: string | undefined);
    /**
     * The time, in milliseconds, to deliver a campaign after it was approved. If it's not specified, `0` is used.
     */
...
export declare class CfnDecoderManifest extends cdk.CfnResource implements cdk.IInspectable, IDecoderManifestRef, cdk.ITaggable {
     ...
     */
    private _defaultForUnmappedSignals?;
    /**
     ...
     * Use default decoders for all unmapped signals in the model.
     */
    get defaultForUnmappedSignals(): string | undefined;
    /**
     * Use default decoders for all unmapped signals in the model.
     */
    set defaultForUnmappedSignals(value: string | undefined);
    /**
     * A brief description of the decoder manifest.
     */
    get description(): string | undefined;
     ...
     * The Amazon Resource Name (ARN) of a vehicle model (model manifest) associated with the decoder manifest.
     */
    get modelManifestArn(): string;
    /**
     * The Amazon Resource Name (ARN) of a vehicle model (model manifest) associated with the decoder manifest.
     */
    set modelManifestArn(value: string);
    /**
     * The name of the decoder manifest.
     */
    get name(): string;
     ...
     * A list of information about available network interfaces.
     */
    get networkInterfaces(): Array<cdk.IResolvable | CfnDecoderManifest.NetworkInterfacesItemsProperty> | cdk.IResolvable | undefined;
    /**
     * A list of information about available network interfaces.
     */
    set networkInterfaces(value: Array<cdk.IResolvable | CfnDecoderManifest.NetworkInterfacesItemsProperty> | cdk.IResolvable | undefined);
    /**
     * A list of information about signal decoders.
     */
    get signalDecoders(): Array<cdk.IResolvable | CfnDecoderManifest.SignalDecodersItemsProperty> | cdk.IResolvable | undefined;
    /**
     * A list of information about signal decoders.
     */
    set signalDecoders(value: Array<cdk.IResolvable | CfnDecoderManifest.SignalDecodersItemsProperty> | cdk.IResolvable | undefined);
    /**
     * The state of the decoder manifest.
     */
...
export declare class CfnSignalCatalog extends cdk.CfnResource implements cdk.IInspectable, ISignalCatalogRef, cdk.ITaggable {
     ...
     * Information about the number of nodes and node types in a vehicle network.
     */
    get nodeCounts(): cdk.IResolvable | CfnSignalCatalog.NodeCountsProperty | undefined;
    /**
     * Information about the number of nodes and node types in a vehicle network.
     */
    set nodeCounts(value: cdk.IResolvable | CfnSignalCatalog.NodeCountsProperty | undefined);
    /**
     * A list of information about nodes, which are a general abstraction of signals.
     */
    get nodes(): Array<cdk.IResolvable | CfnSignalCatalog.NodeProperty> | cdk.IResolvable | undefined;
    /**
     * A list of information about nodes, which are a general abstraction of signals.
     */
    set nodes(value: Array<cdk.IResolvable | CfnSignalCatalog.NodeProperty> | cdk.IResolvable | undefined);
    /**
     * Metadata that can be used to manage the signal catalog.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnVehicle extends cdk.CfnResource implements cdk.IInspectable, IVehicleRef, cdk.ITaggable {
     ...
     * An option to create a new AWS IoT thing when creating a vehicle, or to validate an existing thing as a vehicle.
     */
    get associationBehavior(): string | undefined;
    /**
     * An option to create a new AWS IoT thing when creating a vehicle, or to validate an existing thing as a vehicle.
     */
    set associationBehavior(value: string | undefined);
    /**
     * Static information about a vehicle in a key-value pair.
     */
     ...
     * The Amazon Resource Name (ARN) of a decoder manifest associated with the vehicle to create.
     */
    get decoderManifestArn(): string;
    /**
     * The Amazon Resource Name (ARN) of a decoder manifest associated with the vehicle to create.
     */
    set decoderManifestArn(value: string);
    /**
     * The Amazon Resource Name (ARN) of the vehicle model (model manifest) to create the vehicle from.
     */
    get modelManifestArn(): string;
     ...
     * Associate state templates to track the state of the vehicle.
     */
    get stateTemplates(): Array<cdk.IResolvable | CfnVehicle.StateTemplateAssociationProperty> | cdk.IResolvable | undefined;
    /**
     * Associate state templates to track the state of the vehicle.
     */
    set stateTemplates(value: Array<cdk.IResolvable | CfnVehicle.StateTemplateAssociationProperty> | cdk.IResolvable | undefined);
    /**
     * Metadata which can be used to manage the vehicle.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnStateTemplate extends cdk.CfnResource implements cdk.IInspectable, IStateTemplateRef, cdk.ITaggableV2 {
     ...
     */
    private _metadataExtraDimensions?;
    /**
     ...
     */
    private _stateTemplateProperties;
    /**
     ...
     * A list of vehicle attributes to associate with the user properties of the messages published on the state template's MQTT topic.
     */
    get metadataExtraDimensions(): Array<string> | undefined;
    /**
     * A list of vehicle attributes to associate with the user properties of the messages published on the state template's MQTT topic.
     */
    set metadataExtraDimensions(value: Array<string> | undefined);
    /**
     * The unique alias of the state template.
     */
    get name(): string;
     ...
     * A list of signals from which data is collected.
     */
    get stateTemplateProperties(): Array<string>;
    /**
     * A list of signals from which data is collected.
     */
    set stateTemplateProperties(value: Array<string>);
    /**
     * Metadata that can be used to manage the state template.
     */
