...
import { EnvironmentEC2Reference, IEnvironmentEC2Ref } from "../../interfaces/generated/aws-cloud9-interfaces.generated";
/**
...
export declare class CfnEnvironmentEC2 extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentEC2Ref, cdk.ITaggable {
     ...
     * Any AWS CodeCommit source code repositories to be cloned into the development environment.
     */
    get repositories(): Array<cdk.IResolvable | CfnEnvironmentEC2.RepositoryProperty> | cdk.IResolvable | undefined;
    /**
     * Any AWS CodeCommit source code repositories to be cloned into the development environment.
     */
    set repositories(value: Array<cdk.IResolvable | CfnEnvironmentEC2.RepositoryProperty> | cdk.IResolvable | undefined);
    /**
     * The ID of the subnet in Amazon Virtual Private Cloud (Amazon VPC) that AWS Cloud9 will use to communicate with the Amazon Elastic Compute Cloud (Amazon EC2) instance.
     */
