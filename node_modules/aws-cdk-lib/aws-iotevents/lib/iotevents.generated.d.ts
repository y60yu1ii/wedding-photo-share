...
import { AlarmModelReference, DetectorModelReference, IAlarmModelRef, IDetectorModelRef, IInputRef, InputReference } from "../../interfaces/generated/aws-iotevents-interfaces.generated";
...
export declare class CfnAlarmModel extends cdk.CfnResource implements cdk.IInspectable, IAlarmModelRef, cdk.ITaggable {
     ...
     */
    private _alarmCapabilities?;
    /**
     * Contains information about one or more alarm actions.
     */
    private _alarmEventActions?;
    /**
     * The description of the alarm model.
     */
    private _alarmModelDescription?;
    /**
     * The name of the alarm model.
     */
    private _alarmModelName?;
    /**
     ...
     * Contains the configuration information of alarm state changes.
     */
    get alarmCapabilities(): CfnAlarmModel.AlarmCapabilitiesProperty | cdk.IResolvable | undefined;
    /**
     * Contains the configuration information of alarm state changes.
     */
    set alarmCapabilities(value: CfnAlarmModel.AlarmCapabilitiesProperty | cdk.IResolvable | undefined);
    /**
     * Contains information about one or more alarm actions.
     */
    get alarmEventActions(): CfnAlarmModel.AlarmEventActionsProperty | cdk.IResolvable | undefined;
    /**
     * Contains information about one or more alarm actions.
     */
    set alarmEventActions(value: CfnAlarmModel.AlarmEventActionsProperty | cdk.IResolvable | undefined);
    /**
     * The description of the alarm model.
     */
    get alarmModelDescription(): string | undefined;
    /**
     * The description of the alarm model.
     */
    set alarmModelDescription(value: string | undefined);
    /**
     * The name of the alarm model.
     */
    get alarmModelName(): string | undefined;
    /**
     * The name of the alarm model.
     */
    set alarmModelName(value: string | undefined);
    /**
     * Defines when your alarm is invoked.
     */
    get alarmRule(): CfnAlarmModel.AlarmRuleProperty | cdk.IResolvable;
    /**
     * Defines when your alarm is invoked.
     */
    set alarmRule(value: CfnAlarmModel.AlarmRuleProperty | cdk.IResolvable);
    /**
     * An input attribute used as a key to create an alarm.
     */
...
export declare class CfnDetectorModel extends cdk.CfnResource implements cdk.IInspectable, IDetectorModelRef, cdk.ITaggable {
     ...
     * Information that defines how a detector operates.
     */
    get detectorModelDefinition(): CfnDetectorModel.DetectorModelDefinitionProperty | cdk.IResolvable;
    /**
     * Information that defines how a detector operates.
     */
    set detectorModelDefinition(value: CfnDetectorModel.DetectorModelDefinitionProperty | cdk.IResolvable);
    /**
     * A brief description of the detector model.
     */
    get detectorModelDescription(): string | undefined;
    /**
     * A brief description of the detector model.
     */
    set detectorModelDescription(value: string | undefined);
    /**
     * The name of the detector model.
     */
    get detectorModelName(): string | undefined;
    /**
     * The name of the detector model.
     */
    set detectorModelName(value: string | undefined);
    /**
     * Information about the order in which events are evaluated and how actions are executed.
     */
    get evaluationMethod(): string | undefined;
    /**
     * Information about the order in which events are evaluated and how actions are executed.
     */
    set evaluationMethod(value: string | undefined);
    /**
     * The value used to identify a detector instance.
     */
    get key(): string | undefined;
...
export declare class CfnInput extends cdk.CfnResource implements cdk.IInspectable, IInputRef, cdk.ITaggable {
     ...
     * The definition of the input.
     */
    get inputDefinition(): CfnInput.InputDefinitionProperty | cdk.IResolvable;
    /**
     * The definition of the input.
     */
    set inputDefinition(value: CfnInput.InputDefinitionProperty | cdk.IResolvable);
    /**
     * A brief description of the input.
     */
    get inputDescription(): string | undefined;
    /**
     * A brief description of the input.
     */
    set inputDescription(value: string | undefined);
    /**
     * The name of the input.
     */
     ...
     * The name of the input.
     */
    set inputName(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
