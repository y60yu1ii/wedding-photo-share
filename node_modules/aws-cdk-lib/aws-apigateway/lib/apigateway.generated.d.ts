...
import { aws_apigateway as apiGatewayRefs, aws_cognito as cognitoRefs, aws_elasticloadbalancingv2 as elasticLoadBalancingV2Refs, aws_iam as iamRefs } from "../../interfaces";
import { AccountReference, ApiKeyReference, AuthorizerReference, BasePathMappingReference, BasePathMappingV2Reference, ClientCertificateReference, DeploymentReference, DocumentationPartReference, DocumentationVersionReference, DomainNameAccessAssociationReference, DomainNameReference, DomainNameV2Reference, GatewayResponseReference, IAccountRef, IApiKeyRef, IAuthorizerRef, IBasePathMappingRef, IBasePathMappingV2Ref, IClientCertificateRef, IDeploymentRef, IDocumentationPartRef, IDocumentationVersionRef, IDomainNameAccessAssociationRef, IDomainNameRef, IDomainNameV2Ref, IGatewayResponseRef, IMethodRef, IModelRef, IRequestValidatorRef, IResourceRef, IRestApiRef, IStageRef, IUsagePlanKeyRef, IUsagePlanRef, IVpcLinkRef, MethodReference, ModelReference, RequestValidatorReference, ResourceReference, RestApiReference, StageReference, UsagePlanKeyReference, UsagePlanReference, VpcLinkReference } from "../../interfaces/generated/aws-apigateway-interfaces.generated";
/**
...
export interface CfnAccountProps {
     ...
     */
    readonly cloudWatchRoleArn?: iamRefs.IRoleRef | string;
}
/**
...
export declare class CfnApiKey extends cdk.CfnResource implements cdk.IInspectable, IApiKeyRef, cdk.ITaggable {
     ...
     * Specifies whether ( `true` ) or not ( `false` ) the key identifier is distinct from the created API key value.
     */
    get generateDistinctId(): boolean | cdk.IResolvable | undefined;
    /**
     * Specifies whether ( `true` ) or not ( `false` ) the key identifier is distinct from the created API key value.
     */
    set generateDistinctId(value: boolean | cdk.IResolvable | undefined);
    /**
     * A name for the API key.
     */
     ...
     * DEPRECATED FOR USAGE PLANS - Specifies stages associated with the API key.
     */
    get stageKeys(): Array<cdk.IResolvable | CfnApiKey.StageKeyProperty> | cdk.IResolvable | undefined;
    /**
     * DEPRECATED FOR USAGE PLANS - Specifies stages associated with the API key.
     */
    set stageKeys(value: Array<cdk.IResolvable | CfnApiKey.StageKeyProperty> | cdk.IResolvable | undefined);
    /**
     * The key-value map of strings.
     */
...
export declare class CfnAuthorizer extends cdk.CfnResource implements cdk.IInspectable, IAuthorizerRef {
     ...
     * A list of the Amazon Cognito user pool ARNs for the `COGNITO_USER_POOLS` authorizer.
     */
    get providerArns(): Array<string> | undefined;
    /**
     * A list of the Amazon Cognito user pool ARNs for the `COGNITO_USER_POOLS` authorizer.
     */
    set providerArns(value: Array<string> | undefined);
    /**
     * The string identifier of the associated RestApi.
     */
...
export interface CfnAuthorizerProps {
     ...
     */
    readonly authorizerCredentials?: iamRefs.IRoleRef | string;
    /**
     * The TTL in seconds of cached authorizer results.
     *
     ...
     */
    readonly providerArns?: Array<cognitoRefs.IUserPoolRef | string>;
    /**
     * The string identifier of the associated RestApi.
     *
     ...
     */
    readonly restApiId: apiGatewayRefs.IRestApiRef | string;
    /**
     * The authorizer type.
     *
...
export declare class CfnBasePathMapping extends cdk.CfnResource implements cdk.IInspectable, IBasePathMappingRef {
     ...
     * The string identifier of the associated RestApi.
     */
    get restApiId(): string | undefined;
    /**
     * The string identifier of the associated RestApi.
     */
    set restApiId(value: string | undefined);
    /**
     * The name of the associated stage.
     */
...
export interface CfnBasePathMappingProps {
     ...
     */
    readonly domainName: apiGatewayRefs.IDomainNameRef | string;
    /**
     ...
     */
    readonly stage?: apiGatewayRefs.IStageRef | string;
}
/**
...
export declare class CfnClientCertificate extends cdk.CfnResource implements cdk.IInspectable, IClientCertificateRef, cdk.ITaggable {
     ...
     */
    get attrClientCertificateId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDeployment extends cdk.CfnResource implements cdk.IInspectable, IDeploymentRef {
     ...
     */
    private _deploymentCanarySettings?;
    /**
     ...
     * The input configuration for a canary deployment.
     */
    get deploymentCanarySettings(): CfnDeployment.DeploymentCanarySettingsProperty | cdk.IResolvable | undefined;
    /**
     * The input configuration for a canary deployment.
     */
    set deploymentCanarySettings(value: CfnDeployment.DeploymentCanarySettingsProperty | cdk.IResolvable | undefined);
    /**
     * The description for the Deployment resource to create.
     */
    get description(): string | undefined;
     ...
     * The description of the Stage resource for the Deployment resource to create.
     */
    get stageDescription(): cdk.IResolvable | CfnDeployment.StageDescriptionProperty | undefined;
    /**
     * The description of the Stage resource for the Deployment resource to create.
     */
    set stageDescription(value: cdk.IResolvable | CfnDeployment.StageDescriptionProperty | undefined);
    /**
     * The name of the Stage resource for the Deployment resource to create.
     */
...
export declare class CfnDocumentationPart extends cdk.CfnResource implements cdk.IInspectable, IDocumentationPartRef {
     ...
     * The location of the targeted API entity of the to-be-created documentation part.
     */
    get location(): cdk.IResolvable | CfnDocumentationPart.LocationProperty;
    /**
     * The location of the targeted API entity of the to-be-created documentation part.
     */
    set location(value: cdk.IResolvable | CfnDocumentationPart.LocationProperty);
    /**
     * The new documentation content map of the targeted API entity.
     */
     ...
     */
    get attrDocumentationPartId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDomainName extends cdk.CfnResource implements cdk.IInspectable, IDomainNameRef, cdk.ITaggable {
     ...
     * The endpoint access mode for your DomainName.
     */
    get endpointAccessMode(): string | undefined;
    /**
     * The endpoint access mode for your DomainName.
     */
    set endpointAccessMode(value: string | undefined);
    /**
     * The endpoint configuration of this DomainName showing the endpoint types and IP address types of the domain name.
     */
    get endpointConfiguration(): CfnDomainName.EndpointConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The endpoint configuration of this DomainName showing the endpoint types and IP address types of the domain name.
     */
    set endpointConfiguration(value: CfnDomainName.EndpointConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The mutual TLS authentication configuration for a custom domain name.
     */
     ...
     * The ARN of the public certificate issued by ACM to validate ownership of your custom domain.
     */
    get ownershipVerificationCertificateArn(): string | undefined;
    /**
     * The ARN of the public certificate issued by ACM to validate ownership of your custom domain.
     */
    set ownershipVerificationCertificateArn(value: string | undefined);
    /**
     * The reference to an AWS -managed certificate that will be used for validating the regional domain name.
     */
     ...
     */
    get attrDistributionDomainName(): string;
    /**
     ...
     */
    get attrDistributionHostedZoneId(): string;
    /**
...
export declare class CfnGatewayResponse extends cdk.CfnResource implements cdk.IInspectable, IGatewayResponseRef {
     ...
     * Response parameters (paths, query strings and headers) of the GatewayResponse as a string-to-string map of key-value pairs.
     */
    get responseParameters(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Response parameters (paths, query strings and headers) of the GatewayResponse as a string-to-string map of key-value pairs.
     */
    set responseParameters(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * Response templates of the GatewayResponse as a string-to-string map of key-value pairs.
     */
    get responseTemplates(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Response templates of the GatewayResponse as a string-to-string map of key-value pairs.
     */
    set responseTemplates(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * The response type of the associated GatewayResponse.
     */
     ...
     * The HTTP status code for this GatewayResponse.
     */
    set statusCode(value: string | undefined);
    /**
...
export declare class CfnMethod extends cdk.CfnResource implements cdk.IInspectable, IMethodRef {
     ...
     * Represents an `HTTP` , `HTTP_PROXY` , `AWS` , `AWS_PROXY` , or Mock integration.
     */
    get integration(): CfnMethod.IntegrationProperty | cdk.IResolvable | undefined;
    /**
     * Represents an `HTTP` , `HTTP_PROXY` , `AWS` , `AWS_PROXY` , or Mock integration.
     */
    set integration(value: CfnMethod.IntegrationProperty | cdk.IResolvable | undefined);
    /**
     * Gets a method response associated with a given HTTP status code.
     */
    get methodResponses(): Array<cdk.IResolvable | CfnMethod.MethodResponseProperty> | cdk.IResolvable | undefined;
    /**
     * Gets a method response associated with a given HTTP status code.
     */
    set methodResponses(value: Array<cdk.IResolvable | CfnMethod.MethodResponseProperty> | cdk.IResolvable | undefined);
    /**
     * A human-friendly operation identifier for the method.
     */
     ...
     * A key-value map specifying data schemas, represented by Model resources, (as the mapped value) of the request payloads of given content types (as the mapping key).
     */
    get requestModels(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A key-value map specifying data schemas, represented by Model resources, (as the mapped value) of the request payloads of given content types (as the mapping key).
     */
    set requestModels(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * A key-value map defining required or optional method request parameters that can be accepted by API Gateway.
     */
    get requestParameters(): cdk.IResolvable | Record<string, boolean | cdk.IResolvable> | undefined;
    /**
     * A key-value map defining required or optional method request parameters that can be accepted by API Gateway.
     */
    set requestParameters(value: cdk.IResolvable | Record<string, boolean | cdk.IResolvable> | undefined);
    /**
     * The identifier of a RequestValidator for request validation.
     */
...
export interface CfnMethodProps {
     ...
     */
    readonly authorizerId?: apiGatewayRefs.IAuthorizerRef | string;
    /**
     * The method's HTTP verb.
     *
     ...
     */
    readonly requestValidatorId?: apiGatewayRefs.IRequestValidatorRef | string;
    /**
     * The Resource identifier for the MethodResponse resource.
     *
     ...
     */
    readonly resourceId: apiGatewayRefs.IResourceRef | string;
    /**
     * The string identifier of the associated RestApi.
     *
...
export declare class CfnModel extends cdk.CfnResource implements cdk.IInspectable, IModelRef {
     ...
     * The schema for the model.
     */
    get schema(): any | cdk.IResolvable | undefined;
    /**
     * The schema for the model.
     */
    set schema(value: any | cdk.IResolvable | undefined);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnRequestValidator extends cdk.CfnResource implements cdk.IInspectable, IRequestValidatorRef {
     ...
     * A Boolean flag to indicate whether to validate a request body according to the configured Model schema.
     */
    get validateRequestBody(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean flag to indicate whether to validate a request body according to the configured Model schema.
     */
    set validateRequestBody(value: boolean | cdk.IResolvable | undefined);
    /**
     * A Boolean flag to indicate whether to validate request parameters ( `true` ) or not ( `false` ).
     */
    get validateRequestParameters(): boolean | cdk.IResolvable | undefined;
    /**
     * A Boolean flag to indicate whether to validate request parameters ( `true` ) or not ( `false` ).
     */
    set validateRequestParameters(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ID for the request validator. For example: `abc123` .
     *
     * @cloudformationAttribute RequestValidatorId
     */
    get attrRequestValidatorId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnResourceProps {
     ...
     */
    readonly parentId: apiGatewayRefs.IResourceRef | string;
    /**
     * The last path segment for this resource.
     *
...
export declare class CfnRestApi extends cdk.CfnResource implements cdk.IInspectable, IRestApiRef, cdk.ITaggable {
     ...
     * The source of the API key for metering requests according to a usage plan.
     */
    get apiKeySourceType(): string | undefined;
    /**
     * The source of the API key for metering requests according to a usage plan.
     */
    set apiKeySourceType(value: string | undefined);
    /**
     * The list of binary media types supported by the RestApi.
     */
     ...
     * The Amazon Simple Storage Service (Amazon S3) location that points to an OpenAPI file, which defines a set of RESTful APIs in JSON or YAML format.
     */
    get bodyS3Location(): cdk.IResolvable | CfnRestApi.S3LocationProperty | undefined;
    /**
     * The Amazon Simple Storage Service (Amazon S3) location that points to an OpenAPI file, which defines a set of RESTful APIs in JSON or YAML format.
     */
    set bodyS3Location(value: cdk.IResolvable | CfnRestApi.S3LocationProperty | undefined);
    /**
     * The ID of the RestApi that you want to clone from.
     */
    get cloneFrom(): string | undefined;
    /**
     * The ID of the RestApi that you want to clone from.
     */
    set cloneFrom(value: string | undefined);
    /**
     * The description of the RestApi.
     */
    get description(): string | undefined;
     ...
     * A list of the endpoint types and IP address types of the API.
     */
    get endpointConfiguration(): CfnRestApi.EndpointConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * A list of the endpoint types and IP address types of the API.
     */
    set endpointConfiguration(value: CfnRestApi.EndpointConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A query parameter to indicate whether to rollback the API update ( `true` ) or not ( `false` ) when a warning is encountered.
     */
     ...
     */
    get attrRestApiId(): string;
    /**
     * The root resource ID for a `RestApi` resource, such as `a0bc123d4e` .
     *
     * @cloudformationAttribute RootResourceId
     */
    get attrRootResourceId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnRestApiProps {
     ...
     */
    readonly cloneFrom?: apiGatewayRefs.IRestApiRef | string;
    /**
     * The description of the RestApi.
     *
...
export declare class CfnStage extends cdk.CfnResource implements cdk.IInspectable, IStageRef, cdk.ITaggable {
     ...
     * Access log settings, including the access log format and access log destination ARN.
     */
    get accessLogSetting(): CfnStage.AccessLogSettingProperty | cdk.IResolvable | undefined;
    /**
     * Access log settings, including the access log format and access log destination ARN.
     */
    set accessLogSetting(value: CfnStage.AccessLogSettingProperty | cdk.IResolvable | undefined);
    /**
     * Specifies whether a cache cluster is enabled for the stage.
     */
     ...
     * Settings for the canary deployment in this stage.
     */
    get canarySetting(): CfnStage.CanarySettingProperty | cdk.IResolvable | undefined;
    /**
     * Settings for the canary deployment in this stage.
     */
    set canarySetting(value: CfnStage.CanarySettingProperty | cdk.IResolvable | undefined);
    /**
     * The identifier of a client certificate for an API stage.
     */
     ...
     * A map that defines the method settings for a Stage resource.
     */
    get methodSettings(): Array<cdk.IResolvable | CfnStage.MethodSettingProperty> | cdk.IResolvable | undefined;
    /**
     * A map that defines the method settings for a Stage resource.
     */
    set methodSettings(value: Array<cdk.IResolvable | CfnStage.MethodSettingProperty> | cdk.IResolvable | undefined);
    /**
     * The string identifier of the associated RestApi.
     */
    get restApiId(): string;
...
export interface CfnStageProps {
     ...
     */
    readonly clientCertificateId?: apiGatewayRefs.IClientCertificateRef | string;
    /**
     * The identifier of the Deployment that the stage points to.
     *
     ...
     */
    readonly deploymentId?: apiGatewayRefs.IDeploymentRef | string;
    /**
     * The stage's description.
     *
...
export declare class CfnUsagePlan extends cdk.CfnResource implements cdk.IInspectable, IUsagePlanRef, cdk.ITaggable {
     ...
     * The associated API stages of a usage plan.
     */
    get apiStages(): Array<CfnUsagePlan.ApiStageProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The associated API stages of a usage plan.
     */
    set apiStages(value: Array<CfnUsagePlan.ApiStageProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * The description of a usage plan.
     */
    get description(): string | undefined;
     ...
     * The target maximum number of permitted requests per a given unit time interval.
     */
    get quota(): cdk.IResolvable | CfnUsagePlan.QuotaSettingsProperty | undefined;
    /**
     * The target maximum number of permitted requests per a given unit time interval.
     */
    set quota(value: cdk.IResolvable | CfnUsagePlan.QuotaSettingsProperty | undefined);
    /**
     * The collection of tags.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * A map containing method level throttling information for API stage in a usage plan.
     */
    get throttle(): cdk.IResolvable | CfnUsagePlan.ThrottleSettingsProperty | undefined;
    /**
     * A map containing method level throttling information for API stage in a usage plan.
     */
    set throttle(value: cdk.IResolvable | CfnUsagePlan.ThrottleSettingsProperty | undefined);
    /**
     * The name of a usage plan.
     */
    get usagePlanName(): string | undefined;
    /**
     * The name of a usage plan.
     */
    set usagePlanName(value: string | undefined);
    /**
...
export interface CfnUsagePlanKeyProps {
     ...
     */
    readonly keyId: apiGatewayRefs.IApiKeyRef | string;
    /**
     * The type of a UsagePlanKey resource for a plan customer.
     *
     ...
     */
    readonly usagePlanId: apiGatewayRefs.IUsagePlanRef | string;
}
/**
...
export declare class CfnVpcLink extends cdk.CfnResource implements cdk.IInspectable, IVpcLinkRef, cdk.ITaggable {
     ...
     * The ARN of the network load balancer of the VPC targeted by the VPC link.
     */
    get targetArns(): Array<string>;
    /**
     * The ARN of the network load balancer of the VPC targeted by the VPC link.
     */
    set targetArns(value: Array<string>);
    /**
...
export interface CfnVpcLinkProps {
     ...
     */
    readonly targetArns: Array<elasticLoadBalancingV2Refs.ILoadBalancerRef | string>;
}
/**
...
export declare class CfnBasePathMappingV2 extends cdk.CfnResource implements cdk.IInspectable, IBasePathMappingV2Ref {
     ...
     */
    get attrBasePathMappingArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDomainNameAccessAssociation extends cdk.CfnResource implements cdk.IInspectable, IDomainNameAccessAssociationRef, cdk.ITaggableV2 {
     ...
     */
    get attrDomainNameAccessAssociationArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnDomainNameV2 extends cdk.CfnResource implements cdk.IInspectable, IDomainNameV2Ref, cdk.ITaggableV2 {
     ...
     * The endpoint configuration to indicate the types of endpoints an API (RestApi) or its custom domain name (DomainName) has and the IP address types that can invoke it.
     */
    get endpointConfiguration(): CfnDomainNameV2.EndpointConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The endpoint configuration to indicate the types of endpoints an API (RestApi) or its custom domain name (DomainName) has and the IP address types that can invoke it.
     */
    set endpointConfiguration(value: CfnDomainNameV2.EndpointConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * A stringified JSON policy document that applies to the `execute-api` service for this DomainName regardless of the caller and Method configuration.
     */
