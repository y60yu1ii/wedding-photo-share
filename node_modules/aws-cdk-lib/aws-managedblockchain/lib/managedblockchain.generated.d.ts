...
import { AccessorReference, IAccessorRef, IMemberRef, INodeRef, MemberReference, NodeReference } from "../../interfaces/generated/aws-managedblockchain-interfaces.generated";
/**
...
export declare class CfnAccessor extends cdk.CfnResource implements cdk.IInspectable, IAccessorRef, cdk.ITaggable {
     ...
     * The type of the accessor.
     */
    get accessorType(): string;
    /**
     * The type of the accessor.
     */
    set accessorType(value: string);
    /**
     * The blockchain network that the `Accessor` token is created for.
     */
...
export declare class CfnMember extends cdk.CfnResource implements cdk.IInspectable, IMemberRef {
     ...
     * Configuration properties of the member.
     */
    get memberConfiguration(): cdk.IResolvable | CfnMember.MemberConfigurationProperty;
    /**
     * Configuration properties of the member.
     */
    set memberConfiguration(value: cdk.IResolvable | CfnMember.MemberConfigurationProperty);
    /**
     * Configuration properties of the network to which the member belongs.
     */
    get networkConfiguration(): cdk.IResolvable | CfnMember.NetworkConfigurationProperty | undefined;
    /**
     * Configuration properties of the network to which the member belongs.
     */
    set networkConfiguration(value: cdk.IResolvable | CfnMember.NetworkConfigurationProperty | undefined);
    /**
     * The unique identifier of the network to which the member belongs.
     */
     ...
     */
    get attrMemberId(): string;
    /**
     * The unique identifier of the network to which the member belongs.
     *
     * @cloudformationAttribute NetworkId
     */
    get attrNetworkId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnNode extends cdk.CfnResource implements cdk.IInspectable, INodeRef {
     ...
     * Configuration properties of a peer node.
     */
    get nodeConfiguration(): cdk.IResolvable | CfnNode.NodeConfigurationProperty;
    /**
     * Configuration properties of a peer node.
     */
    set nodeConfiguration(value: cdk.IResolvable | CfnNode.NodeConfigurationProperty);
    /**
