...
import { aws_iam as iamRefs, aws_kms as kmsRefs, aws_s3 as s3Refs } from "../../interfaces";
import { EnvironmentReference, IEnvironmentRef } from "../../interfaces/generated/aws-mwaa-interfaces.generated";
/**
...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggable {
     ...
     * A list of key-value pairs containing the Airflow configuration options for your environment.
     */
    get airflowConfigurationOptions(): any | cdk.IResolvable | undefined;
    /**
     * A list of key-value pairs containing the Airflow configuration options for your environment.
     */
    set airflowConfigurationOptions(value: any | cdk.IResolvable | undefined);
    /**
     * The version of Apache Airflow to use for the environment.
     */
    get airflowVersion(): string | undefined;
    /**
     * The version of Apache Airflow to use for the environment.
     */
    set airflowVersion(value: string | undefined);
    /**
     * The relative path to the DAGs folder on your Amazon S3 bucket.
     */
    get dagS3Path(): string | undefined;
    /**
     * The relative path to the DAGs folder on your Amazon S3 bucket.
     */
    set dagS3Path(value: string | undefined);
    /**
     * Defines whether the VPC endpoints configured for the environment are created, and managed, by the customer or by Amazon MWAA.
     */
    get endpointManagement(): string | undefined;
    /**
     * Defines whether the VPC endpoints configured for the environment are created, and managed, by the customer or by Amazon MWAA.
     */
    set endpointManagement(value: string | undefined);
    /**
     * The environment class type.
     */
    get environmentClass(): string | undefined;
    /**
     * The environment class type.
     */
    set environmentClass(value: string | undefined);
    /**
     * The Amazon Resource Name (ARN) of the execution role in IAM that allows MWAA to access AWS resources in your environment.
     */
     ...
     * The Apache Airflow logs being sent to CloudWatch Logs: `DagProcessingLogs` , `SchedulerLogs` , `TaskLogs` , `WebserverLogs` , `WorkerLogs` .
     */
    get loggingConfiguration(): cdk.IResolvable | CfnEnvironment.LoggingConfigurationProperty | undefined;
    /**
     * The Apache Airflow logs being sent to CloudWatch Logs: `DagProcessingLogs` , `SchedulerLogs` , `TaskLogs` , `WebserverLogs` , `WorkerLogs` .
     */
    set loggingConfiguration(value: cdk.IResolvable | CfnEnvironment.LoggingConfigurationProperty | undefined);
    /**
     * The maximum number of web servers that you want to run in your environment.
     */
    get maxWebservers(): number | undefined;
    /**
     * The maximum number of web servers that you want to run in your environment.
     */
    set maxWebservers(value: number | undefined);
    /**
     * The maximum number of workers that you want to run in your environment.
     */
     ...
     * The minimum number of web servers that you want to run in your environment.
     */
    get minWebservers(): number | undefined;
    /**
     * The minimum number of web servers that you want to run in your environment.
     */
    set minWebservers(value: number | undefined);
    /**
     * The minimum number of workers that you want to run in your environment.
     */
    get minWorkers(): number | undefined;
    /**
     * The minimum number of workers that you want to run in your environment.
     */
    set minWorkers(value: number | undefined);
    /**
     * The name of your Amazon MWAA environment.
     */
    get name(): string;
     ...
     * The VPC networking components used to secure and enable network traffic between the AWS resources for your environment.
     */
    get networkConfiguration(): cdk.IResolvable | CfnEnvironment.NetworkConfigurationProperty | undefined;
    /**
     * The VPC networking components used to secure and enable network traffic between the AWS resources for your environment.
     */
    set networkConfiguration(value: cdk.IResolvable | CfnEnvironment.NetworkConfigurationProperty | undefined);
    /**
     * The version of the plugins.zip file on your Amazon S3 bucket. To learn more, see [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html) .
     */
    get pluginsS3ObjectVersion(): string | undefined;
    /**
     * The version of the plugins.zip file on your Amazon S3 bucket. To learn more, see [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html) .
     */
    set pluginsS3ObjectVersion(value: string | undefined);
    /**
     * The relative path to the `plugins.zip` file on your Amazon S3 bucket. For example, `plugins.zip` . To learn more, see [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html) .
     */
    get pluginsS3Path(): string | undefined;
    /**
     * The relative path to the `plugins.zip` file on your Amazon S3 bucket. For example, `plugins.zip` . To learn more, see [Installing custom plugins](https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html) .
     */
    set pluginsS3Path(value: string | undefined);
    /**
     * The version of the requirements.txt file on your Amazon S3 bucket. To learn more, see [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html) .
     */
    get requirementsS3ObjectVersion(): string | undefined;
    /**
     * The version of the requirements.txt file on your Amazon S3 bucket. To learn more, see [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html) .
     */
    set requirementsS3ObjectVersion(value: string | undefined);
    /**
     * The relative path to the `requirements.txt` file on your Amazon S3 bucket. For example, `requirements.txt` . To learn more, see [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html) .
     */
    get requirementsS3Path(): string | undefined;
    /**
     * The relative path to the `requirements.txt` file on your Amazon S3 bucket. For example, `requirements.txt` . To learn more, see [Installing Python dependencies](https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html) .
     */
    set requirementsS3Path(value: string | undefined);
    /**
     * The number of schedulers that you want to run in your environment. Valid values:.
     */
    get schedulers(): number | undefined;
    /**
     * The number of schedulers that you want to run in your environment. Valid values:.
     */
    set schedulers(value: number | undefined);
    /**
     * The Amazon Resource Name (ARN) of the Amazon S3 bucket where your DAG code and supporting files are stored.
     */
    get sourceBucketArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the Amazon S3 bucket where your DAG code and supporting files are stored.
     */
    set sourceBucketArn(value: string | undefined);
    /**
     * The version of the startup shell script in your Amazon S3 bucket.
     */
    get startupScriptS3ObjectVersion(): string | undefined;
    /**
     * The version of the startup shell script in your Amazon S3 bucket.
     */
    set startupScriptS3ObjectVersion(value: string | undefined);
    /**
     * The relative path to the startup shell script in your Amazon S3 bucket. For example, `s3://mwaa-environment/startup.sh` .
     */
    get startupScriptS3Path(): string | undefined;
    /**
     * The relative path to the startup shell script in your Amazon S3 bucket. For example, `s3://mwaa-environment/startup.sh` .
     */
    set startupScriptS3Path(value: string | undefined);
    /**
     * The key-value tag pairs associated to your environment. For example, `"Environment": "Staging"` . To learn more, see [Tagging](https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html) .
     */
     ...
     * The Apache Airflow *Web server* access mode.
     */
    get webserverAccessMode(): string | undefined;
    /**
     * The Apache Airflow *Web server* access mode.
     */
    set webserverAccessMode(value: string | undefined);
    /**
     * The day and time of the week to start weekly maintenance updates of your environment in the following format: `DAY:HH:MM` .
     */
     ...
     * The worker replacement strategy to use when updating the environment.
     */
    get workerReplacementStrategy(): string | undefined;
    /**
     * The worker replacement strategy to use when updating the environment.
     */
    set workerReplacementStrategy(value: string | undefined);
    /**
     ...
     */
    get attrCeleryExecutorQueue(): string;
    /**
     * The VPC endpoint for the environment's Amazon RDS database.
     *
     * @cloudformationAttribute DatabaseVpcEndpointService
     */
    get attrDatabaseVpcEndpointService(): string;
    /**
     ...
     */
    get attrLoggingConfigurationDagProcessingLogsCloudWatchLogGroupArn(): string;
    /**
     ...
     */
    get attrLoggingConfigurationSchedulerLogsCloudWatchLogGroupArn(): string;
    /**
     ...
     */
    get attrLoggingConfigurationTaskLogsCloudWatchLogGroupArn(): string;
    /**
     ...
     */
    get attrLoggingConfigurationWebserverLogsCloudWatchLogGroupArn(): string;
    /**
     ...
     */
    get attrLoggingConfigurationWorkerLogsCloudWatchLogGroupArn(): string;
    /**
     * The URL of your Apache Airflow UI.
     *
     * @cloudformationAttribute WebserverUrl
     */
    get attrWebserverUrl(): string;
    /**
     * The VPC endpoint for the environment's web server.
     *
     * @cloudformationAttribute WebserverVpcEndpointService
     */
    get attrWebserverVpcEndpointService(): string;
...
export interface CfnEnvironmentProps {
     ...
     */
    readonly kmsKey?: kmsRefs.IKeyRef | string;
    /**
     * The Apache Airflow logs being sent to CloudWatch Logs: `DagProcessingLogs` , `SchedulerLogs` , `TaskLogs` , `WebserverLogs` , `WorkerLogs` .
     *
     ...
     */
    readonly sourceBucketArn?: s3Refs.IBucketRef | string;
    /**
     * The version of the startup shell script in your Amazon S3 bucket.
     *
