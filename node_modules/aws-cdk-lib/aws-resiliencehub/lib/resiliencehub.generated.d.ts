...
import { AppReference, IAppRef, IResiliencyPolicyRef, ResiliencyPolicyReference } from "../../interfaces/generated/aws-resiliencehub-interfaces.generated";
/**
...
export declare class CfnApp extends cdk.CfnResource implements cdk.IInspectable, IAppRef, cdk.ITaggable {
     ...
     */
    private _resiliencyPolicyArn?;
    /**
     * An array of `ResourceMapping` objects.
     */
    private _resourceMappings;
    /**
     ...
     * Assessment execution schedule with 'Daily' or 'Disabled' values.
     */
    get appAssessmentSchedule(): string | undefined;
    /**
     * Assessment execution schedule with 'Daily' or 'Disabled' values.
     */
    set appAssessmentSchedule(value: string | undefined);
    /**
     * A JSON string that provides information about your application structure.
     */
    get appTemplateBody(): string;
    /**
     * A JSON string that provides information about your application structure.
     */
    set appTemplateBody(value: string);
    /**
     * Optional description for an application.
     */
     ...
     * The list of events you would like to subscribe and get notification for.
     */
    get eventSubscriptions(): Array<CfnApp.EventSubscriptionProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of events you would like to subscribe and get notification for.
     */
    set eventSubscriptions(value: Array<CfnApp.EventSubscriptionProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Name for the application.
     */
    get name(): string;
     ...
     * Defines the roles and credentials that AWS Resilience Hub would use while creating the application, importing its resources, and running an assessment.
     */
    get permissionModel(): cdk.IResolvable | CfnApp.PermissionModelProperty | undefined;
    /**
     * Defines the roles and credentials that AWS Resilience Hub would use while creating the application, importing its resources, and running an assessment.
     */
    set permissionModel(value: cdk.IResolvable | CfnApp.PermissionModelProperty | undefined);
    /**
     * The Amazon Resource Name (ARN) of the resiliency policy.
     */
    get resiliencyPolicyArn(): string | undefined;
    /**
     * The Amazon Resource Name (ARN) of the resiliency policy.
     */
    set resiliencyPolicyArn(value: string | undefined);
    /**
     * An array of `ResourceMapping` objects.
     */
    get resourceMappings(): Array<cdk.IResolvable | CfnApp.ResourceMappingProperty> | cdk.IResolvable;
    /**
     * An array of `ResourceMapping` objects.
     */
    set resourceMappings(value: Array<cdk.IResolvable | CfnApp.ResourceMappingProperty> | cdk.IResolvable);
    /**
     * Tags assigned to the resource.
     */
...
export declare class CfnResiliencyPolicy extends cdk.CfnResource implements cdk.IInspectable, IResiliencyPolicyRef, cdk.ITaggable {
     ...
     * Specifies a high-level geographical location constraint for where your resilience policy data can be stored.
     */
    get dataLocationConstraint(): string | undefined;
    /**
     * Specifies a high-level geographical location constraint for where your resilience policy data can be stored.
     */
    set dataLocationConstraint(value: string | undefined);
    /**
     * The resiliency policy.
     */
    get policy(): cdk.IResolvable | Record<string, CfnResiliencyPolicy.FailurePolicyProperty | cdk.IResolvable>;
    /**
     * The resiliency policy.
     */
    set policy(value: cdk.IResolvable | Record<string, CfnResiliencyPolicy.FailurePolicyProperty | cdk.IResolvable>);
    /**
     * Description of the resiliency policy.
     */
