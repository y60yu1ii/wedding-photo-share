...
import { BudgetReference, BudgetsActionReference, IBudgetRef, IBudgetsActionRef } from "../../interfaces/generated/aws-budgets-interfaces.generated";
/**
...
export declare class CfnBudget extends cdk.CfnResource implements cdk.IInspectable, IBudgetRef {
     ...
     */
    private _notificationsWithSubscribers?;
    /**
     ...
     * The budget object that you want to create.
     */
    get budget(): CfnBudget.BudgetDataProperty | cdk.IResolvable;
    /**
     * The budget object that you want to create.
     */
    set budget(value: CfnBudget.BudgetDataProperty | cdk.IResolvable);
    /**
     * A notification that you want to associate with a budget.
     */
    get notificationsWithSubscribers(): Array<cdk.IResolvable | CfnBudget.NotificationWithSubscribersProperty> | cdk.IResolvable | undefined;
    /**
     * A notification that you want to associate with a budget.
     */
    set notificationsWithSubscribers(value: Array<cdk.IResolvable | CfnBudget.NotificationWithSubscribersProperty> | cdk.IResolvable | undefined);
    /**
     * An optional list of tags to associate with the specified budget.
     */
    get resourceTags(): Array<cdk.IResolvable | CfnBudget.ResourceTagProperty> | cdk.IResolvable | undefined;
    /**
     * An optional list of tags to associate with the specified budget.
     */
    set resourceTags(value: Array<cdk.IResolvable | CfnBudget.ResourceTagProperty> | cdk.IResolvable | undefined);
    /**
...
export declare class CfnBudgetsAction extends cdk.CfnResource implements cdk.IInspectable, IBudgetsActionRef, cdk.ITaggableV2 {
     ...
     * The trigger threshold of the action.
     */
    get actionThreshold(): CfnBudgetsAction.ActionThresholdProperty | cdk.IResolvable;
    /**
     * The trigger threshold of the action.
     */
    set actionThreshold(value: CfnBudgetsAction.ActionThresholdProperty | cdk.IResolvable);
    /**
     * The type of action.
     */
     ...
     * This specifies if the action needs manual or automatic approval.
     */
    get approvalModel(): string | undefined;
    /**
     * This specifies if the action needs manual or automatic approval.
     */
    set approvalModel(value: string | undefined);
    /**
     * A string that represents the budget name.
     */
     ...
     * Specifies all of the type-specific parameters.
     */
    get definition(): CfnBudgetsAction.DefinitionProperty | cdk.IResolvable;
    /**
     * Specifies all of the type-specific parameters.
     */
    set definition(value: CfnBudgetsAction.DefinitionProperty | cdk.IResolvable);
    /**
     * The role passed for action execution and reversion.
     */
     ...
     * An optional list of tags to associate with the specified budget action.
     */
    get resourceTags(): Array<CfnBudgetsAction.ResourceTagProperty> | undefined;
    /**
     * An optional list of tags to associate with the specified budget action.
     */
    set resourceTags(value: Array<CfnBudgetsAction.ResourceTagProperty> | undefined);
    /**
     * A list of subscribers.
     */
    get subscribers(): Array<cdk.IResolvable | CfnBudgetsAction.SubscriberProperty> | cdk.IResolvable;
    /**
     * A list of subscribers.
     */
    set subscribers(value: Array<cdk.IResolvable | CfnBudgetsAction.SubscriberProperty> | cdk.IResolvable);
    /**
     * A system-generated universally unique identifier (UUID) for the action.
     *
     * @cloudformationAttribute ActionId
     */
    get attrActionId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
