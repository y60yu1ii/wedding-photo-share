...
export declare class CfnInferenceScheduler extends cdk.CfnResource implements cdk.IInspectable, IInferenceSchedulerRef, cdk.ITaggable {
     ...
     */
    private _dataDelayOffsetInMinutes?;
    /**
     * Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
     */
    private _dataInputConfiguration;
    /**
     ...
     */
    private _dataOutputConfiguration;
    /**
     * How often data is uploaded to the source S3 bucket for the input data.
     */
    private _dataUploadFrequency;
    /**
     * The name of the inference scheduler.
     */
    private _inferenceSchedulerName?;
    /**
     ...
     * A period of time (in minutes) by which inference on the data is delayed after the data starts.
     */
    get dataDelayOffsetInMinutes(): number | undefined;
    /**
     * A period of time (in minutes) by which inference on the data is delayed after the data starts.
     */
    set dataDelayOffsetInMinutes(value: number | undefined);
    /**
     * Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
     */
    get dataInputConfiguration(): any | cdk.IResolvable;
    /**
     * Specifies configuration information for the input data for the inference scheduler, including delimiter, format, and dataset location.
     */
    set dataInputConfiguration(value: any | cdk.IResolvable);
    /**
     * Specifies configuration information for the output results for the inference scheduler, including the Amazon S3 location for the output.
     */
    get dataOutputConfiguration(): any | cdk.IResolvable;
    /**
     * Specifies configuration information for the output results for the inference scheduler, including the Amazon S3 location for the output.
     */
    set dataOutputConfiguration(value: any | cdk.IResolvable);
    /**
     * How often data is uploaded to the source S3 bucket for the input data.
     */
    get dataUploadFrequency(): string;
    /**
     * How often data is uploaded to the source S3 bucket for the input data.
     */
    set dataUploadFrequency(value: string);
    /**
     * The name of the inference scheduler.
     */
    get inferenceSchedulerName(): string | undefined;
    /**
     * The name of the inference scheduler.
     */
    set inferenceSchedulerName(value: string | undefined);
    /**
     * The name of the machine learning model used for the inference scheduler.
     */
     ...
     * Provides the identifier of the AWS KMS key used to encrypt inference scheduler data by  .
     */
    get serverSideKmsKeyId(): string | undefined;
    /**
     * Provides the identifier of the AWS KMS key used to encrypt inference scheduler data by  .
     */
    set serverSideKmsKeyId(value: string | undefined);
    /**
     * Any tags associated with the inference scheduler.
     */
     ...
     */
    get attrInferenceSchedulerArn(): string;
