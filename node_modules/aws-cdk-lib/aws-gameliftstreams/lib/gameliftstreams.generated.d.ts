...
import { ApplicationReference, IApplicationRef, IStreamGroupRef, StreamGroupReference } from "../../interfaces/generated/aws-gameliftstreams-interfaces.generated";
/**
...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, IApplicationRef, cdk.ITaggableV2 {
     ...
     * An Amazon S3 URI to a bucket where you would like Amazon GameLift Streams to save application logs.
     */
    get applicationLogOutputUri(): string | undefined;
    /**
     * An Amazon S3 URI to a bucket where you would like Amazon GameLift Streams to save application logs.
     */
    set applicationLogOutputUri(value: string | undefined);
    /**
     * Locations of log files that your content generates during a stream session.
     */
    get applicationLogPaths(): Array<string> | undefined;
    /**
     * Locations of log files that your content generates during a stream session.
     */
    set applicationLogPaths(value: Array<string> | undefined);
    /**
     * The location of the content that you want to stream.
     */
    get applicationSourceUri(): string;
    /**
     * The location of the content that you want to stream.
     */
    set applicationSourceUri(value: string);
    /**
     * A human-readable label for the application.
     */
     ...
     * A set of configuration settings to run the application on a stream group.
     */
    get runtimeEnvironment(): cdk.IResolvable | CfnApplication.RuntimeEnvironmentProperty;
    /**
     * A set of configuration settings to run the application on a stream group.
     */
    set runtimeEnvironment(value: cdk.IResolvable | CfnApplication.RuntimeEnvironmentProperty);
    /**
     * A list of labels to assign to the new application resource.
     */
...
export declare class CfnStreamGroup extends cdk.CfnResource implements cdk.IInspectable, IStreamGroupRef, cdk.ITaggableV2 {
     ...
     * Object that identifies the Amazon GameLift Streams application to stream with this stream group.
     */
    get defaultApplication(): CfnStreamGroup.DefaultApplicationProperty | cdk.IResolvable | undefined;
    /**
     * Object that identifies the Amazon GameLift Streams application to stream with this stream group.
     */
    set defaultApplication(value: CfnStreamGroup.DefaultApplicationProperty | cdk.IResolvable | undefined);
    /**
     * A descriptive label for the stream group.
     */
    get description(): string;
     ...
     * A set of one or more locations and the streaming capacity for each location.
     */
    get locationConfigurations(): Array<cdk.IResolvable | CfnStreamGroup.LocationConfigurationProperty> | cdk.IResolvable;
    /**
     * A set of one or more locations and the streaming capacity for each location.
     */
    set locationConfigurations(value: Array<cdk.IResolvable | CfnStreamGroup.LocationConfigurationProperty> | cdk.IResolvable);
    /**
     * The target stream quality for sessions that are hosted in this stream group.
     */
...
export declare namespace CfnStreamGroup {
    ...
    interface LocationConfigurationProperty {
         ...
         */
        readonly targetIdleCapacity?: number;
        /**
         ...
         */
        readonly vpcTransitConfiguration?: cdk.IResolvable | CfnStreamGroup.VpcTransitConfigurationProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface VpcTransitConfigurationProperty {
        /**
         ...
         */
        readonly ipv4CidrBlocks: Array<string>;
        /**
