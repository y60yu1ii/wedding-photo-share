...
import { ConfigReference, DataflowEndpointGroupReference, DataflowEndpointGroupV2Reference, IConfigRef, IDataflowEndpointGroupRef, IDataflowEndpointGroupV2Ref, IMissionProfileRef, MissionProfileReference } from "../../interfaces/generated/aws-groundstation-interfaces.generated";
import { aws_groundstation as groundStationRefs } from "../../interfaces";
/**
...
export declare class CfnConfig extends cdk.CfnResource implements cdk.IInspectable, IConfigRef, cdk.ITaggable {
     ...
     * Object containing the parameters of a config.
     */
    get configData(): CfnConfig.ConfigDataProperty | cdk.IResolvable;
    /**
     * Object containing the parameters of a config.
     */
    set configData(value: CfnConfig.ConfigDataProperty | cdk.IResolvable);
    /**
     * The name of the config object.
     */
    get name(): string;
...
export declare namespace CfnConfig {
    ...
    interface ConfigDataProperty {
         ...
         */
        readonly telemetrySinkConfig?: cdk.IResolvable | CfnConfig.TelemetrySinkConfigProperty;
        /**
     ...
     */
    interface TelemetrySinkConfigProperty {
        /**
         ...
         */
        readonly telemetrySinkData: cdk.IResolvable | CfnConfig.TelemetrySinkDataProperty;
        /**
     ...
     */
    interface TelemetrySinkDataProperty {
        /**
         ...
         */
        readonly kinesisDataStreamData: cdk.IResolvable | CfnConfig.KinesisDataStreamDataProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface KinesisDataStreamDataProperty {
        /**
...
export declare class CfnDataflowEndpointGroup extends cdk.CfnResource implements cdk.IInspectable, IDataflowEndpointGroupRef, cdk.ITaggable {
     ...
     * Amount of time, in seconds, after a contact ends that the Ground Station Dataflow Endpoint Group will be in a `POSTPASS` state.
     */
    get contactPostPassDurationSeconds(): number | undefined;
    /**
     * Amount of time, in seconds, after a contact ends that the Ground Station Dataflow Endpoint Group will be in a `POSTPASS` state.
     */
    set contactPostPassDurationSeconds(value: number | undefined);
    /**
     * Amount of time, in seconds, before a contact starts that the Ground Station Dataflow Endpoint Group will be in a `PREPASS` state.
     */
    get contactPrePassDurationSeconds(): number | undefined;
    /**
     * Amount of time, in seconds, before a contact starts that the Ground Station Dataflow Endpoint Group will be in a `PREPASS` state.
     */
    set contactPrePassDurationSeconds(value: number | undefined);
    /**
     * List of Endpoint Details, containing address and port for each endpoint.
     */
    get endpointDetails(): Array<CfnDataflowEndpointGroup.EndpointDetailsProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * List of Endpoint Details, containing address and port for each endpoint.
     */
    set endpointDetails(value: Array<CfnDataflowEndpointGroup.EndpointDetailsProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Tags assigned to a resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnMissionProfile extends cdk.CfnResource implements cdk.IInspectable, IMissionProfileRef, cdk.ITaggable {
     ...
     */
    private _streamsKmsKey?;
    /**
     * Role to use for encrypting streams with KMS key.
     */
    private _streamsKmsRole?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     */
    private _telemetrySinkConfigArn?;
    /**
     ...
     * A list containing lists of config ARNs.
     */
    get dataflowEdges(): Array<CfnMissionProfile.DataflowEdgeProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list containing lists of config ARNs.
     */
    set dataflowEdges(value: Array<CfnMissionProfile.DataflowEdgeProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Minimum length of a contact in seconds that Ground Station will return when listing contacts.
     */
     ...
     * KMS key to use for encrypting streams.
     */
    get streamsKmsKey(): cdk.IResolvable | CfnMissionProfile.StreamsKmsKeyProperty | undefined;
    /**
     * KMS key to use for encrypting streams.
     */
    set streamsKmsKey(value: cdk.IResolvable | CfnMissionProfile.StreamsKmsKeyProperty | undefined);
    /**
     * Role to use for encrypting streams with KMS key.
     */
    get streamsKmsRole(): string | undefined;
    /**
     * Role to use for encrypting streams with KMS key.
     */
    set streamsKmsRole(value: string | undefined);
    /**
     * Tags assigned to the mission profile.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * ARN of a Config resource of type TelemetrySinkConfig used for telemetry data sink configuration.
     */
    get telemetrySinkConfigArn(): string | undefined;
    /**
     * ARN of a Config resource of type TelemetrySinkConfig used for telemetry data sink configuration.
     */
    set telemetrySinkConfigArn(value: string | undefined);
    /**
     * The ARN of a tracking config objects that defines how to track the satellite through the sky during a contact.
     */
...
export interface CfnMissionProfileProps {
     ...
     */
    readonly trackingConfigArn: groundStationRefs.IConfigRef | string;
}
/**
 ...
 */
export declare class CfnDataflowEndpointGroupV2 extends cdk.CfnResource implements cdk.IInspectable, IDataflowEndpointGroupV2Ref, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDataflowEndpointGroupV2 from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDataflowEndpointGroupV2;
    /**
     * Checks whether the given object is a CfnDataflowEndpointGroupV2
     */
    static isCfnDataflowEndpointGroupV2(x: any): x is CfnDataflowEndpointGroupV2;
    static arnForDataflowEndpointGroupV2(resource: IDataflowEndpointGroupV2Ref): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnDataflowEndpointGroupV2Props);
    get dataflowEndpointGroupV2Ref(): DataflowEndpointGroupV2Reference;
    /**
     * Amount of time, in seconds, after a contact ends that the Ground Station Dataflow Endpoint Group will be in a POSTPASS state.
     */
    get contactPostPassDurationSeconds(): number | undefined;
     ...
     * List of endpoints for the dataflow endpoint group.
     */
    get endpoints(): Array<CfnDataflowEndpointGroupV2.CreateEndpointDetailsProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * List of endpoints for the dataflow endpoint group.
     */
    set endpoints(value: Array<CfnDataflowEndpointGroupV2.CreateEndpointDetailsProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Tags assigned to a resource.
     */
     ...
     */
    get attrEndpointDetails(): cdk.IResolvable;
    /**
     * @cloudformationAttribute Id
     */
    get attrId(): string;
...
export declare namespace CfnDataflowEndpointGroupV2 {
    /**
     ...
     */
    interface CreateEndpointDetailsProperty {
        /**
         ...
         */
        readonly downlinkAwsGroundStationAgentEndpoint?: CfnDataflowEndpointGroupV2.DownlinkAwsGroundStationAgentEndpointProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly uplinkAwsGroundStationAgentEndpoint?: cdk.IResolvable | CfnDataflowEndpointGroupV2.UplinkAwsGroundStationAgentEndpointProperty;
    }
    /**
     * Definition for an uplink agent endpoint.
     *
    ...
    interface UplinkAwsGroundStationAgentEndpointProperty {
         ...
         */
        readonly dataflowDetails: cdk.IResolvable | CfnDataflowEndpointGroupV2.UplinkDataflowDetailsProperty;
        /**
    ...
    interface UplinkDataflowDetailsProperty {
         ...
         */
        readonly agentConnectionDetails: cdk.IResolvable | CfnDataflowEndpointGroupV2.UplinkConnectionDetailsProperty;
    }
    /**
    ...
    interface UplinkConnectionDetailsProperty {
         ...
         */
        readonly agentIpAndPortAddress: cdk.IResolvable | CfnDataflowEndpointGroupV2.RangedConnectionDetailsProperty;
        /**
         ...
         */
        readonly ingressAddressAndPort: CfnDataflowEndpointGroupV2.ConnectionDetailsProperty | cdk.IResolvable;
    }
    /**
     * Egress address of AgentEndpoint with an optional mtu.
     *
    ...
    interface ConnectionDetailsProperty {
         ...
         */
        readonly socketAddress: cdk.IResolvable | CfnDataflowEndpointGroupV2.SocketAddressProperty;
    }
    /**
    ...
    interface RangedConnectionDetailsProperty {
         ...
         */
        readonly socketAddress: cdk.IResolvable | CfnDataflowEndpointGroupV2.RangedSocketAddressProperty;
    }
    /**
     * A socket address with a port range.
     *
    ...
    interface RangedSocketAddressProperty {
         ...
         */
        readonly portRange: CfnDataflowEndpointGroupV2.IntegerRangeProperty | cdk.IResolvable;
    }
    /**
     * An integer range that has a minimum and maximum value.
     *
    ...
    interface DownlinkAwsGroundStationAgentEndpointProperty {
         ...
         */
        readonly dataflowDetails: CfnDataflowEndpointGroupV2.DownlinkDataflowDetailsProperty | cdk.IResolvable;
        /**
    ...
    interface DownlinkDataflowDetailsProperty {
         ...
         */
        readonly agentConnectionDetails: CfnDataflowEndpointGroupV2.DownlinkConnectionDetailsProperty | cdk.IResolvable;
    }
    /**
     ...
     */
    interface DownlinkConnectionDetailsProperty {
        /**
         ...
         */
        readonly egressAddressAndPort: CfnDataflowEndpointGroupV2.ConnectionDetailsProperty | cdk.IResolvable;
    }
    /**
     * Information about the endpoint details.
     *
    ...
    interface EndpointDetailsProperty {
         ...
         */
        readonly downlinkAwsGroundStationAgentEndpoint?: CfnDataflowEndpointGroupV2.DownlinkAwsGroundStationAgentEndpointDetailsProperty | cdk.IResolvable;
        /**
         * Definition for an uplink agent endpoint.
         *
         ...
         */
        readonly uplinkAwsGroundStationAgentEndpoint?: cdk.IResolvable | CfnDataflowEndpointGroupV2.UplinkAwsGroundStationAgentEndpointDetailsProperty;
    }
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-groundstation-dataflowendpointgroupv2.html
 */
export interface CfnDataflowEndpointGroupV2Props {
    /**
     * Amount of time, in seconds, after a contact ends that the Ground Station Dataflow Endpoint Group will be in a POSTPASS state.
     *
     ...
     */
    readonly endpoints?: Array<CfnDataflowEndpointGroupV2.CreateEndpointDetailsProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Tags assigned to a resource.
     *
...
export type { IDataflowEndpointGroupV2Ref, DataflowEndpointGroupV2Reference };
